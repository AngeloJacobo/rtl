...
VL_ATTR_COLD void Vmain___024root__trace_init_sub__TOP__0(Vmain___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    tracep->declBit(c+4147,"i_clk", false,-1);
    tracep->declBit(c+4148,"i_reset", false,-1);
    tracep->declQuad(c+4149,"i_ddr3_controller_iserdes_data", false,-1, 63,0);
    tracep->declBus(c+4151,"i_ddr3_controller_iserdes_dqs", false,-1, 7,0);
    tracep->declBus(c+4152,"i_ddr3_controller_iserdes_bitslip_reference", false,-1, 7,0);
    tracep->declBit(c+4153,"i_ddr3_controller_idelayctrl_rdy", false,-1);
    tracep->declArray(c+4154,"o_ddr3_controller_cmd", false,-1, 95,0);
    tracep->declBit(c+4157,"o_ddr3_controller_dqs_tri_control", false,-1);
    tracep->declBit(c+4158,"o_ddr3_controller_dq_tri_control", false,-1);
    tracep->declBit(c+4159,"o_ddr3_controller_toggle_dqs", false,-1);
    tracep->declQuad(c+4160,"o_ddr3_controller_data", false,-1, 63,0);
    tracep->declBus(c+4162,"o_ddr3_controller_dm", false,-1, 7,0);
    tracep->declBus(c+4163,"o_ddr3_controller_odelay_data_cntvaluein", false,-1, 4,0);
    tracep->declBus(c+4164,"o_ddr3_controller_odelay_dqs_cntvaluein", false,-1, 4,0);
    tracep->declBus(c+4165,"o_ddr3_controller_idelay_data_cntvaluein", false,-1, 4,0);
    tracep->declBus(c+4166,"o_ddr3_controller_idelay_dqs_cntvaluein", false,-1, 4,0);
    tracep->declBus(c+4167,"o_ddr3_controller_odelay_data_ld", false,-1, 0,0);
    tracep->declBus(c+4168,"o_ddr3_controller_odelay_dqs_ld", false,-1, 0,0);
    tracep->declBus(c+4169,"o_ddr3_controller_idelay_data_ld", false,-1, 0,0);
    tracep->declBus(c+4170,"o_ddr3_controller_idelay_dqs_ld", false,-1, 0,0);
    tracep->declBus(c+4171,"o_ddr3_controller_bitslip", false,-1, 0,0);
    tracep->declBus(c+4172,"o_sirefclk_word", false,-1, 7,0);
    tracep->declBit(c+4173,"o_sirefclk_ce", false,-1);
    tracep->declBit(c+4174,"i_fan_sda", false,-1);
    tracep->declBit(c+4175,"i_fan_scl", false,-1);
    tracep->declBit(c+4176,"o_fan_sda", false,-1);
    tracep->declBit(c+4177,"o_fan_scl", false,-1);
    tracep->declBit(c+4178,"o_fpga_pwm", false,-1);
    tracep->declBit(c+4179,"o_sys_pwm", false,-1);
    tracep->declBit(c+4180,"i_fan_tach", false,-1);
    tracep->declBit(c+4181,"i_i2c_sda", false,-1);
    tracep->declBit(c+4182,"i_i2c_scl", false,-1);
    tracep->declBit(c+4183,"o_i2c_sda", false,-1);
    tracep->declBit(c+4184,"o_i2c_scl", false,-1);
    tracep->declBit(c+4185,"cpu_sim_cyc", false,-1);
    tracep->declBit(c+4186,"cpu_sim_stb", false,-1);
    tracep->declBit(c+4187,"cpu_sim_we", false,-1);
    tracep->declBus(c+4188,"cpu_sim_addr", false,-1, 6,0);
    tracep->declBus(c+4189,"cpu_sim_data", false,-1, 31,0);
    tracep->declBit(c+4190,"cpu_sim_stall", false,-1);
    tracep->declBit(c+4191,"cpu_sim_ack", false,-1);
    tracep->declBus(c+4192,"cpu_sim_idata", false,-1, 31,0);
    tracep->declBit(c+4193,"cpu_prof_stb", false,-1);
    tracep->declBus(c+4194,"cpu_prof_addr", false,-1, 27,0);
    tracep->declBus(c+4195,"cpu_prof_ticks", false,-1, 31,0);
    tracep->declBit(c+4196,"i_cpu_reset", false,-1);
    tracep->declBit(c+4197,"i_wbu_uart_rx", false,-1);
    tracep->declBit(c+4198,"o_wbu_uart_tx", false,-1);
    tracep->declBit(c+4199,"o_wbu_uart_cts_n", false,-1);
    tracep->declBus(c+4200,"i_gpio", false,-1, 15,0);
    tracep->declBus(c+4201,"o_gpio", false,-1, 7,0);
    tracep->declBus(c+4202,"i_sw", false,-1, 7,0);
    tracep->declBus(c+4203,"i_btn", false,-1, 4,0);
    tracep->declBus(c+4204,"o_led", false,-1, 7,0);
    tracep->declBit(c+4205,"i_clk200", false,-1);
    tracep->pushNamePrefix("main ");
    tracep->declDouble(c+4247,"DDR3_CONTROLLERCONTROLLER_CLK_PERIOD", false,-1);
    tracep->declDouble(c+4249,"DDR3_CLK_PERIOD", false,-1);
    tracep->declBus(c+4251,"DDR3_CONTROLLERROW_BITS", false,-1, 31,0);
    tracep->declBus(c+4252,"DDR3_CONTROLLERCOL_BITS", false,-1, 31,0);
    tracep->declBus(c+4253,"DDR3_CONTROLLERBA_BITS", false,-1, 31,0);
    tracep->declBus(c+4254,"DDR3_CONTROLLERDQ_BITS", false,-1, 31,0);
    tracep->declBus(c+4255,"DDR3_CONTROLLERLANES", false,-1, 31,0);
    tracep->declBus(c+4255,"DDR3_CONTROLLERAUX_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4256,"DDR3_CONTROLLERSERDES_RATIO", false,-1, 31,0);
    tracep->declBus(c+4257,"DDR3_CONTROLLERCMD_LEN", false,-1, 31,0);
    tracep->declBus(c+4258,"RESET_ADDRESS", false,-1, 31,0);
    tracep->declBus(c+4259,"ZIP_ADDRESS_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4260,"ZIP_INTS", false,-1, 31,0);
    tracep->declBus(c+4261,"ZIP_START_HALTED", false,-1, 0,0);
    tracep->declBus(c+4262,"BUSUART", false,-1, 23,0);
    tracep->declBus(c+4263,"DBGBUSBITS", false,-1, 31,0);
    tracep->declBus(c+4260,"DBGBUSWATCHDOG_RAW", false,-1, 31,0);
    tracep->declBus(c+4264,"DBGBUSWATCHDOG", false,-1, 31,0);
    tracep->declBus(c+4253,"ICAPE_LGDIV", false,-1, 31,0);
    tracep->declBit(c+4147,"i_clk", false,-1);
    tracep->declBit(c+4148,"i_reset", false,-1);
    tracep->declQuad(c+4149,"i_ddr3_controller_iserdes_data", false,-1, 63,0);
    tracep->declBus(c+4151,"i_ddr3_controller_iserdes_dqs", false,-1, 7,0);
    ...
    tracep->declBit(c+4198,"o_wbu_uart_tx", false,-1);
    tracep->declBit(c+4199,"o_wbu_uart_cts_n", false,-1);
    tracep->declBus(c+4260,"NGPI", false,-1, 31,0);
    tracep->declBus(c+4254,"NGPO", false,-1, 31,0);
    tracep->declBus(c+4200,"i_gpio", false,-1, 15,0);
    tracep->declBus(c+4201,"o_gpio", false,-1, 7,0);
    tracep->declBus(c+4202,"i_sw", false,-1, 7,0);
    tracep->declBus(c+4203,"i_btn", false,-1, 4,0);
    ...
    tracep->declBus(c+4065,"ddr3_controller_aux_out", false,-1, 0,0);
    tracep->declBus(c+4206,"ddr3_controller_debug1", false,-1, 31,0);
    tracep->declBus(c+4207,"ddr3_controller_debug2", false,-1, 31,0);
    tracep->declBus(c+4208,"ddr3_controller_debug3", false,-1, 31,0);
    ...
    tracep->declBus(c+4209,"fan_debug", false,-1, 31,0);
    tracep->declBus(c+4265,"I2C_ID_WIDTH", false,-1, 31,0);
    ...
    tracep->declBus(c+4266,"zip_debug", false,-1, 31,0);
    tracep->declBit(c+4267,"zip_trigger", false,-1);
    ...
    tracep->declBus(c+4266,"cfg_debug", false,-1, 31,0);
    ...
    tracep->declBit(c+4268,"wbwide_i2cdma_we", false,-1);
    ...
    tracep->declBit(c+4267,"wbwide_i2cm_we", false,-1);
    tracep->declBus(c+218,"wbwide_i2cm_addr", false,-1, 21,0);
    tracep->declArray(c+4269,"wbwide_i2cm_data", false,-1, 511,0);
    tracep->declQuad(c+4285,"wbwide_i2cm_sel", false,-1, 63,0);
    ...
    tracep->declBit(c+3835,"wbwide_bkram_cyc", false,-1);
    tracep->declBit(c+3836,"wbwide_bkram_stb", false,-1);
    ...
    tracep->declBit(c+4267,"wbwide_bkram_stall", false,-1);
    tracep->declBit(c+340,"wbwide_bkram_ack", false,-1);
    tracep->declBit(c+4267,"wbwide_bkram_err", false,-1);
    tracep->declArray(c+341,"wbwide_bkram_idata", false,-1, 511,0);
    tracep->declBit(c+3837,"wbwide_wbdown_cyc", false,-1);
    tracep->declBit(c+3838,"wbwide_wbdown_stb", false,-1);
    ...
    tracep->declBit(c+3839,"wbwide_wbdown_err", false,-1);
    tracep->declArray(c+379,"wbwide_wbdown_idata", false,-1, 511,0);
    tracep->declBit(c+3840,"wb32_wbdown_cyc", false,-1);
    ...
    tracep->declBit(c+3841,"wb32_wbdown_err", false,-1);
    tracep->declBus(c+402,"wb32_wbdown_idata", false,-1, 31,0);
    tracep->declBit(c+3842,"wb32_buildtime_cyc", false,-1);
    tracep->declBit(c+3843,"wb32_buildtime_stb", false,-1);
    tracep->declBit(c+3844,"wb32_buildtime_we", false,-1);
    tracep->declBus(c+4287,"wb32_buildtime_addr", false,-1, 24,0);
    tracep->declBus(c+3845,"wb32_buildtime_data", false,-1, 31,0);
    tracep->declBus(c+3846,"wb32_buildtime_sel", false,-1, 3,0);
    tracep->declBit(c+4267,"wb32_buildtime_stall", false,-1);
    tracep->declBit(c+3843,"wb32_buildtime_ack", false,-1);
    tracep->declBit(c+4288,"wb32_buildtime_err", false,-1);
    tracep->declBus(c+4289,"wb32_buildtime_idata", false,-1, 31,0);
    tracep->declBit(c+3842,"wb32_gpio_cyc", false,-1);
    tracep->declBit(c+3847,"wb32_gpio_stb", false,-1);
    tracep->declBit(c+3844,"wb32_gpio_we", false,-1);
    tracep->declBus(c+4290,"wb32_gpio_addr", false,-1, 24,0);
    tracep->declBus(c+3845,"wb32_gpio_data", false,-1, 31,0);
    tracep->declBus(c+3846,"wb32_gpio_sel", false,-1, 3,0);
    tracep->declBit(c+4267,"wb32_gpio_stall", false,-1);
    tracep->declBit(c+3847,"wb32_gpio_ack", false,-1);
    tracep->declBit(c+4291,"wb32_gpio_err", false,-1);
    tracep->declBus(c+4210,"wb32_gpio_idata", false,-1, 31,0);
    tracep->declBit(c+3842,"wb32_sirefclk_cyc", false,-1);
    tracep->declBit(c+3848,"wb32_sirefclk_stb", false,-1);
    tracep->declBit(c+3844,"wb32_sirefclk_we", false,-1);
    tracep->declBus(c+4292,"wb32_sirefclk_addr", false,-1, 24,0);
    tracep->declBus(c+3845,"wb32_sirefclk_data", false,-1, 31,0);
    tracep->declBus(c+3846,"wb32_sirefclk_sel", false,-1, 3,0);
    tracep->declBit(c+4267,"wb32_sirefclk_stall", false,-1);
    tracep->declBit(c+150,"wb32_sirefclk_ack", false,-1);
    tracep->declBit(c+4293,"wb32_sirefclk_err", false,-1);
    tracep->declBus(c+403,"wb32_sirefclk_idata", false,-1, 31,0);
    tracep->declBit(c+3842,"wb32_spio_cyc", false,-1);
    tracep->declBit(c+3849,"wb32_spio_stb", false,-1);
    tracep->declBit(c+3844,"wb32_spio_we", false,-1);
    tracep->declBus(c+4294,"wb32_spio_addr", false,-1, 24,0);
    tracep->declBus(c+3845,"wb32_spio_data", false,-1, 31,0);
    tracep->declBus(c+3846,"wb32_spio_sel", false,-1, 3,0);
    tracep->declBit(c+4267,"wb32_spio_stall", false,-1);
    tracep->declBit(c+404,"wb32_spio_ack", false,-1);
    tracep->declBit(c+4295,"wb32_spio_err", false,-1);
    tracep->declBus(c+405,"wb32_spio_idata", false,-1, 31,0);
    tracep->declBit(c+3842,"wb32_version_cyc", false,-1);
    tracep->declBit(c+3850,"wb32_version_stb", false,-1);
    tracep->declBit(c+3844,"wb32_version_we", false,-1);
    tracep->declBus(c+4296,"wb32_version_addr", false,-1, 24,0);
    tracep->declBus(c+3845,"wb32_version_data", false,-1, 31,0);
    tracep->declBus(c+3846,"wb32_version_sel", false,-1, 3,0);
    tracep->declBit(c+4267,"wb32_version_stall", false,-1);
    tracep->declBit(c+3850,"wb32_version_ack", false,-1);
    tracep->declBit(c+4297,"wb32_version_err", false,-1);
    tracep->declBus(c+4298,"wb32_version_idata", false,-1, 31,0);
    tracep->declBit(c+3851,"wb32_i2cscope_cyc", false,-1);
    tracep->declBit(c+3852,"wb32_i2cscope_stb", false,-1);
    tracep->declBit(c+3853,"wb32_i2cscope_we", false,-1);
    tracep->declBus(c+3854,"wb32_i2cscope_addr", false,-1, 24,0);
    tracep->declBus(c+3855,"wb32_i2cscope_data", false,-1, 31,0);
    tracep->declBus(c+3856,"wb32_i2cscope_sel", false,-1, 3,0);
    tracep->declBit(c+4267,"wb32_i2cscope_stall", false,-1);
    tracep->declBit(c+406,"wb32_i2cscope_ack", false,-1);
    tracep->declBit(c+4267,"wb32_i2cscope_err", false,-1);
    tracep->declBus(c+407,"wb32_i2cscope_idata", false,-1, 31,0);
    tracep->declBit(c+3857,"wb32_scope1_ddr3_cyc", false,-1);
    tracep->declBit(c+3858,"wb32_scope1_ddr3_stb", false,-1);
    tracep->declBit(c+3859,"wb32_scope1_ddr3_we", false,-1);
    tracep->declBus(c+3860,"wb32_scope1_ddr3_addr", false,-1, 24,0);
    tracep->declBus(c+3861,"wb32_scope1_ddr3_data", false,-1, 31,0);
    tracep->declBus(c+3862,"wb32_scope1_ddr3_sel", false,-1, 3,0);
    tracep->declBit(c+4267,"wb32_scope1_ddr3_stall", false,-1);
    tracep->declBit(c+408,"wb32_scope1_ddr3_ack", false,-1);
    tracep->declBit(c+4267,"wb32_scope1_ddr3_err", false,-1);
    tracep->declBus(c+409,"wb32_scope1_ddr3_idata", false,-1, 31,0);
    tracep->declBit(c+3863,"wb32_scope2_ddr3_cyc", false,-1);
    tracep->declBit(c+3864,"wb32_scope2_ddr3_stb", false,-1);
    tracep->declBit(c+3865,"wb32_scope2_ddr3_we", false,-1);
    tracep->declBus(c+3866,"wb32_scope2_ddr3_addr", false,-1, 24,0);
    tracep->declBus(c+3867,"wb32_scope2_ddr3_data", false,-1, 31,0);
    tracep->declBus(c+3868,"wb32_scope2_ddr3_sel", false,-1, 3,0);
    tracep->declBit(c+4267,"wb32_scope2_ddr3_stall", false,-1);
    tracep->declBit(c+410,"wb32_scope2_ddr3_ack", false,-1);
    tracep->declBit(c+4267,"wb32_scope2_ddr3_err", false,-1);
    tracep->declBus(c+411,"wb32_scope2_ddr3_idata", false,-1, 31,0);
    tracep->declBit(c+3869,"wb32_scope3_ddr3_cyc", false,-1);
    tracep->declBit(c+3870,"wb32_scope3_ddr3_stb", false,-1);
    tracep->declBit(c+3871,"wb32_scope3_ddr3_we", false,-1);
    tracep->declBus(c+3872,"wb32_scope3_ddr3_addr", false,-1, 24,0);
    tracep->declBus(c+3873,"wb32_scope3_ddr3_data", false,-1, 31,0);
    tracep->declBus(c+3874,"wb32_scope3_ddr3_sel", false,-1, 3,0);
    tracep->declBit(c+4267,"wb32_scope3_ddr3_stall", false,-1);
    tracep->declBit(c+412,"wb32_scope3_ddr3_ack", false,-1);
    tracep->declBit(c+4267,"wb32_scope3_ddr3_err", false,-1);
    tracep->declBus(c+413,"wb32_scope3_ddr3_idata", false,-1, 31,0);
    tracep->declBit(c+3875,"wb32_i2cs_cyc", false,-1);
    tracep->declBit(c+3876,"wb32_i2cs_stb", false,-1);
    tracep->declBit(c+3877,"wb32_i2cs_we", false,-1);
    tracep->declBus(c+3878,"wb32_i2cs_addr", false,-1, 24,0);
    tracep->declBus(c+3879,"wb32_i2cs_data", false,-1, 31,0);
    tracep->declBus(c+3880,"wb32_i2cs_sel", false,-1, 3,0);
    tracep->declBit(c+4267,"wb32_i2cs_stall", false,-1);
    tracep->declBit(c+414,"wb32_i2cs_ack", false,-1);
    tracep->declBit(c+4267,"wb32_i2cs_err", false,-1);
    tracep->declBus(c+415,"wb32_i2cs_idata", false,-1, 31,0);
    tracep->declBit(c+3881,"wb32_i2cdma_cyc", false,-1);
    tracep->declBit(c+3882,"wb32_i2cdma_stb", false,-1);
    tracep->declBit(c+3883,"wb32_i2cdma_we", false,-1);
    tracep->declBus(c+3884,"wb32_i2cdma_addr", false,-1, 24,0);
    tracep->declBus(c+3885,"wb32_i2cdma_data", false,-1, 31,0);
    tracep->declBus(c+3886,"wb32_i2cdma_sel", false,-1, 3,0);
    tracep->declBit(c+4267,"wb32_i2cdma_stall", false,-1);
    tracep->declBit(c+416,"wb32_i2cdma_ack", false,-1);
    tracep->declBit(c+4267,"wb32_i2cdma_err", false,-1);
    tracep->declBus(c+417,"wb32_i2cdma_idata", false,-1, 31,0);
    tracep->declBit(c+3887,"wb32_uart_cyc", false,-1);
    tracep->declBit(c+3888,"wb32_uart_stb", false,-1);
    tracep->declBit(c+3889,"wb32_uart_we", false,-1);
    tracep->declBus(c+3890,"wb32_uart_addr", false,-1, 24,0);
    tracep->declBus(c+3891,"wb32_uart_data", false,-1, 31,0);
    tracep->declBus(c+3892,"wb32_uart_sel", false,-1, 3,0);
    tracep->declBit(c+4267,"wb32_uart_stall", false,-1);
    tracep->declBit(c+418,"wb32_uart_ack", false,-1);
    tracep->declBit(c+4267,"wb32_uart_err", false,-1);
    tracep->declBus(c+419,"wb32_uart_idata", false,-1, 31,0);
    tracep->declBit(c+3893,"wb32_fan_cyc", false,-1);
    tracep->declBit(c+3894,"wb32_fan_stb", false,-1);
    tracep->declBit(c+3895,"wb32_fan_we", false,-1);
    tracep->declBus(c+3896,"wb32_fan_addr", false,-1, 24,0);
    tracep->declBus(c+3897,"wb32_fan_data", false,-1, 31,0);
    tracep->declBus(c+3898,"wb32_fan_sel", false,-1, 3,0);
    tracep->declBit(c+4267,"wb32_fan_stall", false,-1);
    tracep->declBit(c+420,"wb32_fan_ack", false,-1);
    tracep->declBit(c+4267,"wb32_fan_err", false,-1);
    tracep->declBus(c+421,"wb32_fan_idata", false,-1, 31,0);
    tracep->declBit(c+3842,"wb32_sio_cyc", false,-1);
    tracep->declBit(c+3899,"wb32_sio_stb", false,-1);
    tracep->declBit(c+3844,"wb32_sio_we", false,-1);
    tracep->declBus(c+3900,"wb32_sio_addr", false,-1, 24,0);
    tracep->declBus(c+3845,"wb32_sio_data", false,-1, 31,0);
    tracep->declBus(c+3846,"wb32_sio_sel", false,-1, 3,0);
    tracep->declBit(c+4267,"wb32_sio_stall", false,-1);
    tracep->declBit(c+422,"wb32_sio_ack", false,-1);
    tracep->declBit(c+4267,"wb32_sio_err", false,-1);
    tracep->declBus(c+423,"wb32_sio_idata", false,-1, 31,0);
    tracep->declBit(c+3901,"wb32_cfg_cyc", false,-1);
    tracep->declBit(c+3902,"wb32_cfg_stb", false,-1);
    tracep->declBit(c+3903,"wb32_cfg_we", false,-1);
    tracep->declBus(c+3904,"wb32_cfg_addr", false,-1, 24,0);
    tracep->declBus(c+3905,"wb32_cfg_data", false,-1, 31,0);
    tracep->declBus(c+3906,"wb32_cfg_sel", false,-1, 3,0);
    tracep->declBit(c+4267,"wb32_cfg_stall", false,-1);
    tracep->declBit(c+424,"wb32_cfg_ack", false,-1);
    tracep->declBit(c+4267,"wb32_cfg_err", false,-1);
    tracep->declBus(c+4266,"wb32_cfg_idata", false,-1, 31,0);
    tracep->declBit(c+3907,"wb32_ddr3_phy_cyc", false,-1);
    tracep->declBit(c+3908,"wb32_ddr3_phy_stb", false,-1);
    tracep->declBit(c+3909,"wb32_ddr3_phy_we", false,-1);
    tracep->declBus(c+3910,"wb32_ddr3_phy_addr", false,-1, 24,0);
    tracep->declBus(c+3911,"wb32_ddr3_phy_data", false,-1, 31,0);
    tracep->declBus(c+3912,"wb32_ddr3_phy_sel", false,-1, 3,0);
    tracep->declBit(c+3658,"wb32_ddr3_phy_stall", false,-1);
    tracep->declBit(c+3659,"wb32_ddr3_phy_ack", false,-1);
    tracep->declBit(c+4267,"wb32_ddr3_phy_err", false,-1);
    tracep->declBus(c+3660,"wb32_ddr3_phy_idata", false,-1, 31,0);
    tracep->declBit(c+3913,"wb32_ddr3_controller_cyc", false,-1);
    tracep->declBit(c+3914,"wb32_ddr3_controller_stb", false,-1);
    tracep->declBit(c+3915,"wb32_ddr3_controller_we", false,-1);
    tracep->declBus(c+3916,"wb32_ddr3_controller_addr", false,-1, 24,0);
    tracep->declBus(c+3917,"wb32_ddr3_controller_data", false,-1, 31,0);
    tracep->declBus(c+3918,"wb32_ddr3_controller_sel", false,-1, 3,0);
    tracep->declBit(c+3661,"wb32_ddr3_controller_stall", false,-1);
    tracep->declBit(c+4211,"wb32_ddr3_controller_ack", false,-1);
    tracep->declBit(c+4267,"wb32_ddr3_controller_err", false,-1);
    tracep->declBus(c+4066,"wb32_ddr3_controller_idata", false,-1, 31,0);
    ...
    tracep->declBus(c+4299,"wbu_sel", false,-1, 3,0);
    ...
    tracep->declBit(c+4212,"wbu_zip_stall", false,-1);
    tracep->declBit(c+4213,"wbu_zip_ack", false,-1);
    tracep->declBit(c+4267,"wbu_zip_err", false,-1);
    ...
    tracep->declBit(c+4267,"zip_unused", false,-1);
    ...
    tracep->declBit(c+4267,"cfg_unused", false,-1);
    tracep->declBus(c+4300,"INITIAL_GPIO", false,-1, 7,0);
    tracep->pushNamePrefix("bkrami ");
    tracep->declBus(c+4301,"LGMEMSZ", false,-1, 31,0);
    tracep->declBus(c+4302,"DW", false,-1, 31,0);
    tracep->declBus(c+4255,"EXTRACLOCK", false,-1, 31,0);
    tracep->declBus(c+4303,"HEXFILE", false,-1, 7,0);
    tracep->declBus(c+4304,"OPT_ROM", false,-1, 0,0);
    tracep->declBus(c+4251,"AW", false,-1, 31,0);
    tracep->declBit(c+4147,"i_clk", false,-1);
    tracep->declBit(c+4148,"i_reset", false,-1);
    tracep->declBit(c+3835,"i_wb_cyc", false,-1);
    tracep->declBit(c+3836,"i_wb_stb", false,-1);
    ...
    tracep->declBit(c+4267,"o_wb_stall", false,-1);
    ...
    tracep->declBit(c+4267,"unused", false,-1);
    ...
    tracep->declBus(c+4305,"BW", false,-1, 31,0);
    tracep->declBus(c+4254,"UPSAMPLE", false,-1, 31,0);
    tracep->declBit(c+4147,"i_clk", false,-1);
    tracep->declBus(c+475,"i_delay", false,-1, 31,0);
    tracep->declBus(c+4172,"o_word", false,-1, 7,0);
    ...
    tracep->declBus(c+4306,"LGFLEN", false,-1, 3,0);
    tracep->declBit(c+4147,"i_clk", false,-1);
    tracep->declBit(c+4267,"i_reset", false,-1);
    tracep->declBit(c+3887,"i_wb_cyc", false,-1);
    tracep->declBit(c+3888,"i_wb_stb", false,-1);
    tracep->declBit(c+3889,"i_wb_we", false,-1);
    tracep->declBus(c+3919,"i_wb_addr", false,-1, 1,0);
    ...
    tracep->declBus(c+4306,"LCLLGFLEN", false,-1, 3,0);
    tracep->declBus(c+4307,"UART_SETUP", false,-1, 1,0);
    tracep->declBus(c+4308,"UART_FIFO", false,-1, 1,0);
    tracep->declBus(c+4309,"UART_RXREG", false,-1, 1,0);
    tracep->declBus(c+4310,"UART_TXREG", false,-1, 1,0);
    ...
    tracep->declBus(c+4263,"BW", false,-1, 31,0);
    tracep->declBus(c+4306,"LGFLEN", false,-1, 3,0);
    tracep->declBus(c+4261,"RXFIFO", false,-1, 0,0);
    tracep->declBus(c+4311,"FLEN", false,-1, 31,0);
    tracep->declBit(c+4147,"i_clk", false,-1);
    ...
    tracep->declBus(c+4306,"lglen", false,-1, 3,0);
    ...
    tracep->declBus(c+4263,"BW", false,-1, 31,0);
    tracep->declBus(c+4306,"LGFLEN", false,-1, 3,0);
    tracep->declBus(c+4304,"RXFIFO", false,-1, 0,0);
    tracep->declBus(c+4311,"FLEN", false,-1, 31,0);
    tracep->declBit(c+4147,"i_clk", false,-1);
    ...
    tracep->declDouble(c+4247,"CONTROLLER_CLK_PERIOD", false,-1);
    tracep->declDouble(c+4249,"DDR3_CLK_PERIOD", false,-1);
    tracep->declBus(c+4251,"ROW_BITS", false,-1, 31,0);
    tracep->declBus(c+4252,"COL_BITS", false,-1, 31,0);
    tracep->declBus(c+4253,"BA_BITS", false,-1, 31,0);
    tracep->declBus(c+4254,"DQ_BITS", false,-1, 31,0);
    tracep->declBus(c+4255,"LANES", false,-1, 31,0);
    tracep->declBus(c+4255,"AUX_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4263,"WB2_ADDR_BITS", false,-1, 31,0);
    tracep->declBus(c+4305,"WB2_DATA_BITS", false,-1, 31,0);
    tracep->declBus(c+4261,"OPT_LOWPOWER", false,-1, 0,0);
    tracep->declBus(c+4261,"OPT_BUS_ABORT", false,-1, 0,0);
    tracep->declBus(c+4304,"MICRON_SIM", false,-1, 0,0);
    tracep->declBus(c+4261,"ODELAY_SUPPORTED", false,-1, 0,0);
    tracep->declBus(c+4256,"serdes_ratio", false,-1, 31,0);
    tracep->declBus(c+4311,"wb_data_bits", false,-1, 31,0);
    tracep->declBus(c+4257,"wb_addr_bits", false,-1, 31,0);
    tracep->declBus(c+4254,"wb_sel_bits", false,-1, 31,0);
    tracep->declBus(c+4256,"wb2_sel_bits", false,-1, 31,0);
    tracep->declBus(c+4257,"cmd_len", false,-1, 31,0);
    tracep->declBus(c+4255,"lanes_clog2", false,-1, 31,0);
    tracep->declBit(c+4147,"i_controller_clk", false,-1);
    tracep->declBit(c+4214,"i_rst_n", false,-1);
    tracep->declBit(c+3913,"i_wb_cyc", false,-1);
    tracep->declBit(c+3914,"i_wb_stb", false,-1);
    tracep->declBit(c+3915,"i_wb_we", false,-1);
    tracep->declBus(c+3920,"i_wb_addr", false,-1, 23,0);
    tracep->declQuad(c+3921,"i_wb_data", false,-1, 63,0);
    tracep->declBus(c+3923,"i_wb_sel", false,-1, 7,0);
    tracep->declBus(c+4267,"i_aux", false,-1, 0,0);
    tracep->declBit(c+3661,"o_wb_stall", false,-1);
    tracep->declBit(c+4211,"o_wb_ack", false,-1);
    tracep->declQuad(c+4067,"o_wb_data", false,-1, 63,0);
    tracep->declBus(c+4065,"o_aux", false,-1, 0,0);
    tracep->declBit(c+3907,"i_wb2_cyc", false,-1);
    tracep->declBit(c+3908,"i_wb2_stb", false,-1);
    tracep->declBit(c+3909,"i_wb2_we", false,-1);
    tracep->declBus(c+3924,"i_wb2_addr", false,-1, 6,0);
    tracep->declBus(c+3912,"i_wb2_sel", false,-1, 3,0);
    tracep->declBus(c+3911,"i_wb2_data", false,-1, 31,0);
    ...
    tracep->declQuad(c+4149,"i_phy_iserdes_data", false,-1, 63,0);
    tracep->declBus(c+4151,"i_phy_iserdes_dqs", false,-1, 7,0);
    tracep->declBus(c+4152,"i_phy_iserdes_bitslip_reference", false,-1, 7,0);
    tracep->declBit(c+4153,"i_phy_idelayctrl_rdy", false,-1);
    tracep->declArray(c+4154,"o_phy_cmd", false,-1, 95,0);
    tracep->declBit(c+4157,"o_phy_dqs_tri_control", false,-1);
    tracep->declBit(c+4158,"o_phy_dq_tri_control", false,-1);
    tracep->declBit(c+4159,"o_phy_toggle_dqs", false,-1);
    tracep->declQuad(c+4160,"o_phy_data", false,-1, 63,0);
    tracep->declBus(c+4162,"o_phy_dm", false,-1, 7,0);
    tracep->declBus(c+4163,"o_phy_odelay_data_cntvaluein", false,-1, 4,0);
    tracep->declBus(c+4164,"o_phy_odelay_dqs_cntvaluein", false,-1, 4,0);
    tracep->declBus(c+4165,"o_phy_idelay_data_cntvaluein", false,-1, 4,0);
    tracep->declBus(c+4166,"o_phy_idelay_dqs_cntvaluein", false,-1, 4,0);
    tracep->declBus(c+4167,"o_phy_odelay_data_ld", false,-1, 0,0);
    tracep->declBus(c+4168,"o_phy_odelay_dqs_ld", false,-1, 0,0);
    tracep->declBus(c+4169,"o_phy_idelay_data_ld", false,-1, 0,0);
    tracep->declBus(c+4170,"o_phy_idelay_dqs_ld", false,-1, 0,0);
    tracep->declBus(c+4171,"o_phy_bitslip", false,-1, 0,0);
    tracep->declBus(c+4206,"o_debug1", false,-1, 31,0);
    tracep->declBus(c+4207,"o_debug2", false,-1, 31,0);
    tracep->declBus(c+4208,"o_debug3", false,-1, 31,0);
    tracep->declBus(c+4312,"CMD_MRS", false,-1, 3,0);
    tracep->declBus(c+4313,"CMD_REF", false,-1, 3,0);
    tracep->declBus(c+4314,"CMD_PRE", false,-1, 3,0);
    tracep->declBus(c+4315,"CMD_ACT", false,-1, 3,0);
    tracep->declBus(c+4316,"CMD_WR", false,-1, 3,0);
    tracep->declBus(c+4317,"CMD_RD", false,-1, 3,0);
    tracep->declBus(c+4318,"CMD_NOP", false,-1, 3,0);
    tracep->declBus(c+4306,"CMD_ZQC", false,-1, 3,0);
    tracep->declBus(c+4319,"RST_DONE", false,-1, 31,0);
    tracep->declBus(c+4319,"REF_IDLE", false,-1, 31,0);
    tracep->declBus(c+4320,"USE_TIMER", false,-1, 31,0);
    tracep->declBus(c+4321,"A10_CONTROL", false,-1, 31,0);
    tracep->declBus(c+4257,"CLOCK_EN", false,-1, 31,0);
    tracep->declBus(c+4322,"RESET_N", false,-1, 31,0);
    tracep->declBus(c+4259,"DDR3_CMD_START", false,-1, 31,0);
    tracep->declBus(c+4264,"DDR3_CMD_END", false,-1, 31,0);
    tracep->declBus(c+4323,"MRS_BANK_START", false,-1, 31,0);
    tracep->declBus(c+4322,"CMD_CS_N", false,-1, 31,0);
    tracep->declBus(c+4259,"CMD_RAS_N", false,-1, 31,0);
    tracep->declBus(c+4324,"CMD_CAS_N", false,-1, 31,0);
    tracep->declBus(c+4301,"CMD_WE_N", false,-1, 31,0);
    tracep->declBus(c+4264,"CMD_ODT", false,-1, 31,0);
    tracep->declBus(c+4323,"CMD_CKE", false,-1, 31,0);
    tracep->declBus(c+4325,"CMD_RESET_N", false,-1, 31,0);
    tracep->declBus(c+4260,"CMD_BANK_START", false,-1, 31,0);
    tracep->declBus(c+4326,"CMD_ADDRESS_START", false,-1, 31,0);
    tracep->declBus(c+4309,"READ_SLOT", false,-1, 1,0);
    tracep->declBus(c+4310,"WRITE_SLOT", false,-1, 1,0);
    tracep->declBus(c+4307,"ACTIVATE_SLOT", false,-1, 1,0);
    tracep->declBus(c+4308,"PRECHARGE_SLOT", false,-1, 1,0);
    tracep->declBus(c+4266,"DATA_INITIAL_ODELAY_TAP", false,-1, 31,0);
    tracep->declBus(c+4254,"DQS_INITIAL_ODELAY_TAP", false,-1, 31,0);
    tracep->declBus(c+4266,"DATA_INITIAL_IDELAY_TAP", false,-1, 31,0);
    tracep->declBus(c+4254,"DQS_INITIAL_IDELAY_TAP", false,-1, 31,0);
    tracep->declBus(c+4264,"DELAY_SLOT_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4327,"POWER_ON_RESET_HIGH", false,-1, 31,0);
    tracep->declBus(c+4328,"INITIAL_CKE_LOW", false,-1, 31,0);
    tracep->declDouble(c+4329,"tRCD", false,-1);
    tracep->declDouble(c+4329,"tRP", false,-1);
    tracep->declBus(c+4331,"tRAS", false,-1, 31,0);
    tracep->declDouble(c+4332,"tRFC", false,-1);
    tracep->declBus(c+4334,"tREFI", false,-1, 31,0);
    tracep->declDouble(c+4335,"tXPR", false,-1);
    tracep->declDouble(c+4337,"tWR", false,-1);
    tracep->declDouble(c+4247,"tWTR", false,-1);
    tracep->declBus(c+4339,"tWLMRD", false,-1, 18,0);
    tracep->declDouble(c+4340,"tWLO", false,-1);
    tracep->declBus(c+4265,"tWLOE", false,-1, 31,0);
    tracep->declDouble(c+4247,"tRTP", false,-1);
    tracep->declBus(c+4256,"tCCD", false,-1, 31,0);
    tracep->declBus(c+4253,"tMOD", false,-1, 31,0);
    tracep->declBus(c+4342,"tZQinit", false,-1, 31,0);
    tracep->declBus(c+4343,"CL_nCK", false,-1, 31,0);
    tracep->declBus(c+4344,"CWL_nCK", false,-1, 31,0);
    tracep->declBus(c+4345,"DELAY_MAX_VALUE", false,-1, 18,0);
    tracep->declBus(c+4260,"DELAY_COUNTER_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4265,"CALIBRATION_DELAY", false,-1, 31,0);
    tracep->declBus(c+4313,"PRECHARGE_TO_ACTIVATE_DELAY", false,-1, 3,0);
    tracep->declBus(c+4315,"ACTIVATE_TO_PRECHARGE_DELAY", false,-1, 3,0);
    tracep->declBus(c+4312,"ACTIVATE_TO_WRITE_DELAY", false,-1, 3,0);
    tracep->declBus(c+4312,"ACTIVATE_TO_READ_DELAY", false,-1, 3,0);
    tracep->declBus(c+4313,"READ_TO_WRITE_DELAY", false,-1, 3,0);
    tracep->declBus(c+4312,"READ_TO_READ_DELAY", false,-1, 3,0);
    tracep->declBus(c+4313,"READ_TO_PRECHARGE_DELAY", false,-1, 3,0);
    tracep->declBus(c+4312,"WRITE_TO_WRITE_DELAY", false,-1, 3,0);
    tracep->declBus(c+4315,"WRITE_TO_READ_DELAY", false,-1, 3,0);
    tracep->declBus(c+4316,"WRITE_TO_PRECHARGE_DELAY", false,-1, 3,0);
    tracep->declBus(c+4344,"PRE_REFRESH_DELAY", false,-1, 31,0);
    tracep->declBus(c+4317,"MARGIN_BEFORE_ANTICIPATE", false,-1, 3,0);
    tracep->declBus(c+4265,"STAGE2_DATA_DEPTH", false,-1, 31,0);
    tracep->declBus(c+4266,"READ_DELAY", false,-1, 31,0);
    tracep->declBus(c+4344,"READ_ACK_PIPE_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4260,"MAX_ADDED_READ_ACK_DELAY", false,-1, 31,0);
    tracep->declBus(c+4326,"DELAY_BEFORE_WRITE_LEVEL_FEEDBACK", false,-1, 31,0);
    tracep->declBus(c+4266,"IDLE", false,-1, 31,0);
    tracep->declBus(c+4255,"BITSLIP_DQS_TRAIN_1", false,-1, 31,0);
    tracep->declBus(c+4265,"MPR_READ", false,-1, 31,0);
    tracep->declBus(c+4253,"COLLECT_DQS", false,-1, 31,0);
    tracep->declBus(c+4256,"ANALYZE_DQS", false,-1, 31,0);
    tracep->declBus(c+4344,"CALIBRATE_DQS", false,-1, 31,0);
    tracep->declBus(c+4343,"BITSLIP_DQS_TRAIN_2", false,-1, 31,0);
    tracep->declBus(c+4263,"START_WRITE_LEVEL", false,-1, 31,0);
    tracep->declBus(c+4254,"WAIT_FOR_FEEDBACK", false,-1, 31,0);
    tracep->declBus(c+4346,"ISSUE_WRITE_1", false,-1, 31,0);
    tracep->declBus(c+4252,"ISSUE_WRITE_2", false,-1, 31,0);
    tracep->declBus(c+4347,"ISSUE_READ", false,-1, 31,0);
    tracep->declBus(c+4348,"READ_DATA", false,-1, 31,0);
    tracep->declBus(c+4326,"ANALYZE_DATA", false,-1, 31,0);
    tracep->declBus(c+4251,"CHECK_STARTING_DATA", false,-1, 31,0);
    tracep->declBus(c+4349,"BITSLIP_DQS_TRAIN_3", false,-1, 31,0);
    tracep->declBus(c+4260,"DONE_CALIBRATE", false,-1, 31,0);
    tracep->declBus(c+4344,"STORED_DQS_SIZE", false,-1, 31,0);
    tracep->declBus(c+4255,"REPEAT_DQS_ANALYZE", false,-1, 31,0);
    tracep->declBus(c+4301,"REPEAT_CLK_SAMPLING", false,-1, 31,0);
    tracep->declBus(c+4350,"PASR", false,-1, 2,0);
    tracep->declBus(c+4350,"CWL", false,-1, 2,0);
    tracep->declBus(c+4261,"ASR", false,-1, 0,0);
    tracep->declBus(c+4304,"SRT", false,-1, 0,0);
    tracep->declBus(c+4307,"RTT_WR", false,-1, 1,0);
    tracep->declBus(c+4351,"MR2_SEL", false,-1, 2,0);
    tracep->declBus(c+4352,"MR2", false,-1, 18,0);
    tracep->declBus(c+4307,"MPR_LOC", false,-1, 1,0);
    tracep->declBus(c+4261,"MPR_EN", false,-1, 0,0);
    tracep->declBus(c+4304,"MPR_DIS", false,-1, 0,0);
    tracep->declBus(c+4353,"MR3_SEL", false,-1, 2,0);
    tracep->declBus(c+4354,"MR3_MPR_EN", false,-1, 18,0);
    tracep->declBus(c+4355,"MR3_MPR_DIS", false,-1, 18,0);
    tracep->declBus(c+4304,"DLL_EN", false,-1, 0,0);
    tracep->declBus(c+4307,"DIC", false,-1, 1,0);
    tracep->declBus(c+4353,"RTT_NOM", false,-1, 2,0);
    tracep->declBus(c+4261,"WL_EN", false,-1, 0,0);
    tracep->declBus(c+4304,"WL_DIS", false,-1, 0,0);
    tracep->declBus(c+4307,"AL", false,-1, 1,0);
    tracep->declBus(c+4304,"TDQS", false,-1, 0,0);
    tracep->declBus(c+4304,"QOFF", false,-1, 0,0);
    tracep->declBus(c+4356,"MR1_SEL", false,-1, 2,0);
    tracep->declBus(c+4357,"MR1_WL_EN", false,-1, 18,0);
    tracep->declBus(c+4358,"MR1_WL_DIS", false,-1, 18,0);
    tracep->declBus(c+4307,"BL", false,-1, 1,0);
    tracep->declBus(c+4316,"CL", false,-1, 3,0);
    tracep->declBus(c+4304,"RBT", false,-1, 0,0);
    tracep->declBus(c+4261,"DLL_RST", false,-1, 0,0);
    tracep->declBus(c+4353,"WR", false,-1, 2,0);
    tracep->declBus(c+4304,"PPD", false,-1, 0,0);
    tracep->declBus(c+4350,"MR0_SEL", false,-1, 2,0);
    tracep->declBus(c+4359,"MR0", false,-1, 18,0);
    tracep->declBus(c+4360,"INITIAL_RESET_INSTRUCTION", false,-1, 27,0);
    ...
    tracep->declBit(c+4267,"issue_write_command", false,-1);
    tracep->declBit(c+3670,"stage2_update", false,-1);
    tracep->declBit(c+4086,"stage2_stall", false,-1);
    tracep->declBit(c+4087,"stage1_stall", false,-1);
    tracep->declBus(c+3671,"bank_status_q", false,-1, 7,0);
    tracep->declBus(c+4088,"bank_status_d", false,-1, 7,0);
    for (int i = 0; i < 8; ++i) {
        tracep->declBus(c+3672+i*1,"bank_active_row_q", true,(i+0), 13,0);
    }
    for (int i = 0; i < 8; ++i) {
        tracep->declBus(c+4089+i*1,"bank_active_row_d", true,(i+0), 13,0);
    }
    ...
    tracep->declBus(c+3925,"wb_addr_plus_anticipate", false,-1, 23,0);
    ...
    for (int i = 0; i < 8; ++i) {
        tracep->declBus(c+4097+i*1,"delay_before_precharge_counter_d", true,(i+0), 3,0);
    }
    for (int i = 0; i < 8; ++i) {
        tracep->declBus(c+3720+i*1,"delay_before_activate_counter_q", true,(i+0), 3,0);
    }
    for (int i = 0; i < 8; ++i) {
        tracep->declBus(c+4105+i*1,"delay_before_activate_counter_d", true,(i+0), 3,0);
    }
    for (int i = 0; i < 8; ++i) {
        tracep->declBus(c+3728+i*1,"delay_before_write_counter_q", true,(i+0), 3,0);
    }
    for (int i = 0; i < 8; ++i) {
        tracep->declBus(c+4113+i*1,"delay_before_write_counter_d", true,(i+0), 3,0);
    }
    for (int i = 0; i < 8; ++i) {
        tracep->declBus(c+3736+i*1,"delay_before_read_counter_q", true,(i+0), 3,0);
    }
    for (int i = 0; i < 8; ++i) {
        tracep->declBus(c+4121+i*1,"delay_before_read_counter_d", true,(i+0), 3,0);
    }
    for (int i = 0; i < 4; ++i) {
        tracep->declBus(c+4129+i*1,"cmd_d", true,(i+0), 23,0);
    }
    tracep->declBit(c+3744,"cmd_odt_q", false,-1);
    tracep->declBit(c+4133,"cmd_odt", false,-1);
    tracep->declBit(c+4134,"cmd_ck_en", false,-1);
    tracep->declBit(c+4135,"cmd_reset_n", false,-1);
    tracep->declBit(c+3745,"o_wb_stall_q", false,-1);
    tracep->declBit(c+4136,"o_wb_stall_d", false,-1);
    tracep->declBit(c+4137,"precharge_slot_busy", false,-1);
    tracep->declBit(c+4138,"activate_slot_busy", false,-1);
    ...
    for (int i = 0; i < 16; ++i) {
        tracep->declBus(c+4069+i*1,"o_wb_ack_read_q", true,(i+0), 1,0);
    }
    ...
    tracep->declBus(c+3812,"odelay_data_cntvaluein_prev", false,-1, 4,0);
    for (int i = 0; i < 1; ++i) {
        tracep->declBus(c+3813+i*1,"idelay_dqs_cntvaluein", true,(i+0), 4,0);
    }
    tracep->declBus(c+3814,"sample_clk_repeat", false,-1, 5,0);
    tracep->declBit(c+3815,"stored_write_level_feedback", false,-1);
    tracep->declBus(c+3816,"start_index_check", false,-1, 5,0);
    tracep->declQuad(c+3817,"read_lane_data", false,-1, 63,0);
    tracep->declBit(c+3819,"wb2_stb", false,-1);
    tracep->declBit(c+3820,"wb2_update", false,-1);
    tracep->declBit(c+3821,"wb2_we", false,-1);
    tracep->declBus(c+3822,"wb2_addr", false,-1, 6,0);
    tracep->declBus(c+3823,"wb2_data", false,-1, 31,0);
    tracep->declBus(c+3824,"wb2_sel", false,-1, 3,0);
    tracep->declBus(c+3825,"wb2_phy_odelay_data_cntvaluein", false,-1, 4,0);
    tracep->declBus(c+3826,"wb2_phy_odelay_dqs_cntvaluein", false,-1, 4,0);
    tracep->declBus(c+3827,"wb2_phy_idelay_data_cntvaluein", false,-1, 4,0);
    tracep->declBus(c+3828,"wb2_phy_idelay_dqs_cntvaluein", false,-1, 4,0);
    tracep->declBus(c+3829,"wb2_phy_odelay_data_ld", false,-1, 0,0);
    tracep->declBus(c+3830,"wb2_phy_odelay_dqs_ld", false,-1, 0,0);
    tracep->declBus(c+3831,"wb2_phy_idelay_data_ld", false,-1, 0,0);
    tracep->declBus(c+3832,"wb2_phy_idelay_dqs_ld", false,-1, 0,0);
    tracep->declBus(c+3833,"wb2_write_lane", false,-1, 0,0);
    tracep->declBus(c+3926,"wb_data_to_wb2", false,-1, 31,0);
    tracep->declBit(c+4085,"debug_trigger", false,-1);
    tracep->declBit(c+4215,"dq_all_zeroes", false,-1);
    tracep->declBus(c+4361,"get_slot__Vstatic__delay", false,-1, 31,0);
    tracep->declBus(c+4362,"get_slot__Vstatic__slot_number", false,-1, 1,0);
    tracep->declBus(c+4363,"get_slot__Vstatic__read_slot", false,-1, 1,0);
    tracep->declBus(c+4364,"get_slot__Vstatic__write_slot", false,-1, 1,0);
    tracep->declBus(c+4365,"get_slot__Vstatic__anticipate_activate_slot", false,-1, 1,0);
    tracep->declBus(c+4366,"get_slot__Vstatic__anticipate_precharge_slot", false,-1, 1,0);
    tracep->declBus(c+4367,"find_delay__Vstatic__k", false,-1, 31,0);
    tracep->popNamePrefix(1);
    tracep->pushNamePrefix("genbus ");
    tracep->declBus(c+4264,"LGWATCHDOG", false,-1, 31,0);
    tracep->declBus(c+4343,"LGINPUT_FIFO", false,-1, 31,0);
    tracep->declBus(c+4252,"LGOUTPUT_FIFO", false,-1, 31,0);
    tracep->declBus(c+4304,"CMD_PORT_OFF_UNTIL_ACCESSED", false,-1, 0,0);
    tracep->declBus(c+4368,"AW", false,-1, 31,0);
    tracep->declBit(c+4147,"i_clk", false,-1);
    tracep->declBit(c+4148,"i_reset", false,-1);
    ...
    tracep->declBit(c+4268,"cmd_port_active", false,-1);
    ...
    tracep->declBus(c+4369,"BW", false,-1, 31,0);
    tracep->declBus(c+4252,"LGFLEN", false,-1, 31,0);
    tracep->declBit(c+4147,"i_clk", false,-1);
    ...
    tracep->declBus(c+4370,"FLEN", false,-1, 31,0);
    ...
    tracep->declBit(c+4267,"gen_unused", false,-1);
    ...
    tracep->declBus(c+4261,"OPT_COMPRESSION", false,-1, 0,0);
    tracep->declBit(c+4147,"i_clk", false,-1);
    tracep->declBit(c+4148,"i_reset", false,-1);
    ...
    tracep->declBit(c+4267,"i_busy", false,-1);
    ...
    tracep->declBus(c+4304,"OPT_SKIDBUFFER", false,-1, 0,0);
    tracep->declBit(c+4147,"i_clk", false,-1);
    tracep->declBit(c+4148,"i_reset", false,-1);
    ...
    tracep->declBus(c+4304,"OPT_COUNT_FIFO", false,-1, 0,0);
    tracep->declBus(c+4256,"LGFIFO", false,-1, 31,0);
    tracep->declBus(c+4368,"AW", false,-1, 31,0);
    ...
    tracep->declBus(c+4307,"WB_IDLE", false,-1, 1,0);
    tracep->declBus(c+4308,"WB_READ_REQUEST", false,-1, 1,0);
    tracep->declBus(c+4309,"WB_WRITE_REQUEST", false,-1, 1,0);
    tracep->declBus(c+4310,"WB_FLUSH_WRITE_REQUESTS", false,-1, 1,0);
    tracep->declBus(c+4308,"WRITE_PREFIX", false,-1, 1,0);
    ...
    tracep->declBus(c+4371,"fifo_space_available", false,-1, 4,0);
    tracep->declBit(c+4268,"space_available", false,-1);
    tracep->pushNamePrefix("NO_FIFO ");
    tracep->declBit(c+4267,"unused_count", false,-1);
    tracep->popNamePrefix(2);
    tracep->pushNamePrefix("wroutput ");
    tracep->declBus(c+4261,"OPT_COMPRESSION", false,-1, 0,0);
    tracep->declBus(c+4261,"OPT_IDLES", false,-1, 0,0);
    tracep->declBit(c+4147,"i_clk", false,-1);
    tracep->declBit(c+4148,"i_reset", false,-1);
    ...
    tracep->declBus(c+4305,"DW", false,-1, 31,0);
    tracep->declBus(c+4369,"CW", false,-1, 31,0);
    tracep->declBus(c+4252,"TBITS", false,-1, 31,0);
    tracep->declBit(c+4147,"i_clk", false,-1);
    tracep->declBit(c+172,"i_reset", false,-1);
    ...
    tracep->declQuad(c+4372,"CW_INTERRUPT", false,-1, 35,0);
    tracep->declQuad(c+4374,"CW_BUSBUSY", false,-1, 35,0);
    tracep->declQuad(c+4376,"CW_IDLE", false,-1, 35,0);
    tracep->declBus(c+4259,"IDLEBITS", false,-1, 31,0);
    ...
    tracep->declBus(c+4378,"MAX_LINE_LENGTH", false,-1, 6,0);
    tracep->declBus(c+4379,"TRIGGER_LENGTH", false,-1, 6,0);
    ...
    tracep->declBus(c+4260,"NIN", false,-1, 31,0);
    tracep->declBus(c+4254,"NOUT", false,-1, 31,0);
    tracep->declBus(c+4300,"DEFAULT", false,-1, 7,0);
    tracep->declBit(c+4147,"i_clk", false,-1);
    tracep->declBit(c+3842,"i_wb_cyc", false,-1);
    tracep->declBit(c+3847,"i_wb_stb", false,-1);
    tracep->declBit(c+3844,"i_wb_we", false,-1);
    tracep->declBus(c+3845,"i_wb_data", false,-1, 31,0);
    tracep->declBus(c+3846,"i_wb_sel", false,-1, 3,0);
    tracep->declBit(c+4267,"o_wb_stall", false,-1);
    tracep->declBit(c+3847,"o_wb_ack", false,-1);
    tracep->declBus(c+4210,"o_wb_data", false,-1, 31,0);
    tracep->declBus(c+4200,"i_gpio", false,-1, 15,0);
    tracep->declBus(c+4201,"o_gpio", false,-1, 7,0);
    ...
    tracep->declBus(c+4216,"low_bits", false,-1, 15,0);
    tracep->declBit(c+4267,"unused", false,-1);
    tracep->popNamePrefix(1);
    tracep->pushNamePrefix("i2ci ");
    tracep->declBus(c+4259,"ADDRESS_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4302,"DATA_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4254,"I2C_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4265,"AXIS_ID_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4307,"DEF_CHANNEL", false,-1, 1,0);
    tracep->declBus(c+4259,"AW", false,-1, 31,0);
    tracep->declBus(c+4302,"DW", false,-1, 31,0);
    tracep->declBus(c+4254,"RW", false,-1, 31,0);
    tracep->declBus(c+4380,"BAW", false,-1, 31,0);
    tracep->declBus(c+4381,"RESET_ADDRESS", false,-1, 27,0);
    tracep->declBus(c+4261,"OPT_START_HALTED", false,-1, 0,0);
    tracep->declBus(c+4261,"OPT_MANUAL", false,-1, 0,0);
    tracep->declBus(c+4266,"OPT_WATCHDOG", false,-1, 31,0);
    tracep->declBus(c+4382,"DEF_CKCOUNT", false,-1, 11,0);
    tracep->declBus(c+4304,"OPT_LOWPOWER", false,-1, 0,0);
    tracep->declBit(c+4147,"i_clk", false,-1);
    tracep->declBit(c+4148,"i_reset", false,-1);
    tracep->declBit(c+3875,"i_wb_cyc", false,-1);
    tracep->declBit(c+3876,"i_wb_stb", false,-1);
    tracep->declBit(c+3877,"i_wb_we", false,-1);
    tracep->declBus(c+3927,"i_wb_addr", false,-1, 1,0);
    ...
    tracep->declBit(c+4267,"o_pf_we", false,-1);
    tracep->declBus(c+218,"o_pf_addr", false,-1, 21,0);
    tracep->declArray(c+4269,"o_pf_data", false,-1, 511,0);
    tracep->declQuad(c+4285,"o_pf_sel", false,-1, 63,0);
    ...
    tracep->declBit(c+4267,"i_sync_signal", false,-1);
    tracep->declBus(c+35,"o_debug", false,-1, 31,0);
    tracep->declBus(c+4307,"ADR_CONTROL", false,-1, 1,0);
    tracep->declBus(c+4308,"ADR_OVERRIDE", false,-1, 1,0);
    tracep->declBus(c+4309,"ADR_ADDRESS", false,-1, 1,0);
    tracep->declBus(c+4310,"ADR_CKCOUNT", false,-1, 1,0);
    tracep->declBus(c+4264,"HALT_BIT", false,-1, 31,0);
    tracep->declBus(c+4301,"ERR_BIT", false,-1, 31,0);
    tracep->declBus(c+4324,"ABORT_BIT", false,-1, 31,0);
    tracep->declBus(c+4259,"SOFTHALT_BIT", false,-1, 31,0);
    tracep->declBus(c+4346,"OVW_VALID", false,-1, 31,0);
    tracep->declBus(c+4347,"MANUAL_BIT", false,-1, 31,0);
    tracep->declBus(c+4312,"CMD_NOOP", false,-1, 3,0);
    tracep->declBus(c+4314,"CMD_STOP", false,-1, 3,0);
    tracep->declBus(c+4315,"CMD_SEND", false,-1, 3,0);
    tracep->declBus(c+4316,"CMD_RXK", false,-1, 3,0);
    tracep->declBus(c+4317,"CMD_RXN", false,-1, 3,0);
    tracep->declBus(c+4306,"CMD_RXLK", false,-1, 3,0);
    tracep->declBus(c+4318,"CMD_RXLN", false,-1, 3,0);
    tracep->declBus(c+4383,"CMD_WAIT", false,-1, 3,0);
    tracep->declBus(c+4384,"CMD_HALT", false,-1, 3,0);
    tracep->declBus(c+4385,"CMD_ABORT", false,-1, 3,0);
    tracep->declBus(c+4386,"CMD_TARGET", false,-1, 3,0);
    tracep->declBus(c+4387,"CMD_JUMP", false,-1, 3,0);
    tracep->declBus(c+4388,"CMD_CHANNEL", false,-1, 3,0);
    tracep->declBit(c+675,"cpu_reset", false,-1);
    tracep->declBit(c+4267,"cpu_clear_cache", false,-1);
    ...
    tracep->declBit(c+3928,"next_valid", false,-1);
    tracep->declBus(c+3929,"next_insn", false,-1, 7,0);
    ...
    tracep->declBit(c+3930,"bus_read", false,-1);
    tracep->declBit(c+3931,"bus_write", false,-1);
    tracep->declBit(c+3932,"bus_override", false,-1);
    tracep->declBit(c+3933,"bus_manual", false,-1);
    tracep->declBit(c+707,"ovw_ready", false,-1);
    tracep->declBit(c+3934,"bus_jump", false,-1);
    tracep->declBus(c+3927,"bus_write_addr", false,-1, 1,0);
    tracep->declBus(c+3927,"bus_read_addr", false,-1, 1,0);
    tracep->declBus(c+3879,"bus_write_data", false,-1, 31,0);
    tracep->declBus(c+3880,"bus_write_strb", false,-1, 3,0);
    ...
    tracep->declBus(c+4266,"OPT_WATCHDOG", false,-1, 31,0);
    tracep->declBus(c+4304,"OPT_LOWPOWER", false,-1, 0,0);
    tracep->declBit(c+4147,"S_AXI_ACLK", false,-1);
    ...
    tracep->declBit(c+4182,"i_scl", false,-1);
    tracep->declBit(c+4181,"i_sda", false,-1);
    tracep->declBit(c+706,"o_scl", false,-1);
    tracep->declBit(c+705,"o_sda", false,-1);
    tracep->declBit(c+687,"o_abort", false,-1);
    tracep->declBus(c+4312,"IDLE_STOPPED", false,-1, 3,0);
    tracep->declBus(c+4313,"START", false,-1, 3,0);
    tracep->declBus(c+4314,"IDLE_ACTIVE", false,-1, 3,0);
    tracep->declBus(c+4315,"STOP", false,-1, 3,0);
    tracep->declBus(c+4316,"DATA", false,-1, 3,0);
    tracep->declBus(c+4317,"CLOCK", false,-1, 3,0);
    tracep->declBus(c+4306,"ACK", false,-1, 3,0);
    tracep->declBus(c+4318,"CKACKLO", false,-1, 3,0);
    tracep->declBus(c+4383,"CKACKHI", false,-1, 3,0);
    tracep->declBus(c+4384,"RXNAK", false,-1, 3,0);
    tracep->declBus(c+4385,"ABORT", false,-1, 3,0);
    tracep->declBus(c+4386,"REPEAT_START", false,-1, 3,0);
    tracep->declBus(c+4387,"REPEAT_START2", false,-1, 3,0);
    tracep->declBus(c+4304,"D_RD", false,-1, 0,0);
    tracep->declBus(c+4261,"D_WR", false,-1, 0,0);
    tracep->declBus(c+4350,"CMD_NOOP", false,-1, 2,0);
    tracep->declBus(c+4356,"CMD_START", false,-1, 2,0);
    tracep->declBus(c+4351,"CMD_STOP", false,-1, 2,0);
    tracep->declBus(c+4353,"CMD_SEND", false,-1, 2,0);
    tracep->declBus(c+4389,"CMD_RXK", false,-1, 2,0);
    tracep->declBus(c+4390,"CMD_RXN", false,-1, 2,0);
    tracep->declBus(c+4391,"CMD_RXLK", false,-1, 2,0);
    tracep->declBus(c+4392,"CMD_RXLN", false,-1, 2,0);
    tracep->declBus(c+4304,"OPT_ABORT_REQUEST", false,-1, 0,0);
    ...
    tracep->declBit(c+4267,"watchdog_timeout", false,-1);
    tracep->popNamePrefix(1);
    tracep->pushNamePrefix("u_fetch ");
    tracep->declBus(c+4380,"ADDRESS_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4254,"INSN_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4302,"DATA_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4380,"AW", false,-1, 31,0);
    tracep->declBus(c+4302,"DW", false,-1, 31,0);
    tracep->declBus(c+4304,"OPT_LITTLE_ENDIAN", false,-1, 0,0);
    tracep->declBit(c+4147,"i_clk", false,-1);
    tracep->declBit(c+38,"i_reset", false,-1);
    tracep->declBit(c+676,"i_new_pc", false,-1);
    tracep->declBit(c+4267,"i_clear_cache", false,-1);
    ...
    tracep->declBit(c+4267,"o_wb_we", false,-1);
    tracep->declBus(c+218,"o_wb_addr", false,-1, 21,0);
    tracep->declArray(c+4269,"o_wb_data", false,-1, 511,0);
    ...
    tracep->declBus(c+4343,"NSHIFT", false,-1, 31,0);
    ...
    tracep->declBit(c+4267,"unused_shift", false,-1);
    tracep->popNamePrefix(3);
    tracep->pushNamePrefix("i2cscopei ");
    tracep->declBus(c+4393,"LGMEM", false,-1, 4,0);
    tracep->declBus(c+4305,"BUSW", false,-1, 31,0);
    tracep->declBus(c+4394,"NELM", false,-1, 31,0);
    tracep->declBus(c+4261,"SYNCHRONOUS", false,-1, 0,0);
    tracep->declBus(c+4301,"HOLDOFFBITS", false,-1, 31,0);
    tracep->declBus(c+4395,"DEFAULT_HOLDOFF", false,-1, 19,0);
    tracep->declBus(c+4394,"STEP_BITS", false,-1, 31,0);
    tracep->declBus(c+4396,"MAX_STEP", false,-1, 30,0);
    tracep->declBit(c+4147,"i_data_clk", false,-1);
    tracep->declBit(c+4268,"i_ce", false,-1);
    tracep->declBit(c+700,"i_trigger", false,-1);
    tracep->declBus(c+39,"i_data", false,-1, 30,0);
    tracep->declBit(c+4147,"i_wb_clk", false,-1);
    tracep->declBit(c+3851,"i_wb_cyc", false,-1);
    tracep->declBit(c+3852,"i_wb_stb", false,-1);
    tracep->declBit(c+3853,"i_wb_we", false,-1);
    tracep->declBit(c+3935,"i_wb_addr", false,-1);
    ...
    tracep->declBit(c+3936,"write_stb", false,-1);
    tracep->declBit(c+3937,"read_from_data", false,-1);
    tracep->declBit(c+3938,"write_to_control", false,-1);
    tracep->declBus(c+407,"o_bus_data", false,-1, 31,0);
    tracep->declBit(c+4147,"bus_clock", false,-1);
    ...
    tracep->declBus(c+4344,"DLYSTOP", false,-1, 31,0);
    ...
    tracep->declBus(c+4393,"bw_lgmem", false,-1, 4,0);
    tracep->declBit(c+815,"br_level_interrupt", false,-1);
    tracep->declBit(c+4267,"unused", false,-1);
    tracep->popNamePrefix(1);
    tracep->pushNamePrefix("rcv ");
    tracep->declBus(c+4263,"TIMER_BITS", false,-1, 31,0);
    tracep->declBus(c+4397,"CLOCKS_PER_BAUD", false,-1, 6,0);
    tracep->declBus(c+4263,"TB", false,-1, 31,0);
    tracep->declBus(c+4312,"RXUL_BIT_ZERO", false,-1, 3,0);
    tracep->declBus(c+4313,"RXUL_BIT_ONE", false,-1, 3,0);
    tracep->declBus(c+4314,"RXUL_BIT_TWO", false,-1, 3,0);
    tracep->declBus(c+4315,"RXUL_BIT_THREE", false,-1, 3,0);
    tracep->declBus(c+4316,"RXUL_BIT_FOUR", false,-1, 3,0);
    tracep->declBus(c+4317,"RXUL_BIT_FIVE", false,-1, 3,0);
    tracep->declBus(c+4306,"RXUL_BIT_SIX", false,-1, 3,0);
    tracep->declBus(c+4318,"RXUL_BIT_SEVEN", false,-1, 3,0);
    tracep->declBus(c+4383,"RXUL_STOP", false,-1, 3,0);
    tracep->declBus(c+4384,"RXUL_WAIT", false,-1, 3,0);
    tracep->declBus(c+4299,"RXUL_IDLE", false,-1, 3,0);
    tracep->declBit(c+4147,"i_clk", false,-1);
    tracep->declBit(c+4197,"i_uart_rx", false,-1);
    tracep->declBit(c+169,"o_wr", false,-1);
    tracep->declBus(c+167,"o_data", false,-1, 7,0);
    tracep->declBus(c+4398,"half_baud", false,-1, 6,0);
    ...
    tracep->declBit(c+4147,"i_data_clk", false,-1);
    tracep->declBit(c+4268,"i_ce", false,-1);
    tracep->declBit(c+4085,"i_trigger", false,-1);
    ...
    tracep->declBit(c+3939,"i_wb_addr", false,-1);
    ...
    tracep->declBit(c+3940,"write_stb", false,-1);
    tracep->declBit(c+3941,"read_from_data", false,-1);
    tracep->declBit(c+3942,"write_to_control", false,-1);
    ...
    tracep->declBit(c+3943,"i_wb_addr", false,-1);
    ...
    tracep->declBit(c+3944,"write_stb", false,-1);
    tracep->declBit(c+3945,"read_from_data", false,-1);
    tracep->declBit(c+3946,"write_to_control", false,-1);
    ...
    tracep->declBit(c+3947,"i_wb_addr", false,-1);
    ...
    tracep->declBit(c+3948,"write_stb", false,-1);
    tracep->declBit(c+3949,"read_from_data", false,-1);
    tracep->declBit(c+3950,"write_to_control", false,-1);
    tracep->declBus(c+413,"o_bus_data", false,-1, 31,0);
    tracep->declBit(c+4147,"bus_clock", false,-1);
    tracep->declBit(c+885,"read_address", false,-1);
    tracep->declBus(c+3873,"i_bus_data", false,-1, 31,0);
    ...
    tracep->declBit(c+4141,"dw_trigger", false,-1);
    ...
    tracep->declBit(c+3870,"bw_cyc_stb", false,-1);
    ...
    tracep->declBus(c+4254,"NLEDS", false,-1, 31,0);
    tracep->declBus(c+4344,"NBTN", false,-1, 31,0);
    tracep->declBus(c+4254,"NSW", false,-1, 31,0);
    tracep->declBus(c+4265,"NFF", false,-1, 31,0);
    tracep->declBit(c+4147,"i_clk", false,-1);
    tracep->declBit(c+4148,"i_reset", false,-1);
    tracep->declBit(c+3842,"i_wb_cyc", false,-1);
    tracep->declBit(c+3849,"i_wb_stb", false,-1);
    tracep->declBit(c+3844,"i_wb_we", false,-1);
    tracep->declBus(c+3845,"i_wb_data", false,-1, 31,0);
    tracep->declBus(c+3846,"i_wb_sel", false,-1, 3,0);
    tracep->declBit(c+4267,"o_wb_stall", false,-1);
    ...
    tracep->declBus(c+3951,"next_btn", false,-1, 4,0);
    ...
    tracep->declBit(c+3952,"next_int", false,-1);
    tracep->popNamePrefix(1);
    ...
    tracep->declBus(c+4254,"NLEDS", false,-1, 31,0);
    tracep->declBus(c+4321,"CTRBITS", false,-1, 31,0);
    tracep->declBit(c+4147,"i_clk", false,-1);
    ...
    tracep->declBus(c+4258,"RESET_ADDRESS", false,-1, 31,0);
    tracep->declBus(c+4380,"ADDRESS_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4302,"BUS_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4305,"DBG_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4261,"OPT_PIPELINED", false,-1, 0,0);
    tracep->declBus(c+4261,"OPT_EARLY_BRANCHING", false,-1, 0,0);
    tracep->declBus(c+4348,"OPT_LGICACHE", false,-1, 31,0);
    tracep->declBus(c+4348,"OPT_LGDCACHE", false,-1, 31,0);
    tracep->declBus(c+4261,"START_HALTED", false,-1, 0,0);
    tracep->declBus(c+4261,"OPT_DISTRIBUTED_REGS", false,-1, 0,0);
    tracep->declBus(c+4260,"EXTERNAL_INTERRUPTS", false,-1, 31,0);
    tracep->declBus(c+4253,"OPT_MPY", false,-1, 31,0);
    tracep->declBus(c+4261,"OPT_DIV", false,-1, 0,0);
    tracep->declBus(c+4261,"OPT_SHIFTS", false,-1, 0,0);
    tracep->declBus(c+4304,"OPT_FPU", false,-1, 0,0);
    tracep->declBus(c+4261,"OPT_CIS", false,-1, 0,0);
    tracep->declBus(c+4261,"OPT_LOCK", false,-1, 0,0);
    tracep->declBus(c+4261,"OPT_USERMODE", false,-1, 0,0);
    tracep->declBus(c+4261,"OPT_DBGPORT", false,-1, 0,0);
    tracep->declBus(c+4304,"OPT_TRACE_PORT", false,-1, 0,0);
    tracep->declBus(c+4261,"OPT_PROFILER", false,-1, 0,0);
    tracep->declBus(c+4304,"OPT_LOWPOWER", false,-1, 0,0);
    tracep->declBus(c+4261,"OPT_DMA", false,-1, 0,0);
    tracep->declBus(c+4252,"DMA_LGMEM", false,-1, 31,0);
    tracep->declBus(c+4261,"OPT_ACCOUNTING", false,-1, 0,0);
    tracep->declBus(c+4261,"DELAY_DBG_BUS", false,-1, 0,0);
    tracep->declBus(c+4304,"DELAY_EXT_BUS", false,-1, 0,0);
    tracep->declBus(c+4261,"OPT_SIM", false,-1, 0,0);
    tracep->declBus(c+4304,"OPT_CLKGATE", false,-1, 0,0);
    tracep->declBus(c+4301,"RESET_DURATION", false,-1, 31,0);
    tracep->declBus(c+4259,"PAW", false,-1, 31,0);
    tracep->declBit(c+4147,"i_clk", false,-1);
    tracep->declBit(c+4220,"i_reset", false,-1);
    ...
    tracep->declBus(c+4221,"i_dbg_sel", false,-1, 3,0);
    ...
    tracep->declBus(c+4266,"o_cpu_debug", false,-1, 31,0);
    tracep->declBit(c+4193,"o_prof_stb", false,-1);
    tracep->declBus(c+4194,"o_prof_addr", false,-1, 27,0);
    tracep->declBus(c+4195,"o_prof_ticks", false,-1, 31,0);
    tracep->declBus(c+4302,"DW", false,-1, 31,0);
    tracep->declBus(c+4399,"PERIPHBASE", false,-1, 31,0);
    tracep->declBus(c+4303,"INTCTRL", false,-1, 7,0);
    tracep->declBus(c+4400,"WATCHDOG", false,-1, 7,0);
    tracep->declBus(c+4401,"BUSWATCHDOG", false,-1, 7,0);
    tracep->declBus(c+4402,"CTRINT", false,-1, 7,0);
    tracep->declBus(c+4403,"TIMER_A", false,-1, 7,0);
    tracep->declBus(c+4404,"TIMER_B", false,-1, 7,0);
    tracep->declBus(c+4405,"TIMER_C", false,-1, 7,0);
    tracep->declBus(c+4406,"JIFFIES", false,-1, 7,0);
    tracep->declBus(c+4407,"MSTR_TASK_CTR", false,-1, 7,0);
    tracep->declBus(c+4408,"MSTR_MSTL_CTR", false,-1, 7,0);
    tracep->declBus(c+4409,"MSTR_PSTL_CTR", false,-1, 7,0);
    tracep->declBus(c+4410,"MSTR_INST_CTR", false,-1, 7,0);
    tracep->declBus(c+4411,"USER_TASK_CTR", false,-1, 7,0);
    tracep->declBus(c+4412,"USER_MSTL_CTR", false,-1, 7,0);
    tracep->declBus(c+4413,"USER_PSTL_CTR", false,-1, 7,0);
    tracep->declBus(c+4414,"USER_INST_CTR", false,-1, 7,0);
    tracep->declBus(c+4415,"MMU_ADDR", false,-1, 7,0);
    tracep->declBus(c+4416,"DMAC_ADDR", false,-1, 7,0);
    tracep->declBus(c+4266,"HALT_BIT", false,-1, 31,0);
    tracep->declBus(c+4265,"STEP_BIT", false,-1, 31,0);
    tracep->declBus(c+4253,"RESET_BIT", false,-1, 31,0);
    tracep->declBus(c+4256,"CLEAR_CACHE_BIT", false,-1, 31,0);
    tracep->declBus(c+4344,"CATCH_BIT", false,-1, 31,0);
    tracep->declBus(c+4259,"VIRTUAL_ADDRESS_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4307,"DBG_ADDR_CTRL", false,-1, 1,0);
    tracep->declBus(c+4308,"DBG_ADDR_CPU", false,-1, 1,0);
    tracep->declBus(c+4309,"DBG_ADDR_SYS", false,-1, 1,0);
    ...
    tracep->declBit(c+4267,"actr_stall", false,-1);
    ...
    tracep->declBit(c+4267,"sys_stall", false,-1);
    ...
    tracep->declBit(c+4267,"wdt_stall", false,-1);
    ...
    tracep->declBit(c+4267,"dmac_stall", false,-1);
    ...
    tracep->declBit(c+4267,"ctri_stall", false,-1);
    tracep->declBit(c+1048,"ctri_ack", false,-1);
    tracep->declBus(c+1049,"ctri_data", false,-1, 31,0);
    tracep->declBit(c+4267,"tma_stall", false,-1);
    tracep->declBit(c+1050,"tma_ack", false,-1);
    tracep->declBit(c+4267,"tmb_stall", false,-1);
    tracep->declBit(c+1051,"tmb_ack", false,-1);
    tracep->declBit(c+4267,"tmc_stall", false,-1);
    tracep->declBit(c+1052,"tmc_ack", false,-1);
    tracep->declBit(c+4267,"jif_stall", false,-1);
    ...
    tracep->declBit(c+4267,"pic_stall", false,-1);
    ...
    tracep->declBit(c+4267,"mmus_stall", false,-1);
    ...
    tracep->declBus(c+4266,"mmus_data", false,-1, 31,0);
    tracep->declBit(c+4267,"cpu_miss", false,-1);
    ...
    tracep->declBit(c+4267,"pf_return_stb", false,-1);
    tracep->declBit(c+4267,"pf_return_we", false,-1);
    tracep->declBit(c+4267,"pf_return_cachable", false,-1);
    tracep->declBus(c+4417,"pf_return_v", false,-1, 19,0);
    tracep->declBus(c+4417,"pf_return_p", false,-1, 19,0);
    ...
    tracep->declBit(c+4267,"mtc_stall", false,-1);
    tracep->declBit(c+1115,"mtc_ack", false,-1);
    tracep->declBit(c+4267,"moc_stall", false,-1);
    tracep->declBit(c+1116,"moc_ack", false,-1);
    tracep->declBit(c+4267,"mpc_stall", false,-1);
    tracep->declBit(c+1117,"mpc_ack", false,-1);
    tracep->declBit(c+4267,"mic_stall", false,-1);
    tracep->declBit(c+1118,"mic_ack", false,-1);
    tracep->declBit(c+4267,"utc_stall", false,-1);
    tracep->declBit(c+1119,"utc_ack", false,-1);
    tracep->declBit(c+4267,"uoc_stall", false,-1);
    tracep->declBit(c+1120,"uoc_ack", false,-1);
    tracep->declBit(c+4267,"upc_stall", false,-1);
    tracep->declBit(c+1121,"upc_ack", false,-1);
    tracep->declBit(c+4267,"uic_stall", false,-1);
    ...
    tracep->declBit(c+4267,"dbg_err", false,-1);
    tracep->pushNamePrefix("wbdelay ");
    tracep->declBus(c+4263,"AW", false,-1, 31,0);
    tracep->declBus(c+4305,"DW", false,-1, 31,0);
    tracep->declBus(c+4261,"DELAY_STALL", false,-1, 0,0);
    tracep->declBus(c+4304,"OPT_LOWPOWER", false,-1, 0,0);
    tracep->declBit(c+4147,"i_clk", false,-1);
    tracep->declBit(c+4220,"i_reset", false,-1);
    ...
    tracep->declBus(c+4299,"i_wb_sel", false,-1, 3,0);
    ...
    tracep->declBit(c+4267,"i_dly_err", false,-1);
    ...
    tracep->declBus(c+4380,"ADDRESS_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4252,"LGMEMLEN", false,-1, 31,0);
    tracep->declBus(c+4380,"LGDMALENGTH", false,-1, 31,0);
    tracep->declBus(c+4305,"SLV_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4302,"BUS_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4304,"OPT_LITTLE_ENDIAN", false,-1, 0,0);
    tracep->declBus(c+4304,"OPT_LOWPOWER", false,-1, 0,0);
    tracep->declBus(c+4304,"OPT_REGISTER_RAM", false,-1, 0,0);
    tracep->declBus(c+4259,"AW", false,-1, 31,0);
    tracep->declBit(c+4147,"i_clk", false,-1);
    ...
    tracep->declBus(c+4299,"i_swb_sel", false,-1, 3,0);
    tracep->declBit(c+4267,"o_swb_stall", false,-1);
    ...
    tracep->declBus(c+4418,"FIFO_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4256,"LGFIFO", false,-1, 31,0);
    ...
    tracep->declBit(c+4267,"mm2s_rd_we", false,-1);
    ...
    tracep->declArray(c+4269,"mm2s_rd_data", false,-1, 511,0);
    ...
    tracep->declBit(c+4268,"s2mm_wr_we", false,-1);
    ...
    tracep->declBus(c+4302,"DW", false,-1, 31,0);
    tracep->declBus(c+4259,"AW", false,-1, 31,0);
    tracep->declArray(c+4419,"SCHEME", false,-1, 87,0);
    tracep->declBus(c+4304,"OPT_ZERO_ON_IDLE", false,-1, 0,0);
    tracep->declBit(c+4147,"i_clk", false,-1);
    tracep->declBit(c+994,"i_reset", false,-1);
    tracep->declBit(c+1173,"i_a_cyc", false,-1);
    tracep->declBit(c+1174,"i_a_stb", false,-1);
    tracep->declBit(c+4267,"i_a_we", false,-1);
    ...
    tracep->declBit(c+4268,"i_b_we", false,-1);
    ...
    tracep->declBus(c+4305,"SLV_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4380,"LGDMALENGTH", false,-1, 31,0);
    tracep->declBus(c+4422,"ABORT_KEY", false,-1, 31,0);
    tracep->declBus(c+4304,"OPT_LOWPOWER", false,-1, 0,0);
    tracep->declBus(c+4380,"AW", false,-1, 31,0);
    tracep->declBit(c+4147,"i_clk", false,-1);
    tracep->declBit(c+994,"i_reset", false,-1);
    ...
    tracep->declBus(c+4299,"i_sel", false,-1, 3,0);
    tracep->declBit(c+4267,"o_stall", false,-1);
    ...
    tracep->declBit(c+4267,"unused_len", false,-1);
    tracep->popNamePrefix(1);
    tracep->pushNamePrefix("UNUSED_WIDE_ADDR ");
    tracep->declBit(c+4267,"unused_addr", false,-1);
    tracep->popNamePrefix(2);
    tracep->pushNamePrefix("u_dma_fsm ");
    tracep->declBus(c+4380,"ADDRESS_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4380,"LGDMALENGTH", false,-1, 31,0);
    tracep->declBus(c+4252,"LGSUBLENGTH", false,-1, 31,0);
    tracep->declBit(c+4147,"i_clk", false,-1);
    tracep->declBit(c+994,"i_reset", false,-1);
    ...
    tracep->declBus(c+4307,"S_IDLE", false,-1, 1,0);
    tracep->declBus(c+4308,"S_WAIT", false,-1, 1,0);
    tracep->declBus(c+4309,"S_READ", false,-1, 1,0);
    tracep->declBus(c+4310,"S_WRITE", false,-1, 1,0);
    ...
    tracep->declBus(c+4380,"ADDRESS_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4302,"BUS_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4252,"LGLENGTH", false,-1, 31,0);
    tracep->declBus(c+4304,"OPT_LITTLE_ENDIAN", false,-1, 0,0);
    tracep->declBus(c+4304,"OPT_LOWPOWER", false,-1, 0,0);
    tracep->declBus(c+4302,"DW", false,-1, 31,0);
    tracep->declBus(c+4259,"AW", false,-1, 31,0);
    ...
    tracep->declBit(c+4267,"o_rd_we", false,-1);
    tracep->declBus(c+1178,"o_rd_addr", false,-1, 21,0);
    tracep->declArray(c+4269,"o_rd_data", false,-1, 511,0);
    ...
    tracep->declBus(c+4310,"SZ_BYTE", false,-1, 1,0);
    tracep->declBus(c+4309,"SZ_16B", false,-1, 1,0);
    tracep->declBus(c+4308,"SZ_32B", false,-1, 1,0);
    tracep->declBus(c+4307,"SZ_BUS", false,-1, 1,0);
    tracep->declBus(c+4343,"WBLSB", false,-1, 31,0);
    ...
    tracep->declBus(c+4423,"ik", false,-1, 31,0);
    tracep->popNamePrefix(1);
    tracep->pushNamePrefix("u_s2mm ");
    tracep->declBus(c+4380,"ADDRESS_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4302,"BUS_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4304,"OPT_LITTLE_ENDIAN", false,-1, 0,0);
    tracep->declBus(c+4252,"LGPIPE", false,-1, 31,0);
    tracep->declBus(c+4302,"DW", false,-1, 31,0);
    tracep->declBus(c+4259,"AW", false,-1, 31,0);
    tracep->declBit(c+4147,"i_clk", false,-1);
    tracep->declBit(c+1285,"i_reset", false,-1);
    ...
    tracep->declBit(c+4268,"o_wr_we", false,-1);
    ...
    tracep->declBus(c+4418,"BW", false,-1, 31,0);
    tracep->declBus(c+4256,"LGFLEN", false,-1, 31,0);
    tracep->declBus(c+4261,"OPT_ASYNC_READ", false,-1, 0,0);
    tracep->declBus(c+4304,"OPT_WRITE_ON_FULL", false,-1, 0,0);
    tracep->declBus(c+4304,"OPT_READ_ON_EMPTY", false,-1, 0,0);
    tracep->declBit(c+4147,"i_clk", false,-1);
    tracep->declBit(c+1285,"i_reset", false,-1);
    ...
    tracep->declBus(c+4260,"FLEN", false,-1, 31,0);
    ...
    tracep->declBus(c+4349,"IUSED", false,-1, 31,0);
    tracep->declBus(c+4305,"DW", false,-1, 31,0);
    tracep->declBit(c+4147,"i_clk", false,-1);
    tracep->declBit(c+994,"i_reset", false,-1);
    tracep->declBit(c+958,"i_wb_cyc", false,-1);
    ...
    tracep->declBus(c+4261,"OPT_DIV", false,-1, 0,0);
    tracep->declBus(c+4261,"OPT_SHIFTS", false,-1, 0,0);
    tracep->declBus(c+4304,"IMPLEMENT_FPU", false,-1, 0,0);
    tracep->declBus(c+4261,"OPT_EARLY_BRANCHING", false,-1, 0,0);
    tracep->declBus(c+4261,"OPT_CIS", false,-1, 0,0);
    tracep->declBus(c+4261,"OPT_DISTRIBUTED_REGS", false,-1, 0,0);
    tracep->declBus(c+4261,"OPT_PIPELINED", false,-1, 0,0);
    ...
    tracep->declBus(c+4261,"OPT_SIM", false,-1, 0,0);
    tracep->declBus(c+4304,"OPT_CLKGATE", false,-1, 0,0);
    tracep->declBus(c+4261,"WITH_LOCAL_BUS", false,-1, 0,0);
    tracep->declBus(c+4261,"OPT_DBGPORT", false,-1, 0,0);
    tracep->declBus(c+4304,"OPT_TRACE_PORT", false,-1, 0,0);
    tracep->declBus(c+4261,"OPT_PROFILER", false,-1, 0,0);
    tracep->declBus(c+4261,"OPT_USERMODE", false,-1, 0,0);
    ...
    tracep->declBus(c+4266,"o_debug", false,-1, 31,0);
    tracep->declBit(c+4193,"o_prof_stb", false,-1);
    tracep->declBus(c+4194,"o_prof_addr", false,-1, 27,0);
    tracep->declBus(c+4195,"o_prof_ticks", false,-1, 31,0);
    tracep->declBus(c+4261,"OPT_DCACHE", false,-1, 0,0);
    tracep->declBus(c+4261,"OPT_PIPELINED_BUS_ACCESS", false,-1, 0,0);
    tracep->declBus(c+4261,"OPT_MEMPIPE", false,-1, 0,0);
    tracep->declBus(c+4305,"INSN_WIDTH", false,-1, 31,0);
    tracep->declBit(c+4268,"cpu_clken", false,-1);
    tracep->declBit(c+4147,"cpu_clock", false,-1);
    tracep->declBit(c+4268,"clk_gate", false,-1);
    tracep->declBus(c+4266,"cpu_debug", false,-1, 31,0);
    ...
    tracep->declBit(c+4267,"pf_we", false,-1);
    tracep->declArray(c+4269,"pf_data", false,-1, 511,0);
    ...
    tracep->declBus(c+4343,"LGCACHELEN", false,-1, 31,0);
    tracep->declBus(c+4302,"BUS_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4259,"ADDRESS_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4253,"LGNLINES", false,-1, 31,0);
    tracep->declBus(c+4344,"NAUX", false,-1, 31,0);
    tracep->declBus(c+4305,"DATA_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4261,"OPT_LOCAL_BUS", false,-1, 0,0);
    tracep->declBus(c+4261,"OPT_PIPE", false,-1, 0,0);
    tracep->declBus(c+4261,"OPT_LOCK", false,-1, 0,0);
    tracep->declBus(c+4261,"OPT_DUAL_READ_PORT", false,-1, 0,0);
    tracep->declBus(c+4256,"OPT_FIFO_DEPTH", false,-1, 31,0);
    tracep->declBus(c+4259,"AW", false,-1, 31,0);
    tracep->declBus(c+4343,"CS", false,-1, 31,0);
    tracep->declBus(c+4253,"LS", false,-1, 31,0);
    tracep->declBus(c+4304,"OPT_LOWPOWER", false,-1, 0,0);
    tracep->declBus(c+4256,"DP", false,-1, 31,0);
    tracep->declBus(c+4343,"WBLSB", false,-1, 31,0);
    tracep->declBus(c+4307,"DC_IDLE", false,-1, 1,0);
    tracep->declBus(c+4308,"DC_WRITE", false,-1, 1,0);
    tracep->declBus(c+4309,"DC_READS", false,-1, 1,0);
    tracep->declBus(c+4310,"DC_READC", false,-1, 1,0);
    tracep->declBit(c+4147,"i_clk", false,-1);
    tracep->declBit(c+994,"i_reset", false,-1);
    ...
    tracep->declArray(c+1081,"i_wb_data", false,-1, 511,0);
    tracep->declBus(c+4348,"FIF_WIDTH", false,-1, 31,0);
    ...
    tracep->declBit(c+4424,"unused_aw", false,-1);
    tracep->popNamePrefix(1);
    ...
    tracep->declBit(c+4267,"unused_clk", false,-1);
    tracep->popNamePrefix(1);
    tracep->pushNamePrefix("PFCACHE ");
    tracep->pushNamePrefix("pf ");
    tracep->declBus(c+4343,"LGCACHELEN", false,-1, 31,0);
    tracep->declBus(c+4259,"ADDRESS_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4253,"LGLINES", false,-1, 31,0);
    tracep->declBus(c+4302,"BUS_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4304,"OPT_LITTLE_ENDIAN", false,-1, 0,0);
    tracep->declBus(c+4311,"CACHELEN", false,-1, 31,0);
    tracep->declBus(c+4343,"CW", false,-1, 31,0);
    tracep->declBus(c+4253,"LS", false,-1, 31,0);
    tracep->declBus(c+4302,"BUSW", false,-1, 31,0);
    tracep->declBus(c+4305,"INSN_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4343,"WBLSB", false,-1, 31,0);
    tracep->declBus(c+4259,"AW", false,-1, 31,0);
    tracep->declBit(c+4147,"i_clk", false,-1);
    ...
    tracep->declArray(c+1081,"i_wb_data", false,-1, 511,0);
    tracep->declBus(c+4265,"INLSB", false,-1, 31,0);
    ...
    tracep->declBit(c+4267,"i_b_cyc_b", false,-1);
    tracep->declBit(c+1784,"i_b_stb_a", false,-1);
    tracep->declBit(c+4267,"i_b_stb_b", false,-1);
    ...
    tracep->declQuad(c+4285,"i_b_sel", false,-1, 63,0);
    ...
    tracep->declBus(c+4320,"ADDRESS_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4258,"RESET_ADDRESS", false,-1, 31,0);
    tracep->declBus(c+4253,"OPT_MPY", false,-1, 31,0);
    tracep->declBus(c+4261,"OPT_SHIFTS", false,-1, 0,0);
    tracep->declBus(c+4261,"OPT_DIV", false,-1, 0,0);
    ...
    tracep->declBit(c+994,"i_reset", false,-1);
    tracep->declBit(c+1098,"i_interrupt", false,-1);
    tracep->declBit(c+4268,"o_clken", false,-1);
    tracep->declBit(c+995,"i_halt", false,-1);
    tracep->declBit(c+997,"i_clear_cache", false,-1);
    tracep->declBus(c+1000,"i_dbg_wreg", false,-1, 4,0);
    tracep->declBit(c+998,"i_dbg_we", false,-1);
    ...
    tracep->declBus(c+4195,"o_prof_ticks", false,-1, 31,0);
    tracep->declBus(c+4261,"OPT_MEMPIPE", false,-1, 0,0);
    tracep->declBus(c+4425,"RESET_BUS_ADDRESS", false,-1, 25,0);
    tracep->declBus(c+4426,"CPU_CC_REG", false,-1, 3,0);
    tracep->declBus(c+4299,"CPU_PC_REG", false,-1, 3,0);
    tracep->declBus(c+4312,"CPU_SUB_OP", false,-1, 3,0);
    tracep->declBus(c+4313,"CPU_AND_OP", false,-1, 3,0);
    tracep->declBus(c+4383,"CPU_BREV_OP", false,-1, 3,0);
    tracep->declBus(c+4388,"CPU_MOV_OP", false,-1, 3,0);
    tracep->declBus(c+4349,"CPU_CLRDCACHE_BIT", false,-1, 31,0);
    tracep->declBus(c+4251,"CPU_CLRICACHE_BIT", false,-1, 31,0);
    tracep->declBus(c+4326,"CPU_PHASE_BIT", false,-1, 31,0);
    tracep->declBus(c+4348,"CPU_FPUERR_BIT", false,-1, 31,0);
    tracep->declBus(c+4347,"CPU_DIVERR_BIT", false,-1, 31,0);
    tracep->declBus(c+4252,"CPU_BUSERR_BIT", false,-1, 31,0);
    tracep->declBus(c+4346,"CPU_TRAP_BIT", false,-1, 31,0);
    tracep->declBus(c+4254,"CPU_ILL_BIT", false,-1, 31,0);
    tracep->declBus(c+4263,"CPU_BREAK_BIT", false,-1, 31,0);
    tracep->declBus(c+4343,"CPU_STEP_BIT", false,-1, 31,0);
    tracep->declBus(c+4344,"CPU_GIE_BIT", false,-1, 31,0);
    tracep->declBus(c+4256,"CPU_SLEEP_BIT", false,-1, 31,0);
    for (int i = 0; i < 32; ++i) {
    ...
    tracep->declBit(c+4267,"ifpu_err_flag", false,-1);
    tracep->declBit(c+4267,"ufpu_err_flag", false,-1);
    ...
    tracep->declBus(c+4222,"dcd_pc", false,-1, 27,0);
    ...
    tracep->declBit(c+4223,"dcd_F_stall", false,-1);
    ...
    tracep->declBit(c+4224,"dcd_sim", false,-1);
    tracep->declBus(c+4225,"dcd_sim_immv", false,-1, 22,0);
    ...
    tracep->declBit(c+4226,"op_valid", false,-1);
    ...
    tracep->declBit(c+4267,"op_lowpower_clear", false,-1);
    tracep->declBus(c+4427,"w_cpu_info", false,-1, 8,0);
    tracep->declBit(c+2220,"op_illegal", false,-1);
    tracep->declBit(c+2218,"op_break", false,-1);
    tracep->declBit(c+2221,"op_lock", false,-1);
    tracep->declBit(c+4227,"op_sim", false,-1);
    tracep->declBus(c+4228,"op_sim_immv", false,-1, 22,0);
    tracep->declBit(c+4229,"alu_sim", false,-1);
    tracep->declBus(c+4230,"alu_sim_immv", false,-1, 22,0);
    ...
    tracep->declBit(c+4231,"alu_ce", false,-1);
    ...
    tracep->declBit(c+4267,"fpu_ce", false,-1);
    tracep->declBit(c+4267,"fpu_error", false,-1);
    tracep->declBit(c+4267,"fpu_busy", false,-1);
    tracep->declBit(c+4267,"fpu_valid", false,-1);
    tracep->declBus(c+4266,"fpu_result", false,-1, 31,0);
    tracep->declBus(c+4312,"fpu_flags", false,-1, 3,0);
    ...
    tracep->declBit(c+4268,"w_clken", false,-1);
    ...
    tracep->declBus(c+4304,"OPT_SIM_DEBUG", false,-1, 0,0);
    tracep->declBit(c+4267,"unused", false,-1);
    ...
    tracep->declBus(c+4305,"BW", false,-1, 31,0);
    tracep->declBus(c+4344,"LGBW", false,-1, 31,0);
    tracep->declBus(c+4304,"OPT_LOWPOWER", false,-1, 0,0);
    tracep->declBit(c+4147,"i_clk", false,-1);
    ...
    tracep->declBit(c+4267,"unused_alu_stall", false,-1);
    tracep->popNamePrefix(1);
    tracep->pushNamePrefix("GEN_DISTRIBUTED_REGS ");
    tracep->declBit(c+4267,"unused_prereg_addrs", false,-1);
    tracep->popNamePrefix(1);
    ...
    tracep->declBit(c+4267,"generic_ignore", false,-1);
    tracep->popNamePrefix(1);
    ...
    tracep->declBit(c+4147,"i_clk", false,-1);
    tracep->declBit(c+2271,"i_reset", false,-1);
    tracep->declBit(c+4231,"i_stb", false,-1);
    ...
    tracep->declBus(c+4320,"ADDRESS_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4261,"OPT_MPY", false,-1, 0,0);
    tracep->declBus(c+4261,"OPT_SHIFTS", false,-1, 0,0);
    tracep->declBus(c+4261,"OPT_EARLY_BRANCHING", false,-1, 0,0);
    tracep->declBus(c+4261,"OPT_PIPELINED", false,-1, 0,0);
    tracep->declBus(c+4261,"OPT_DIVIDE", false,-1, 0,0);
    tracep->declBus(c+4304,"OPT_FPU", false,-1, 0,0);
    tracep->declBus(c+4261,"OPT_CIS", false,-1, 0,0);
    tracep->declBus(c+4261,"OPT_LOCK", false,-1, 0,0);
    tracep->declBus(c+4261,"OPT_OPIPE", false,-1, 0,0);
    tracep->declBus(c+4261,"OPT_SIM", false,-1, 0,0);
    tracep->declBus(c+4304,"OPT_SUPPRESS_NULL_BRANCHES", false,-1, 0,0);
    tracep->declBus(c+4261,"OPT_USERMODE", false,-1, 0,0);
    tracep->declBus(c+4304,"OPT_LOWPOWER", false,-1, 0,0);
    tracep->declBus(c+4320,"AW", false,-1, 31,0);
    tracep->declBit(c+4147,"i_clk", false,-1);
    ...
    tracep->declBus(c+4222,"o_pc", false,-1, 27,0);
    ...
    tracep->declBit(c+4224,"o_sim", false,-1);
    tracep->declBus(c+4225,"o_sim_immv", false,-1, 22,0);
    tracep->declBus(c+4388,"CPU_SP_REG", false,-1, 3,0);
    tracep->declBus(c+4426,"CPU_CC_REG", false,-1, 3,0);
    tracep->declBus(c+4299,"CPU_PC_REG", false,-1, 3,0);
    tracep->declBus(c+4394,"CISBIT", false,-1, 31,0);
    tracep->declBus(c+4322,"CISIMMSEL", false,-1, 31,0);
    tracep->declBus(c+4323,"IMMSEL", false,-1, 31,0);
    ...
    tracep->declBit(c+4267,"illegal_shift", false,-1);
    tracep->declBit(c+4267,"possibly_unused", false,-1);
    ...
    tracep->declBus(c+4305,"BW", false,-1, 31,0);
    tracep->declBus(c+4394,"VW", false,-1, 31,0);
    tracep->declBus(c+4261,"RELOADABLE", false,-1, 0,0);
    tracep->declBit(c+4147,"i_clk", false,-1);
    tracep->declBit(c+994,"i_reset", false,-1);
    tracep->declBit(c+1134,"i_ce", false,-1);
    tracep->declBit(c+958,"i_wb_cyc", false,-1);
    ...
    tracep->declBus(c+4251,"BW", false,-1, 31,0);
    tracep->declBit(c+4147,"i_clk", false,-1);
    tracep->declBit(c+2408,"i_reset", false,-1);
    tracep->declBus(c+4428,"i_timeout", false,-1, 13,0);
    ...
    tracep->declBus(c+4305,"BW", false,-1, 31,0);
    tracep->declBus(c+4394,"VW", false,-1, 31,0);
    tracep->declBus(c+4304,"RELOADABLE", false,-1, 0,0);
    tracep->declBit(c+4147,"i_clk", false,-1);
    tracep->declBit(c+994,"i_reset", false,-1);
    tracep->declBit(c+1134,"i_ce", false,-1);
    tracep->declBit(c+958,"i_wb_cyc", false,-1);
    ...
    tracep->declBit(c+4267,"auto_reload", false,-1);
    tracep->declBus(c+4429,"interval_count", false,-1, 30,0);
    tracep->declBit(c+4267,"unused", false,-1);
    tracep->popNamePrefix(2);
    tracep->pushNamePrefix("txv ");
    tracep->declBus(c+4430,"TIMING_BITS", false,-1, 4,0);
    tracep->declBus(c+4430,"TB", false,-1, 4,0);
    tracep->declBus(c+4397,"CLOCKS_PER_BAUD", false,-1, 6,0);
    tracep->declBit(c+4147,"i_clk", false,-1);
    tracep->declBit(c+170,"i_wr", false,-1);
    tracep->declBus(c+168,"i_data", false,-1, 7,0);
    tracep->declBit(c+4198,"o_uart_tx", false,-1);
    tracep->declBit(c+171,"o_busy", false,-1);
    tracep->declBus(c+4312,"TXUL_BIT_ZERO", false,-1, 3,0);
    tracep->declBus(c+4383,"TXUL_STOP", false,-1, 3,0);
    tracep->declBus(c+4299,"TXUL_IDLE", false,-1, 3,0);
    ...
    tracep->declBus(c+3953,"i_wb_addr", false,-1, 2,0);
    ...
    tracep->declBit(c+4174,"i_temp_sda", false,-1);
    tracep->declBit(c+4175,"i_temp_scl", false,-1);
    tracep->declBit(c+4176,"o_temp_sda", false,-1);
    tracep->declBit(c+4177,"o_temp_scl", false,-1);
    tracep->declBit(c+4178,"o_fpga_pwm", false,-1);
    tracep->declBit(c+4179,"o_sys_pwm", false,-1);
    tracep->declBit(c+4180,"i_fan_tach", false,-1);
    tracep->declBus(c+4209,"temp_debug", false,-1, 31,0);
    tracep->declBus(c+4431,"CK_PER_SECOND", false,-1, 31,0);
    tracep->declBus(c+4432,"CK_PER_MS", false,-1, 31,0);
    tracep->declBus(c+4433,"PWM_HZ", false,-1, 31,0);
    tracep->declBus(c+4434,"MAX_PWM", false,-1, 31,0);
    tracep->declBus(c+4326,"LGPWM", false,-1, 31,0);
    ...
    tracep->declBit(c+4267,"i2c_wb_stall", false,-1);
    ...
    tracep->declBit(c+4267,"ign_mem_we", false,-1);
    tracep->declBit(c+4261,"ign_mem_sel", false,-1);
    tracep->declBus(c+2433,"mem_addr", false,-1, 4,0);
    tracep->declBus(c+4303,"ign_mem_data", false,-1, 7,0);
    ...
    tracep->declBit(c+4267,"ign_i2cd_id", false,-1);
    ...
    tracep->declBus(c+4344,"ADDRESS_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4254,"DATA_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4254,"I2C_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4266,"AXIS_ID_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4304,"DEF_CHANNEL", false,-1, 0,0);
    tracep->declBus(c+4344,"AW", false,-1, 31,0);
    tracep->declBus(c+4254,"DW", false,-1, 31,0);
    tracep->declBus(c+4254,"RW", false,-1, 31,0);
    tracep->declBus(c+4344,"BAW", false,-1, 31,0);
    tracep->declBus(c+4371,"RESET_ADDRESS", false,-1, 4,0);
    tracep->declBus(c+4304,"OPT_START_HALTED", false,-1, 0,0);
    tracep->declBus(c+4261,"OPT_MANUAL", false,-1, 0,0);
    tracep->declBus(c+4266,"OPT_WATCHDOG", false,-1, 31,0);
    tracep->declBus(c+4435,"DEF_CKCOUNT", false,-1, 11,0);
    tracep->declBus(c+4304,"OPT_LOWPOWER", false,-1, 0,0);
    tracep->declBit(c+4147,"i_clk", false,-1);
    tracep->declBit(c+4148,"i_reset", false,-1);
    tracep->declBit(c+3893,"i_wb_cyc", false,-1);
    tracep->declBit(c+3954,"i_wb_stb", false,-1);
    tracep->declBit(c+3895,"i_wb_we", false,-1);
    tracep->declBus(c+3955,"i_wb_addr", false,-1, 1,0);
    tracep->declBus(c+3897,"i_wb_data", false,-1, 31,0);
    tracep->declBus(c+3898,"i_wb_sel", false,-1, 3,0);
    tracep->declBit(c+4267,"o_wb_stall", false,-1);
    ...
    tracep->declBus(c+4303,"o_pf_data", false,-1, 7,0);
    tracep->declBus(c+4261,"o_pf_sel", false,-1, 0,0);
    tracep->declBit(c+4267,"i_pf_stall", false,-1);
    tracep->declBit(c+2435,"i_pf_ack", false,-1);
    tracep->declBit(c+4267,"i_pf_err", false,-1);
    tracep->declBus(c+2434,"i_pf_data", false,-1, 7,0);
    tracep->declBit(c+4174,"i_i2c_sda", false,-1);
    tracep->declBit(c+4175,"i_i2c_scl", false,-1);
    tracep->declBit(c+4176,"o_i2c_sda", false,-1);
    tracep->declBit(c+4177,"o_i2c_scl", false,-1);
    tracep->declBit(c+2436,"M_AXIS_TVALID", false,-1);
    tracep->declBit(c+4268,"M_AXIS_TREADY", false,-1);
    tracep->declBus(c+2438,"M_AXIS_TDATA", false,-1, 7,0);
    tracep->declBit(c+2437,"M_AXIS_TLAST", false,-1);
    tracep->declBus(c+4267,"M_AXIS_TID", false,-1, 0,0);
    tracep->declBit(c+2439,"i_sync_signal", false,-1);
    tracep->declBus(c+4209,"o_debug", false,-1, 31,0);
    tracep->declBus(c+4307,"ADR_CONTROL", false,-1, 1,0);
    tracep->declBus(c+4308,"ADR_OVERRIDE", false,-1, 1,0);
    tracep->declBus(c+4309,"ADR_ADDRESS", false,-1, 1,0);
    tracep->declBus(c+4310,"ADR_CKCOUNT", false,-1, 1,0);
    ...
    tracep->declBit(c+3956,"next_valid", false,-1);
    tracep->declBus(c+3957,"next_insn", false,-1, 7,0);
    ...
    tracep->declBit(c+3958,"bus_read", false,-1);
    tracep->declBit(c+3959,"bus_write", false,-1);
    tracep->declBit(c+3960,"bus_override", false,-1);
    tracep->declBit(c+3961,"bus_manual", false,-1);
    tracep->declBit(c+2477,"ovw_ready", false,-1);
    tracep->declBit(c+3962,"bus_jump", false,-1);
    tracep->declBus(c+3955,"bus_write_addr", false,-1, 1,0);
    tracep->declBus(c+3955,"bus_read_addr", false,-1, 1,0);
    tracep->declBus(c+3897,"bus_write_data", false,-1, 31,0);
    tracep->declBus(c+3898,"bus_write_strb", false,-1, 3,0);
    ...
    tracep->declBus(c+4232,"w_control", false,-1, 31,0);
    tracep->declBit(c+4267,"unused", false,-1);
    tracep->pushNamePrefix("GEN_MANUAL ");
    ...
    tracep->declBit(c+4175,"i_scl", false,-1);
    tracep->declBit(c+4174,"i_sda", false,-1);
    ...
    tracep->declBus(c+4303,"o_wb_data", false,-1, 7,0);
    tracep->declBit(c+4267,"i_wb_stall", false,-1);
    tracep->declBit(c+2435,"i_wb_ack", false,-1);
    tracep->declBit(c+4267,"i_wb_err", false,-1);
    ...
    tracep->declBit(c+4267,"r_valid", false,-1);
    tracep->declBus(c+4303,"r_insn", false,-1, 7,0);
    tracep->declBus(c+2434,"i_wb_shifted", false,-1, 7,0);
    tracep->popNamePrefix(3);
    tracep->pushNamePrefix("u_i2cdma ");
    tracep->declBus(c+4259,"AW", false,-1, 31,0);
    tracep->declBus(c+4302,"DW", false,-1, 31,0);
    tracep->declBus(c+4254,"SW", false,-1, 31,0);
    tracep->declBus(c+4304,"OPT_LITTLE_ENDIAN", false,-1, 0,0);
    tracep->declBus(c+4304,"OPT_LOWPOWER", false,-1, 0,0);
    tracep->declBit(c+4147,"i_clk", false,-1);
    tracep->declBit(c+4148,"i_reset", false,-1);
    ...
    tracep->declBus(c+3963,"i_wb_addr", false,-1, 1,0);
    ...
    tracep->declBit(c+4268,"o_dma_we", false,-1);
    ...
    tracep->declBus(c+4266,"SUBLSB", false,-1, 31,0);
    tracep->declBus(c+4343,"WBLSB", false,-1, 31,0);
    tracep->declBus(c+4380,"ADDRESS_WIDTH", false,-1, 31,0);
    ...
    tracep->declBus(c+3964,"next_baseaddr", false,-1, 31,0);
    tracep->declBus(c+3965,"next_memlen", false,-1, 31,0);
    ...
    tracep->declBus(c+4304,"OPT_LOWPOWER", false,-1, 0,0);
    tracep->declBus(c+4261,"OPT_OUTREG", false,-1, 0,0);
    tracep->declBus(c+4304,"OPT_PASSTHROUGH", false,-1, 0,0);
    tracep->declBus(c+4346,"DW", false,-1, 31,0);
    tracep->declBus(c+4261,"OPT_INITIAL", false,-1, 0,0);
    tracep->declBit(c+4147,"i_clk", false,-1);
    tracep->declBit(c+4148,"i_reset", false,-1);
    ...
    tracep->declBus(c+4302,"WIDE_DW", false,-1, 31,0);
    tracep->declBus(c+4305,"SMALL_DW", false,-1, 31,0);
    tracep->declBus(c+4304,"OPT_LITTLE_ENDIAN", false,-1, 0,0);
    tracep->declBus(c+4304,"OPT_LOWPOWER", false,-1, 0,0);
    tracep->declBus(c+4304,"OPT_LOWLOGIC", false,-1, 0,0);
    tracep->declBus(c+4324,"WIDE_AW", false,-1, 31,0);
    tracep->declBus(c+4321,"SMALL_AW", false,-1, 31,0);
    tracep->declBit(c+4147,"i_clk", false,-1);
    tracep->declBit(c+4148,"i_reset", false,-1);
    tracep->declBit(c+3837,"i_wcyc", false,-1);
    tracep->declBit(c+3838,"i_wstb", false,-1);
    ...
    tracep->declBit(c+3839,"o_werr", false,-1);
    tracep->declBit(c+3840,"o_scyc", false,-1);
    ...
    tracep->declBit(c+3841,"i_serr", false,-1);
    tracep->declBus(c+4256,"WBLSB", false,-1, 31,0);
    tracep->pushNamePrefix("DOWNSIZE ");
    tracep->declBus(c+4344,"LGFIFO", false,-1, 31,0);
    tracep->declBit(c+3840,"r_cyc", false,-1);
    tracep->declBit(c+2521,"r_stb", false,-1);
    tracep->declBit(c+396,"r_we", false,-1);
    tracep->declBit(c+378,"r_ack", false,-1);
    tracep->declBit(c+3839,"r_err", false,-1);
    ...
    tracep->declBit(c+4267,"unused", false,-1);
    tracep->pushNamePrefix("DOWNSIZE ");
    tracep->declBus(c+4436,"subaddr_fn__Vstatic__fnk", false,-1, 31,0);
    tracep->declBus(c+2568,"subaddr_fn__Vstatic__fm", false,-1, 31,0);
    tracep->popNamePrefix(1);
    tracep->pushNamePrefix("u_fifo ");
    tracep->declBus(c+4344,"BW", false,-1, 31,0);
    tracep->declBus(c+4344,"LGFLEN", false,-1, 31,0);
    tracep->declBus(c+4261,"OPT_ASYNC_READ", false,-1, 0,0);
    tracep->declBus(c+4261,"OPT_WRITE_ON_FULL", false,-1, 0,0);
    tracep->declBus(c+4261,"OPT_READ_ON_EMPTY", false,-1, 0,0);
    tracep->declBit(c+4147,"i_clk", false,-1);
    ...
    tracep->declBus(c+4348,"NS", false,-1, 31,0);
    tracep->declBus(c+4321,"AW", false,-1, 31,0);
    tracep->declBus(c+4305,"DW", false,-1, 31,0);
    tracep->declArray(c+4437,"SLAVE_ADDR", false,-1, 299,0);
    tracep->declArray(c+4447,"SLAVE_MASK", false,-1, 299,0);
    tracep->declBus(c+4343,"LGMAXBURST", false,-1, 31,0);
    tracep->declBus(c+4266,"OPT_TIMEOUT", false,-1, 31,0);
    tracep->declBus(c+4304,"OPT_STARVATION_TIMEOUT", false,-1, 0,0);
    tracep->declBus(c+4261,"OPT_DBLBUFFER", false,-1, 0,0);
    tracep->declBus(c+4261,"OPT_LOWPOWER", false,-1, 0,0);
    tracep->declBit(c+4147,"i_clk", false,-1);
    tracep->declBit(c+4148,"i_reset", false,-1);
    tracep->declBus(c+3840,"i_mcyc", false,-1, 0,0);
    ...
    tracep->declBus(c+3841,"o_merr", false,-1, 0,0);
    tracep->declBus(c+3966,"o_scyc", false,-1, 11,0);
    tracep->declBus(c+3967,"o_sstb", false,-1, 11,0);
    tracep->declBus(c+3968,"o_swe", false,-1, 11,0);
    tracep->declArray(c+3969,"o_saddr", false,-1, 299,0);
    tracep->declArray(c+3979,"o_sdata", false,-1, 383,0);
    tracep->declQuad(c+3991,"o_ssel", false,-1, 47,0);
    tracep->declBus(c+3834,"i_sstall", false,-1, 11,0);
    tracep->declBus(c+3629,"i_sack", false,-1, 11,0);
    tracep->declArray(c+3630,"i_sdata", false,-1, 383,0);
    tracep->declBus(c+4457,"i_serr", false,-1, 11,0);
    tracep->declBus(c+4266,"TIMEOUT_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4255,"LGNM", false,-1, 31,0);
    tracep->declBus(c+4256,"LGNS", false,-1, 31,0);
    for (int i = 0; i < 1; ++i) {
        tracep->declBus(c+3993+i*1,"request", true,(i+0), 12,0);
    }
    for (int i = 0; i < 1; ++i) {
    ...
    tracep->declBus(c+3994,"sgrant", false,-1, 11,0);
    for (int i = 0; i < 1; ++i) {
    ...
    tracep->declBus(c+4304,"timed_out", false,-1, 0,0);
    tracep->declBus(c+4255,"NMFULL", false,-1, 31,0);
    tracep->declBus(c+4260,"NSFULL", false,-1, 31,0);
    for (int i = 0; i < 1; ++i) {
        tracep->declBus(c+3995+i*1,"mindex", true,(i+0), 3,0);
    }
    for (int i = 0; i < 16; ++i) {
        tracep->declBus(c+8+i*1,"sindex", true,(i+0), 0,0);
    }
    tracep->declBus(c+3840,"m_cyc", false,-1, 0,0);
    tracep->declBus(c+3996,"m_stb", false,-1, 0,0);
    tracep->declBus(c+3997,"m_we", false,-1, 0,0);
    for (int i = 0; i < 1; ++i) {
        tracep->declBus(c+3998+i*1,"m_addr", true,(i+0), 24,0);
    }
    for (int i = 0; i < 1; ++i) {
        tracep->declBus(c+3999+i*1,"m_data", true,(i+0), 31,0);
    }
    for (int i = 0; i < 1; ++i) {
        tracep->declBus(c+4000+i*1,"m_sel", true,(i+0), 3,0);
    }
    tracep->declBus(c+4142,"m_stall", false,-1, 0,0);
    tracep->declBus(c+4143,"s_stall", false,-1, 15,0);
    for (int i = 0; i < 16; ++i) {
        tracep->declBus(c+3642+i*1,"s_data", true,(i+0), 31,0);
    }
    tracep->declBus(c+4233,"s_ack", false,-1, 15,0);
    tracep->declBus(c+4458,"s_err", false,-1, 15,0);
    tracep->declBus(c+4001,"dcd_stb", false,-1, 0,0);
    tracep->declBus(c+4261,"OPT_BUFFER_DECODER", false,-1, 0,0);
    tracep->declBus(c+2616,"iN", false,-1, 31,0);
    tracep->declBus(c+4234,"iM", false,-1, 31,0);
    tracep->pushNamePrefix("ARBITRATE_REQUESTS[0] ");
    tracep->declBus(c+4002,"regrant", false,-1, 12,0);
    tracep->declBus(c+4235,"reindex", false,-1, 3,0);
    tracep->declBit(c+4003,"stay_on_channel", false,-1);
    tracep->declBit(c+4004,"requested_channel_is_available", false,-1);
    tracep->pushNamePrefix("MINDEX_MULTIPLE_SLAVES ");
    tracep->declBus(c+4005,"r_mindex", false,-1, 3,0);
    tracep->declBus(c+4002,"r_regrant", false,-1, 12,0);
    ...
    tracep->declBit(c+4006,"skd_we", false,-1);
    tracep->declBus(c+4007,"skd_addr", false,-1, 24,0);
    tracep->declBus(c+4008,"skd_data", false,-1, 31,0);
    tracep->declBus(c+4009,"skd_sel", false,-1, 3,0);
    ...
    tracep->declArray(c+4437,"SLAVE_ADDR", false,-1, 299,0);
    tracep->declArray(c+4447,"SLAVE_MASK", false,-1, 299,0);
    tracep->declBus(c+4382,"ACCESS_ALLOWED", false,-1, 11,0);
    tracep->declBus(c+4261,"OPT_REGISTERED", false,-1, 0,0);
    tracep->declBus(c+4304,"OPT_LOWPOWER", false,-1, 0,0);
    tracep->declBit(c+4147,"i_clk", false,-1);
    tracep->declBit(c+4148,"i_reset", false,-1);
    tracep->declBit(c+113,"i_valid", false,-1);
    tracep->declBit(c+4144,"o_stall", false,-1);
    tracep->declBus(c+4007,"i_addr", false,-1, 24,0);
    tracep->declQuad(c+4010,"i_data", false,-1, 36,0);
    tracep->declBit(c+4001,"o_valid", false,-1);
    ...
    tracep->declQuad(c+4012,"o_data", false,-1, 36,0);
    tracep->declBus(c+4261,"OPT_NONESEL", false,-1, 0,0);
    tracep->declBus(c+114,"request", false,-1, 12,0);
    tracep->declBus(c+4014,"prerequest", false,-1, 11,0);
    ...
    tracep->declBus(c+4304,"OPT_LOWPOWER", false,-1, 0,0);
    tracep->declBus(c+4304,"OPT_OUTREG", false,-1, 0,0);
    tracep->declBus(c+4304,"OPT_PASSTHROUGH", false,-1, 0,0);
    tracep->declBus(c+4460,"DW", false,-1, 31,0);
    tracep->declBus(c+4261,"OPT_INITIAL", false,-1, 0,0);
    tracep->declBit(c+4147,"i_clk", false,-1);
    ...
    tracep->declQuad(c+4015,"o_data", false,-1, 61,0);
    ...
    tracep->declBus(c+3841,"r_merr", false,-1, 0,0);
    tracep->popNamePrefix(1);
    ...
    tracep->declBit(c+4267,"unused", false,-1);
    tracep->pushNamePrefix("u_fifo ");
    tracep->declBus(c+4256,"BW", false,-1, 31,0);
    tracep->declBus(c+4344,"LGFLEN", false,-1, 31,0);
    tracep->declBus(c+4261,"OPT_ASYNC_READ", false,-1, 0,0);
    tracep->declBus(c+4304,"OPT_WRITE_ON_FULL", false,-1, 0,0);
    tracep->declBus(c+4304,"OPT_READ_ON_EMPTY", false,-1, 0,0);
    ...
    tracep->declBus(c+4255,"NM", false,-1, 31,0);
    tracep->declBus(c+4265,"NS", false,-1, 31,0);
    tracep->declBus(c+4319,"AW", false,-1, 31,0);
    tracep->declBus(c+4305,"DW", false,-1, 31,0);
    tracep->declQuad(c+4461,"SLAVE_ADDR", false,-1, 53,0);
    tracep->declQuad(c+4463,"SLAVE_MASK", false,-1, 53,0);
    tracep->declBus(c+4343,"LGMAXBURST", false,-1, 31,0);
    tracep->declBus(c+4266,"OPT_TIMEOUT", false,-1, 31,0);
    tracep->declBus(c+4304,"OPT_STARVATION_TIMEOUT", false,-1, 0,0);
    tracep->declBus(c+4261,"OPT_DBLBUFFER", false,-1, 0,0);
    ...
    tracep->declBus(c+4299,"i_msel", false,-1, 3,0);
    ...
    tracep->declBus(c+4266,"TIMEOUT_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4255,"LGNM", false,-1, 31,0);
    tracep->declBus(c+4265,"LGNS", false,-1, 31,0);
    for (int i = 0; i < 1; ++i) {
    ...
    tracep->declBus(c+4304,"timed_out", false,-1, 0,0);
    tracep->declBus(c+4255,"NMFULL", false,-1, 31,0);
    tracep->declBus(c+4256,"NSFULL", false,-1, 31,0);
    for (int i = 0; i < 1; ++i) {
        tracep->declBus(c+4017+i*1,"mindex", true,(i+0), 1,0);
    }
    for (int i = 0; i < 4; ++i) {
    ...
    tracep->declBus(c+4238,"s_ack", false,-1, 3,0);
    tracep->declBus(c+2732,"s_err", false,-1, 3,0);
    tracep->declBus(c+2733,"dcd_stb", false,-1, 0,0);
    tracep->declBus(c+4261,"OPT_BUFFER_DECODER", false,-1, 0,0);
    tracep->declBus(c+2734,"iN", false,-1, 31,0);
    tracep->declBus(c+4239,"iM", false,-1, 31,0);
    tracep->pushNamePrefix("ARBITRATE_REQUESTS[0] ");
    tracep->declBus(c+4018,"regrant", false,-1, 2,0);
    ...
    tracep->pushNamePrefix("MINDEX_MULTIPLE_SLAVES ");
    tracep->declBus(c+4019,"r_mindex", false,-1, 1,0);
    tracep->declBus(c+4018,"r_regrant", false,-1, 2,0);
    ...
    tracep->declQuad(c+4461,"SLAVE_ADDR", false,-1, 53,0);
    tracep->declQuad(c+4463,"SLAVE_MASK", false,-1, 53,0);
    tracep->declBus(c+4310,"ACCESS_ALLOWED", false,-1, 1,0);
    tracep->declBus(c+4261,"OPT_REGISTERED", false,-1, 0,0);
    tracep->declBus(c+4304,"OPT_LOWPOWER", false,-1, 0,0);
    tracep->declBit(c+4147,"i_clk", false,-1);
    tracep->declBit(c+4148,"i_reset", false,-1);
    ...
    tracep->declBus(c+4304,"OPT_OUTREG", false,-1, 0,0);
    tracep->declBus(c+4304,"OPT_PASSTHROUGH", false,-1, 0,0);
    tracep->declBus(c+4311,"DW", false,-1, 31,0);
    tracep->declBus(c+4261,"OPT_INITIAL", false,-1, 0,0);
    tracep->declBit(c+4147,"i_clk", false,-1);
    ...
    tracep->declBus(c+4256,"NM", false,-1, 31,0);
    tracep->declBus(c+4265,"NS", false,-1, 31,0);
    tracep->declBus(c+4259,"AW", false,-1, 31,0);
    tracep->declBus(c+4302,"DW", false,-1, 31,0);
    tracep->declQuad(c+4465,"SLAVE_ADDR", false,-1, 43,0);
    tracep->declQuad(c+4467,"SLAVE_MASK", false,-1, 43,0);
    tracep->declBus(c+4343,"LGMAXBURST", false,-1, 31,0);
    tracep->declBus(c+4266,"OPT_TIMEOUT", false,-1, 31,0);
    tracep->declBus(c+4304,"OPT_STARVATION_TIMEOUT", false,-1, 0,0);
    tracep->declBus(c+4261,"OPT_DBLBUFFER", false,-1, 0,0);
    ...
    tracep->declBit(c+4147,"i_clk", false,-1);
    tracep->declBit(c+4148,"i_reset", false,-1);
    tracep->declBus(c+4020,"i_mcyc", false,-1, 3,0);
    ...
    tracep->declBus(c+4021,"o_scyc", false,-1, 1,0);
    tracep->declBus(c+4022,"o_sstb", false,-1, 1,0);
    ...
    tracep->declBus(c+4023,"i_serr", false,-1, 1,0);
    tracep->declBus(c+4266,"TIMEOUT_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4265,"LGNM", false,-1, 31,0);
    tracep->declBus(c+4265,"LGNS", false,-1, 31,0);
    for (int i = 0; i < 4; ++i) {
    ...
    tracep->declBus(c+4024,"sgrant", false,-1, 1,0);
    for (int i = 0; i < 4; ++i) {
    ...
    tracep->declBus(c+4312,"timed_out", false,-1, 3,0);
    tracep->declBus(c+4256,"NMFULL", false,-1, 31,0);
    tracep->declBus(c+4256,"NSFULL", false,-1, 31,0);
    for (int i = 0; i < 4; ++i) {
        tracep->declBus(c+4025+i*1,"mindex", true,(i+0), 1,0);
    }
    for (int i = 0; i < 4; ++i) {
        tracep->declBus(c+4029+i*1,"sindex", true,(i+0), 1,0);
    }
    tracep->declBus(c+4020,"m_cyc", false,-1, 3,0);
    ...
    tracep->declBus(c+4033,"m_stall", false,-1, 3,0);
    tracep->declBus(c+4034,"s_stall", false,-1, 3,0);
    for (int i = 0; i < 4; ++i) {
        tracep->declArray(c+3071+i*16,"s_data", true,(i+0), 511,0);
    }
    tracep->declBus(c+4035,"s_ack", false,-1, 3,0);
    tracep->declBus(c+4036,"s_err", false,-1, 3,0);
    tracep->declBus(c+3135,"dcd_stb", false,-1, 3,0);
    tracep->declBus(c+4261,"OPT_BUFFER_DECODER", false,-1, 0,0);
    tracep->declBus(c+4241,"iN", false,-1, 31,0);
    tracep->declBus(c+4242,"iM", false,-1, 31,0);
    tracep->pushNamePrefix("ARBITRATE_REQUESTS[0] ");
    ...
    tracep->declBus(c+4043,"regrant", false,-1, 2,0);
    tracep->declBus(c+4245,"reindex", false,-1, 1,0);
    tracep->declBit(c+3138,"stay_on_channel", false,-1);
    tracep->declBit(c+4044,"requested_channel_is_available", false,-1);
    tracep->pushNamePrefix("MINDEX_MULTIPLE_SLAVES ");
    tracep->declBus(c+4045,"r_mindex", false,-1, 1,0);
    tracep->declBus(c+4043,"r_regrant", false,-1, 2,0);
    tracep->declBus(c+4245,"r_reindex", false,-1, 1,0);
    tracep->popNamePrefix(2);
    tracep->pushNamePrefix("ARBITRATE_REQUESTS[3] ");
    tracep->declBus(c+4046,"regrant", false,-1, 2,0);
    tracep->declBus(c+4246,"reindex", false,-1, 1,0);
    tracep->declBit(c+3139,"stay_on_channel", false,-1);
    tracep->declBit(c+4047,"requested_channel_is_available", false,-1);
    tracep->pushNamePrefix("MINDEX_MULTIPLE_SLAVES ");
    tracep->declBus(c+4048,"r_mindex", false,-1, 1,0);
    tracep->declBus(c+4046,"r_regrant", false,-1, 2,0);
    ...
    tracep->declBus(c+4304,"OPT_OUTREG", false,-1, 0,0);
    tracep->declBus(c+4304,"OPT_PASSTHROUGH", false,-1, 0,0);
    tracep->declBus(c+4470,"DW", false,-1, 31,0);
    tracep->declBus(c+4261,"OPT_INITIAL", false,-1, 0,0);
    tracep->declBit(c+4147,"i_clk", false,-1);
    ...
    tracep->declBit(c+4055,"skd_stall", false,-1);
    ...
    tracep->declBit(c+4055,"o_stall", false,-1);
    ...
    tracep->declBit(c+4056,"i_stall", false,-1);
    ...
    tracep->declBit(c+4057,"i_ready", false,-1);
    ...
    tracep->declBit(c+4058,"skd_stall", false,-1);
    ...
    tracep->declBit(c+4058,"o_stall", false,-1);
    ...
    tracep->declBit(c+4059,"i_stall", false,-1);
    ...
    tracep->declBit(c+4060,"i_ready", false,-1);
    ...
    tracep->declBus(c+4061,"regrant", false,-1, 3,0);
    tracep->declBus(c+4062,"reindex", false,-1, 1,0);
    tracep->popNamePrefix(2);
    tracep->pushNamePrefix("GEN_SINDEX[1] ");
    tracep->pushNamePrefix("SINDEX_MORE_THAN_ONE_MASTER ");
    tracep->declBus(c+3628,"r_sindex", false,-1, 1,0);
    tracep->declBus(c+4063,"regrant", false,-1, 3,0);
    tracep->declBus(c+4064,"reindex", false,-1, 1,0);
    tracep->popNamePrefix(2);
    tracep->pushNamePrefix("SLAVE_GRANT[0] ");
...
VL_ATTR_COLD void Vmain___024root__trace_full_sub_0(Vmain___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+3812,(vlSelf->main__DOT__ddr3_controller_inst__DOT__odelay_data_cntvaluein_prev),5);
    bufp->fullCData(oldp+3813,(vlSelf->main__DOT__ddr3_controller_inst__DOT__idelay_dqs_cntvaluein[0]),5);
    bufp->fullCData(oldp+3814,(vlSelf->main__DOT__ddr3_controller_inst__DOT__sample_clk_repeat),6);
    bufp->fullBit(oldp+3815,(vlSelf->main__DOT__ddr3_controller_inst__DOT__stored_write_level_feedback));
    bufp->fullCData(oldp+3816,(vlSelf->main__DOT__ddr3_controller_inst__DOT__start_index_check),6);
    bufp->fullQData(oldp+3817,(vlSelf->main__DOT__ddr3_controller_inst__DOT__read_lane_data),64);
    bufp->fullBit(oldp+3819,(vlSelf->main__DOT__ddr3_controller_inst__DOT__wb2_stb));
    bufp->fullBit(oldp+3820,(vlSelf->main__DOT__ddr3_controller_inst__DOT__wb2_update));
    bufp->fullBit(oldp+3821,(vlSelf->main__DOT__ddr3_controller_inst__DOT__wb2_we));
    bufp->fullCData(oldp+3822,(vlSelf->main__DOT__ddr3_controller_inst__DOT__wb2_addr),7);
    bufp->fullIData(oldp+3823,(vlSelf->main__DOT__ddr3_controller_inst__DOT__wb2_data),32);
    bufp->fullCData(oldp+3824,(vlSelf->main__DOT__ddr3_controller_inst__DOT__wb2_sel),4);
    bufp->fullCData(oldp+3825,(vlSelf->main__DOT__ddr3_controller_inst__DOT__wb2_phy_odelay_data_cntvaluein),5);
    bufp->fullCData(oldp+3826,(vlSelf->main__DOT__ddr3_controller_inst__DOT__wb2_phy_odelay_dqs_cntvaluein),5);
    bufp->fullCData(oldp+3827,(vlSelf->main__DOT__ddr3_controller_inst__DOT__wb2_phy_idelay_data_cntvaluein),5);
    bufp->fullCData(oldp+3828,(vlSelf->main__DOT__ddr3_controller_inst__DOT__wb2_phy_idelay_dqs_cntvaluein),5);
    bufp->fullBit(oldp+3829,(vlSelf->main__DOT__ddr3_controller_inst__DOT__wb2_phy_odelay_data_ld));
    bufp->fullBit(oldp+3830,(vlSelf->main__DOT__ddr3_controller_inst__DOT__wb2_phy_odelay_dqs_ld));
    bufp->fullBit(oldp+3831,(vlSelf->main__DOT__ddr3_controller_inst__DOT__wb2_phy_idelay_data_ld));
    bufp->fullBit(oldp+3832,(vlSelf->main__DOT__ddr3_controller_inst__DOT__wb2_phy_idelay_dqs_ld));
    bufp->fullBit(oldp+3833,(vlSelf->main__DOT__ddr3_controller_inst__DOT__wb2_write_lane));
    bufp->fullSData(oldp+3834,((((IData)(vlSelf->main__DOT__wb32_ddr3_controller_stall) 
                                 << 0xbU) | ((IData)(vlSelf->main__DOT__wb32_ddr3_phy_stall) 
                                             << 0xaU))),12);
    bufp->fullBit(oldp+3835,((1U & (IData)(vlSelf->main__DOT____Vcellout__wbwide_xbar__o_scyc))));
    bufp->fullBit(oldp+3836,((1U & (IData)(vlSelf->main__DOT____Vcellout__wbwide_xbar__o_sstb))));
    bufp->fullBit(oldp+3837,((1U & ((IData)(vlSelf->main__DOT____Vcellout__wbwide_xbar__o_scyc) 
                                    >> 1U))));
    bufp->fullBit(oldp+3838,((1U & ((IData)(vlSelf->main__DOT____Vcellout__wbwide_xbar__o_sstb) 
                                    >> 1U))));
    bufp->fullBit(oldp+3839,(vlSelf->main__DOT__u_wbdown__DOT__DOWNSIZE__DOT__r_err));
    bufp->fullBit(oldp+3840,(vlSelf->main__DOT__u_wbdown__DOT__DOWNSIZE__DOT__r_cyc));
    bufp->fullBit(oldp+3841,(vlSelf->main__DOT__wb32_xbar__DOT__DOUBLE_BUFFERRED_STALL__DOT__r_merr));
    bufp->fullBit(oldp+3842,((1U & ((IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_scyc) 
                                    >> 8U))));
    bufp->fullBit(oldp+3843,((IData)((((IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_sstb) 
                                       >> 8U) & (0U 
                                                 == 
                                                 (0x700U 
                                                  & vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[6U]))))));
    bufp->fullBit(oldp+3844,((1U & ((IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_swe) 
                                    >> 8U))));
    bufp->fullIData(oldp+3845,(vlSelf->main__DOT____Vcellout__wb32_xbar__o_sdata[8U]),32);
    bufp->fullCData(oldp+3846,((0xfU & (IData)((vlSelf->main__DOT____Vcellout__wb32_xbar__o_ssel 
                                                >> 0x20U)))),4);
    bufp->fullBit(oldp+3847,((IData)((((IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_sstb) 
                                       >> 8U) & (0x100U 
                                                 == 
                                                 (0x700U 
                                                  & vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[6U]))))));
    bufp->fullBit(oldp+3848,(vlSelf->main__DOT__wb32_sirefclk_stb));
    bufp->fullBit(oldp+3849,(vlSelf->main__DOT__wb32_spio_stb));
    bufp->fullBit(oldp+3850,((IData)((((IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_sstb) 
                                       >> 8U) & (0x400U 
                                                 == 
                                                 (0x700U 
                                                  & vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[6U]))))));
    ...
    bufp->fullIData(oldp+3854,((0x1ffffffU & vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[0U])),25);
    bufp->fullIData(oldp+3855,(vlSelf->main__DOT____Vcellout__wb32_xbar__o_sdata[0U]),32);
    bufp->fullCData(oldp+3856,((0xfU & (IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_ssel))),4);
    ...
    bufp->fullBit(oldp+3859,((1U & ((IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_swe) 
                                    >> 1U))));
    bufp->fullIData(oldp+3860,((0x1ffffffU & ((vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[1U] 
                                               << 7U) 
                                              | (vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[0U] 
                                                 >> 0x19U)))),25);
    bufp->fullIData(oldp+3861,(vlSelf->main__DOT____Vcellout__wb32_xbar__o_sdata[1U]),32);
    ...
    bufp->fullBit(oldp+3865,((1U & ((IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_swe) 
                                    >> 2U))));
    bufp->fullIData(oldp+3866,((0x1ffffffU & ((vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[2U] 
                                               << 0xeU) 
                                              | (vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[1U] 
                                                 >> 0x12U)))),25);
    bufp->fullIData(oldp+3867,(vlSelf->main__DOT____Vcellout__wb32_xbar__o_sdata[2U]),32);
    ...
    bufp->fullIData(oldp+3872,((0x1ffffffU & ((vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[3U] 
                                              ...
                                              | (vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[2U] 
                                                 >> 0xbU)))),25);
    bufp->fullIData(oldp+3873,(vlSelf->main__DOT____Vcellout__wb32_xbar__o_sdata[3U]),32);
    ...
    bufp->fullBit(oldp+3877,((1U & ((IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_swe) 
                                    >> 4U))));
    bufp->fullIData(oldp+3878,((0x1ffffffU & (vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[3U] 
                                              >> 4U))),25);
    bufp->fullIData(oldp+3879,(vlSelf->main__DOT____Vcellout__wb32_xbar__o_sdata[4U]),32);
    ...
    bufp->fullBit(oldp+3883,((1U & ((IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_swe) 
                                    >> 5U))));
    bufp->fullIData(oldp+3884,((0x1ffffffU & ((vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[4U] 
                                               << 3U) 
                                              | (vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[3U] 
                                                 >> 0x1dU)))),25);
    bufp->fullIData(oldp+3885,(vlSelf->main__DOT____Vcellout__wb32_xbar__o_sdata[5U]),32);
    ...
    bufp->fullBit(oldp+3889,((1U & ((IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_swe) 
                                    >> 6U))));
    bufp->fullIData(oldp+3890,((0x1ffffffU & ((vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[5U] 
                                               << 0xaU) 
                                              | (vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[4U] 
                                                 >> 0x16U)))),25);
    bufp->fullIData(oldp+3891,(vlSelf->main__DOT____Vcellout__wb32_xbar__o_sdata[6U]),32);
    ...
    bufp->fullBit(oldp+3895,((1U & ((IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_swe) 
                                    >> 7U))));
    bufp->fullIData(oldp+3896,((0x1ffffffU & ((vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[6U] 
                                               << 0x11U) 
                                              | (vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[5U] 
                                                 >> 0xfU)))),25);
    bufp->fullIData(oldp+3897,(vlSelf->main__DOT____Vcellout__wb32_xbar__o_sdata[7U]),32);
    bufp->fullCData(oldp+3898,((0xfU & (IData)((vlSelf->main__DOT____Vcellout__wb32_xbar__o_ssel 
                                                >> 0x1cU)))),4);
    bufp->fullBit(oldp+3899,((1U & ((IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_sstb) 
                                    >> 8U))));
    bufp->fullIData(oldp+3900,((0x1ffffffU & ((vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[7U] 
                                               << 0x18U) 
                                              | (vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[6U] 
                                                 >> 8U)))),25);
    ...
    bufp->fullBit(oldp+3903,((1U & ((IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_swe) 
                                    >> 9U))));
    bufp->fullIData(oldp+3904,((0x1ffffffU & (vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[7U] 
                                              >> 1U))),25);
    bufp->fullIData(oldp+3905,(vlSelf->main__DOT____Vcellout__wb32_xbar__o_sdata[9U]),32);
    ...
    bufp->fullBit(oldp+3909,((1U & ((IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_swe) 
                                    >> 0xaU))));
    bufp->fullIData(oldp+3910,((0x1ffffffU & ((vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[8U] 
                                               << 6U) 
                                              | (vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[7U] 
                                                 >> 0x1aU)))),25);
    bufp->fullIData(oldp+3911,(vlSelf->main__DOT____Vcellout__wb32_xbar__o_sdata[0xaU]),32);
    bufp->fullCData(oldp+3912,((0xfU & (IData)((vlSelf->main__DOT____Vcellout__wb32_xbar__o_ssel 
                                                >> 0x28U)))),4);
    bufp->fullBit(oldp+3913,((1U & ((IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_scyc) 
                                    >> 0xbU))));
    bufp->fullBit(oldp+3914,((1U & ((IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_sstb) 
                                    >> 0xbU))));
    bufp->fullBit(oldp+3915,((1U & ((IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_swe) 
                                    >> 0xbU))));
    bufp->fullIData(oldp+3916,((0x1ffffffU & ((vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[9U] 
                                               << 0xdU) 
                                              | (vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[8U] 
                                                 >> 0x13U)))),25);
    bufp->fullIData(oldp+3917,(vlSelf->main__DOT____Vcellout__wb32_xbar__o_sdata[0xbU]),32);
    bufp->fullCData(oldp+3918,((0xfU & (IData)((vlSelf->main__DOT____Vcellout__wb32_xbar__o_ssel 
                                                >> 0x2cU)))),4);
    bufp->fullCData(oldp+3919,((3U & (vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[4U] 
                                      >> 0x16U))),2);
    bufp->fullIData(oldp+3920,((0xffffffU & ((vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[9U] 
                                              << 0xdU) 
                                             | (vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[8U] 
                                                >> 0x13U)))),24);
    bufp->fullQData(oldp+3921,(((0xffffffffULL & (QData)((IData)(
    ...
    bufp->fullCData(oldp+3923,((0xfU & (IData)((vlSelf->main__DOT____Vcellout__wb32_xbar__o_ssel 
                                                >> 0x2cU)))),8);
    bufp->fullCData(oldp+3924,((0x7fU & ((vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[8U] 
                                          << 6U) | 
                                         (vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[7U] 
                                          >> 0x1aU)))),7);
    bufp->fullIData(oldp+3925,((0xffffffU & ((IData)(5U) 
                                             + ((vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[9U] 
                                                 << 0xdU) 
                                                | (vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[8U] 
                                                   >> 0x13U))))),24);
    bufp->fullIData(oldp+3926,(vlSelf->main__DOT__ddr3_controller_inst__DOT__wb_data_to_wb2),32);
    bufp->fullCData(oldp+3927,((3U & (vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[3U] 
                                      >> 4U))),2);
    bufp->fullBit(oldp+3928,(vlSelf->main__DOT__i2ci__DOT__next_valid));
    bufp->fullCData(oldp+3929,(vlSelf->main__DOT__i2ci__DOT__next_insn),8);
    bufp->fullBit(oldp+3930,((1U & (((IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_sstb) 
                                     >> 4U) & (~ ((IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_swe) 
                                                  >> 4U))))));
    bufp->fullBit(oldp+3931,(vlSelf->main__DOT__i2ci__DOT__bus_write));
    bufp->fullBit(oldp+3932,(vlSelf->main__DOT__i2ci__DOT__bus_override));
    bufp->fullBit(oldp+3933,(vlSelf->main__DOT__i2ci__DOT__bus_manual));
    bufp->fullBit(oldp+3934,(vlSelf->main__DOT__i2ci__DOT__bus_jump));
    bufp->fullBit(oldp+3935,((1U & vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[0U])));
    bufp->fullBit(oldp+3936,((1U & ((IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_sstb) 
                                    & (IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_swe)))));
    bufp->fullBit(oldp+3937,(vlSelf->main__DOT__i2cscopei__DOT__read_from_data));
    bufp->fullBit(oldp+3938,(vlSelf->main__DOT__i2cscopei__DOT__write_to_control));
    bufp->fullBit(oldp+3939,((1U & (vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[0U] 
                                    >> 0x19U))));
    bufp->fullBit(oldp+3940,((1U & (((IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_sstb) 
                                     & (IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_swe)) 
                                    >> 1U))));
    bufp->fullBit(oldp+3941,(vlSelf->main__DOT__scope1_ddr3i__DOT__read_from_data));
    bufp->fullBit(oldp+3942,(vlSelf->main__DOT__scope1_ddr3i__DOT__write_to_control));
    bufp->fullBit(oldp+3943,((1U & (vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[1U] 
                                    >> 0x12U))));
    bufp->fullBit(oldp+3944,((1U & (((IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_sstb) 
                                     & (IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_swe)) 
                                    >> 2U))));
    bufp->fullBit(oldp+3945,(vlSelf->main__DOT__scope2_ddr3i__DOT__read_from_data));
    bufp->fullBit(oldp+3946,(vlSelf->main__DOT__scope2_ddr3i__DOT__write_to_control));
    bufp->fullBit(oldp+3947,((1U & (vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[2U] 
                                    >> 0xbU))));
    bufp->fullBit(oldp+3948,((1U & (((IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_sstb) 
                                     & (IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_swe)) 
                                    >> 3U))));
    bufp->fullBit(oldp+3949,(vlSelf->main__DOT__scope3_ddr3i__DOT__read_from_data));
    bufp->fullBit(oldp+3950,(vlSelf->main__DOT__scope3_ddr3i__DOT__write_to_control));
    bufp->fullCData(oldp+3951,(vlSelf->main__DOT__spioi__DOT__GEN_BUTTON__DOT__next_btn),5);
    bufp->fullBit(oldp+3952,(vlSelf->main__DOT__spioi__DOT__GEN_BUTTON__DOT__next_int));
    bufp->fullCData(oldp+3953,((7U & (vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[5U] 
                                      >> 0xfU))),3);
    bufp->fullBit(oldp+3954,(vlSelf->main__DOT__u_fan__DOT____Vcellinp__u_i2ccpu__i_wb_stb));
    bufp->fullCData(oldp+3955,((3U & (vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[5U] 
                                      >> 0xfU))),2);
    bufp->fullBit(oldp+3956,(vlSelf->main__DOT__u_fan__DOT__u_i2ccpu__DOT__next_valid));
    bufp->fullCData(oldp+3957,(vlSelf->main__DOT__u_fan__DOT__u_i2ccpu__DOT__next_insn),8);
    bufp->fullBit(oldp+3958,(((IData)(vlSelf->main__DOT__u_fan__DOT____Vcellinp__u_i2ccpu__i_wb_stb) 
                              & (~ ((IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_swe) 
                                    >> 7U)))));
    bufp->fullBit(oldp+3959,(vlSelf->main__DOT__u_fan__DOT__u_i2ccpu__DOT__bus_write));
    bufp->fullBit(oldp+3960,(vlSelf->main__DOT__u_fan__DOT__u_i2ccpu__DOT__bus_override));
    bufp->fullBit(oldp+3961,(vlSelf->main__DOT__u_fan__DOT__u_i2ccpu__DOT__bus_manual));
    bufp->fullBit(oldp+3962,(vlSelf->main__DOT__u_fan__DOT__u_i2ccpu__DOT__bus_jump));
    bufp->fullCData(oldp+3963,((3U & (vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[3U] 
                                      >> 0x1dU))),2);
    bufp->fullIData(oldp+3964,(vlSelf->main__DOT__u_i2cdma__DOT__next_baseaddr),32);
    bufp->fullIData(oldp+3965,(vlSelf->main__DOT__u_i2cdma__DOT__next_memlen),32);
    bufp->fullSData(oldp+3966,(vlSelf->main__DOT____Vcellout__wb32_xbar__o_scyc),12);
    bufp->fullSData(oldp+3967,(vlSelf->main__DOT____Vcellout__wb32_xbar__o_sstb),12);
    bufp->fullSData(oldp+3968,(vlSelf->main__DOT____Vcellout__wb32_xbar__o_swe),12);
    bufp->fullWData(oldp+3969,(vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr),300);
    bufp->fullWData(oldp+3979,(vlSelf->main__DOT____Vcellout__wb32_xbar__o_sdata),384);
    bufp->fullQData(oldp+3991,(vlSelf->main__DOT____Vcellout__wb32_xbar__o_ssel),48);
    bufp->fullSData(oldp+3993,(vlSelf->main__DOT__wb32_xbar__DOT__request[0]),13);
    bufp->fullSData(oldp+3994,(vlSelf->main__DOT__wb32_xbar__DOT__sgrant),12);
    bufp->fullCData(oldp+3995,(vlSelf->main__DOT__wb32_xbar__DOT__mindex[0]),4);
    bufp->fullBit(oldp+3996,(vlSelf->main__DOT__wb32_xbar__DOT__m_stb));
    bufp->fullBit(oldp+3997,((1U & (IData)((vlSelf->main__DOT__wb32_xbar__DOT____Vcellout__DECODE_REQUEST__BRA__0__KET____DOT__adcd__o_data 
                                            >> 0x24U)))));
    bufp->fullIData(oldp+3998,(vlSelf->main__DOT__wb32_xbar__DOT__m_addr[0]),25);
    bufp->fullIData(oldp+3999,(vlSelf->main__DOT__wb32_xbar__DOT__m_data[0]),32);
    bufp->fullCData(oldp+4000,(vlSelf->main__DOT__wb32_xbar__DOT__m_sel[0]),4);
    bufp->fullBit(oldp+4001,(vlSelf->main__DOT__wb32_xbar__DOT__dcd_stb));
    bufp->fullSData(oldp+4002,(vlSelf->main__DOT__wb32_xbar__DOT__ARBITRATE_REQUESTS__BRA__0__KET____DOT__MINDEX_MULTIPLE_SLAVES__DOT__r_regrant),13);
    bufp->fullBit(oldp+4003,(vlSelf->main__DOT__wb32_xbar__DOT__ARBITRATE_REQUESTS__BRA__0__KET____DOT__stay_on_channel));
    bufp->fullBit(oldp+4004,(vlSelf->main__DOT__wb32_xbar__DOT__ARBITRATE_REQUESTS__BRA__0__KET____DOT__requested_channel_is_available));
    bufp->fullCData(oldp+4005,(vlSelf->main__DOT__wb32_xbar__DOT__ARBITRATE_REQUESTS__BRA__0__KET____DOT__MINDEX_MULTIPLE_SLAVES__DOT__r_mindex),4);
    bufp->fullBit(oldp+4006,((1U & (IData)((vlSelf->main__DOT__wb32_xbar__DOT____Vcellout__DECODE_REQUEST__BRA__0__KET____DOT__iskid__o_data 
                                            >> 0x3dU)))));
    bufp->fullIData(oldp+4007,((0x1ffffffU & (IData)(
                                                     (vlSelf->main__DOT__wb32_xbar__DOT____Vcellout__DECODE_REQUEST__BRA__0__KET____DOT__iskid__o_data 
                                                      >> 0x24U)))),25);
    bufp->fullIData(oldp+4008,((IData)((vlSelf->main__DOT__wb32_xbar__DOT____Vcellout__DECODE_REQUEST__BRA__0__KET____DOT__iskid__o_data 
                                        >> 4U))),32);
    bufp->fullCData(oldp+4009,((0xfU & (IData)(vlSelf->main__DOT__wb32_xbar__DOT____Vcellout__DECODE_REQUEST__BRA__0__KET____DOT__iskid__o_data))),4);
    bufp->fullQData(oldp+4010,((((QData)((IData)((1U 
                                                  & (IData)(
                                                            (vlSelf->main__DOT__wb32_xbar__DOT____Vcellout__DECODE_REQUEST__BRA__0__KET____DOT__iskid__o_data 
                                                             >> 0x3dU))))) 
                                 << 0x24U) | (0xfffffffffULL 
                                              & vlSelf->main__DOT__wb32_xbar__DOT____Vcellout__DECODE_REQUEST__BRA__0__KET____DOT__iskid__o_data))),37);
    bufp->fullQData(oldp+4012,(vlSelf->main__DOT__wb32_xbar__DOT____Vcellout__DECODE_REQUEST__BRA__0__KET____DOT__adcd__o_data),37);
    bufp->fullSData(oldp+4014,(vlSelf->main__DOT__wb32_xbar__DOT__DECODE_REQUEST__BRA__0__KET____DOT__adcd__DOT__prerequest),12);
    bufp->fullQData(oldp+4015,(vlSelf->main__DOT__wb32_xbar__DOT____Vcellout__DECODE_REQUEST__BRA__0__KET____DOT__iskid__o_data),62);
    bufp->fullCData(oldp+4017,(vlSelf->main__DOT__wbu_xbar__DOT__mindex[0]),2);
    bufp->fullCData(oldp+4018,(vlSelf->main__DOT__wbu_xbar__DOT__ARBITRATE_REQUESTS__BRA__0__KET____DOT__MINDEX_MULTIPLE_SLAVES__DOT__r_regrant),3);
    bufp->fullCData(oldp+4019,(vlSelf->main__DOT__wbu_xbar__DOT__ARBITRATE_REQUESTS__BRA__0__KET____DOT__MINDEX_MULTIPLE_SLAVES__DOT__r_mindex),2);
    bufp->fullCData(oldp+4020,(vlSelf->main__DOT____Vcellinp__wbwide_xbar__i_mcyc),4);
    bufp->fullCData(oldp+4021,(vlSelf->main__DOT____Vcellout__wbwide_xbar__o_scyc),2);
    bufp->fullCData(oldp+4022,(vlSelf->main__DOT____Vcellout__wbwide_xbar__o_sstb),2);
    bufp->fullCData(oldp+4023,(((IData)(vlSelf->main__DOT__u_wbdown__DOT__DOWNSIZE__DOT__r_err) 
                                << 1U)),2);
    bufp->fullCData(oldp+4024,(vlSelf->main__DOT__wbwide_xbar__DOT__sgrant),2);
    bufp->fullCData(oldp+4025,(vlSelf->main__DOT__wbwide_xbar__DOT__mindex[0]),2);
    bufp->fullCData(oldp+4026,(vlSelf->main__DOT__wbwide_xbar__DOT__mindex[1]),2);
    bufp->fullCData(oldp+4027,(vlSelf->main__DOT__wbwide_xbar__DOT__mindex[2]),2);
    bufp->fullCData(oldp+4028,(vlSelf->main__DOT__wbwide_xbar__DOT__mindex[3]),2);
    bufp->fullCData(oldp+4029,(vlSelf->main__DOT__wbwide_xbar__DOT__sindex[0]),2);
    bufp->fullCData(oldp+4030,(vlSelf->main__DOT__wbwide_xbar__DOT__sindex[1]),2);
    bufp->fullCData(oldp+4031,(vlSelf->main__DOT__wbwide_xbar__DOT__sindex[2]),2);
    bufp->fullCData(oldp+4032,(vlSelf->main__DOT__wbwide_xbar__DOT__sindex[3]),2);
    bufp->fullCData(oldp+4033,(vlSelf->main__DOT__wbwide_xbar__DOT__m_stall),4);
    bufp->fullCData(oldp+4034,(vlSelf->main__DOT__wbwide_xbar__DOT__s_stall),4);
    bufp->fullCData(oldp+4035,(vlSelf->main__DOT__wbwide_xbar__DOT__s_ack),4);
    bufp->fullCData(oldp+4036,(vlSelf->main__DOT__wbwide_xbar__DOT__s_err),4);
    bufp->fullCData(oldp+4037,(vlSelf->main__DOT__wbwide_xbar__DOT__ARBITRATE_REQUESTS__BRA__0__KET____DOT__MINDEX_MULTIPLE_SLAVES__DOT__r_regrant),3);
    bufp->fullBit(oldp+4038,(vlSelf->main__DOT__wbwide_xbar__DOT__ARBITRATE_REQUESTS__BRA__0__KET____DOT__requested_channel_is_available));
    bufp->fullCData(oldp+4039,(vlSelf->main__DOT__wbwide_xbar__DOT__ARBITRATE_REQUESTS__BRA__0__KET____DOT__MINDEX_MULTIPLE_SLAVES__DOT__r_mindex),2);
    bufp->fullCData(oldp+4040,(vlSelf->main__DOT__wbwide_xbar__DOT__ARBITRATE_REQUESTS__BRA__1__KET____DOT__MINDEX_MULTIPLE_SLAVES__DOT__r_regrant),3);
    bufp->fullBit(oldp+4041,(vlSelf->main__DOT__wbwide_xbar__DOT__ARBITRATE_REQUESTS__BRA__1__KET____DOT__requested_channel_is_available));
    bufp->fullCData(oldp+4042,(vlSelf->main__DOT__wbwide_xbar__DOT__ARBITRATE_REQUESTS__BRA__1__KET____DOT__MINDEX_MULTIPLE_SLAVES__DOT__r_mindex),2);
    bufp->fullCData(oldp+4043,(vlSelf->main__DOT__wbwide_xbar__DOT__ARBITRATE_REQUESTS__BRA__2__KET____DOT__MINDEX_MULTIPLE_SLAVES__DOT__r_regrant),3);
    bufp->fullBit(oldp+4044,(vlSelf->main__DOT__wbwide_xbar__DOT__ARBITRATE_REQUESTS__BRA__2__KET____DOT__requested_channel_is_available));
    bufp->fullCData(oldp+4045,(vlSelf->main__DOT__wbwide_xbar__DOT__ARBITRATE_REQUESTS__BRA__2__KET____DOT__MINDEX_MULTIPLE_SLAVES__DOT__r_mindex),2);
    bufp->fullCData(oldp+4046,(vlSelf->main__DOT__wbwide_xbar__DOT__ARBITRATE_REQUESTS__BRA__3__KET____DOT__MINDEX_MULTIPLE_SLAVES__DOT__r_regrant),3);
    bufp->fullBit(oldp+4047,(vlSelf->main__DOT__wbwide_xbar__DOT__ARBITRATE_REQUESTS__BRA__3__KET____DOT__requested_channel_is_available));
    bufp->fullCData(oldp+4048,(vlSelf->main__DOT__wbwide_xbar__DOT__ARBITRATE_REQUESTS__BRA__3__KET____DOT__MINDEX_MULTIPLE_SLAVES__DOT__r_mindex),2);
    bufp->fullBit(oldp+4049,(vlSelf->main__DOT__wbwide_xbar__DOT__DECODE_REQUEST__BRA__0__KET____DOT__skd_stall));
    bufp->fullBit(oldp+4050,(vlSelf->main__DOT__wbwide_xbar__DOT____Vcellinp__DECODE_REQUEST__BRA__0__KET____DOT__adcd__i_stall));
    bufp->fullBit(oldp+4051,((1U & (~ (IData)(vlSelf->main__DOT__wbwide_xbar__DOT__DECODE_REQUEST__BRA__0__KET____DOT__skd_stall)))));
    bufp->fullBit(oldp+4052,(vlSelf->main__DOT__wbwide_xbar__DOT__DECODE_REQUEST__BRA__1__KET____DOT__skd_stall));
    bufp->fullBit(oldp+4053,(vlSelf->main__DOT__wbwide_xbar__DOT____Vcellinp__DECODE_REQUEST__BRA__1__KET____DOT__adcd__i_stall));
    bufp->fullBit(oldp+4054,((1U & (~ (IData)(vlSelf->main__DOT__wbwide_xbar__DOT__DECODE_REQUEST__BRA__1__KET____DOT__skd_stall)))));
    bufp->fullBit(oldp+4055,(vlSelf->main__DOT__wbwide_xbar__DOT__DECODE_REQUEST__BRA__2__KET____DOT__skd_stall));
    bufp->fullBit(oldp+4056,(vlSelf->main__DOT__wbwide_xbar__DOT____Vcellinp__DECODE_REQUEST__BRA__2__KET____DOT__adcd__i_stall));
    bufp->fullBit(oldp+4057,((1U & (~ (IData)(vlSelf->main__DOT__wbwide_xbar__DOT__DECODE_REQUEST__BRA__2__KET____DOT__skd_stall)))));
    bufp->fullBit(oldp+4058,(vlSelf->main__DOT__wbwide_xbar__DOT__DECODE_REQUEST__BRA__3__KET____DOT__skd_stall));
    bufp->fullBit(oldp+4059,(vlSelf->main__DOT__wbwide_xbar__DOT____Vcellinp__DECODE_REQUEST__BRA__3__KET____DOT__adcd__i_stall));
    bufp->fullBit(oldp+4060,((1U & (~ (IData)(vlSelf->main__DOT__wbwide_xbar__DOT__DECODE_REQUEST__BRA__3__KET____DOT__skd_stall)))));
    bufp->fullCData(oldp+4061,(vlSelf->main__DOT__wbwide_xbar__DOT__GEN_SINDEX__BRA__0__KET____DOT__SINDEX_MORE_THAN_ONE_MASTER__DOT__regrant),4);
    bufp->fullCData(oldp+4062,(vlSelf->main__DOT__wbwide_xbar__DOT__GEN_SINDEX__BRA__0__KET____DOT__SINDEX_MORE_THAN_ONE_MASTER__DOT__reindex),2);
    bufp->fullCData(oldp+4063,(vlSelf->main__DOT__wbwide_xbar__DOT__GEN_SINDEX__BRA__1__KET____DOT__SINDEX_MORE_THAN_ONE_MASTER__DOT__regrant),4);
    bufp->fullCData(oldp+4064,(vlSelf->main__DOT__wbwide_xbar__DOT__GEN_SINDEX__BRA__1__KET____DOT__SINDEX_MORE_THAN_ONE_MASTER__DOT__reindex),2);
    bufp->fullBit(oldp+4065,((1U & (vlSelf->main__DOT__ddr3_controller_inst__DOT__o_wb_ack_read_q
                                    [0U] >> 1U))));
    bufp->fullIData(oldp+4066,((IData)(vlSelf->main__DOT____Vcellout__ddr3_controller_inst__o_wb_data)),32);
    bufp->fullQData(oldp+4067,(vlSelf->main__DOT____Vcellout__ddr3_controller_inst__o_wb_data),64);
    bufp->fullCData(oldp+4069,(vlSelf->main__DOT__ddr3_controller_inst__DOT__o_wb_ack_read_q[0]),2);
    bufp->fullCData(oldp+4070,(vlSelf->main__DOT__ddr3_controller_inst__DOT__o_wb_ack_read_q[1]),2);
    bufp->fullCData(oldp+4071,(vlSelf->main__DOT__ddr3_controller_inst__DOT__o_wb_ack_read_q[2]),2);
    bufp->fullCData(oldp+4072,(vlSelf->main__DOT__ddr3_controller_inst__DOT__o_wb_ack_read_q[3]),2);
    bufp->fullCData(oldp+4073,(vlSelf->main__DOT__ddr3_controller_inst__DOT__o_wb_ack_read_q[4]),2);
    bufp->fullCData(oldp+4074,(vlSelf->main__DOT__ddr3_controller_inst__DOT__o_wb_ack_read_q[5]),2);
    bufp->fullCData(oldp+4075,(vlSelf->main__DOT__ddr3_controller_inst__DOT__o_wb_ack_read_q[6]),2);
    bufp->fullCData(oldp+4076,(vlSelf->main__DOT__ddr3_controller_inst__DOT__o_wb_ack_read_q[7]),2);
    bufp->fullCData(oldp+4077,(vlSelf->main__DOT__ddr3_controller_inst__DOT__o_wb_ack_read_q[8]),2);
    bufp->fullCData(oldp+4078,(vlSelf->main__DOT__ddr3_controller_inst__DOT__o_wb_ack_read_q[9]),2);
    bufp->fullCData(oldp+4079,(vlSelf->main__DOT__ddr3_controller_inst__DOT__o_wb_ack_read_q[10]),2);
    bufp->fullCData(oldp+4080,(vlSelf->main__DOT__ddr3_controller_inst__DOT__o_wb_ack_read_q[11]),2);
    bufp->fullCData(oldp+4081,(vlSelf->main__DOT__ddr3_controller_inst__DOT__o_wb_ack_read_q[12]),2);
    bufp->fullCData(oldp+4082,(vlSelf->main__DOT__ddr3_controller_inst__DOT__o_wb_ack_read_q[13]),2);
    bufp->fullCData(oldp+4083,(vlSelf->main__DOT__ddr3_controller_inst__DOT__o_wb_ack_read_q[14]),2);
    bufp->fullCData(oldp+4084,(vlSelf->main__DOT__ddr3_controller_inst__DOT__o_wb_ack_read_q[15]),2);
    bufp->fullBit(oldp+4085,((1U & vlSelf->main__DOT__ddr3_controller_inst__DOT__o_wb_ack_read_q
                              [0U])));
    bufp->fullBit(oldp+4086,(vlSelf->main__DOT__ddr3_controller_inst__DOT__stage2_stall));
    bufp->fullBit(oldp+4087,(vlSelf->main__DOT__ddr3_controller_inst__DOT__stage1_stall));
    bufp->fullCData(oldp+4088,(vlSelf->main__DOT__ddr3_controller_inst__DOT__bank_status_d),8);
    bufp->fullSData(oldp+4089,(vlSelf->main__DOT__ddr3_controller_inst__DOT__bank_active_row_d[0]),14);
    bufp->fullSData(oldp+4090,(vlSelf->main__DOT__ddr3_controller_inst__DOT__bank_active_row_d[1]),14);
    bufp->fullSData(oldp+4091,(vlSelf->main__DOT__ddr3_controller_inst__DOT__bank_active_row_d[2]),14);
    bufp->fullSData(oldp+4092,(vlSelf->main__DOT__ddr3_controller_inst__DOT__bank_active_row_d[3]),14);
    bufp->fullSData(oldp+4093,(vlSelf->main__DOT__ddr3_controller_inst__DOT__bank_active_row_d[4]),14);
    bufp->fullSData(oldp+4094,(vlSelf->main__DOT__ddr3_controller_inst__DOT__bank_active_row_d[5]),14);
    bufp->fullSData(oldp+4095,(vlSelf->main__DOT__ddr3_controller_inst__DOT__bank_active_row_d[6]),14);
    bufp->fullSData(oldp+4096,(vlSelf->main__DOT__ddr3_controller_inst__DOT__bank_active_row_d[7]),14);
    bufp->fullCData(oldp+4097,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_precharge_counter_d[0]),4);
    bufp->fullCData(oldp+4098,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_precharge_counter_d[1]),4);
    bufp->fullCData(oldp+4099,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_precharge_counter_d[2]),4);
    bufp->fullCData(oldp+4100,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_precharge_counter_d[3]),4);
    bufp->fullCData(oldp+4101,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_precharge_counter_d[4]),4);
    bufp->fullCData(oldp+4102,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_precharge_counter_d[5]),4);
    bufp->fullCData(oldp+4103,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_precharge_counter_d[6]),4);
    bufp->fullCData(oldp+4104,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_precharge_counter_d[7]),4);
    bufp->fullCData(oldp+4105,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_activate_counter_d[0]),4);
    bufp->fullCData(oldp+4106,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_activate_counter_d[1]),4);
    bufp->fullCData(oldp+4107,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_activate_counter_d[2]),4);
    bufp->fullCData(oldp+4108,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_activate_counter_d[3]),4);
    bufp->fullCData(oldp+4109,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_activate_counter_d[4]),4);
    bufp->fullCData(oldp+4110,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_activate_counter_d[5]),4);
    bufp->fullCData(oldp+4111,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_activate_counter_d[6]),4);
    bufp->fullCData(oldp+4112,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_activate_counter_d[7]),4);
    bufp->fullCData(oldp+4113,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_write_counter_d[0]),4);
    bufp->fullCData(oldp+4114,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_write_counter_d[1]),4);
    bufp->fullCData(oldp+4115,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_write_counter_d[2]),4);
    bufp->fullCData(oldp+4116,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_write_counter_d[3]),4);
    bufp->fullCData(oldp+4117,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_write_counter_d[4]),4);
    bufp->fullCData(oldp+4118,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_write_counter_d[5]),4);
    bufp->fullCData(oldp+4119,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_write_counter_d[6]),4);
    bufp->fullCData(oldp+4120,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_write_counter_d[7]),4);
    bufp->fullCData(oldp+4121,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_read_counter_d[0]),4);
    bufp->fullCData(oldp+4122,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_read_counter_d[1]),4);
    bufp->fullCData(oldp+4123,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_read_counter_d[2]),4);
    bufp->fullCData(oldp+4124,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_read_counter_d[3]),4);
    bufp->fullCData(oldp+4125,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_read_counter_d[4]),4);
    bufp->fullCData(oldp+4126,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_read_counter_d[5]),4);
    bufp->fullCData(oldp+4127,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_read_counter_d[6]),4);
    bufp->fullCData(oldp+4128,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_read_counter_d[7]),4);
    bufp->fullIData(oldp+4129,(vlSelf->main__DOT__ddr3_controller_inst__DOT__cmd_d[0]),24);
    bufp->fullIData(oldp+4130,(vlSelf->main__DOT__ddr3_controller_inst__DOT__cmd_d[1]),24);
    bufp->fullIData(oldp+4131,(vlSelf->main__DOT__ddr3_controller_inst__DOT__cmd_d[2]),24);
    bufp->fullIData(oldp+4132,(vlSelf->main__DOT__ddr3_controller_inst__DOT__cmd_d[3]),24);
    bufp->fullBit(oldp+4133,(vlSelf->main__DOT__ddr3_controller_inst__DOT__cmd_odt));
    bufp->fullBit(oldp+4134,(vlSelf->main__DOT__ddr3_controller_inst__DOT__cmd_ck_en));
    bufp->fullBit(oldp+4135,(vlSelf->main__DOT__ddr3_controller_inst__DOT__cmd_reset_n));
    bufp->fullBit(oldp+4136,(vlSelf->main__DOT__ddr3_controller_inst__DOT__o_wb_stall_d));
    bufp->fullBit(oldp+4137,(vlSelf->main__DOT__ddr3_controller_inst__DOT__precharge_slot_busy));
    bufp->fullBit(oldp+4138,(vlSelf->main__DOT__ddr3_controller_inst__DOT__activate_slot_busy));
    bufp->fullBit(oldp+4139,(vlSelf->main__DOT__scope1_ddr3i__DOT__dw_trigger));
    bufp->fullBit(oldp+4140,(vlSelf->main__DOT__scope2_ddr3i__DOT__dw_trigger));
    bufp->fullBit(oldp+4141,(vlSelf->main__DOT__scope3_ddr3i__DOT__dw_trigger));
    bufp->fullBit(oldp+4142,(vlSelf->main__DOT__wb32_xbar__DOT__m_stall));
    bufp->fullSData(oldp+4143,(vlSelf->main__DOT__wb32_xbar__DOT__s_stall),16);
    bufp->fullBit(oldp+4144,(vlSelf->main__DOT__wb32_xbar__DOT__DECODE_REQUEST__BRA__0__KET____DOT__skd_stall));
    bufp->fullBit(oldp+4145,(vlSelf->main__DOT__wb32_xbar__DOT____Vcellinp__DECODE_REQUEST__BRA__0__KET____DOT__adcd__i_stall));
    bufp->fullBit(oldp+4146,((1U & (~ (IData)(vlSelf->main__DOT__wb32_xbar__DOT__DECODE_REQUEST__BRA__0__KET____DOT__skd_stall)))));
    bufp->fullBit(oldp+4147,(vlSelf->i_clk));
    bufp->fullBit(oldp+4148,(vlSelf->i_reset));
    bufp->fullQData(oldp+4149,(vlSelf->i_ddr3_controller_iserdes_data),64);
    bufp->fullCData(oldp+4151,(vlSelf->i_ddr3_controller_iserdes_dqs),8);
    bufp->fullCData(oldp+4152,(vlSelf->i_ddr3_controller_iserdes_bitslip_reference),8);
    bufp->fullBit(oldp+4153,(vlSelf->i_ddr3_controller_idelayctrl_rdy));
    bufp->fullWData(oldp+4154,(vlSelf->o_ddr3_controller_cmd),96);
    bufp->fullBit(oldp+4157,(vlSelf->o_ddr3_controller_dqs_tri_control));
    bufp->fullBit(oldp+4158,(vlSelf->o_ddr3_controller_dq_tri_control));
    bufp->fullBit(oldp+4159,(vlSelf->o_ddr3_controller_toggle_dqs));
    bufp->fullQData(oldp+4160,(vlSelf->o_ddr3_controller_data),64);
    bufp->fullCData(oldp+4162,(vlSelf->o_ddr3_controller_dm),8);
    bufp->fullCData(oldp+4163,(vlSelf->o_ddr3_controller_odelay_data_cntvaluein),5);
    bufp->fullCData(oldp+4164,(vlSelf->o_ddr3_controller_odelay_dqs_cntvaluein),5);
    bufp->fullCData(oldp+4165,(vlSelf->o_ddr3_controller_idelay_data_cntvaluein),5);
    bufp->fullCData(oldp+4166,(vlSelf->o_ddr3_controller_idelay_dqs_cntvaluein),5);
    bufp->fullBit(oldp+4167,(vlSelf->o_ddr3_controller_odelay_data_ld));
    bufp->fullBit(oldp+4168,(vlSelf->o_ddr3_controller_odelay_dqs_ld));
    bufp->fullBit(oldp+4169,(vlSelf->o_ddr3_controller_idelay_data_ld));
    bufp->fullBit(oldp+4170,(vlSelf->o_ddr3_controller_idelay_dqs_ld));
    bufp->fullBit(oldp+4171,(vlSelf->o_ddr3_controller_bitslip));
    bufp->fullCData(oldp+4172,(vlSelf->o_sirefclk_word),8);
    bufp->fullBit(oldp+4173,(vlSelf->o_sirefclk_ce));
    bufp->fullBit(oldp+4174,(vlSelf->i_fan_sda));
    bufp->fullBit(oldp+4175,(vlSelf->i_fan_scl));
    bufp->fullBit(oldp+4176,(vlSelf->o_fan_sda));
    bufp->fullBit(oldp+4177,(vlSelf->o_fan_scl));
    bufp->fullBit(oldp+4178,(vlSelf->o_fpga_pwm));
    bufp->fullBit(oldp+4179,(vlSelf->o_sys_pwm));
    bufp->fullBit(oldp+4180,(vlSelf->i_fan_tach));
    bufp->fullBit(oldp+4181,(vlSelf->i_i2c_sda));
    bufp->fullBit(oldp+4182,(vlSelf->i_i2c_scl));
    bufp->fullBit(oldp+4183,(vlSelf->o_i2c_sda));
    bufp->fullBit(oldp+4184,(vlSelf->o_i2c_scl));
    bufp->fullBit(oldp+4185,(vlSelf->cpu_sim_cyc));
    bufp->fullBit(oldp+4186,(vlSelf->cpu_sim_stb));
    bufp->fullBit(oldp+4187,(vlSelf->cpu_sim_we));
    bufp->fullCData(oldp+4188,(vlSelf->cpu_sim_addr),7);
    bufp->fullIData(oldp+4189,(vlSelf->cpu_sim_data),32);
    bufp->fullBit(oldp+4190,(vlSelf->cpu_sim_stall));
    bufp->fullBit(oldp+4191,(vlSelf->cpu_sim_ack));
    bufp->fullIData(oldp+4192,(vlSelf->cpu_sim_idata),32);
    bufp->fullBit(oldp+4193,(vlSelf->cpu_prof_stb));
    bufp->fullIData(oldp+4194,(vlSelf->cpu_prof_addr),28);
    bufp->fullIData(oldp+4195,(vlSelf->cpu_prof_ticks),32);
    bufp->fullBit(oldp+4196,(vlSelf->i_cpu_reset));
    bufp->fullBit(oldp+4197,(vlSelf->i_wbu_uart_rx));
    bufp->fullBit(oldp+4198,(vlSelf->o_wbu_uart_tx));
    bufp->fullBit(oldp+4199,(vlSelf->o_wbu_uart_cts_n));
    bufp->fullSData(oldp+4200,(vlSelf->i_gpio),16);
    bufp->fullCData(oldp+4201,(vlSelf->o_gpio),8);
    bufp->fullCData(oldp+4202,(vlSelf->i_sw),8);
    bufp->fullCData(oldp+4203,(vlSelf->i_btn),5);
    bufp->fullCData(oldp+4204,(vlSelf->o_led),8);
    bufp->fullBit(oldp+4205,(vlSelf->i_clk200));
                                 ...
                                 [0U] << 0x1fU) | (0x7fffffffU 
                                                   & (IData)(
                                                             (vlSelf->i_ddr3_controller_iserdes_data 
                                                              >> 0x20U))))),32);
    bufp->fullIData(oldp+4208,(((vlSelf->main__DOT__ddr3_controller_inst__DOT__o_wb_ack_read_q
                                 [0U] << 0x1fU) | (0x7fffffffU 
                                                   & (IData)(vlSelf->i_ddr3_controller_iserdes_data)))),32);
    bufp->fullIData(oldp+4209,((((IData)(vlSelf->main__DOT__u_fan__DOT__u_i2ccpu__DOT__r_aborted) 
                                 << 0x1fU) | ((0x40000000U 
    ...
    bufp->fullIData(oldp+4210,((((IData)(vlSelf->main__DOT__gpioi__DOT__r_gpio) 
                                 << 0x10U) | (IData)(vlSelf->o_gpio))),32);
    bufp->fullBit(oldp+4211,((vlSelf->main__DOT__ddr3_controller_inst__DOT__o_wb_ack_read_q
                              [0U] & (0x10U == (IData)(vlSelf->main__DOT__ddr3_controller_inst__DOT__state_calibrate)))));
    ...
    bufp->fullBit(oldp+4213,(((~ (IData)(vlSelf->cpu_sim_cyc)) 
                              & (IData)(vlSelf->main__DOT__raw_cpu_dbg_ack))));
    bufp->fullBit(oldp+4214,(vlSelf->main__DOT____Vcellinp__ddr3_controller_inst__i_rst_n));
    bufp->fullBit(oldp+4215,((0ULL == vlSelf->i_ddr3_controller_iserdes_data)));
    bufp->fullSData(oldp+4216,(vlSelf->o_gpio),16);
    bufp->fullIData(oldp+4217,(vlSelf->main__DOT____Vcellinp__scope1_ddr3i____pinNumber4),31);
    bufp->fullIData(oldp+4218,((0x7fffffffU & (IData)(
                                                      (vlSelf->i_ddr3_controller_iserdes_data 
                                                       >> 0x20U)))),31);
    bufp->fullIData(oldp+4219,((0x7fffffffU & (IData)(vlSelf->i_ddr3_controller_iserdes_data))),31);
    bufp->fullBit(oldp+4220,(vlSelf->main__DOT____Vcellinp__swic__i_reset));
    bufp->fullCData(oldp+4221,(((IData)(vlSelf->cpu_sim_cyc)
                                 ? 0xfU : (0xfU & ((IData)(vlSelf->main__DOT____Vcellout__wbu_xbar__o_ssel) 
                                                   >> 4U)))),4);
    bufp->fullIData(oldp+4222,(vlSelf->main__DOT__swic__DOT__thecpu__DOT__core__DOT__dcd_pc),28);
    bufp->fullBit(oldp+4223,((((~ ((IData)(vlSelf->main__DOT__swic__DOT__thecpu__DOT__core__DOT__dcd_F) 
    ...
    bufp->fullBit(oldp+4224,(vlSelf->main__DOT__swic__DOT__thecpu__DOT__core__DOT__instruction_decoder__DOT__o_sim));
    bufp->fullIData(oldp+4225,(vlSelf->main__DOT__swic__DOT__thecpu__DOT__core__DOT__instruction_decoder__DOT__o_sim_immv),23);
    bufp->fullBit(oldp+4226,(vlSelf->main__DOT__swic__DOT__thecpu__DOT__core__DOT__op_valid));
    bufp->fullBit(oldp+4227,(vlSelf->main__DOT__swic__DOT__thecpu__DOT__core__DOT__op_sim));
    bufp->fullIData(oldp+4228,(vlSelf->main__DOT__swic__DOT__thecpu__DOT__core__DOT__op_sim_immv),23);
    bufp->fullBit(oldp+4229,(vlSelf->main__DOT__swic__DOT__thecpu__DOT__core__DOT__alu_sim));
    bufp->fullIData(oldp+4230,(vlSelf->main__DOT__swic__DOT__thecpu__DOT__core__DOT__alu_sim_immv),23);
    bufp->fullBit(oldp+4231,(vlSelf->main__DOT__swic__DOT__thecpu__DOT__core__DOT__alu_ce));
    bufp->fullIData(oldp+4232,((((IData)(vlSelf->main__DOT__u_fan__DOT__u_i2ccpu__DOT__half_insn) 
                                                                         ...
                                                                         | (((IData)(vlSelf->main__DOT__u_fan__DOT__u_i2ccpu__DOT__GEN_MANUAL__DOT__o_sda) 
                                                                            ...
                                                                            | (((IData)(vlSelf->i_fan_scl) 
                                                                               ...
                                                                               | (((IData)(vlSelf->i_fan_sda) 
                                                                                << 0xcU) 
                                                                                | (IData)(vlSelf->main__DOT__u_fan__DOT__u_i2ccpu__DOT__insn)))))))))))))))),32);
    bufp->fullSData(oldp+4233,(((0xfffff800U & ((IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_scyc) 
    ...
    bufp->fullCData(oldp+4238,(((0xfffffffeU & ((IData)(vlSelf->main__DOT____Vcellout__wbu_xbar__o_scyc) 
    ...
    bufp->fullIData(oldp+4239,(vlSelf->main__DOT__wbu_xbar__DOT__iM),32);
    bufp->fullCData(oldp+4240,(vlSelf->main__DOT__wbu_xbar__DOT__ARBITRATE_REQUESTS__BRA__0__KET____DOT__MINDEX_MULTIPLE_SLAVES__DOT__r_reindex),2);
    bufp->fullIData(oldp+4241,(vlSelf->main__DOT__wbwide_xbar__DOT__iN),32);
    bufp->fullIData(oldp+4242,(vlSelf->main__DOT__wbwide_xbar__DOT__iM),32);
    bufp->fullCData(oldp+4243,(vlSelf->main__DOT__wbwide_xbar__DOT__ARBITRATE_REQUESTS__BRA__0__KET____DOT__MINDEX_MULTIPLE_SLAVES__DOT__r_reindex),2);
    bufp->fullCData(oldp+4244,(vlSelf->main__DOT__wbwide_xbar__DOT__ARBITRATE_REQUESTS__BRA__1__KET____DOT__MINDEX_MULTIPLE_SLAVES__DOT__r_reindex),2);
    bufp->fullCData(oldp+4245,(vlSelf->main__DOT__wbwide_xbar__DOT__ARBITRATE_REQUESTS__BRA__2__KET____DOT__MINDEX_MULTIPLE_SLAVES__DOT__r_reindex),2);
    bufp->fullCData(oldp+4246,(vlSelf->main__DOT__wbwide_xbar__DOT__ARBITRATE_REQUESTS__BRA__3__KET____DOT__MINDEX_MULTIPLE_SLAVES__DOT__r_reindex),2);
    bufp->fullDouble(oldp+4247,(10.0));
    bufp->fullDouble(oldp+4249,(2.50000000000000000e+00));
    bufp->fullIData(oldp+4251,(0xeU),32);
    bufp->fullIData(oldp+4252,(0xaU),32);
    bufp->fullIData(oldp+4253,(3U),32);
    bufp->fullIData(oldp+4254,(8U),32);
    bufp->fullIData(oldp+4255,(1U),32);
    bufp->fullIData(oldp+4256,(4U),32);
    bufp->fullIData(oldp+4257,(0x18U),32);
    bufp->fullIData(oldp+4258,(0x2000000U),32);
    bufp->fullIData(oldp+4259,(0x16U),32);
    bufp->fullIData(oldp+4260,(0x10U),32);
    bufp->fullBit(oldp+4261,(1U));
    bufp->fullIData(oldp+4262,(0x64U),24);
    bufp->fullIData(oldp+4263,(7U),32);
    bufp->fullIData(oldp+4264,(0x13U),32);
    bufp->fullIData(oldp+4265,(2U),32);
    bufp->fullIData(oldp+4266,(0U),32);
    bufp->fullBit(oldp+4267,(0U));
    bufp->fullBit(oldp+4268,(1U));
    bufp->fullWData(oldp+4269,(Vmain__ConstPool__CONST_h93e1b771_0),512);
    bufp->fullQData(oldp+4285,(0xffffffffffffffffULL),64);
    bufp->fullIData(oldp+4287,(vlSelf->main__DOT__wb32_buildtime_addr),25);
    bufp->fullBit(oldp+4288,(vlSelf->main__DOT__wb32_buildtime_err));
    bufp->fullIData(oldp+4289,(0x201022U),32);
    bufp->fullIData(oldp+4290,(vlSelf->main__DOT__wb32_gpio_addr),25);
    bufp->fullBit(oldp+4291,(vlSelf->main__DOT__wb32_gpio_err));
    bufp->fullIData(oldp+4292,(vlSelf->main__DOT__wb32_sirefclk_addr),25);
    bufp->fullBit(oldp+4293,(vlSelf->main__DOT__wb32_sirefclk_err));
    bufp->fullIData(oldp+4294,(vlSelf->main__DOT__wb32_spio_addr),25);
    bufp->fullBit(oldp+4295,(vlSelf->main__DOT__wb32_spio_err));
    bufp->fullIData(oldp+4296,(vlSelf->main__DOT__wb32_version_addr),25);
    bufp->fullBit(oldp+4297,(vlSelf->main__DOT__wb32_version_err));
    bufp->fullIData(oldp+4298,(0x20230904U),32);
    bufp->fullCData(oldp+4299,(0xfU),4);
    bufp->fullCData(oldp+4300,(0x20U),8);
    bufp->fullIData(oldp+4301,(0x14U),32);
    bufp->fullIData(oldp+4302,(0x200U),32);
    bufp->fullCData(oldp+4303,(0U),8);
    bufp->fullBit(oldp+4304,(0U));
    bufp->fullIData(oldp+4305,(0x20U),32);
    bufp->fullCData(oldp+4306,(6U),4);
    bufp->fullCData(oldp+4307,(0U),2);
    bufp->fullCData(oldp+4308,(1U),2);
    bufp->fullCData(oldp+4309,(2U),2);
    bufp->fullCData(oldp+4310,(3U),2);
    bufp->fullIData(oldp+4311,(0x40U),32);
    bufp->fullCData(oldp+4312,(0U),4);
    bufp->fullCData(oldp+4313,(1U),4);
    bufp->fullCData(oldp+4314,(2U),4);
    bufp->fullCData(oldp+4315,(3U),4);
    bufp->fullCData(oldp+4316,(4U),4);
    bufp->fullCData(oldp+4317,(5U),4);
    bufp->fullCData(oldp+4318,(7U),4);
    bufp->fullIData(oldp+4319,(0x1bU),32);
    bufp->fullIData(oldp+4320,(0x1aU),32);
    bufp->fullIData(oldp+4321,(0x19U),32);
    bufp->fullIData(oldp+4322,(0x17U),32);
    bufp->fullIData(oldp+4323,(0x12U),32);
    bufp->fullIData(oldp+4324,(0x15U),32);
    bufp->fullIData(oldp+4325,(0x11U),32);
    bufp->fullIData(oldp+4326,(0xdU),32);
    bufp->fullIData(oldp+4327,(0x30d40U),32);
    bufp->fullIData(oldp+4328,(0x7a120U),32);
    bufp->fullDouble(oldp+4329,(1.37500000000000000e+01));
    bufp->fullIData(oldp+4331,(0x23U),32);
    bufp->fullDouble(oldp+4332,(350.0));
    bufp->fullIData(oldp+4334,(0x1e78U),32);
    bufp->fullDouble(oldp+4335,(360.0));
    bufp->fullDouble(oldp+4337,(15.0));
    bufp->fullIData(oldp+4339,(0xaU),19);
    bufp->fullDouble(oldp+4340,(7.50000000000000000e+00));
    bufp->fullIData(oldp+4342,(0x80U),32);
    bufp->fullIData(oldp+4343,(6U),32);
    bufp->fullIData(oldp+4344,(5U),32);
    bufp->fullIData(oldp+4345,(0xc350U),19);
    bufp->fullIData(oldp+4346,(9U),32);
    bufp->fullIData(oldp+4347,(0xbU),32);
    bufp->fullIData(oldp+4348,(0xcU),32);
    bufp->fullIData(oldp+4349,(0xfU),32);
    bufp->fullCData(oldp+4350,(0U),3);
    bufp->fullCData(oldp+4351,(2U),3);
    bufp->fullIData(oldp+4352,(0x20040U),19);
    bufp->fullCData(oldp+4353,(3U),3);
    bufp->fullIData(oldp+4354,(0x30004U),19);
    bufp->fullIData(oldp+4355,(0x30000U),19);
    bufp->fullCData(oldp+4356,(1U),3);
    bufp->fullIData(oldp+4357,(0x100c4U),19);
    bufp->fullIData(oldp+4358,(0x10044U),19);
    bufp->fullIData(oldp+4359,(0x720U),19);
    bufp->fullIData(oldp+4360,(0x4380005U),28);
    bufp->fullIData(oldp+4361,(vlSelf->main__DOT__ddr3_controller_inst__DOT__get_slot__Vstatic__delay),32);
    bufp->fullCData(oldp+4362,(vlSelf->main__DOT__ddr3_controller_inst__DOT__get_slot__Vstatic__slot_number),2);
    bufp->fullCData(oldp+4363,(vlSelf->main__DOT__ddr3_controller_inst__DOT__get_slot__Vstatic__read_slot),2);
    bufp->fullCData(oldp+4364,(vlSelf->main__DOT__ddr3_controller_inst__DOT__get_slot__Vstatic__write_slot),2);
    bufp->fullCData(oldp+4365,(vlSelf->main__DOT__ddr3_controller_inst__DOT__get_slot__Vstatic__anticipate_activate_slot),2);
    bufp->fullCData(oldp+4366,(vlSelf->main__DOT__ddr3_controller_inst__DOT__get_slot__Vstatic__anticipate_precharge_slot),2);
    bufp->fullIData(oldp+4367,(vlSelf->main__DOT__ddr3_controller_inst__DOT__find_delay__Vstatic__k),32);
    bufp->fullIData(oldp+4368,(0x1eU),32);
    bufp->fullIData(oldp+4369,(0x24U),32);
    bufp->fullIData(oldp+4370,(0x400U),32);
    bufp->fullCData(oldp+4371,(0U),5);
    bufp->fullQData(oldp+4372,(0x100000000ULL),36);
    bufp->fullQData(oldp+4374,(0x40000000ULL),36);
    bufp->fullQData(oldp+4376,(0ULL),36);
    bufp->fullCData(oldp+4378,(0x4fU),7);
    bufp->fullCData(oldp+4379,(0x49U),7);
    bufp->fullIData(oldp+4380,(0x1cU),32);
    bufp->fullIData(oldp+4381,(0U),28);
    bufp->fullSData(oldp+4382,(0xfffU),12);
    bufp->fullCData(oldp+4383,(8U),4);
    bufp->fullCData(oldp+4384,(9U),4);
    bufp->fullCData(oldp+4385,(0xaU),4);
    bufp->fullCData(oldp+4386,(0xbU),4);
    bufp->fullCData(oldp+4387,(0xcU),4);
    bufp->fullCData(oldp+4388,(0xdU),4);
    bufp->fullCData(oldp+4389,(4U),3);
    bufp->fullCData(oldp+4390,(5U),3);
    bufp->fullCData(oldp+4391,(6U),3);
    bufp->fullCData(oldp+4392,(7U),3);
    bufp->fullCData(oldp+4393,(0xaU),5);
    bufp->fullIData(oldp+4394,(0x1fU),32);
    bufp->fullIData(oldp+4395,(0x1fcU),20);
    bufp->fullIData(oldp+4396,(0x7fffffffU),31);
    bufp->fullCData(oldp+4397,(0x64U),7);
    bufp->fullCData(oldp+4398,(0x32U),7);
    bufp->fullIData(oldp+4399,(0xc0000000U),32);
    bufp->fullCData(oldp+4400,(1U),8);
    bufp->fullCData(oldp+4401,(2U),8);
    bufp->fullCData(oldp+4402,(3U),8);
    bufp->fullCData(oldp+4403,(4U),8);
    bufp->fullCData(oldp+4404,(5U),8);
    bufp->fullCData(oldp+4405,(6U),8);
    bufp->fullCData(oldp+4406,(7U),8);
    bufp->fullCData(oldp+4407,(8U),8);
    bufp->fullCData(oldp+4408,(9U),8);
    bufp->fullCData(oldp+4409,(0xaU),8);
    bufp->fullCData(oldp+4410,(0xbU),8);
    bufp->fullCData(oldp+4411,(0xcU),8);
    bufp->fullCData(oldp+4412,(0xdU),8);
    bufp->fullCData(oldp+4413,(0xeU),8);
    bufp->fullCData(oldp+4414,(0xfU),8);
    bufp->fullCData(oldp+4415,(0x80U),8);
    bufp->fullCData(oldp+4416,(0x10U),8);
    bufp->fullIData(oldp+4417,(0U),20);
    bufp->fullIData(oldp+4418,(0x208U),32);
    __Vtemp_hf465e4c8__0[0U] = 0x54494e47U;
    __Vtemp_hf465e4c8__0[1U] = 0x45524e41U;
    __Vtemp_hf465e4c8__0[2U] = 0x414c54U;
    bufp->fullWData(oldp+4419,(__Vtemp_hf465e4c8__0),88);
    bufp->fullIData(oldp+4422,(0x41425254U),32);
    bufp->fullIData(oldp+4423,(0x40U),32);
    bufp->fullBit(oldp+4424,(vlSelf->main__DOT__swic__DOT__thecpu__DOT__DATA_CACHE__DOT__mem__DOT__UNUSED_BITS__DOT__unused_aw));
    bufp->fullIData(oldp+4425,(0x800000U),26);
    bufp->fullCData(oldp+4426,(0xeU),4);
    bufp->fullSData(oldp+4427,(0x1d7U),9);
    bufp->fullSData(oldp+4428,(0x2000U),14);
    bufp->fullIData(oldp+4429,(0U),31);
    bufp->fullCData(oldp+4430,(7U),5);
    bufp->fullIData(oldp+4431,(0x5f5e100U),32);
    bufp->fullIData(oldp+4432,(0x186a0U),32);
    bufp->fullIData(oldp+4433,(0x4e20U),32);
    bufp->fullIData(oldp+4434,(0x1387U),32);
    bufp->fullSData(oldp+4435,(0xc8U),12);
    bufp->fullIData(oldp+4436,(0x10U),32);
    bufp->fullWData(oldp+4437,(Vmain__ConstPool__CONST_h3dd842ba_0),300);
    bufp->fullWData(oldp+4447,(Vmain__ConstPool__CONST_h21727c79_0),300);
    bufp->fullSData(oldp+4457,(0U),12);
    bufp->fullSData(oldp+4458,(0xf000U),16);
    bufp->fullIData(oldp+4459,(0x25U),32);
    bufp->fullIData(oldp+4460,(0x3eU),32);
    bufp->fullQData(oldp+4461,(0x20000000000000ULL),54);
    bufp->fullQData(oldp+4463,(0x20000004000000ULL),54);
    bufp->fullQData(oldp+4465,(0x80000080000ULL),44);
    bufp->fullQData(oldp+4467,(0x80000380000ULL),44);
    bufp->fullIData(oldp+4469,(0x241U),32);
    bufp->fullIData(oldp+4470,(0x257U),32);
}

...
VL_ATTR_COLD void Vmain___024root__trace_init_sub__TOP__0(Vmain___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    tracep->declBit(c+4176,"i_clk", false,-1);
    tracep->declBit(c+4177,"i_reset", false,-1);
    tracep->declArray(c+4178,"i_ddr3_controller_iserdes_data", false,-1, 127,0);
    tracep->declBus(c+4182,"i_ddr3_controller_iserdes_dqs", false,-1, 15,0);
    tracep->declBus(c+4183,"i_ddr3_controller_iserdes_bitslip_reference", false,-1, 15,0);
    tracep->declBit(c+4184,"i_ddr3_controller_idelayctrl_rdy", false,-1);
    tracep->declArray(c+4185,"o_ddr3_controller_cmd", false,-1, 95,0);
    tracep->declBit(c+4188,"o_ddr3_controller_dqs_tri_control", false,-1);
    tracep->declBit(c+4189,"o_ddr3_controller_dq_tri_control", false,-1);
    tracep->declBit(c+4190,"o_ddr3_controller_toggle_dqs", false,-1);
    tracep->declArray(c+4191,"o_ddr3_controller_data", false,-1, 127,0);
    tracep->declBus(c+4195,"o_ddr3_controller_dm", false,-1, 15,0);
    tracep->declBus(c+4196,"o_ddr3_controller_odelay_data_cntvaluein", false,-1, 4,0);
    tracep->declBus(c+4197,"o_ddr3_controller_odelay_dqs_cntvaluein", false,-1, 4,0);
    tracep->declBus(c+4198,"o_ddr3_controller_idelay_data_cntvaluein", false,-1, 4,0);
    tracep->declBus(c+4199,"o_ddr3_controller_idelay_dqs_cntvaluein", false,-1, 4,0);
    tracep->declBus(c+4200,"o_ddr3_controller_odelay_data_ld", false,-1, 1,0);
    tracep->declBus(c+4201,"o_ddr3_controller_odelay_dqs_ld", false,-1, 1,0);
    tracep->declBus(c+4202,"o_ddr3_controller_idelay_data_ld", false,-1, 1,0);
    tracep->declBus(c+4203,"o_ddr3_controller_idelay_dqs_ld", false,-1, 1,0);
    tracep->declBus(c+4204,"o_ddr3_controller_bitslip", false,-1, 1,0);
    tracep->declBus(c+4205,"o_sirefclk_word", false,-1, 7,0);
    tracep->declBit(c+4206,"o_sirefclk_ce", false,-1);
    tracep->declBit(c+4207,"i_fan_sda", false,-1);
    tracep->declBit(c+4208,"i_fan_scl", false,-1);
    tracep->declBit(c+4209,"o_fan_sda", false,-1);
    tracep->declBit(c+4210,"o_fan_scl", false,-1);
    tracep->declBit(c+4211,"o_fpga_pwm", false,-1);
    tracep->declBit(c+4212,"o_sys_pwm", false,-1);
    tracep->declBit(c+4213,"i_fan_tach", false,-1);
    tracep->declBit(c+4214,"i_i2c_sda", false,-1);
    tracep->declBit(c+4215,"i_i2c_scl", false,-1);
    tracep->declBit(c+4216,"o_i2c_sda", false,-1);
    tracep->declBit(c+4217,"o_i2c_scl", false,-1);
    tracep->declBit(c+4218,"cpu_sim_cyc", false,-1);
    tracep->declBit(c+4219,"cpu_sim_stb", false,-1);
    tracep->declBit(c+4220,"cpu_sim_we", false,-1);
    tracep->declBus(c+4221,"cpu_sim_addr", false,-1, 6,0);
    tracep->declBus(c+4222,"cpu_sim_data", false,-1, 31,0);
    tracep->declBit(c+4223,"cpu_sim_stall", false,-1);
    tracep->declBit(c+4224,"cpu_sim_ack", false,-1);
    tracep->declBus(c+4225,"cpu_sim_idata", false,-1, 31,0);
    tracep->declBit(c+4226,"cpu_prof_stb", false,-1);
    tracep->declBus(c+4227,"cpu_prof_addr", false,-1, 27,0);
    tracep->declBus(c+4228,"cpu_prof_ticks", false,-1, 31,0);
    tracep->declBit(c+4229,"i_cpu_reset", false,-1);
    tracep->declBit(c+4230,"i_wbu_uart_rx", false,-1);
    tracep->declBit(c+4231,"o_wbu_uart_tx", false,-1);
    tracep->declBit(c+4232,"o_wbu_uart_cts_n", false,-1);
    tracep->declBus(c+4233,"i_gpio", false,-1, 15,0);
    tracep->declBus(c+4234,"o_gpio", false,-1, 7,0);
    tracep->declBus(c+4235,"i_sw", false,-1, 7,0);
    tracep->declBus(c+4236,"i_btn", false,-1, 4,0);
    tracep->declBus(c+4237,"o_led", false,-1, 7,0);
    tracep->declBit(c+4238,"i_clk200", false,-1);
    tracep->pushNamePrefix("main ");
    tracep->declDouble(c+4276,"DDR3_CONTROLLERCONTROLLER_CLK_PERIOD", false,-1);
    tracep->declDouble(c+4278,"DDR3_CLK_PERIOD", false,-1);
    tracep->declBus(c+4280,"DDR3_CONTROLLERROW_BITS", false,-1, 31,0);
    tracep->declBus(c+4281,"DDR3_CONTROLLERCOL_BITS", false,-1, 31,0);
    tracep->declBus(c+4282,"DDR3_CONTROLLERBA_BITS", false,-1, 31,0);
    tracep->declBus(c+4283,"DDR3_CONTROLLERDQ_BITS", false,-1, 31,0);
    tracep->declBus(c+4284,"DDR3_CONTROLLERLANES", false,-1, 31,0);
    tracep->declBus(c+4285,"DDR3_CONTROLLERAUX_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4286,"DDR3_CONTROLLERSERDES_RATIO", false,-1, 31,0);
    tracep->declBus(c+4287,"DDR3_CONTROLLERCMD_LEN", false,-1, 31,0);
    tracep->declBus(c+4288,"RESET_ADDRESS", false,-1, 31,0);
    tracep->declBus(c+4289,"ZIP_ADDRESS_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4290,"ZIP_INTS", false,-1, 31,0);
    tracep->declBus(c+4291,"ZIP_START_HALTED", false,-1, 0,0);
    tracep->declBus(c+4292,"BUSUART", false,-1, 23,0);
    tracep->declBus(c+4293,"DBGBUSBITS", false,-1, 31,0);
    tracep->declBus(c+4290,"DBGBUSWATCHDOG_RAW", false,-1, 31,0);
    tracep->declBus(c+4294,"DBGBUSWATCHDOG", false,-1, 31,0);
    tracep->declBus(c+4282,"ICAPE_LGDIV", false,-1, 31,0);
    tracep->declBit(c+4176,"i_clk", false,-1);
    tracep->declBit(c+4177,"i_reset", false,-1);
    tracep->declArray(c+4178,"i_ddr3_controller_iserdes_data", false,-1, 127,0);
    tracep->declBus(c+4182,"i_ddr3_controller_iserdes_dqs", false,-1, 15,0);
    ...
    tracep->declBit(c+4231,"o_wbu_uart_tx", false,-1);
    tracep->declBit(c+4232,"o_wbu_uart_cts_n", false,-1);
    tracep->declBus(c+4290,"NGPI", false,-1, 31,0);
    tracep->declBus(c+4283,"NGPO", false,-1, 31,0);
    tracep->declBus(c+4233,"i_gpio", false,-1, 15,0);
    tracep->declBus(c+4234,"o_gpio", false,-1, 7,0);
    tracep->declBus(c+4235,"i_sw", false,-1, 7,0);
    tracep->declBus(c+4236,"i_btn", false,-1, 4,0);
    ...
    tracep->declBus(c+4092,"ddr3_controller_aux_out", false,-1, 0,0);
    tracep->declBus(c+4239,"ddr3_controller_debug1", false,-1, 31,0);
    tracep->declBus(c+4240,"ddr3_controller_debug2", false,-1, 31,0);
    tracep->declBus(c+4241,"ddr3_controller_debug3", false,-1, 31,0);
    ...
    tracep->declBus(c+4242,"fan_debug", false,-1, 31,0);
    tracep->declBus(c+4284,"I2C_ID_WIDTH", false,-1, 31,0);
    ...
    tracep->declBus(c+4295,"zip_debug", false,-1, 31,0);
    tracep->declBit(c+4296,"zip_trigger", false,-1);
    ...
    tracep->declBus(c+4295,"cfg_debug", false,-1, 31,0);
    ...
    tracep->declBit(c+4297,"wbwide_i2cdma_we", false,-1);
    ...
    tracep->declBit(c+4296,"wbwide_i2cm_we", false,-1);
    tracep->declBus(c+221,"wbwide_i2cm_addr", false,-1, 21,0);
    tracep->declArray(c+4298,"wbwide_i2cm_data", false,-1, 511,0);
    tracep->declQuad(c+4314,"wbwide_i2cm_sel", false,-1, 63,0);
    ...
    tracep->declBit(c+3860,"wbwide_bkram_cyc", false,-1);
    tracep->declBit(c+3861,"wbwide_bkram_stb", false,-1);
    ...
    tracep->declBit(c+4296,"wbwide_bkram_stall", false,-1);
    tracep->declBit(c+343,"wbwide_bkram_ack", false,-1);
    tracep->declBit(c+4296,"wbwide_bkram_err", false,-1);
    tracep->declArray(c+344,"wbwide_bkram_idata", false,-1, 511,0);
    tracep->declBit(c+3862,"wbwide_wbdown_cyc", false,-1);
    tracep->declBit(c+3863,"wbwide_wbdown_stb", false,-1);
    ...
    tracep->declBit(c+3864,"wbwide_wbdown_err", false,-1);
    tracep->declArray(c+382,"wbwide_wbdown_idata", false,-1, 511,0);
    tracep->declBit(c+3865,"wb32_wbdown_cyc", false,-1);
    ...
    tracep->declBit(c+3866,"wb32_wbdown_err", false,-1);
    tracep->declBus(c+405,"wb32_wbdown_idata", false,-1, 31,0);
    tracep->declBit(c+3867,"wb32_buildtime_cyc", false,-1);
    tracep->declBit(c+3868,"wb32_buildtime_stb", false,-1);
    tracep->declBit(c+3869,"wb32_buildtime_we", false,-1);
    tracep->declBus(c+4316,"wb32_buildtime_addr", false,-1, 24,0);
    tracep->declBus(c+3870,"wb32_buildtime_data", false,-1, 31,0);
    tracep->declBus(c+3871,"wb32_buildtime_sel", false,-1, 3,0);
    tracep->declBit(c+4296,"wb32_buildtime_stall", false,-1);
    tracep->declBit(c+3868,"wb32_buildtime_ack", false,-1);
    tracep->declBit(c+4317,"wb32_buildtime_err", false,-1);
    tracep->declBus(c+4318,"wb32_buildtime_idata", false,-1, 31,0);
    tracep->declBit(c+3867,"wb32_gpio_cyc", false,-1);
    tracep->declBit(c+3872,"wb32_gpio_stb", false,-1);
    tracep->declBit(c+3869,"wb32_gpio_we", false,-1);
    tracep->declBus(c+4319,"wb32_gpio_addr", false,-1, 24,0);
    tracep->declBus(c+3870,"wb32_gpio_data", false,-1, 31,0);
    tracep->declBus(c+3871,"wb32_gpio_sel", false,-1, 3,0);
    tracep->declBit(c+4296,"wb32_gpio_stall", false,-1);
    tracep->declBit(c+3872,"wb32_gpio_ack", false,-1);
    tracep->declBit(c+4320,"wb32_gpio_err", false,-1);
    tracep->declBus(c+4243,"wb32_gpio_idata", false,-1, 31,0);
    tracep->declBit(c+3867,"wb32_sirefclk_cyc", false,-1);
    tracep->declBit(c+3873,"wb32_sirefclk_stb", false,-1);
    tracep->declBit(c+3869,"wb32_sirefclk_we", false,-1);
    tracep->declBus(c+4321,"wb32_sirefclk_addr", false,-1, 24,0);
    tracep->declBus(c+3870,"wb32_sirefclk_data", false,-1, 31,0);
    tracep->declBus(c+3871,"wb32_sirefclk_sel", false,-1, 3,0);
    tracep->declBit(c+4296,"wb32_sirefclk_stall", false,-1);
    tracep->declBit(c+153,"wb32_sirefclk_ack", false,-1);
    tracep->declBit(c+4322,"wb32_sirefclk_err", false,-1);
    tracep->declBus(c+406,"wb32_sirefclk_idata", false,-1, 31,0);
    tracep->declBit(c+3867,"wb32_spio_cyc", false,-1);
    tracep->declBit(c+3874,"wb32_spio_stb", false,-1);
    tracep->declBit(c+3869,"wb32_spio_we", false,-1);
    tracep->declBus(c+4323,"wb32_spio_addr", false,-1, 24,0);
    tracep->declBus(c+3870,"wb32_spio_data", false,-1, 31,0);
    tracep->declBus(c+3871,"wb32_spio_sel", false,-1, 3,0);
    tracep->declBit(c+4296,"wb32_spio_stall", false,-1);
    tracep->declBit(c+407,"wb32_spio_ack", false,-1);
    tracep->declBit(c+4324,"wb32_spio_err", false,-1);
    tracep->declBus(c+408,"wb32_spio_idata", false,-1, 31,0);
    tracep->declBit(c+3867,"wb32_version_cyc", false,-1);
    tracep->declBit(c+3875,"wb32_version_stb", false,-1);
    tracep->declBit(c+3869,"wb32_version_we", false,-1);
    tracep->declBus(c+4325,"wb32_version_addr", false,-1, 24,0);
    tracep->declBus(c+3870,"wb32_version_data", false,-1, 31,0);
    tracep->declBus(c+3871,"wb32_version_sel", false,-1, 3,0);
    tracep->declBit(c+4296,"wb32_version_stall", false,-1);
    tracep->declBit(c+3875,"wb32_version_ack", false,-1);
    tracep->declBit(c+4326,"wb32_version_err", false,-1);
    tracep->declBus(c+4327,"wb32_version_idata", false,-1, 31,0);
    tracep->declBit(c+3876,"wb32_i2cscope_cyc", false,-1);
    tracep->declBit(c+3877,"wb32_i2cscope_stb", false,-1);
    tracep->declBit(c+3878,"wb32_i2cscope_we", false,-1);
    tracep->declBus(c+3879,"wb32_i2cscope_addr", false,-1, 24,0);
    tracep->declBus(c+3880,"wb32_i2cscope_data", false,-1, 31,0);
    tracep->declBus(c+3881,"wb32_i2cscope_sel", false,-1, 3,0);
    tracep->declBit(c+4296,"wb32_i2cscope_stall", false,-1);
    tracep->declBit(c+409,"wb32_i2cscope_ack", false,-1);
    tracep->declBit(c+4296,"wb32_i2cscope_err", false,-1);
    tracep->declBus(c+410,"wb32_i2cscope_idata", false,-1, 31,0);
    tracep->declBit(c+3882,"wb32_scope1_ddr3_cyc", false,-1);
    tracep->declBit(c+3883,"wb32_scope1_ddr3_stb", false,-1);
    tracep->declBit(c+3884,"wb32_scope1_ddr3_we", false,-1);
    tracep->declBus(c+3885,"wb32_scope1_ddr3_addr", false,-1, 24,0);
    tracep->declBus(c+3886,"wb32_scope1_ddr3_data", false,-1, 31,0);
    tracep->declBus(c+3887,"wb32_scope1_ddr3_sel", false,-1, 3,0);
    tracep->declBit(c+4296,"wb32_scope1_ddr3_stall", false,-1);
    tracep->declBit(c+411,"wb32_scope1_ddr3_ack", false,-1);
    tracep->declBit(c+4296,"wb32_scope1_ddr3_err", false,-1);
    tracep->declBus(c+412,"wb32_scope1_ddr3_idata", false,-1, 31,0);
    tracep->declBit(c+3888,"wb32_scope2_ddr3_cyc", false,-1);
    tracep->declBit(c+3889,"wb32_scope2_ddr3_stb", false,-1);
    tracep->declBit(c+3890,"wb32_scope2_ddr3_we", false,-1);
    tracep->declBus(c+3891,"wb32_scope2_ddr3_addr", false,-1, 24,0);
    tracep->declBus(c+3892,"wb32_scope2_ddr3_data", false,-1, 31,0);
    tracep->declBus(c+3893,"wb32_scope2_ddr3_sel", false,-1, 3,0);
    tracep->declBit(c+4296,"wb32_scope2_ddr3_stall", false,-1);
    tracep->declBit(c+413,"wb32_scope2_ddr3_ack", false,-1);
    tracep->declBit(c+4296,"wb32_scope2_ddr3_err", false,-1);
    tracep->declBus(c+414,"wb32_scope2_ddr3_idata", false,-1, 31,0);
    tracep->declBit(c+3894,"wb32_scope3_ddr3_cyc", false,-1);
    tracep->declBit(c+3895,"wb32_scope3_ddr3_stb", false,-1);
    tracep->declBit(c+3896,"wb32_scope3_ddr3_we", false,-1);
    tracep->declBus(c+3897,"wb32_scope3_ddr3_addr", false,-1, 24,0);
    tracep->declBus(c+3898,"wb32_scope3_ddr3_data", false,-1, 31,0);
    tracep->declBus(c+3899,"wb32_scope3_ddr3_sel", false,-1, 3,0);
    tracep->declBit(c+4296,"wb32_scope3_ddr3_stall", false,-1);
    tracep->declBit(c+415,"wb32_scope3_ddr3_ack", false,-1);
    tracep->declBit(c+4296,"wb32_scope3_ddr3_err", false,-1);
    tracep->declBus(c+416,"wb32_scope3_ddr3_idata", false,-1, 31,0);
    tracep->declBit(c+3900,"wb32_i2cs_cyc", false,-1);
    tracep->declBit(c+3901,"wb32_i2cs_stb", false,-1);
    tracep->declBit(c+3902,"wb32_i2cs_we", false,-1);
    tracep->declBus(c+3903,"wb32_i2cs_addr", false,-1, 24,0);
    tracep->declBus(c+3904,"wb32_i2cs_data", false,-1, 31,0);
    tracep->declBus(c+3905,"wb32_i2cs_sel", false,-1, 3,0);
    tracep->declBit(c+4296,"wb32_i2cs_stall", false,-1);
    tracep->declBit(c+417,"wb32_i2cs_ack", false,-1);
    tracep->declBit(c+4296,"wb32_i2cs_err", false,-1);
    tracep->declBus(c+418,"wb32_i2cs_idata", false,-1, 31,0);
    tracep->declBit(c+3906,"wb32_i2cdma_cyc", false,-1);
    tracep->declBit(c+3907,"wb32_i2cdma_stb", false,-1);
    tracep->declBit(c+3908,"wb32_i2cdma_we", false,-1);
    tracep->declBus(c+3909,"wb32_i2cdma_addr", false,-1, 24,0);
    tracep->declBus(c+3910,"wb32_i2cdma_data", false,-1, 31,0);
    tracep->declBus(c+3911,"wb32_i2cdma_sel", false,-1, 3,0);
    tracep->declBit(c+4296,"wb32_i2cdma_stall", false,-1);
    tracep->declBit(c+419,"wb32_i2cdma_ack", false,-1);
    tracep->declBit(c+4296,"wb32_i2cdma_err", false,-1);
    tracep->declBus(c+420,"wb32_i2cdma_idata", false,-1, 31,0);
    tracep->declBit(c+3912,"wb32_uart_cyc", false,-1);
    tracep->declBit(c+3913,"wb32_uart_stb", false,-1);
    tracep->declBit(c+3914,"wb32_uart_we", false,-1);
    tracep->declBus(c+3915,"wb32_uart_addr", false,-1, 24,0);
    tracep->declBus(c+3916,"wb32_uart_data", false,-1, 31,0);
    tracep->declBus(c+3917,"wb32_uart_sel", false,-1, 3,0);
    tracep->declBit(c+4296,"wb32_uart_stall", false,-1);
    tracep->declBit(c+421,"wb32_uart_ack", false,-1);
    tracep->declBit(c+4296,"wb32_uart_err", false,-1);
    tracep->declBus(c+422,"wb32_uart_idata", false,-1, 31,0);
    tracep->declBit(c+3918,"wb32_fan_cyc", false,-1);
    tracep->declBit(c+3919,"wb32_fan_stb", false,-1);
    tracep->declBit(c+3920,"wb32_fan_we", false,-1);
    tracep->declBus(c+3921,"wb32_fan_addr", false,-1, 24,0);
    tracep->declBus(c+3922,"wb32_fan_data", false,-1, 31,0);
    tracep->declBus(c+3923,"wb32_fan_sel", false,-1, 3,0);
    tracep->declBit(c+4296,"wb32_fan_stall", false,-1);
    tracep->declBit(c+423,"wb32_fan_ack", false,-1);
    tracep->declBit(c+4296,"wb32_fan_err", false,-1);
    tracep->declBus(c+424,"wb32_fan_idata", false,-1, 31,0);
    tracep->declBit(c+3867,"wb32_sio_cyc", false,-1);
    tracep->declBit(c+3924,"wb32_sio_stb", false,-1);
    tracep->declBit(c+3869,"wb32_sio_we", false,-1);
    tracep->declBus(c+3925,"wb32_sio_addr", false,-1, 24,0);
    tracep->declBus(c+3870,"wb32_sio_data", false,-1, 31,0);
    tracep->declBus(c+3871,"wb32_sio_sel", false,-1, 3,0);
    tracep->declBit(c+4296,"wb32_sio_stall", false,-1);
    tracep->declBit(c+425,"wb32_sio_ack", false,-1);
    tracep->declBit(c+4296,"wb32_sio_err", false,-1);
    tracep->declBus(c+426,"wb32_sio_idata", false,-1, 31,0);
    tracep->declBit(c+3926,"wb32_cfg_cyc", false,-1);
    tracep->declBit(c+3927,"wb32_cfg_stb", false,-1);
    tracep->declBit(c+3928,"wb32_cfg_we", false,-1);
    tracep->declBus(c+3929,"wb32_cfg_addr", false,-1, 24,0);
    tracep->declBus(c+3930,"wb32_cfg_data", false,-1, 31,0);
    tracep->declBus(c+3931,"wb32_cfg_sel", false,-1, 3,0);
    tracep->declBit(c+4296,"wb32_cfg_stall", false,-1);
    tracep->declBit(c+427,"wb32_cfg_ack", false,-1);
    tracep->declBit(c+4296,"wb32_cfg_err", false,-1);
    tracep->declBus(c+4295,"wb32_cfg_idata", false,-1, 31,0);
    tracep->declBit(c+3932,"wb32_ddr3_phy_cyc", false,-1);
    tracep->declBit(c+3933,"wb32_ddr3_phy_stb", false,-1);
    tracep->declBit(c+3934,"wb32_ddr3_phy_we", false,-1);
    tracep->declBus(c+3935,"wb32_ddr3_phy_addr", false,-1, 24,0);
    tracep->declBus(c+3936,"wb32_ddr3_phy_data", false,-1, 31,0);
    tracep->declBus(c+3937,"wb32_ddr3_phy_sel", false,-1, 3,0);
    tracep->declBit(c+3661,"wb32_ddr3_phy_stall", false,-1);
    tracep->declBit(c+3662,"wb32_ddr3_phy_ack", false,-1);
    tracep->declBit(c+4296,"wb32_ddr3_phy_err", false,-1);
    tracep->declBus(c+3663,"wb32_ddr3_phy_idata", false,-1, 31,0);
    tracep->declBit(c+3938,"wb32_ddr3_controller_cyc", false,-1);
    tracep->declBit(c+3939,"wb32_ddr3_controller_stb", false,-1);
    tracep->declBit(c+3940,"wb32_ddr3_controller_we", false,-1);
    tracep->declBus(c+3941,"wb32_ddr3_controller_addr", false,-1, 24,0);
    tracep->declBus(c+3942,"wb32_ddr3_controller_data", false,-1, 31,0);
    tracep->declBus(c+3943,"wb32_ddr3_controller_sel", false,-1, 3,0);
    tracep->declBit(c+3664,"wb32_ddr3_controller_stall", false,-1);
    tracep->declBit(c+4244,"wb32_ddr3_controller_ack", false,-1);
    tracep->declBit(c+4296,"wb32_ddr3_controller_err", false,-1);
    tracep->declBus(c+4093,"wb32_ddr3_controller_idata", false,-1, 31,0);
    ...
    tracep->declBus(c+4328,"wbu_sel", false,-1, 3,0);
    ...
    tracep->declBit(c+4245,"wbu_zip_stall", false,-1);
    tracep->declBit(c+4246,"wbu_zip_ack", false,-1);
    tracep->declBit(c+4296,"wbu_zip_err", false,-1);
    ...
    tracep->declBit(c+4296,"zip_unused", false,-1);
    ...
    tracep->declBit(c+4296,"cfg_unused", false,-1);
    tracep->declBus(c+4329,"INITIAL_GPIO", false,-1, 7,0);
    tracep->pushNamePrefix("bkrami ");
    tracep->declBus(c+4330,"LGMEMSZ", false,-1, 31,0);
    tracep->declBus(c+4331,"DW", false,-1, 31,0);
    tracep->declBus(c+4285,"EXTRACLOCK", false,-1, 31,0);
    tracep->declBus(c+4332,"HEXFILE", false,-1, 7,0);
    tracep->declBus(c+4333,"OPT_ROM", false,-1, 0,0);
    tracep->declBus(c+4280,"AW", false,-1, 31,0);
    tracep->declBit(c+4176,"i_clk", false,-1);
    tracep->declBit(c+4177,"i_reset", false,-1);
    tracep->declBit(c+3860,"i_wb_cyc", false,-1);
    tracep->declBit(c+3861,"i_wb_stb", false,-1);
    ...
    tracep->declBit(c+4296,"o_wb_stall", false,-1);
    ...
    tracep->declBit(c+4296,"unused", false,-1);
    ...
    tracep->declBus(c+4334,"BW", false,-1, 31,0);
    tracep->declBus(c+4283,"UPSAMPLE", false,-1, 31,0);
    tracep->declBit(c+4176,"i_clk", false,-1);
    tracep->declBus(c+478,"i_delay", false,-1, 31,0);
    tracep->declBus(c+4205,"o_word", false,-1, 7,0);
    ...
    tracep->declBus(c+4335,"LGFLEN", false,-1, 3,0);
    tracep->declBit(c+4176,"i_clk", false,-1);
    tracep->declBit(c+4296,"i_reset", false,-1);
    tracep->declBit(c+3912,"i_wb_cyc", false,-1);
    tracep->declBit(c+3913,"i_wb_stb", false,-1);
    tracep->declBit(c+3914,"i_wb_we", false,-1);
    tracep->declBus(c+3944,"i_wb_addr", false,-1, 1,0);
    tracep->declBus(c+3916,"i_wb_data", false,-1, 31,0);
    tracep->declBus(c+3917,"i_wb_sel", false,-1, 3,0);
    tracep->declBit(c+4296,"o_wb_stall", false,-1);
    ...
    tracep->declBus(c+4335,"LCLLGFLEN", false,-1, 3,0);
    tracep->declBus(c+4336,"UART_SETUP", false,-1, 1,0);
    tracep->declBus(c+4337,"UART_FIFO", false,-1, 1,0);
    tracep->declBus(c+4338,"UART_RXREG", false,-1, 1,0);
    tracep->declBus(c+4339,"UART_TXREG", false,-1, 1,0);
    ...
    tracep->declBus(c+4293,"BW", false,-1, 31,0);
    tracep->declBus(c+4335,"LGFLEN", false,-1, 3,0);
    tracep->declBus(c+4291,"RXFIFO", false,-1, 0,0);
    tracep->declBus(c+4340,"FLEN", false,-1, 31,0);
    tracep->declBit(c+4176,"i_clk", false,-1);
    ...
    tracep->declBus(c+4335,"lglen", false,-1, 3,0);
    ...
    tracep->declBus(c+4293,"BW", false,-1, 31,0);
    tracep->declBus(c+4335,"LGFLEN", false,-1, 3,0);
    tracep->declBus(c+4333,"RXFIFO", false,-1, 0,0);
    tracep->declBus(c+4340,"FLEN", false,-1, 31,0);
    tracep->declBit(c+4176,"i_clk", false,-1);
    ...
    tracep->declDouble(c+4276,"CONTROLLER_CLK_PERIOD", false,-1);
    tracep->declDouble(c+4278,"DDR3_CLK_PERIOD", false,-1);
    tracep->declBus(c+4280,"ROW_BITS", false,-1, 31,0);
    tracep->declBus(c+4281,"COL_BITS", false,-1, 31,0);
    tracep->declBus(c+4282,"BA_BITS", false,-1, 31,0);
    tracep->declBus(c+4283,"DQ_BITS", false,-1, 31,0);
    tracep->declBus(c+4284,"LANES", false,-1, 31,0);
    tracep->declBus(c+4285,"AUX_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4293,"WB2_ADDR_BITS", false,-1, 31,0);
    tracep->declBus(c+4334,"WB2_DATA_BITS", false,-1, 31,0);
    tracep->declBus(c+4291,"OPT_LOWPOWER", false,-1, 0,0);
    tracep->declBus(c+4291,"OPT_BUS_ABORT", false,-1, 0,0);
    tracep->declBus(c+4333,"MICRON_SIM", false,-1, 0,0);
    tracep->declBus(c+4291,"ODELAY_SUPPORTED", false,-1, 0,0);
    tracep->declBus(c+4286,"serdes_ratio", false,-1, 31,0);
    tracep->declBus(c+4341,"wb_data_bits", false,-1, 31,0);
    tracep->declBus(c+4287,"wb_addr_bits", false,-1, 31,0);
    tracep->declBus(c+4290,"wb_sel_bits", false,-1, 31,0);
    tracep->declBus(c+4286,"wb2_sel_bits", false,-1, 31,0);
    tracep->declBus(c+4287,"cmd_len", false,-1, 31,0);
    tracep->declBus(c+4285,"lanes_clog2", false,-1, 31,0);
    tracep->declBit(c+4176,"i_controller_clk", false,-1);
    tracep->declBit(c+35,"i_rst_n", false,-1);
    tracep->declBit(c+3938,"i_wb_cyc", false,-1);
    tracep->declBit(c+3939,"i_wb_stb", false,-1);
    tracep->declBit(c+3940,"i_wb_we", false,-1);
    tracep->declBus(c+3945,"i_wb_addr", false,-1, 23,0);
    tracep->declArray(c+3946,"i_wb_data", false,-1, 127,0);
    tracep->declBus(c+3950,"i_wb_sel", false,-1, 15,0);
    tracep->declBus(c+4296,"i_aux", false,-1, 0,0);
    tracep->declBit(c+3664,"o_wb_stall", false,-1);
    tracep->declBit(c+4244,"o_wb_ack", false,-1);
    tracep->declArray(c+4094,"o_wb_data", false,-1, 127,0);
    tracep->declBus(c+4092,"o_aux", false,-1, 0,0);
    tracep->declBit(c+3932,"i_wb2_cyc", false,-1);
    tracep->declBit(c+3933,"i_wb2_stb", false,-1);
    tracep->declBit(c+3934,"i_wb2_we", false,-1);
    tracep->declBus(c+3951,"i_wb2_addr", false,-1, 6,0);
    tracep->declBus(c+3937,"i_wb2_sel", false,-1, 3,0);
    tracep->declBus(c+3936,"i_wb2_data", false,-1, 31,0);
    ...
    tracep->declArray(c+4178,"i_phy_iserdes_data", false,-1, 127,0);
    tracep->declBus(c+4182,"i_phy_iserdes_dqs", false,-1, 15,0);
    tracep->declBus(c+4183,"i_phy_iserdes_bitslip_reference", false,-1, 15,0);
    tracep->declBit(c+4184,"i_phy_idelayctrl_rdy", false,-1);
    tracep->declArray(c+4185,"o_phy_cmd", false,-1, 95,0);
    tracep->declBit(c+4188,"o_phy_dqs_tri_control", false,-1);
    tracep->declBit(c+4189,"o_phy_dq_tri_control", false,-1);
    tracep->declBit(c+4190,"o_phy_toggle_dqs", false,-1);
    tracep->declArray(c+4191,"o_phy_data", false,-1, 127,0);
    tracep->declBus(c+4195,"o_phy_dm", false,-1, 15,0);
    tracep->declBus(c+4196,"o_phy_odelay_data_cntvaluein", false,-1, 4,0);
    tracep->declBus(c+4197,"o_phy_odelay_dqs_cntvaluein", false,-1, 4,0);
    tracep->declBus(c+4198,"o_phy_idelay_data_cntvaluein", false,-1, 4,0);
    tracep->declBus(c+4199,"o_phy_idelay_dqs_cntvaluein", false,-1, 4,0);
    tracep->declBus(c+4200,"o_phy_odelay_data_ld", false,-1, 1,0);
    tracep->declBus(c+4201,"o_phy_odelay_dqs_ld", false,-1, 1,0);
    tracep->declBus(c+4202,"o_phy_idelay_data_ld", false,-1, 1,0);
    tracep->declBus(c+4203,"o_phy_idelay_dqs_ld", false,-1, 1,0);
    tracep->declBus(c+4204,"o_phy_bitslip", false,-1, 1,0);
    tracep->declBus(c+4239,"o_debug1", false,-1, 31,0);
    tracep->declBus(c+4240,"o_debug2", false,-1, 31,0);
    tracep->declBus(c+4241,"o_debug3", false,-1, 31,0);
    tracep->declBus(c+4342,"CMD_MRS", false,-1, 3,0);
    tracep->declBus(c+4343,"CMD_REF", false,-1, 3,0);
    tracep->declBus(c+4344,"CMD_PRE", false,-1, 3,0);
    tracep->declBus(c+4345,"CMD_ACT", false,-1, 3,0);
    tracep->declBus(c+4346,"CMD_WR", false,-1, 3,0);
    tracep->declBus(c+4347,"CMD_RD", false,-1, 3,0);
    tracep->declBus(c+4348,"CMD_NOP", false,-1, 3,0);
    tracep->declBus(c+4335,"CMD_ZQC", false,-1, 3,0);
    tracep->declBus(c+4349,"RST_DONE", false,-1, 31,0);
    tracep->declBus(c+4349,"REF_IDLE", false,-1, 31,0);
    tracep->declBus(c+4350,"USE_TIMER", false,-1, 31,0);
    tracep->declBus(c+4351,"A10_CONTROL", false,-1, 31,0);
    tracep->declBus(c+4287,"CLOCK_EN", false,-1, 31,0);
    tracep->declBus(c+4352,"RESET_N", false,-1, 31,0);
    tracep->declBus(c+4289,"DDR3_CMD_START", false,-1, 31,0);
    tracep->declBus(c+4294,"DDR3_CMD_END", false,-1, 31,0);
    tracep->declBus(c+4353,"MRS_BANK_START", false,-1, 31,0);
    tracep->declBus(c+4352,"CMD_CS_N", false,-1, 31,0);
    tracep->declBus(c+4289,"CMD_RAS_N", false,-1, 31,0);
    tracep->declBus(c+4354,"CMD_CAS_N", false,-1, 31,0);
    tracep->declBus(c+4330,"CMD_WE_N", false,-1, 31,0);
    tracep->declBus(c+4294,"CMD_ODT", false,-1, 31,0);
    tracep->declBus(c+4353,"CMD_CKE", false,-1, 31,0);
    tracep->declBus(c+4355,"CMD_RESET_N", false,-1, 31,0);
    tracep->declBus(c+4290,"CMD_BANK_START", false,-1, 31,0);
    tracep->declBus(c+4356,"CMD_ADDRESS_START", false,-1, 31,0);
    tracep->declBus(c+4338,"READ_SLOT", false,-1, 1,0);
    tracep->declBus(c+4339,"WRITE_SLOT", false,-1, 1,0);
    tracep->declBus(c+4336,"ACTIVATE_SLOT", false,-1, 1,0);
    tracep->declBus(c+4337,"PRECHARGE_SLOT", false,-1, 1,0);
    tracep->declBus(c+4295,"DATA_INITIAL_ODELAY_TAP", false,-1, 31,0);
    tracep->declBus(c+4283,"DQS_INITIAL_ODELAY_TAP", false,-1, 31,0);
    tracep->declBus(c+4295,"DATA_INITIAL_IDELAY_TAP", false,-1, 31,0);
    tracep->declBus(c+4283,"DQS_INITIAL_IDELAY_TAP", false,-1, 31,0);
    tracep->declBus(c+4294,"DELAY_SLOT_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4357,"POWER_ON_RESET_HIGH", false,-1, 31,0);
    tracep->declBus(c+4358,"INITIAL_CKE_LOW", false,-1, 31,0);
    tracep->declDouble(c+4359,"tRCD", false,-1);
    tracep->declDouble(c+4359,"tRP", false,-1);
    tracep->declBus(c+4361,"tRAS", false,-1, 31,0);
    tracep->declDouble(c+4362,"tRFC", false,-1);
    tracep->declBus(c+4364,"tREFI", false,-1, 31,0);
    tracep->declDouble(c+4365,"tXPR", false,-1);
    tracep->declDouble(c+4367,"tWR", false,-1);
    tracep->declDouble(c+4276,"tWTR", false,-1);
    tracep->declBus(c+4369,"tWLMRD", false,-1, 18,0);
    tracep->declDouble(c+4370,"tWLO", false,-1);
    tracep->declBus(c+4284,"tWLOE", false,-1, 31,0);
    tracep->declDouble(c+4276,"tRTP", false,-1);
    tracep->declBus(c+4286,"tCCD", false,-1, 31,0);
    tracep->declBus(c+4282,"tMOD", false,-1, 31,0);
    tracep->declBus(c+4341,"tZQinit", false,-1, 31,0);
    tracep->declBus(c+4372,"CL_nCK", false,-1, 31,0);
    tracep->declBus(c+4373,"CWL_nCK", false,-1, 31,0);
    tracep->declBus(c+4374,"DELAY_MAX_VALUE", false,-1, 18,0);
    tracep->declBus(c+4353,"DELAY_COUNTER_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4284,"CALIBRATION_DELAY", false,-1, 31,0);
    tracep->declBus(c+4343,"PRECHARGE_TO_ACTIVATE_DELAY", false,-1, 3,0);
    tracep->declBus(c+4345,"ACTIVATE_TO_PRECHARGE_DELAY", false,-1, 3,0);
    tracep->declBus(c+4342,"ACTIVATE_TO_WRITE_DELAY", false,-1, 3,0);
    tracep->declBus(c+4342,"ACTIVATE_TO_READ_DELAY", false,-1, 3,0);
    tracep->declBus(c+4343,"READ_TO_WRITE_DELAY", false,-1, 3,0);
    tracep->declBus(c+4342,"READ_TO_READ_DELAY", false,-1, 3,0);
    tracep->declBus(c+4343,"READ_TO_PRECHARGE_DELAY", false,-1, 3,0);
    tracep->declBus(c+4342,"WRITE_TO_WRITE_DELAY", false,-1, 3,0);
    tracep->declBus(c+4345,"WRITE_TO_READ_DELAY", false,-1, 3,0);
    tracep->declBus(c+4346,"WRITE_TO_PRECHARGE_DELAY", false,-1, 3,0);
    tracep->declBus(c+4373,"PRE_REFRESH_DELAY", false,-1, 31,0);
    tracep->declBus(c+4347,"MARGIN_BEFORE_ANTICIPATE", false,-1, 3,0);
    tracep->declBus(c+4284,"STAGE2_DATA_DEPTH", false,-1, 31,0);
    tracep->declBus(c+4295,"READ_DELAY", false,-1, 31,0);
    tracep->declBus(c+4373,"READ_ACK_PIPE_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4290,"MAX_ADDED_READ_ACK_DELAY", false,-1, 31,0);
    tracep->declBus(c+4356,"DELAY_BEFORE_WRITE_LEVEL_FEEDBACK", false,-1, 31,0);
    tracep->declBus(c+4295,"IDLE", false,-1, 31,0);
    tracep->declBus(c+4285,"BITSLIP_DQS_TRAIN_1", false,-1, 31,0);
    tracep->declBus(c+4284,"MPR_READ", false,-1, 31,0);
    tracep->declBus(c+4282,"COLLECT_DQS", false,-1, 31,0);
    tracep->declBus(c+4286,"ANALYZE_DQS", false,-1, 31,0);
    tracep->declBus(c+4373,"CALIBRATE_DQS", false,-1, 31,0);
    tracep->declBus(c+4372,"BITSLIP_DQS_TRAIN_2", false,-1, 31,0);
    tracep->declBus(c+4293,"START_WRITE_LEVEL", false,-1, 31,0);
    tracep->declBus(c+4283,"WAIT_FOR_FEEDBACK", false,-1, 31,0);
    tracep->declBus(c+4375,"ISSUE_WRITE_1", false,-1, 31,0);
    tracep->declBus(c+4281,"ISSUE_WRITE_2", false,-1, 31,0);
    tracep->declBus(c+4376,"ISSUE_READ", false,-1, 31,0);
    tracep->declBus(c+4377,"READ_DATA", false,-1, 31,0);
    tracep->declBus(c+4356,"ANALYZE_DATA", false,-1, 31,0);
    tracep->declBus(c+4280,"DONE_CALIBRATE", false,-1, 31,0);
    tracep->declBus(c+4373,"STORED_DQS_SIZE", false,-1, 31,0);
    tracep->declBus(c+4282,"REPEAT_DQS_ANALYZE", false,-1, 31,0);
    tracep->declBus(c+4378,"PASR", false,-1, 2,0);
    tracep->declBus(c+4378,"CWL", false,-1, 2,0);
    tracep->declBus(c+4291,"ASR", false,-1, 0,0);
    tracep->declBus(c+4333,"SRT", false,-1, 0,0);
    tracep->declBus(c+4336,"RTT_WR", false,-1, 1,0);
    tracep->declBus(c+4379,"MR2_SEL", false,-1, 2,0);
    tracep->declBus(c+4380,"MR2", false,-1, 18,0);
    tracep->declBus(c+4336,"MPR_LOC", false,-1, 1,0);
    tracep->declBus(c+4291,"MPR_EN", false,-1, 0,0);
    tracep->declBus(c+4333,"MPR_DIS", false,-1, 0,0);
    tracep->declBus(c+4381,"MR3_SEL", false,-1, 2,0);
    tracep->declBus(c+4382,"MR3_MPR_EN", false,-1, 18,0);
    tracep->declBus(c+4383,"MR3_MPR_DIS", false,-1, 18,0);
    tracep->declBus(c+4333,"DLL_EN", false,-1, 0,0);
    tracep->declBus(c+4336,"DIC", false,-1, 1,0);
    tracep->declBus(c+4381,"RTT_NOM", false,-1, 2,0);
    tracep->declBus(c+4291,"WL_EN", false,-1, 0,0);
    tracep->declBus(c+4333,"WL_DIS", false,-1, 0,0);
    tracep->declBus(c+4336,"AL", false,-1, 1,0);
    tracep->declBus(c+4333,"TDQS", false,-1, 0,0);
    tracep->declBus(c+4333,"QOFF", false,-1, 0,0);
    tracep->declBus(c+4384,"MR1_SEL", false,-1, 2,0);
    tracep->declBus(c+4385,"MR1_WL_EN", false,-1, 18,0);
    tracep->declBus(c+4386,"MR1_WL_DIS", false,-1, 18,0);
    tracep->declBus(c+4336,"BL", false,-1, 1,0);
    tracep->declBus(c+4346,"CL", false,-1, 3,0);
    tracep->declBus(c+4333,"RBT", false,-1, 0,0);
    tracep->declBus(c+4291,"DLL_RST", false,-1, 0,0);
    tracep->declBus(c+4381,"WR", false,-1, 2,0);
    tracep->declBus(c+4333,"PPD", false,-1, 0,0);
    tracep->declBus(c+4378,"MR0_SEL", false,-1, 2,0);
    tracep->declBus(c+4387,"MR0", false,-1, 18,0);
    tracep->declBus(c+4388,"INITIAL_RESET_INSTRUCTION", false,-1, 27,0);
    ...
    tracep->declBit(c+4296,"issue_write_command", false,-1);
    tracep->declBit(c+3673,"stage2_update", false,-1);
    tracep->declBit(c+4115,"stage2_stall", false,-1);
    tracep->declBit(c+4116,"stage1_stall", false,-1);
    tracep->declBus(c+3674,"bank_status_q", false,-1, 7,0);
    tracep->declBus(c+4117,"bank_status_d", false,-1, 7,0);
    for (int i = 0; i < 8; ++i) {
        tracep->declBus(c+3675+i*1,"bank_active_row_q", true,(i+0), 13,0);
    }
    for (int i = 0; i < 8; ++i) {
        tracep->declBus(c+4118+i*1,"bank_active_row_d", true,(i+0), 13,0);
    }
    ...
    tracep->declArray(c+3686,"stage1_data", false,-1, 127,0);
    tracep->declBus(c+3690,"stage1_dm", false,-1, 15,0);
    tracep->declBus(c+3691,"stage1_col", false,-1, 9,0);
    tracep->declBus(c+3692,"stage1_bank", false,-1, 2,0);
    tracep->declBus(c+3693,"stage1_row", false,-1, 13,0);
    tracep->declBus(c+3694,"stage1_next_bank", false,-1, 2,0);
    tracep->declBus(c+3695,"stage1_next_row", false,-1, 13,0);
    tracep->declBus(c+3952,"wb_addr_plus_anticipate", false,-1, 23,0);
    tracep->declBit(c+3696,"stage2_pending", false,-1);
    tracep->declBus(c+3697,"stage2_aux", false,-1, 0,0);
    tracep->declBit(c+3698,"stage2_we", false,-1);
    tracep->declBus(c+3699,"stage2_dm_unaligned", false,-1, 15,0);
    tracep->declBus(c+3700,"stage2_dm_unaligned_temp", false,-1, 15,0);
    for (int i = 0; i < 2; ++i) {
        tracep->declBus(c+3701+i*1,"stage2_dm", true,(i+0), 15,0);
    }
    tracep->declArray(c+3703,"stage2_data_unaligned", false,-1, 127,0);
    tracep->declArray(c+3707,"stage2_data_unaligned_temp", false,-1, 127,0);
    for (int i = 0; i < 2; ++i) {
        tracep->declArray(c+3711+i*4,"stage2_data", true,(i+0), 127,0);
    }
    for (int i = 0; i < 2; ++i) {
        tracep->declQuad(c+3719+i*2,"unaligned_data", true,(i+0), 63,0);
    }
    for (int i = 0; i < 2; ++i) {
        tracep->declBus(c+3723+i*1,"unaligned_dm", true,(i+0), 7,0);
    }
    tracep->declBus(c+3725,"stage2_col", false,-1, 9,0);
    tracep->declBus(c+3726,"stage2_bank", false,-1, 2,0);
    tracep->declBus(c+3727,"stage2_row", false,-1, 13,0);
    for (int i = 0; i < 8; ++i) {
        tracep->declBus(c+3728+i*1,"delay_before_precharge_counter_q", true,(i+0), 3,0);
    }
    for (int i = 0; i < 8; ++i) {
        tracep->declBus(c+4126+i*1,"delay_before_precharge_counter_d", true,(i+0), 3,0);
    }
    for (int i = 0; i < 8; ++i) {
        tracep->declBus(c+3736+i*1,"delay_before_activate_counter_q", true,(i+0), 3,0);
    }
    for (int i = 0; i < 8; ++i) {
        tracep->declBus(c+4134+i*1,"delay_before_activate_counter_d", true,(i+0), 3,0);
    }
    for (int i = 0; i < 8; ++i) {
        tracep->declBus(c+3744+i*1,"delay_before_write_counter_q", true,(i+0), 3,0);
    }
    for (int i = 0; i < 8; ++i) {
        tracep->declBus(c+4142+i*1,"delay_before_write_counter_d", true,(i+0), 3,0);
    }
    for (int i = 0; i < 8; ++i) {
        tracep->declBus(c+3752+i*1,"delay_before_read_counter_q", true,(i+0), 3,0);
    }
    for (int i = 0; i < 8; ++i) {
        tracep->declBus(c+4150+i*1,"delay_before_read_counter_d", true,(i+0), 3,0);
    }
    for (int i = 0; i < 4; ++i) {
        tracep->declBus(c+4158+i*1,"cmd_d", true,(i+0), 23,0);
    }
    tracep->declBit(c+3760,"cmd_odt_q", false,-1);
    tracep->declBit(c+4162,"cmd_odt", false,-1);
    tracep->declBit(c+4163,"cmd_ck_en", false,-1);
    tracep->declBit(c+4164,"cmd_reset_n", false,-1);
    tracep->declBit(c+3761,"o_wb_stall_q", false,-1);
    tracep->declBit(c+4165,"o_wb_stall_d", false,-1);
    tracep->declBit(c+4166,"precharge_slot_busy", false,-1);
    tracep->declBit(c+4167,"activate_slot_busy", false,-1);
    tracep->declBus(c+3762,"write_dqs_q", false,-1, 1,0);
    tracep->declBit(c+3763,"write_dqs_d", false,-1);
    tracep->declBus(c+3764,"write_dqs", false,-1, 2,0);
    tracep->declBus(c+3765,"write_dqs_val", false,-1, 2,0);
    tracep->declBit(c+3766,"write_dq_q", false,-1);
    tracep->declBit(c+3767,"write_dq_d", false,-1);
    tracep->declBus(c+3768,"write_dq", false,-1, 3,0);
    tracep->declBus(c+3769,"state_calibrate", false,-1, 4,0);
    tracep->declQuad(c+3770,"dqs_store", false,-1, 39,0);
    tracep->declBus(c+3772,"dqs_count_repeat", false,-1, 3,0);
    tracep->declBus(c+3773,"dqs_start_index", false,-1, 5,0);
    tracep->declBus(c+3774,"dqs_start_index_stored", false,-1, 5,0);
    tracep->declBus(c+3775,"dqs_target_index", false,-1, 5,0);
    tracep->declBus(c+3776,"dqs_target_index_orig", false,-1, 5,0);
    tracep->declBus(c+3777,"dq_target_index", false,-1, 5,0);
    tracep->declBus(c+3778,"dqs_target_index_value", false,-1, 5,0);
    tracep->declBus(c+3779,"dqs_start_index_repeat", false,-1, 2,0);
    tracep->declBus(c+3780,"train_delay", false,-1, 1,0);
    tracep->declBus(c+3781,"delay_before_read_data", false,-1, 3,0);
    tracep->declBus(c+3782,"delay_before_write_level_feedback", false,-1, 4,0);
    tracep->declBit(c+3783,"initial_dqs", false,-1);
    tracep->declBus(c+3784,"lane", false,-1, 0,0);
    tracep->declBus(c+3785,"lane_times_8", false,-1, 3,0);
    tracep->declBus(c+3786,"dqs_bitslip_arrangement", false,-1, 15,0);
    tracep->declBus(c+3787,"added_read_pipe_max", false,-1, 3,0);
    for (int i = 0; i < 2; ++i) {
        tracep->declBus(c+3788+i*1,"added_read_pipe", true,(i+0), 3,0);
    }
    for (int i = 0; i < 5; ++i) {
        tracep->declBus(c+3790+i*1,"shift_reg_read_pipe_q", true,(i+0), 1,0);
    }
    for (int i = 0; i < 5; ++i) {
        tracep->declBus(c+3795+i*1,"shift_reg_read_pipe_d", true,(i+0), 1,0);
    }
    tracep->declBit(c+3800,"index_read_pipe", false,-1);
    tracep->declBit(c+3801,"index_wb_data", false,-1);
    for (int i = 0; i < 2; ++i) {
        tracep->declBus(c+3802+i*1,"delay_read_pipe", true,(i+0), 15,0);
    }
    for (int i = 0; i < 2; ++i) {
        tracep->declArray(c+3804+i*4,"o_wb_data_q", true,(i+0), 127,0);
    }
    for (int i = 0; i < 16; ++i) {
        tracep->declBus(c+4098+i*1,"o_wb_ack_read_q", true,(i+0), 1,0);
    }
    tracep->declBit(c+3812,"write_calib_stb", false,-1);
    tracep->declBus(c+3813,"write_calib_aux", false,-1, 0,0);
    tracep->declBit(c+3814,"write_calib_we", false,-1);
    tracep->declBus(c+3815,"write_calib_col", false,-1, 9,0);
    tracep->declArray(c+3816,"write_calib_data", false,-1, 127,0);
    tracep->declBit(c+3820,"write_calib_odt", false,-1);
    tracep->declBit(c+3821,"write_calib_dqs", false,-1);
    tracep->declBit(c+3822,"write_calib_dq", false,-1);
    tracep->declBit(c+3823,"prev_write_level_feedback", false,-1);
    tracep->declArray(c+3824,"read_data_store", false,-1, 127,0);
    tracep->declArray(c+3828,"write_pattern", false,-1, 127,0);
    for (int i = 0; i < 2; ++i) {
        tracep->declBus(c+3832+i*1,"data_start_index", true,(i+0), 6,0);
    }
    for (int i = 0; i < 2; ++i) {
        tracep->declBus(c+3834+i*1,"odelay_data_cntvaluein", true,(i+0), 4,0);
    }
    for (int i = 0; i < 2; ++i) {
        tracep->declBus(c+3836+i*1,"odelay_dqs_cntvaluein", true,(i+0), 4,0);
    }
    for (int i = 0; i < 2; ++i) {
        tracep->declBus(c+3838+i*1,"idelay_data_cntvaluein", true,(i+0), 4,0);
    }
    tracep->declBus(c+3840,"idelay_data_cntvaluein_prev", false,-1, 4,0);
    for (int i = 0; i < 2; ++i) {
        tracep->declBus(c+3841+i*1,"idelay_dqs_cntvaluein", true,(i+0), 4,0);
    }
    tracep->declBit(c+3843,"wb2_stb", false,-1);
    tracep->declBit(c+3844,"wb2_update", false,-1);
    tracep->declBit(c+3845,"wb2_we", false,-1);
    tracep->declBus(c+3846,"wb2_addr", false,-1, 6,0);
    tracep->declBus(c+3847,"wb2_data", false,-1, 31,0);
    tracep->declBus(c+3848,"wb2_sel", false,-1, 3,0);
    tracep->declBus(c+3849,"wb2_phy_odelay_data_cntvaluein", false,-1, 4,0);
    tracep->declBus(c+3850,"wb2_phy_odelay_dqs_cntvaluein", false,-1, 4,0);
    tracep->declBus(c+3851,"wb2_phy_idelay_data_cntvaluein", false,-1, 4,0);
    tracep->declBus(c+3852,"wb2_phy_idelay_dqs_cntvaluein", false,-1, 4,0);
    tracep->declBus(c+3853,"wb2_phy_odelay_data_ld", false,-1, 1,0);
    tracep->declBus(c+3854,"wb2_phy_odelay_dqs_ld", false,-1, 1,0);
    tracep->declBus(c+3855,"wb2_phy_idelay_data_ld", false,-1, 1,0);
    tracep->declBus(c+3856,"wb2_phy_idelay_dqs_ld", false,-1, 1,0);
    tracep->declBus(c+3857,"wb2_write_lane", false,-1, 0,0);
    tracep->declBus(c+3953,"wb_data_to_wb2", false,-1, 31,0);
    tracep->declBit(c+4114,"debug_trigger", false,-1);
    tracep->declBit(c+4247,"dq_all_zeroes", false,-1);
    tracep->declBus(c+4389,"get_slot__Vstatic__delay", false,-1, 31,0);
    tracep->declBus(c+4390,"get_slot__Vstatic__slot_number", false,-1, 1,0);
    tracep->declBus(c+4391,"get_slot__Vstatic__read_slot", false,-1, 1,0);
    tracep->declBus(c+4392,"get_slot__Vstatic__write_slot", false,-1, 1,0);
    tracep->declBus(c+4393,"get_slot__Vstatic__anticipate_activate_slot", false,-1, 1,0);
    tracep->declBus(c+4394,"get_slot__Vstatic__anticipate_precharge_slot", false,-1, 1,0);
    tracep->declBus(c+4395,"find_delay__Vstatic__k", false,-1, 31,0);
    tracep->popNamePrefix(1);
    tracep->pushNamePrefix("genbus ");
    tracep->declBus(c+4294,"LGWATCHDOG", false,-1, 31,0);
    tracep->declBus(c+4372,"LGINPUT_FIFO", false,-1, 31,0);
    tracep->declBus(c+4281,"LGOUTPUT_FIFO", false,-1, 31,0);
    tracep->declBus(c+4333,"CMD_PORT_OFF_UNTIL_ACCESSED", false,-1, 0,0);
    tracep->declBus(c+4396,"AW", false,-1, 31,0);
    tracep->declBit(c+4176,"i_clk", false,-1);
    tracep->declBit(c+4177,"i_reset", false,-1);
    ...
    tracep->declBit(c+4297,"cmd_port_active", false,-1);
    ...
    tracep->declBus(c+4397,"BW", false,-1, 31,0);
    tracep->declBus(c+4281,"LGFLEN", false,-1, 31,0);
    tracep->declBit(c+4176,"i_clk", false,-1);
    ...
    tracep->declBus(c+4398,"FLEN", false,-1, 31,0);
    ...
    tracep->declBit(c+4296,"gen_unused", false,-1);
    tracep->pushNamePrefix("padififo ");
    tracep->declBus(c+4397,"BW", false,-1, 31,0);
    tracep->declBus(c+4372,"LGFLEN", false,-1, 31,0);
    tracep->declBit(c+4176,"i_clk", false,-1);
    tracep->declBit(c+175,"i_reset", false,-1);
    ...
    tracep->declBus(c+4291,"OPT_COMPRESSION", false,-1, 0,0);
    tracep->declBit(c+4176,"i_clk", false,-1);
    tracep->declBit(c+4177,"i_reset", false,-1);
    ...
    tracep->declBit(c+4296,"i_busy", false,-1);
    ...
    tracep->declBus(c+4333,"OPT_SKIDBUFFER", false,-1, 0,0);
    tracep->declBit(c+4176,"i_clk", false,-1);
    tracep->declBit(c+4177,"i_reset", false,-1);
    ...
    tracep->declBus(c+4333,"OPT_COUNT_FIFO", false,-1, 0,0);
    tracep->declBus(c+4286,"LGFIFO", false,-1, 31,0);
    tracep->declBus(c+4396,"AW", false,-1, 31,0);
    tracep->declBus(c+4334,"DW", false,-1, 31,0);
    tracep->declBit(c+4176,"i_clk", false,-1);
    tracep->declBit(c+175,"i_reset", false,-1);
    ...
    tracep->declBus(c+4336,"WB_IDLE", false,-1, 1,0);
    tracep->declBus(c+4337,"WB_READ_REQUEST", false,-1, 1,0);
    tracep->declBus(c+4338,"WB_WRITE_REQUEST", false,-1, 1,0);
    tracep->declBus(c+4339,"WB_FLUSH_WRITE_REQUESTS", false,-1, 1,0);
    tracep->declBus(c+4337,"WRITE_PREFIX", false,-1, 1,0);
    ...
    tracep->declBus(c+4399,"fifo_space_available", false,-1, 4,0);
    tracep->declBit(c+4297,"space_available", false,-1);
    tracep->pushNamePrefix("NO_FIFO ");
    tracep->declBit(c+4296,"unused_count", false,-1);
    tracep->popNamePrefix(2);
    tracep->pushNamePrefix("wroutput ");
    tracep->declBus(c+4291,"OPT_COMPRESSION", false,-1, 0,0);
    tracep->declBus(c+4291,"OPT_IDLES", false,-1, 0,0);
    tracep->declBit(c+4176,"i_clk", false,-1);
    tracep->declBit(c+4177,"i_reset", false,-1);
    ...
    tracep->declBus(c+4334,"DW", false,-1, 31,0);
    tracep->declBus(c+4397,"CW", false,-1, 31,0);
    tracep->declBus(c+4281,"TBITS", false,-1, 31,0);
    tracep->declBit(c+4176,"i_clk", false,-1);
    tracep->declBit(c+175,"i_reset", false,-1);
    ...
    tracep->declQuad(c+4400,"CW_INTERRUPT", false,-1, 35,0);
    tracep->declQuad(c+4402,"CW_BUSBUSY", false,-1, 35,0);
    tracep->declQuad(c+4404,"CW_IDLE", false,-1, 35,0);
    tracep->declBus(c+4289,"IDLEBITS", false,-1, 31,0);
    ...
    tracep->declBus(c+4406,"MAX_LINE_LENGTH", false,-1, 6,0);
    tracep->declBus(c+4407,"TRIGGER_LENGTH", false,-1, 6,0);
    ...
    tracep->declBus(c+4290,"NIN", false,-1, 31,0);
    tracep->declBus(c+4283,"NOUT", false,-1, 31,0);
    tracep->declBus(c+4329,"DEFAULT", false,-1, 7,0);
    tracep->declBit(c+4176,"i_clk", false,-1);
    tracep->declBit(c+3867,"i_wb_cyc", false,-1);
    tracep->declBit(c+3872,"i_wb_stb", false,-1);
    tracep->declBit(c+3869,"i_wb_we", false,-1);
    tracep->declBus(c+3870,"i_wb_data", false,-1, 31,0);
    tracep->declBus(c+3871,"i_wb_sel", false,-1, 3,0);
    tracep->declBit(c+4296,"o_wb_stall", false,-1);
    tracep->declBit(c+3872,"o_wb_ack", false,-1);
    tracep->declBus(c+4243,"o_wb_data", false,-1, 31,0);
    tracep->declBus(c+4233,"i_gpio", false,-1, 15,0);
    tracep->declBus(c+4234,"o_gpio", false,-1, 7,0);
    ...
    tracep->declBus(c+4248,"low_bits", false,-1, 15,0);
    tracep->declBit(c+4296,"unused", false,-1);
    tracep->popNamePrefix(1);
    tracep->pushNamePrefix("i2ci ");
    tracep->declBus(c+4289,"ADDRESS_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4331,"DATA_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4283,"I2C_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4284,"AXIS_ID_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4336,"DEF_CHANNEL", false,-1, 1,0);
    tracep->declBus(c+4289,"AW", false,-1, 31,0);
    tracep->declBus(c+4331,"DW", false,-1, 31,0);
    tracep->declBus(c+4283,"RW", false,-1, 31,0);
    tracep->declBus(c+4408,"BAW", false,-1, 31,0);
    tracep->declBus(c+4409,"RESET_ADDRESS", false,-1, 27,0);
    tracep->declBus(c+4291,"OPT_START_HALTED", false,-1, 0,0);
    tracep->declBus(c+4291,"OPT_MANUAL", false,-1, 0,0);
    tracep->declBus(c+4295,"OPT_WATCHDOG", false,-1, 31,0);
    tracep->declBus(c+4410,"DEF_CKCOUNT", false,-1, 11,0);
    tracep->declBus(c+4333,"OPT_LOWPOWER", false,-1, 0,0);
    tracep->declBit(c+4176,"i_clk", false,-1);
    tracep->declBit(c+4177,"i_reset", false,-1);
    tracep->declBit(c+3900,"i_wb_cyc", false,-1);
    tracep->declBit(c+3901,"i_wb_stb", false,-1);
    tracep->declBit(c+3902,"i_wb_we", false,-1);
    tracep->declBus(c+3954,"i_wb_addr", false,-1, 1,0);
    tracep->declBus(c+3904,"i_wb_data", false,-1, 31,0);
    tracep->declBus(c+3905,"i_wb_sel", false,-1, 3,0);
    tracep->declBit(c+4296,"o_wb_stall", false,-1);
    ...
    tracep->declBit(c+4296,"o_pf_we", false,-1);
    tracep->declBus(c+221,"o_pf_addr", false,-1, 21,0);
    tracep->declArray(c+4298,"o_pf_data", false,-1, 511,0);
    tracep->declQuad(c+4314,"o_pf_sel", false,-1, 63,0);
    ...
    tracep->declBit(c+4296,"i_sync_signal", false,-1);
    tracep->declBus(c+38,"o_debug", false,-1, 31,0);
    tracep->declBus(c+4336,"ADR_CONTROL", false,-1, 1,0);
    tracep->declBus(c+4337,"ADR_OVERRIDE", false,-1, 1,0);
    tracep->declBus(c+4338,"ADR_ADDRESS", false,-1, 1,0);
    tracep->declBus(c+4339,"ADR_CKCOUNT", false,-1, 1,0);
    tracep->declBus(c+4294,"HALT_BIT", false,-1, 31,0);
    tracep->declBus(c+4330,"ERR_BIT", false,-1, 31,0);
    tracep->declBus(c+4354,"ABORT_BIT", false,-1, 31,0);
    tracep->declBus(c+4289,"SOFTHALT_BIT", false,-1, 31,0);
    tracep->declBus(c+4375,"OVW_VALID", false,-1, 31,0);
    tracep->declBus(c+4376,"MANUAL_BIT", false,-1, 31,0);
    tracep->declBus(c+4342,"CMD_NOOP", false,-1, 3,0);
    tracep->declBus(c+4344,"CMD_STOP", false,-1, 3,0);
    tracep->declBus(c+4345,"CMD_SEND", false,-1, 3,0);
    tracep->declBus(c+4346,"CMD_RXK", false,-1, 3,0);
    tracep->declBus(c+4347,"CMD_RXN", false,-1, 3,0);
    tracep->declBus(c+4335,"CMD_RXLK", false,-1, 3,0);
    tracep->declBus(c+4348,"CMD_RXLN", false,-1, 3,0);
    tracep->declBus(c+4411,"CMD_WAIT", false,-1, 3,0);
    tracep->declBus(c+4412,"CMD_HALT", false,-1, 3,0);
    tracep->declBus(c+4413,"CMD_ABORT", false,-1, 3,0);
    tracep->declBus(c+4414,"CMD_TARGET", false,-1, 3,0);
    tracep->declBus(c+4415,"CMD_JUMP", false,-1, 3,0);
    tracep->declBus(c+4416,"CMD_CHANNEL", false,-1, 3,0);
    tracep->declBit(c+678,"cpu_reset", false,-1);
    tracep->declBit(c+4296,"cpu_clear_cache", false,-1);
    ...
    tracep->declBit(c+3955,"next_valid", false,-1);
    tracep->declBus(c+3956,"next_insn", false,-1, 7,0);
    ...
    tracep->declBit(c+3957,"bus_read", false,-1);
    tracep->declBit(c+3958,"bus_write", false,-1);
    tracep->declBit(c+3959,"bus_override", false,-1);
    tracep->declBit(c+3960,"bus_manual", false,-1);
    tracep->declBit(c+710,"ovw_ready", false,-1);
    tracep->declBit(c+3961,"bus_jump", false,-1);
    tracep->declBus(c+3954,"bus_write_addr", false,-1, 1,0);
    tracep->declBus(c+3954,"bus_read_addr", false,-1, 1,0);
    tracep->declBus(c+3904,"bus_write_data", false,-1, 31,0);
    tracep->declBus(c+3905,"bus_write_strb", false,-1, 3,0);
    ...
    tracep->declBus(c+4295,"OPT_WATCHDOG", false,-1, 31,0);
    tracep->declBus(c+4333,"OPT_LOWPOWER", false,-1, 0,0);
    tracep->declBit(c+4176,"S_AXI_ACLK", false,-1);
    ...
    tracep->declBit(c+4215,"i_scl", false,-1);
    tracep->declBit(c+4214,"i_sda", false,-1);
    tracep->declBit(c+709,"o_scl", false,-1);
    tracep->declBit(c+708,"o_sda", false,-1);
    tracep->declBit(c+690,"o_abort", false,-1);
    tracep->declBus(c+4342,"IDLE_STOPPED", false,-1, 3,0);
    tracep->declBus(c+4343,"START", false,-1, 3,0);
    tracep->declBus(c+4344,"IDLE_ACTIVE", false,-1, 3,0);
    tracep->declBus(c+4345,"STOP", false,-1, 3,0);
    tracep->declBus(c+4346,"DATA", false,-1, 3,0);
    tracep->declBus(c+4347,"CLOCK", false,-1, 3,0);
    tracep->declBus(c+4335,"ACK", false,-1, 3,0);
    tracep->declBus(c+4348,"CKACKLO", false,-1, 3,0);
    tracep->declBus(c+4411,"CKACKHI", false,-1, 3,0);
    tracep->declBus(c+4412,"RXNAK", false,-1, 3,0);
    tracep->declBus(c+4413,"ABORT", false,-1, 3,0);
    tracep->declBus(c+4414,"REPEAT_START", false,-1, 3,0);
    tracep->declBus(c+4415,"REPEAT_START2", false,-1, 3,0);
    tracep->declBus(c+4333,"D_RD", false,-1, 0,0);
    tracep->declBus(c+4291,"D_WR", false,-1, 0,0);
    tracep->declBus(c+4378,"CMD_NOOP", false,-1, 2,0);
    tracep->declBus(c+4384,"CMD_START", false,-1, 2,0);
    tracep->declBus(c+4379,"CMD_STOP", false,-1, 2,0);
    tracep->declBus(c+4381,"CMD_SEND", false,-1, 2,0);
    tracep->declBus(c+4417,"CMD_RXK", false,-1, 2,0);
    tracep->declBus(c+4418,"CMD_RXN", false,-1, 2,0);
    tracep->declBus(c+4419,"CMD_RXLK", false,-1, 2,0);
    tracep->declBus(c+4420,"CMD_RXLN", false,-1, 2,0);
    tracep->declBus(c+4333,"OPT_ABORT_REQUEST", false,-1, 0,0);
    ...
    tracep->declBit(c+4296,"watchdog_timeout", false,-1);
    tracep->popNamePrefix(1);
    tracep->pushNamePrefix("u_fetch ");
    tracep->declBus(c+4408,"ADDRESS_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4283,"INSN_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4331,"DATA_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4408,"AW", false,-1, 31,0);
    tracep->declBus(c+4331,"DW", false,-1, 31,0);
    tracep->declBus(c+4333,"OPT_LITTLE_ENDIAN", false,-1, 0,0);
    tracep->declBit(c+4176,"i_clk", false,-1);
    tracep->declBit(c+41,"i_reset", false,-1);
    tracep->declBit(c+679,"i_new_pc", false,-1);
    tracep->declBit(c+4296,"i_clear_cache", false,-1);
    ...
    tracep->declBit(c+4296,"o_wb_we", false,-1);
    tracep->declBus(c+221,"o_wb_addr", false,-1, 21,0);
    tracep->declArray(c+4298,"o_wb_data", false,-1, 511,0);
    ...
    tracep->declBus(c+4372,"NSHIFT", false,-1, 31,0);
    ...
    tracep->declBit(c+4296,"unused_shift", false,-1);
    tracep->popNamePrefix(3);
    tracep->pushNamePrefix("i2cscopei ");
    tracep->declBus(c+4421,"LGMEM", false,-1, 4,0);
    tracep->declBus(c+4334,"BUSW", false,-1, 31,0);
    tracep->declBus(c+4422,"NELM", false,-1, 31,0);
    tracep->declBus(c+4291,"SYNCHRONOUS", false,-1, 0,0);
    tracep->declBus(c+4330,"HOLDOFFBITS", false,-1, 31,0);
    tracep->declBus(c+4423,"DEFAULT_HOLDOFF", false,-1, 19,0);
    tracep->declBus(c+4422,"STEP_BITS", false,-1, 31,0);
    tracep->declBus(c+4424,"MAX_STEP", false,-1, 30,0);
    tracep->declBit(c+4176,"i_data_clk", false,-1);
    tracep->declBit(c+4297,"i_ce", false,-1);
    tracep->declBit(c+703,"i_trigger", false,-1);
    tracep->declBus(c+42,"i_data", false,-1, 30,0);
    tracep->declBit(c+4176,"i_wb_clk", false,-1);
    tracep->declBit(c+3876,"i_wb_cyc", false,-1);
    tracep->declBit(c+3877,"i_wb_stb", false,-1);
    tracep->declBit(c+3878,"i_wb_we", false,-1);
    tracep->declBit(c+3962,"i_wb_addr", false,-1);
    tracep->declBus(c+3880,"i_wb_data", false,-1, 31,0);
    tracep->declBus(c+3881,"i_wb_sel", false,-1, 3,0);
    tracep->declBit(c+4296,"o_wb_stall", false,-1);
    tracep->declBit(c+409,"o_wb_ack", false,-1);
    tracep->declBus(c+410,"o_wb_data", false,-1, 31,0);
    tracep->declBit(c+146,"o_interrupt", false,-1);
    tracep->declBit(c+3963,"write_stb", false,-1);
    tracep->declBit(c+3964,"read_from_data", false,-1);
    tracep->declBit(c+3965,"write_to_control", false,-1);
    tracep->declBus(c+410,"o_bus_data", false,-1, 31,0);
    tracep->declBit(c+4176,"bus_clock", false,-1);
    tracep->declBit(c+788,"read_address", false,-1);
    tracep->declBus(c+3880,"i_bus_data", false,-1, 31,0);
    ...
    tracep->declBus(c+4373,"DLYSTOP", false,-1, 31,0);
    ...
    tracep->declBit(c+3877,"bw_cyc_stb", false,-1);
    ...
    tracep->declBus(c+4421,"bw_lgmem", false,-1, 4,0);
    tracep->declBit(c+818,"br_level_interrupt", false,-1);
    tracep->declBit(c+4296,"unused", false,-1);
    tracep->popNamePrefix(1);
    tracep->pushNamePrefix("rcv ");
    tracep->declBus(c+4293,"TIMER_BITS", false,-1, 31,0);
    tracep->declBus(c+4425,"CLOCKS_PER_BAUD", false,-1, 6,0);
    tracep->declBus(c+4293,"TB", false,-1, 31,0);
    tracep->declBus(c+4342,"RXUL_BIT_ZERO", false,-1, 3,0);
    tracep->declBus(c+4343,"RXUL_BIT_ONE", false,-1, 3,0);
    tracep->declBus(c+4344,"RXUL_BIT_TWO", false,-1, 3,0);
    tracep->declBus(c+4345,"RXUL_BIT_THREE", false,-1, 3,0);
    tracep->declBus(c+4346,"RXUL_BIT_FOUR", false,-1, 3,0);
    tracep->declBus(c+4347,"RXUL_BIT_FIVE", false,-1, 3,0);
    tracep->declBus(c+4335,"RXUL_BIT_SIX", false,-1, 3,0);
    tracep->declBus(c+4348,"RXUL_BIT_SEVEN", false,-1, 3,0);
    tracep->declBus(c+4411,"RXUL_STOP", false,-1, 3,0);
    tracep->declBus(c+4412,"RXUL_WAIT", false,-1, 3,0);
    tracep->declBus(c+4328,"RXUL_IDLE", false,-1, 3,0);
    tracep->declBit(c+4176,"i_clk", false,-1);
    tracep->declBit(c+4230,"i_uart_rx", false,-1);
    tracep->declBit(c+172,"o_wr", false,-1);
    tracep->declBus(c+170,"o_data", false,-1, 7,0);
    tracep->declBus(c+4426,"half_baud", false,-1, 6,0);
    ...
    tracep->declBit(c+4176,"i_data_clk", false,-1);
    tracep->declBit(c+4297,"i_ce", false,-1);
    tracep->declBit(c+4114,"i_trigger", false,-1);
    tracep->declBus(c+3858,"i_data", false,-1, 30,0);
    tracep->declBit(c+4176,"i_wb_clk", false,-1);
    tracep->declBit(c+3882,"i_wb_cyc", false,-1);
    tracep->declBit(c+3883,"i_wb_stb", false,-1);
    tracep->declBit(c+3884,"i_wb_we", false,-1);
    tracep->declBit(c+3966,"i_wb_addr", false,-1);
    tracep->declBus(c+3886,"i_wb_data", false,-1, 31,0);
    tracep->declBus(c+3887,"i_wb_sel", false,-1, 3,0);
    tracep->declBit(c+4296,"o_wb_stall", false,-1);
    tracep->declBit(c+411,"o_wb_ack", false,-1);
    tracep->declBus(c+412,"o_wb_data", false,-1, 31,0);
    tracep->declBit(c+140,"o_interrupt", false,-1);
    tracep->declBit(c+3967,"write_stb", false,-1);
    tracep->declBit(c+3968,"read_from_data", false,-1);
    tracep->declBit(c+3969,"write_to_control", false,-1);
    tracep->declBus(c+412,"o_bus_data", false,-1, 31,0);
    tracep->declBit(c+4176,"bus_clock", false,-1);
    tracep->declBit(c+828,"read_address", false,-1);
    tracep->declBus(c+3886,"i_bus_data", false,-1, 31,0);
    ...
    tracep->declBit(c+4168,"dw_trigger", false,-1);
    ...
    tracep->declBit(c+3883,"bw_cyc_stb", false,-1);
    ...
    tracep->declBit(c+4297,"i_ce", false,-1);
    tracep->declBit(c+4114,"i_trigger", false,-1);
    tracep->declBus(c+4249,"i_data", false,-1, 30,0);
    tracep->declBit(c+4176,"i_wb_clk", false,-1);
    tracep->declBit(c+3888,"i_wb_cyc", false,-1);
    tracep->declBit(c+3889,"i_wb_stb", false,-1);
    tracep->declBit(c+3890,"i_wb_we", false,-1);
    tracep->declBit(c+3970,"i_wb_addr", false,-1);
    tracep->declBus(c+3892,"i_wb_data", false,-1, 31,0);
    tracep->declBus(c+3893,"i_wb_sel", false,-1, 3,0);
    tracep->declBit(c+4296,"o_wb_stall", false,-1);
    tracep->declBit(c+413,"o_wb_ack", false,-1);
    tracep->declBus(c+414,"o_wb_data", false,-1, 31,0);
    tracep->declBit(c+141,"o_interrupt", false,-1);
    tracep->declBit(c+3971,"write_stb", false,-1);
    tracep->declBit(c+3972,"read_from_data", false,-1);
    tracep->declBit(c+3973,"write_to_control", false,-1);
    tracep->declBus(c+414,"o_bus_data", false,-1, 31,0);
    tracep->declBit(c+4176,"bus_clock", false,-1);
    tracep->declBit(c+858,"read_address", false,-1);
    tracep->declBus(c+3892,"i_bus_data", false,-1, 31,0);
    ...
    tracep->declBit(c+4169,"dw_trigger", false,-1);
    ...
    tracep->declBit(c+3889,"bw_cyc_stb", false,-1);
    ...
    tracep->declBit(c+4176,"i_wb_clk", false,-1);
    tracep->declBit(c+3894,"i_wb_cyc", false,-1);
    tracep->declBit(c+3895,"i_wb_stb", false,-1);
    tracep->declBit(c+3896,"i_wb_we", false,-1);
    tracep->declBit(c+3974,"i_wb_addr", false,-1);
    tracep->declBus(c+3898,"i_wb_data", false,-1, 31,0);
    tracep->declBus(c+3899,"i_wb_sel", false,-1, 3,0);
    tracep->declBit(c+4296,"o_wb_stall", false,-1);
    tracep->declBit(c+415,"o_wb_ack", false,-1);
    tracep->declBus(c+416,"o_wb_data", false,-1, 31,0);
    tracep->declBit(c+147,"o_interrupt", false,-1);
    tracep->declBit(c+3975,"write_stb", false,-1);
    tracep->declBit(c+3976,"read_from_data", false,-1);
    tracep->declBit(c+3977,"write_to_control", false,-1);
    tracep->declBus(c+416,"o_bus_data", false,-1, 31,0);
    tracep->declBit(c+4176,"bus_clock", false,-1);
    tracep->declBit(c+888,"read_address", false,-1);
    tracep->declBus(c+3898,"i_bus_data", false,-1, 31,0);
    ...
    tracep->declBit(c+4170,"dw_trigger", false,-1);
    ...
    tracep->declBit(c+3895,"bw_cyc_stb", false,-1);
    ...
    tracep->declBus(c+4283,"NLEDS", false,-1, 31,0);
    tracep->declBus(c+4373,"NBTN", false,-1, 31,0);
    tracep->declBus(c+4283,"NSW", false,-1, 31,0);
    tracep->declBus(c+4284,"NFF", false,-1, 31,0);
    tracep->declBit(c+4176,"i_clk", false,-1);
    tracep->declBit(c+4177,"i_reset", false,-1);
    tracep->declBit(c+3867,"i_wb_cyc", false,-1);
    tracep->declBit(c+3874,"i_wb_stb", false,-1);
    tracep->declBit(c+3869,"i_wb_we", false,-1);
    tracep->declBus(c+3870,"i_wb_data", false,-1, 31,0);
    tracep->declBus(c+3871,"i_wb_sel", false,-1, 3,0);
    tracep->declBit(c+4296,"o_wb_stall", false,-1);
    ...
    tracep->declBus(c+3978,"next_btn", false,-1, 4,0);
    ...
    tracep->declBit(c+3979,"next_int", false,-1);
    tracep->popNamePrefix(1);
    ...
    tracep->declBus(c+4283,"NLEDS", false,-1, 31,0);
    tracep->declBus(c+4351,"CTRBITS", false,-1, 31,0);
    tracep->declBit(c+4176,"i_clk", false,-1);
    ...
    tracep->declBus(c+4288,"RESET_ADDRESS", false,-1, 31,0);
    tracep->declBus(c+4408,"ADDRESS_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4331,"BUS_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4334,"DBG_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4291,"OPT_PIPELINED", false,-1, 0,0);
    tracep->declBus(c+4291,"OPT_EARLY_BRANCHING", false,-1, 0,0);
    tracep->declBus(c+4377,"OPT_LGICACHE", false,-1, 31,0);
    tracep->declBus(c+4377,"OPT_LGDCACHE", false,-1, 31,0);
    tracep->declBus(c+4291,"START_HALTED", false,-1, 0,0);
    tracep->declBus(c+4291,"OPT_DISTRIBUTED_REGS", false,-1, 0,0);
    tracep->declBus(c+4290,"EXTERNAL_INTERRUPTS", false,-1, 31,0);
    tracep->declBus(c+4282,"OPT_MPY", false,-1, 31,0);
    tracep->declBus(c+4291,"OPT_DIV", false,-1, 0,0);
    tracep->declBus(c+4291,"OPT_SHIFTS", false,-1, 0,0);
    tracep->declBus(c+4333,"OPT_FPU", false,-1, 0,0);
    tracep->declBus(c+4291,"OPT_CIS", false,-1, 0,0);
    tracep->declBus(c+4291,"OPT_LOCK", false,-1, 0,0);
    tracep->declBus(c+4291,"OPT_USERMODE", false,-1, 0,0);
    tracep->declBus(c+4291,"OPT_DBGPORT", false,-1, 0,0);
    tracep->declBus(c+4333,"OPT_TRACE_PORT", false,-1, 0,0);
    tracep->declBus(c+4291,"OPT_PROFILER", false,-1, 0,0);
    tracep->declBus(c+4333,"OPT_LOWPOWER", false,-1, 0,0);
    tracep->declBus(c+4291,"OPT_DMA", false,-1, 0,0);
    tracep->declBus(c+4281,"DMA_LGMEM", false,-1, 31,0);
    tracep->declBus(c+4291,"OPT_ACCOUNTING", false,-1, 0,0);
    tracep->declBus(c+4291,"DELAY_DBG_BUS", false,-1, 0,0);
    tracep->declBus(c+4333,"DELAY_EXT_BUS", false,-1, 0,0);
    tracep->declBus(c+4291,"OPT_SIM", false,-1, 0,0);
    tracep->declBus(c+4333,"OPT_CLKGATE", false,-1, 0,0);
    tracep->declBus(c+4330,"RESET_DURATION", false,-1, 31,0);
    tracep->declBus(c+4289,"PAW", false,-1, 31,0);
    tracep->declBit(c+4176,"i_clk", false,-1);
    ...
    tracep->declBus(c+4250,"i_dbg_sel", false,-1, 3,0);
    ...
    tracep->declBus(c+4295,"o_cpu_debug", false,-1, 31,0);
    tracep->declBit(c+4226,"o_prof_stb", false,-1);
    tracep->declBus(c+4227,"o_prof_addr", false,-1, 27,0);
    tracep->declBus(c+4228,"o_prof_ticks", false,-1, 31,0);
    tracep->declBus(c+4331,"DW", false,-1, 31,0);
    tracep->declBus(c+4427,"PERIPHBASE", false,-1, 31,0);
    tracep->declBus(c+4332,"INTCTRL", false,-1, 7,0);
    tracep->declBus(c+4428,"WATCHDOG", false,-1, 7,0);
    tracep->declBus(c+4429,"BUSWATCHDOG", false,-1, 7,0);
    tracep->declBus(c+4430,"CTRINT", false,-1, 7,0);
    tracep->declBus(c+4431,"TIMER_A", false,-1, 7,0);
    tracep->declBus(c+4432,"TIMER_B", false,-1, 7,0);
    tracep->declBus(c+4433,"TIMER_C", false,-1, 7,0);
    tracep->declBus(c+4434,"JIFFIES", false,-1, 7,0);
    tracep->declBus(c+4435,"MSTR_TASK_CTR", false,-1, 7,0);
    tracep->declBus(c+4436,"MSTR_MSTL_CTR", false,-1, 7,0);
    tracep->declBus(c+4437,"MSTR_PSTL_CTR", false,-1, 7,0);
    tracep->declBus(c+4438,"MSTR_INST_CTR", false,-1, 7,0);
    tracep->declBus(c+4439,"USER_TASK_CTR", false,-1, 7,0);
    tracep->declBus(c+4440,"USER_MSTL_CTR", false,-1, 7,0);
    tracep->declBus(c+4441,"USER_PSTL_CTR", false,-1, 7,0);
    tracep->declBus(c+4442,"USER_INST_CTR", false,-1, 7,0);
    tracep->declBus(c+4443,"MMU_ADDR", false,-1, 7,0);
    tracep->declBus(c+4444,"DMAC_ADDR", false,-1, 7,0);
    tracep->declBus(c+4295,"HALT_BIT", false,-1, 31,0);
    tracep->declBus(c+4284,"STEP_BIT", false,-1, 31,0);
    tracep->declBus(c+4282,"RESET_BIT", false,-1, 31,0);
    tracep->declBus(c+4286,"CLEAR_CACHE_BIT", false,-1, 31,0);
    tracep->declBus(c+4373,"CATCH_BIT", false,-1, 31,0);
    tracep->declBus(c+4289,"VIRTUAL_ADDRESS_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4336,"DBG_ADDR_CTRL", false,-1, 1,0);
    tracep->declBus(c+4337,"DBG_ADDR_CPU", false,-1, 1,0);
    tracep->declBus(c+4338,"DBG_ADDR_SYS", false,-1, 1,0);
    ...
    tracep->declBit(c+4296,"actr_stall", false,-1);
    ...
    tracep->declBit(c+4296,"sys_stall", false,-1);
    ...
    tracep->declBit(c+4296,"wdt_stall", false,-1);
    ...
    tracep->declBit(c+4296,"dmac_stall", false,-1);
    ...
    tracep->declBit(c+4296,"ctri_stall", false,-1);
    tracep->declBit(c+1051,"ctri_ack", false,-1);
    tracep->declBus(c+1052,"ctri_data", false,-1, 31,0);
    tracep->declBit(c+4296,"tma_stall", false,-1);
    tracep->declBit(c+1053,"tma_ack", false,-1);
    tracep->declBit(c+4296,"tmb_stall", false,-1);
    tracep->declBit(c+1054,"tmb_ack", false,-1);
    tracep->declBit(c+4296,"tmc_stall", false,-1);
    tracep->declBit(c+1055,"tmc_ack", false,-1);
    tracep->declBit(c+4296,"jif_stall", false,-1);
    ...
    tracep->declBit(c+4296,"pic_stall", false,-1);
    ...
    tracep->declBit(c+4296,"mmus_stall", false,-1);
    ...
    tracep->declBus(c+4295,"mmus_data", false,-1, 31,0);
    tracep->declBit(c+4296,"cpu_miss", false,-1);
    ...
    tracep->declBit(c+4296,"pf_return_stb", false,-1);
    tracep->declBit(c+4296,"pf_return_we", false,-1);
    tracep->declBit(c+4296,"pf_return_cachable", false,-1);
    tracep->declBus(c+4445,"pf_return_v", false,-1, 19,0);
    tracep->declBus(c+4445,"pf_return_p", false,-1, 19,0);
    ...
    tracep->declBit(c+4296,"mtc_stall", false,-1);
    tracep->declBit(c+1118,"mtc_ack", false,-1);
    tracep->declBit(c+4296,"moc_stall", false,-1);
    tracep->declBit(c+1119,"moc_ack", false,-1);
    tracep->declBit(c+4296,"mpc_stall", false,-1);
    tracep->declBit(c+1120,"mpc_ack", false,-1);
    tracep->declBit(c+4296,"mic_stall", false,-1);
    tracep->declBit(c+1121,"mic_ack", false,-1);
    tracep->declBit(c+4296,"utc_stall", false,-1);
    tracep->declBit(c+1122,"utc_ack", false,-1);
    tracep->declBit(c+4296,"uoc_stall", false,-1);
    tracep->declBit(c+1123,"uoc_ack", false,-1);
    tracep->declBit(c+4296,"upc_stall", false,-1);
    tracep->declBit(c+1124,"upc_ack", false,-1);
    tracep->declBit(c+4296,"uic_stall", false,-1);
    ...
    tracep->declBit(c+4296,"dbg_err", false,-1);
    tracep->pushNamePrefix("wbdelay ");
    tracep->declBus(c+4293,"AW", false,-1, 31,0);
    tracep->declBus(c+4334,"DW", false,-1, 31,0);
    tracep->declBus(c+4291,"DELAY_STALL", false,-1, 0,0);
    tracep->declBus(c+4333,"OPT_LOWPOWER", false,-1, 0,0);
    tracep->declBit(c+4176,"i_clk", false,-1);
    tracep->declBit(c+37,"i_reset", false,-1);
    ...
    tracep->declBus(c+4328,"i_wb_sel", false,-1, 3,0);
    ...
    tracep->declBit(c+4296,"i_dly_err", false,-1);
    ...
    tracep->declBus(c+4408,"ADDRESS_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4281,"LGMEMLEN", false,-1, 31,0);
    tracep->declBus(c+4408,"LGDMALENGTH", false,-1, 31,0);
    tracep->declBus(c+4334,"SLV_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4331,"BUS_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4333,"OPT_LITTLE_ENDIAN", false,-1, 0,0);
    tracep->declBus(c+4333,"OPT_LOWPOWER", false,-1, 0,0);
    tracep->declBus(c+4333,"OPT_REGISTER_RAM", false,-1, 0,0);
    tracep->declBus(c+4289,"AW", false,-1, 31,0);
    tracep->declBit(c+4176,"i_clk", false,-1);
    ...
    tracep->declBus(c+4328,"i_swb_sel", false,-1, 3,0);
    tracep->declBit(c+4296,"o_swb_stall", false,-1);
    ...
    tracep->declBus(c+4446,"FIFO_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4286,"LGFIFO", false,-1, 31,0);
    ...
    tracep->declBit(c+4296,"mm2s_rd_we", false,-1);
    ...
    tracep->declArray(c+4298,"mm2s_rd_data", false,-1, 511,0);
    ...
    tracep->declBit(c+4297,"s2mm_wr_we", false,-1);
    ...
    tracep->declBus(c+4331,"DW", false,-1, 31,0);
    tracep->declBus(c+4289,"AW", false,-1, 31,0);
    tracep->declArray(c+4447,"SCHEME", false,-1, 87,0);
    tracep->declBus(c+4333,"OPT_ZERO_ON_IDLE", false,-1, 0,0);
    tracep->declBit(c+4176,"i_clk", false,-1);
    tracep->declBit(c+997,"i_reset", false,-1);
    tracep->declBit(c+1176,"i_a_cyc", false,-1);
    tracep->declBit(c+1177,"i_a_stb", false,-1);
    tracep->declBit(c+4296,"i_a_we", false,-1);
    ...
    tracep->declBit(c+4297,"i_b_we", false,-1);
    ...
    tracep->declBus(c+4334,"SLV_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4408,"LGDMALENGTH", false,-1, 31,0);
    tracep->declBus(c+4450,"ABORT_KEY", false,-1, 31,0);
    tracep->declBus(c+4333,"OPT_LOWPOWER", false,-1, 0,0);
    tracep->declBus(c+4408,"AW", false,-1, 31,0);
    tracep->declBit(c+4176,"i_clk", false,-1);
    tracep->declBit(c+997,"i_reset", false,-1);
    ...
    tracep->declBus(c+4328,"i_sel", false,-1, 3,0);
    tracep->declBit(c+4296,"o_stall", false,-1);
    ...
    tracep->declBit(c+4296,"unused_len", false,-1);
    tracep->popNamePrefix(1);
    tracep->pushNamePrefix("UNUSED_WIDE_ADDR ");
    tracep->declBit(c+4296,"unused_addr", false,-1);
    tracep->popNamePrefix(2);
    tracep->pushNamePrefix("u_dma_fsm ");
    tracep->declBus(c+4408,"ADDRESS_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4408,"LGDMALENGTH", false,-1, 31,0);
    tracep->declBus(c+4281,"LGSUBLENGTH", false,-1, 31,0);
    tracep->declBit(c+4176,"i_clk", false,-1);
    tracep->declBit(c+997,"i_reset", false,-1);
    ...
    tracep->declBus(c+4336,"S_IDLE", false,-1, 1,0);
    tracep->declBus(c+4337,"S_WAIT", false,-1, 1,0);
    tracep->declBus(c+4338,"S_READ", false,-1, 1,0);
    tracep->declBus(c+4339,"S_WRITE", false,-1, 1,0);
    ...
    tracep->declBus(c+4408,"ADDRESS_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4331,"BUS_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4281,"LGLENGTH", false,-1, 31,0);
    tracep->declBus(c+4333,"OPT_LITTLE_ENDIAN", false,-1, 0,0);
    tracep->declBus(c+4333,"OPT_LOWPOWER", false,-1, 0,0);
    tracep->declBus(c+4331,"DW", false,-1, 31,0);
    tracep->declBus(c+4289,"AW", false,-1, 31,0);
    ...
    tracep->declBit(c+4296,"o_rd_we", false,-1);
    tracep->declBus(c+1181,"o_rd_addr", false,-1, 21,0);
    tracep->declArray(c+4298,"o_rd_data", false,-1, 511,0);
    ...
    tracep->declBus(c+4339,"SZ_BYTE", false,-1, 1,0);
    tracep->declBus(c+4338,"SZ_16B", false,-1, 1,0);
    tracep->declBus(c+4337,"SZ_32B", false,-1, 1,0);
    tracep->declBus(c+4336,"SZ_BUS", false,-1, 1,0);
    tracep->declBus(c+4372,"WBLSB", false,-1, 31,0);
    ...
    tracep->declBus(c+4451,"ik", false,-1, 31,0);
    tracep->popNamePrefix(1);
    tracep->pushNamePrefix("u_s2mm ");
    tracep->declBus(c+4408,"ADDRESS_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4331,"BUS_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4333,"OPT_LITTLE_ENDIAN", false,-1, 0,0);
    tracep->declBus(c+4281,"LGPIPE", false,-1, 31,0);
    tracep->declBus(c+4331,"DW", false,-1, 31,0);
    tracep->declBus(c+4289,"AW", false,-1, 31,0);
    tracep->declBit(c+4176,"i_clk", false,-1);
    tracep->declBit(c+1288,"i_reset", false,-1);
    ...
    tracep->declBit(c+4297,"o_wr_we", false,-1);
    ...
    tracep->declBus(c+4446,"BW", false,-1, 31,0);
    tracep->declBus(c+4286,"LGFLEN", false,-1, 31,0);
    tracep->declBus(c+4291,"OPT_ASYNC_READ", false,-1, 0,0);
    tracep->declBus(c+4333,"OPT_WRITE_ON_FULL", false,-1, 0,0);
    tracep->declBus(c+4333,"OPT_READ_ON_EMPTY", false,-1, 0,0);
    tracep->declBit(c+4176,"i_clk", false,-1);
    tracep->declBit(c+1288,"i_reset", false,-1);
    ...
    tracep->declBus(c+4290,"FLEN", false,-1, 31,0);
    ...
    tracep->declBus(c+4452,"IUSED", false,-1, 31,0);
    tracep->declBus(c+4334,"DW", false,-1, 31,0);
    tracep->declBit(c+4176,"i_clk", false,-1);
    tracep->declBit(c+997,"i_reset", false,-1);
    tracep->declBit(c+961,"i_wb_cyc", false,-1);
    ...
    tracep->declBus(c+4331,"BUS_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4377,"OPT_LGICACHE", false,-1, 31,0);
    tracep->declBus(c+4334,"DATA_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4282,"OPT_MPY", false,-1, 31,0);
    tracep->declBus(c+4291,"OPT_DIV", false,-1, 0,0);
    tracep->declBus(c+4291,"OPT_SHIFTS", false,-1, 0,0);
    tracep->declBus(c+4333,"IMPLEMENT_FPU", false,-1, 0,0);
    tracep->declBus(c+4291,"OPT_EARLY_BRANCHING", false,-1, 0,0);
    tracep->declBus(c+4291,"OPT_CIS", false,-1, 0,0);
    tracep->declBus(c+4291,"OPT_DISTRIBUTED_REGS", false,-1, 0,0);
    tracep->declBus(c+4291,"OPT_PIPELINED", false,-1, 0,0);
    ...
    tracep->declBus(c+4291,"OPT_SIM", false,-1, 0,0);
    tracep->declBus(c+4333,"OPT_CLKGATE", false,-1, 0,0);
    tracep->declBus(c+4291,"WITH_LOCAL_BUS", false,-1, 0,0);
    tracep->declBus(c+4291,"OPT_DBGPORT", false,-1, 0,0);
    tracep->declBus(c+4333,"OPT_TRACE_PORT", false,-1, 0,0);
    tracep->declBus(c+4291,"OPT_PROFILER", false,-1, 0,0);
    tracep->declBus(c+4291,"OPT_USERMODE", false,-1, 0,0);
    ...
    tracep->declBus(c+4295,"o_debug", false,-1, 31,0);
    tracep->declBit(c+4226,"o_prof_stb", false,-1);
    tracep->declBus(c+4227,"o_prof_addr", false,-1, 27,0);
    tracep->declBus(c+4228,"o_prof_ticks", false,-1, 31,0);
    tracep->declBus(c+4291,"OPT_DCACHE", false,-1, 0,0);
    tracep->declBus(c+4291,"OPT_PIPELINED_BUS_ACCESS", false,-1, 0,0);
    tracep->declBus(c+4291,"OPT_MEMPIPE", false,-1, 0,0);
    tracep->declBus(c+4334,"INSN_WIDTH", false,-1, 31,0);
    tracep->declBit(c+4297,"cpu_clken", false,-1);
    tracep->declBit(c+4176,"cpu_clock", false,-1);
    tracep->declBit(c+4297,"clk_gate", false,-1);
    tracep->declBus(c+4295,"cpu_debug", false,-1, 31,0);
    ...
    tracep->declBit(c+4296,"pf_we", false,-1);
    tracep->declArray(c+4298,"pf_data", false,-1, 511,0);
    ...
    tracep->declBus(c+4372,"LGCACHELEN", false,-1, 31,0);
    tracep->declBus(c+4331,"BUS_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4289,"ADDRESS_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4282,"LGNLINES", false,-1, 31,0);
    tracep->declBus(c+4373,"NAUX", false,-1, 31,0);
    tracep->declBus(c+4334,"DATA_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4291,"OPT_LOCAL_BUS", false,-1, 0,0);
    tracep->declBus(c+4291,"OPT_PIPE", false,-1, 0,0);
    tracep->declBus(c+4291,"OPT_LOCK", false,-1, 0,0);
    tracep->declBus(c+4291,"OPT_DUAL_READ_PORT", false,-1, 0,0);
    tracep->declBus(c+4286,"OPT_FIFO_DEPTH", false,-1, 31,0);
    tracep->declBus(c+4289,"AW", false,-1, 31,0);
    tracep->declBus(c+4372,"CS", false,-1, 31,0);
    tracep->declBus(c+4282,"LS", false,-1, 31,0);
    tracep->declBus(c+4333,"OPT_LOWPOWER", false,-1, 0,0);
    tracep->declBus(c+4286,"DP", false,-1, 31,0);
    tracep->declBus(c+4372,"WBLSB", false,-1, 31,0);
    tracep->declBus(c+4336,"DC_IDLE", false,-1, 1,0);
    tracep->declBus(c+4337,"DC_WRITE", false,-1, 1,0);
    tracep->declBus(c+4338,"DC_READS", false,-1, 1,0);
    tracep->declBus(c+4339,"DC_READC", false,-1, 1,0);
    tracep->declBit(c+4176,"i_clk", false,-1);
    tracep->declBit(c+997,"i_reset", false,-1);
    ...
    tracep->declArray(c+1084,"i_wb_data", false,-1, 511,0);
    tracep->declBus(c+4377,"FIF_WIDTH", false,-1, 31,0);
    ...
    tracep->declBit(c+4453,"unused_aw", false,-1);
    tracep->popNamePrefix(1);
    ...
    tracep->declBit(c+4296,"unused_clk", false,-1);
    tracep->popNamePrefix(1);
    tracep->pushNamePrefix("PFCACHE ");
    tracep->pushNamePrefix("pf ");
    tracep->declBus(c+4372,"LGCACHELEN", false,-1, 31,0);
    tracep->declBus(c+4289,"ADDRESS_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4282,"LGLINES", false,-1, 31,0);
    tracep->declBus(c+4331,"BUS_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4333,"OPT_LITTLE_ENDIAN", false,-1, 0,0);
    tracep->declBus(c+4340,"CACHELEN", false,-1, 31,0);
    tracep->declBus(c+4372,"CW", false,-1, 31,0);
    tracep->declBus(c+4282,"LS", false,-1, 31,0);
    tracep->declBus(c+4331,"BUSW", false,-1, 31,0);
    tracep->declBus(c+4334,"INSN_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4372,"WBLSB", false,-1, 31,0);
    tracep->declBus(c+4289,"AW", false,-1, 31,0);
    tracep->declBit(c+4176,"i_clk", false,-1);
    ...
    tracep->declArray(c+1084,"i_wb_data", false,-1, 511,0);
    tracep->declBus(c+4284,"INLSB", false,-1, 31,0);
    ...
    tracep->declBit(c+4296,"i_b_cyc_b", false,-1);
    tracep->declBit(c+1787,"i_b_stb_a", false,-1);
    tracep->declBit(c+4296,"i_b_stb_b", false,-1);
    tracep->declBit(c+4296,"i_b_we", false,-1);
    tracep->declBus(c+1791,"i_b_adr", false,-1, 21,0);
    tracep->declArray(c+1066,"i_b_dat", false,-1, 511,0);
    tracep->declQuad(c+4314,"i_b_sel", false,-1, 63,0);
    ...
    tracep->declBus(c+4350,"ADDRESS_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4288,"RESET_ADDRESS", false,-1, 31,0);
    tracep->declBus(c+4282,"OPT_MPY", false,-1, 31,0);
    tracep->declBus(c+4291,"OPT_SHIFTS", false,-1, 0,0);
    tracep->declBus(c+4291,"OPT_DIV", false,-1, 0,0);
    ...
    tracep->declBit(c+997,"i_reset", false,-1);
    tracep->declBit(c+1101,"i_interrupt", false,-1);
    tracep->declBit(c+4297,"o_clken", false,-1);
    tracep->declBit(c+998,"i_halt", false,-1);
    tracep->declBit(c+1000,"i_clear_cache", false,-1);
    tracep->declBus(c+1003,"i_dbg_wreg", false,-1, 4,0);
    tracep->declBit(c+1001,"i_dbg_we", false,-1);
    ...
    tracep->declBus(c+4228,"o_prof_ticks", false,-1, 31,0);
    tracep->declBus(c+4291,"OPT_MEMPIPE", false,-1, 0,0);
    tracep->declBus(c+4454,"RESET_BUS_ADDRESS", false,-1, 25,0);
    tracep->declBus(c+4455,"CPU_CC_REG", false,-1, 3,0);
    tracep->declBus(c+4328,"CPU_PC_REG", false,-1, 3,0);
    tracep->declBus(c+4342,"CPU_SUB_OP", false,-1, 3,0);
    tracep->declBus(c+4343,"CPU_AND_OP", false,-1, 3,0);
    tracep->declBus(c+4411,"CPU_BREV_OP", false,-1, 3,0);
    tracep->declBus(c+4416,"CPU_MOV_OP", false,-1, 3,0);
    tracep->declBus(c+4452,"CPU_CLRDCACHE_BIT", false,-1, 31,0);
    tracep->declBus(c+4280,"CPU_CLRICACHE_BIT", false,-1, 31,0);
    tracep->declBus(c+4356,"CPU_PHASE_BIT", false,-1, 31,0);
    tracep->declBus(c+4377,"CPU_FPUERR_BIT", false,-1, 31,0);
    tracep->declBus(c+4376,"CPU_DIVERR_BIT", false,-1, 31,0);
    tracep->declBus(c+4281,"CPU_BUSERR_BIT", false,-1, 31,0);
    tracep->declBus(c+4375,"CPU_TRAP_BIT", false,-1, 31,0);
    tracep->declBus(c+4283,"CPU_ILL_BIT", false,-1, 31,0);
    tracep->declBus(c+4293,"CPU_BREAK_BIT", false,-1, 31,0);
    tracep->declBus(c+4372,"CPU_STEP_BIT", false,-1, 31,0);
    tracep->declBus(c+4373,"CPU_GIE_BIT", false,-1, 31,0);
    tracep->declBus(c+4286,"CPU_SLEEP_BIT", false,-1, 31,0);
    for (int i = 0; i < 32; ++i) {
    ...
    tracep->declBit(c+4296,"ifpu_err_flag", false,-1);
    tracep->declBit(c+4296,"ufpu_err_flag", false,-1);
    ...
    tracep->declBus(c+4251,"dcd_pc", false,-1, 27,0);
    ...
    tracep->declBit(c+4252,"dcd_F_stall", false,-1);
    ...
    tracep->declBit(c+4253,"dcd_sim", false,-1);
    tracep->declBus(c+4254,"dcd_sim_immv", false,-1, 22,0);
    ...
    tracep->declBit(c+4255,"op_valid", false,-1);
    ...
    tracep->declBit(c+4296,"op_lowpower_clear", false,-1);
    tracep->declBus(c+4456,"w_cpu_info", false,-1, 8,0);
    tracep->declBit(c+2223,"op_illegal", false,-1);
    tracep->declBit(c+2221,"op_break", false,-1);
    tracep->declBit(c+2224,"op_lock", false,-1);
    tracep->declBit(c+4256,"op_sim", false,-1);
    tracep->declBus(c+4257,"op_sim_immv", false,-1, 22,0);
    tracep->declBit(c+4258,"alu_sim", false,-1);
    tracep->declBus(c+4259,"alu_sim_immv", false,-1, 22,0);
    ...
    tracep->declBit(c+4260,"alu_ce", false,-1);
    ...
    tracep->declBit(c+4296,"fpu_ce", false,-1);
    tracep->declBit(c+4296,"fpu_error", false,-1);
    tracep->declBit(c+4296,"fpu_busy", false,-1);
    tracep->declBit(c+4296,"fpu_valid", false,-1);
    tracep->declBus(c+4295,"fpu_result", false,-1, 31,0);
    tracep->declBus(c+4342,"fpu_flags", false,-1, 3,0);
    ...
    tracep->declBit(c+4297,"w_clken", false,-1);
    ...
    tracep->declBus(c+4333,"OPT_SIM_DEBUG", false,-1, 0,0);
    tracep->declBit(c+4296,"unused", false,-1);
    ...
    tracep->declBus(c+4334,"BW", false,-1, 31,0);
    tracep->declBus(c+4373,"LGBW", false,-1, 31,0);
    tracep->declBus(c+4333,"OPT_LOWPOWER", false,-1, 0,0);
    tracep->declBit(c+4176,"i_clk", false,-1);
    ...
    tracep->declBit(c+4296,"unused_alu_stall", false,-1);
    tracep->popNamePrefix(1);
    tracep->pushNamePrefix("GEN_DISTRIBUTED_REGS ");
    tracep->declBit(c+4296,"unused_prereg_addrs", false,-1);
    tracep->popNamePrefix(1);
    ...
    tracep->declBit(c+4296,"generic_ignore", false,-1);
    tracep->popNamePrefix(1);
    ...
    tracep->declBit(c+4176,"i_clk", false,-1);
    tracep->declBit(c+2274,"i_reset", false,-1);
    tracep->declBit(c+4260,"i_stb", false,-1);
    ...
    tracep->declBus(c+4350,"ADDRESS_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4291,"OPT_MPY", false,-1, 0,0);
    tracep->declBus(c+4291,"OPT_SHIFTS", false,-1, 0,0);
    tracep->declBus(c+4291,"OPT_EARLY_BRANCHING", false,-1, 0,0);
    tracep->declBus(c+4291,"OPT_PIPELINED", false,-1, 0,0);
    tracep->declBus(c+4291,"OPT_DIVIDE", false,-1, 0,0);
    tracep->declBus(c+4333,"OPT_FPU", false,-1, 0,0);
    tracep->declBus(c+4291,"OPT_CIS", false,-1, 0,0);
    tracep->declBus(c+4291,"OPT_LOCK", false,-1, 0,0);
    tracep->declBus(c+4291,"OPT_OPIPE", false,-1, 0,0);
    tracep->declBus(c+4291,"OPT_SIM", false,-1, 0,0);
    tracep->declBus(c+4333,"OPT_SUPPRESS_NULL_BRANCHES", false,-1, 0,0);
    tracep->declBus(c+4291,"OPT_USERMODE", false,-1, 0,0);
    tracep->declBus(c+4333,"OPT_LOWPOWER", false,-1, 0,0);
    tracep->declBus(c+4350,"AW", false,-1, 31,0);
    tracep->declBit(c+4176,"i_clk", false,-1);
    ...
    tracep->declBus(c+4251,"o_pc", false,-1, 27,0);
    ...
    tracep->declBit(c+4253,"o_sim", false,-1);
    tracep->declBus(c+4254,"o_sim_immv", false,-1, 22,0);
    tracep->declBus(c+4416,"CPU_SP_REG", false,-1, 3,0);
    tracep->declBus(c+4455,"CPU_CC_REG", false,-1, 3,0);
    tracep->declBus(c+4328,"CPU_PC_REG", false,-1, 3,0);
    tracep->declBus(c+4422,"CISBIT", false,-1, 31,0);
    tracep->declBus(c+4352,"CISIMMSEL", false,-1, 31,0);
    tracep->declBus(c+4353,"IMMSEL", false,-1, 31,0);
    ...
    tracep->declBit(c+4296,"illegal_shift", false,-1);
    tracep->declBit(c+4296,"possibly_unused", false,-1);
    ...
    tracep->declBus(c+4334,"BW", false,-1, 31,0);
    tracep->declBus(c+4422,"VW", false,-1, 31,0);
    tracep->declBus(c+4291,"RELOADABLE", false,-1, 0,0);
    tracep->declBit(c+4176,"i_clk", false,-1);
    tracep->declBit(c+997,"i_reset", false,-1);
    tracep->declBit(c+1137,"i_ce", false,-1);
    tracep->declBit(c+961,"i_wb_cyc", false,-1);
    ...
    tracep->declBus(c+4280,"BW", false,-1, 31,0);
    tracep->declBit(c+4176,"i_clk", false,-1);
    tracep->declBit(c+2411,"i_reset", false,-1);
    tracep->declBus(c+4457,"i_timeout", false,-1, 13,0);
    ...
    tracep->declBus(c+4334,"BW", false,-1, 31,0);
    tracep->declBus(c+4422,"VW", false,-1, 31,0);
    tracep->declBus(c+4333,"RELOADABLE", false,-1, 0,0);
    tracep->declBit(c+4176,"i_clk", false,-1);
    tracep->declBit(c+997,"i_reset", false,-1);
    tracep->declBit(c+1137,"i_ce", false,-1);
    tracep->declBit(c+961,"i_wb_cyc", false,-1);
    ...
    tracep->declBit(c+4296,"auto_reload", false,-1);
    tracep->declBus(c+4458,"interval_count", false,-1, 30,0);
    tracep->declBit(c+4296,"unused", false,-1);
    tracep->popNamePrefix(2);
    tracep->pushNamePrefix("txv ");
    tracep->declBus(c+4459,"TIMING_BITS", false,-1, 4,0);
    tracep->declBus(c+4459,"TB", false,-1, 4,0);
    tracep->declBus(c+4425,"CLOCKS_PER_BAUD", false,-1, 6,0);
    tracep->declBit(c+4176,"i_clk", false,-1);
    tracep->declBit(c+173,"i_wr", false,-1);
    tracep->declBus(c+171,"i_data", false,-1, 7,0);
    tracep->declBit(c+4231,"o_uart_tx", false,-1);
    tracep->declBit(c+174,"o_busy", false,-1);
    tracep->declBus(c+4342,"TXUL_BIT_ZERO", false,-1, 3,0);
    tracep->declBus(c+4411,"TXUL_STOP", false,-1, 3,0);
    tracep->declBus(c+4328,"TXUL_IDLE", false,-1, 3,0);
    ...
    tracep->declBit(c+4176,"i_clk", false,-1);
    tracep->declBit(c+4177,"i_reset", false,-1);
    tracep->declBit(c+3918,"i_wb_cyc", false,-1);
    tracep->declBit(c+3919,"i_wb_stb", false,-1);
    tracep->declBit(c+3920,"i_wb_we", false,-1);
    tracep->declBus(c+3980,"i_wb_addr", false,-1, 2,0);
    tracep->declBus(c+3922,"i_wb_data", false,-1, 31,0);
    tracep->declBus(c+3923,"i_wb_sel", false,-1, 3,0);
    tracep->declBit(c+4296,"o_wb_stall", false,-1);
    tracep->declBit(c+423,"o_wb_ack", false,-1);
    tracep->declBus(c+424,"o_wb_data", false,-1, 31,0);
    tracep->declBit(c+4207,"i_temp_sda", false,-1);
    tracep->declBit(c+4208,"i_temp_scl", false,-1);
    tracep->declBit(c+4209,"o_temp_sda", false,-1);
    tracep->declBit(c+4210,"o_temp_scl", false,-1);
    tracep->declBit(c+4211,"o_fpga_pwm", false,-1);
    tracep->declBit(c+4212,"o_sys_pwm", false,-1);
    tracep->declBit(c+4213,"i_fan_tach", false,-1);
    tracep->declBus(c+4242,"temp_debug", false,-1, 31,0);
    tracep->declBus(c+4460,"CK_PER_SECOND", false,-1, 31,0);
    tracep->declBus(c+4461,"CK_PER_MS", false,-1, 31,0);
    tracep->declBus(c+4462,"PWM_HZ", false,-1, 31,0);
    tracep->declBus(c+4463,"MAX_PWM", false,-1, 31,0);
    tracep->declBus(c+4356,"LGPWM", false,-1, 31,0);
    ...
    tracep->declBit(c+4296,"i2c_wb_stall", false,-1);
    ...
    tracep->declBit(c+4296,"ign_mem_we", false,-1);
    tracep->declBit(c+4291,"ign_mem_sel", false,-1);
    tracep->declBus(c+2436,"mem_addr", false,-1, 4,0);
    tracep->declBus(c+4332,"ign_mem_data", false,-1, 7,0);
    ...
    tracep->declBit(c+4296,"ign_i2cd_id", false,-1);
    ...
    tracep->declBus(c+4283,"DATA_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4283,"I2C_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4295,"AXIS_ID_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4333,"DEF_CHANNEL", false,-1, 0,0);
    tracep->declBus(c+4373,"AW", false,-1, 31,0);
    tracep->declBus(c+4283,"DW", false,-1, 31,0);
    tracep->declBus(c+4283,"RW", false,-1, 31,0);
    tracep->declBus(c+4373,"BAW", false,-1, 31,0);
    tracep->declBus(c+4399,"RESET_ADDRESS", false,-1, 4,0);
    tracep->declBus(c+4333,"OPT_START_HALTED", false,-1, 0,0);
    tracep->declBus(c+4291,"OPT_MANUAL", false,-1, 0,0);
    tracep->declBus(c+4295,"OPT_WATCHDOG", false,-1, 31,0);
    tracep->declBus(c+4464,"DEF_CKCOUNT", false,-1, 11,0);
    tracep->declBus(c+4333,"OPT_LOWPOWER", false,-1, 0,0);
    tracep->declBit(c+4176,"i_clk", false,-1);
    tracep->declBit(c+4177,"i_reset", false,-1);
    tracep->declBit(c+3918,"i_wb_cyc", false,-1);
    tracep->declBit(c+3981,"i_wb_stb", false,-1);
    tracep->declBit(c+3920,"i_wb_we", false,-1);
    tracep->declBus(c+3982,"i_wb_addr", false,-1, 1,0);
    tracep->declBus(c+3922,"i_wb_data", false,-1, 31,0);
    tracep->declBus(c+3923,"i_wb_sel", false,-1, 3,0);
    tracep->declBit(c+4296,"o_wb_stall", false,-1);
    ...
    tracep->declBus(c+4332,"o_pf_data", false,-1, 7,0);
    tracep->declBus(c+4291,"o_pf_sel", false,-1, 0,0);
    tracep->declBit(c+4296,"i_pf_stall", false,-1);
    tracep->declBit(c+2438,"i_pf_ack", false,-1);
    tracep->declBit(c+4296,"i_pf_err", false,-1);
    tracep->declBus(c+2437,"i_pf_data", false,-1, 7,0);
    tracep->declBit(c+4207,"i_i2c_sda", false,-1);
    tracep->declBit(c+4208,"i_i2c_scl", false,-1);
    tracep->declBit(c+4209,"o_i2c_sda", false,-1);
    tracep->declBit(c+4210,"o_i2c_scl", false,-1);
    tracep->declBit(c+2439,"M_AXIS_TVALID", false,-1);
    tracep->declBit(c+4297,"M_AXIS_TREADY", false,-1);
    tracep->declBus(c+2441,"M_AXIS_TDATA", false,-1, 7,0);
    tracep->declBit(c+2440,"M_AXIS_TLAST", false,-1);
    tracep->declBus(c+4296,"M_AXIS_TID", false,-1, 0,0);
    tracep->declBit(c+2442,"i_sync_signal", false,-1);
    tracep->declBus(c+4242,"o_debug", false,-1, 31,0);
    tracep->declBus(c+4336,"ADR_CONTROL", false,-1, 1,0);
    tracep->declBus(c+4337,"ADR_OVERRIDE", false,-1, 1,0);
    tracep->declBus(c+4338,"ADR_ADDRESS", false,-1, 1,0);
    tracep->declBus(c+4339,"ADR_CKCOUNT", false,-1, 1,0);
    ...
    tracep->declBit(c+3983,"next_valid", false,-1);
    tracep->declBus(c+3984,"next_insn", false,-1, 7,0);
    ...
    tracep->declBit(c+3985,"bus_read", false,-1);
    tracep->declBit(c+3986,"bus_write", false,-1);
    tracep->declBit(c+3987,"bus_override", false,-1);
    tracep->declBit(c+3988,"bus_manual", false,-1);
    tracep->declBit(c+2480,"ovw_ready", false,-1);
    tracep->declBit(c+3989,"bus_jump", false,-1);
    tracep->declBus(c+3982,"bus_write_addr", false,-1, 1,0);
    tracep->declBus(c+3982,"bus_read_addr", false,-1, 1,0);
    tracep->declBus(c+3922,"bus_write_data", false,-1, 31,0);
    tracep->declBus(c+3923,"bus_write_strb", false,-1, 3,0);
    ...
    tracep->declBus(c+4261,"w_control", false,-1, 31,0);
    tracep->declBit(c+4296,"unused", false,-1);
    tracep->pushNamePrefix("GEN_MANUAL ");
    ...
    tracep->declBit(c+4208,"i_scl", false,-1);
    tracep->declBit(c+4207,"i_sda", false,-1);
    ...
    tracep->declBus(c+4332,"o_wb_data", false,-1, 7,0);
    tracep->declBit(c+4296,"i_wb_stall", false,-1);
    tracep->declBit(c+2438,"i_wb_ack", false,-1);
    tracep->declBit(c+4296,"i_wb_err", false,-1);
    ...
    tracep->declBit(c+4296,"r_valid", false,-1);
    tracep->declBus(c+4332,"r_insn", false,-1, 7,0);
    tracep->declBus(c+2437,"i_wb_shifted", false,-1, 7,0);
    tracep->popNamePrefix(3);
    tracep->pushNamePrefix("u_i2cdma ");
    tracep->declBus(c+4289,"AW", false,-1, 31,0);
    tracep->declBus(c+4331,"DW", false,-1, 31,0);
    tracep->declBus(c+4283,"SW", false,-1, 31,0);
    tracep->declBus(c+4333,"OPT_LITTLE_ENDIAN", false,-1, 0,0);
    tracep->declBus(c+4333,"OPT_LOWPOWER", false,-1, 0,0);
    tracep->declBit(c+4176,"i_clk", false,-1);
    tracep->declBit(c+4177,"i_reset", false,-1);
    tracep->declBit(c+3906,"i_wb_cyc", false,-1);
    tracep->declBit(c+3907,"i_wb_stb", false,-1);
    tracep->declBit(c+3908,"i_wb_we", false,-1);
    tracep->declBus(c+3990,"i_wb_addr", false,-1, 1,0);
    tracep->declBus(c+3910,"i_wb_data", false,-1, 31,0);
    tracep->declBus(c+3911,"i_wb_sel", false,-1, 3,0);
    tracep->declBit(c+4296,"o_wb_stall", false,-1);
    ...
    tracep->declBit(c+4297,"o_dma_we", false,-1);
    ...
    tracep->declBus(c+4295,"SUBLSB", false,-1, 31,0);
    tracep->declBus(c+4372,"WBLSB", false,-1, 31,0);
    tracep->declBus(c+4408,"ADDRESS_WIDTH", false,-1, 31,0);
    ...
    tracep->declBus(c+3991,"next_baseaddr", false,-1, 31,0);
    tracep->declBus(c+3992,"next_memlen", false,-1, 31,0);
    ...
    tracep->declBus(c+4333,"OPT_LOWPOWER", false,-1, 0,0);
    tracep->declBus(c+4291,"OPT_OUTREG", false,-1, 0,0);
    tracep->declBus(c+4333,"OPT_PASSTHROUGH", false,-1, 0,0);
    tracep->declBus(c+4375,"DW", false,-1, 31,0);
    tracep->declBus(c+4291,"OPT_INITIAL", false,-1, 0,0);
    tracep->declBit(c+4176,"i_clk", false,-1);
    tracep->declBit(c+4177,"i_reset", false,-1);
    ...
    tracep->declBus(c+4349,"ADDRESS_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4331,"WIDE_DW", false,-1, 31,0);
    tracep->declBus(c+4334,"SMALL_DW", false,-1, 31,0);
    tracep->declBus(c+4333,"OPT_LITTLE_ENDIAN", false,-1, 0,0);
    tracep->declBus(c+4333,"OPT_LOWPOWER", false,-1, 0,0);
    tracep->declBus(c+4333,"OPT_LOWLOGIC", false,-1, 0,0);
    tracep->declBus(c+4354,"WIDE_AW", false,-1, 31,0);
    tracep->declBus(c+4351,"SMALL_AW", false,-1, 31,0);
    tracep->declBit(c+4176,"i_clk", false,-1);
    tracep->declBit(c+4177,"i_reset", false,-1);
    tracep->declBit(c+3862,"i_wcyc", false,-1);
    tracep->declBit(c+3863,"i_wstb", false,-1);
    ...
    tracep->declBit(c+3864,"o_werr", false,-1);
    tracep->declBit(c+3865,"o_scyc", false,-1);
    ...
    tracep->declBit(c+3866,"i_serr", false,-1);
    tracep->declBus(c+4286,"WBLSB", false,-1, 31,0);
    tracep->pushNamePrefix("DOWNSIZE ");
    tracep->declBus(c+4373,"LGFIFO", false,-1, 31,0);
    tracep->declBit(c+3865,"r_cyc", false,-1);
    tracep->declBit(c+2524,"r_stb", false,-1);
    tracep->declBit(c+399,"r_we", false,-1);
    tracep->declBit(c+381,"r_ack", false,-1);
    tracep->declBit(c+3864,"r_err", false,-1);
    ...
    tracep->declBit(c+4296,"unused", false,-1);
    tracep->pushNamePrefix("DOWNSIZE ");
    tracep->declBus(c+4465,"subaddr_fn__Vstatic__fnk", false,-1, 31,0);
    tracep->declBus(c+2571,"subaddr_fn__Vstatic__fm", false,-1, 31,0);
    tracep->popNamePrefix(1);
    tracep->pushNamePrefix("u_fifo ");
    tracep->declBus(c+4373,"BW", false,-1, 31,0);
    tracep->declBus(c+4373,"LGFLEN", false,-1, 31,0);
    tracep->declBus(c+4291,"OPT_ASYNC_READ", false,-1, 0,0);
    tracep->declBus(c+4291,"OPT_WRITE_ON_FULL", false,-1, 0,0);
    tracep->declBus(c+4291,"OPT_READ_ON_EMPTY", false,-1, 0,0);
    tracep->declBit(c+4176,"i_clk", false,-1);
    ...
    tracep->declBus(c+4334,"FLEN", false,-1, 31,0);
    ...
    tracep->declBus(c+4285,"NM", false,-1, 31,0);
    tracep->declBus(c+4377,"NS", false,-1, 31,0);
    tracep->declBus(c+4351,"AW", false,-1, 31,0);
    tracep->declBus(c+4334,"DW", false,-1, 31,0);
    tracep->declArray(c+4466,"SLAVE_ADDR", false,-1, 299,0);
    tracep->declArray(c+4476,"SLAVE_MASK", false,-1, 299,0);
    tracep->declBus(c+4372,"LGMAXBURST", false,-1, 31,0);
    tracep->declBus(c+4295,"OPT_TIMEOUT", false,-1, 31,0);
    tracep->declBus(c+4333,"OPT_STARVATION_TIMEOUT", false,-1, 0,0);
    tracep->declBus(c+4291,"OPT_DBLBUFFER", false,-1, 0,0);
    tracep->declBus(c+4291,"OPT_LOWPOWER", false,-1, 0,0);
    tracep->declBit(c+4176,"i_clk", false,-1);
    tracep->declBit(c+4177,"i_reset", false,-1);
    tracep->declBus(c+3865,"i_mcyc", false,-1, 0,0);
    ...
    tracep->declBus(c+3866,"o_merr", false,-1, 0,0);
    tracep->declBus(c+3993,"o_scyc", false,-1, 11,0);
    tracep->declBus(c+3994,"o_sstb", false,-1, 11,0);
    tracep->declBus(c+3995,"o_swe", false,-1, 11,0);
    tracep->declArray(c+3996,"o_saddr", false,-1, 299,0);
    tracep->declArray(c+4006,"o_sdata", false,-1, 383,0);
    tracep->declQuad(c+4018,"o_ssel", false,-1, 47,0);
    tracep->declBus(c+3859,"i_sstall", false,-1, 11,0);
    tracep->declBus(c+3632,"i_sack", false,-1, 11,0);
    tracep->declArray(c+3633,"i_sdata", false,-1, 383,0);
    tracep->declBus(c+4486,"i_serr", false,-1, 11,0);
    tracep->declBus(c+4295,"TIMEOUT_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4285,"LGNM", false,-1, 31,0);
    tracep->declBus(c+4286,"LGNS", false,-1, 31,0);
    for (int i = 0; i < 1; ++i) {
        tracep->declBus(c+4020+i*1,"request", true,(i+0), 12,0);
    }
    for (int i = 0; i < 1; ++i) {
    ...
    tracep->declBus(c+4021,"sgrant", false,-1, 11,0);
    for (int i = 0; i < 1; ++i) {
    ...
    tracep->declBus(c+4333,"timed_out", false,-1, 0,0);
    tracep->declBus(c+4285,"NMFULL", false,-1, 31,0);
    tracep->declBus(c+4290,"NSFULL", false,-1, 31,0);
    for (int i = 0; i < 1; ++i) {
        tracep->declBus(c+4022+i*1,"mindex", true,(i+0), 3,0);
    }
    for (int i = 0; i < 16; ++i) {
        tracep->declBus(c+8+i*1,"sindex", true,(i+0), 0,0);
    }
    tracep->declBus(c+3865,"m_cyc", false,-1, 0,0);
    tracep->declBus(c+4023,"m_stb", false,-1, 0,0);
    tracep->declBus(c+4024,"m_we", false,-1, 0,0);
    for (int i = 0; i < 1; ++i) {
        tracep->declBus(c+4025+i*1,"m_addr", true,(i+0), 24,0);
    }
    for (int i = 0; i < 1; ++i) {
        tracep->declBus(c+4026+i*1,"m_data", true,(i+0), 31,0);
    }
    for (int i = 0; i < 1; ++i) {
        tracep->declBus(c+4027+i*1,"m_sel", true,(i+0), 3,0);
    }
    tracep->declBus(c+4171,"m_stall", false,-1, 0,0);
    tracep->declBus(c+4172,"s_stall", false,-1, 15,0);
    for (int i = 0; i < 16; ++i) {
        tracep->declBus(c+3645+i*1,"s_data", true,(i+0), 31,0);
    }
    tracep->declBus(c+4262,"s_ack", false,-1, 15,0);
    tracep->declBus(c+4487,"s_err", false,-1, 15,0);
    tracep->declBus(c+4028,"dcd_stb", false,-1, 0,0);
    tracep->declBus(c+4291,"OPT_BUFFER_DECODER", false,-1, 0,0);
    tracep->declBus(c+2619,"iN", false,-1, 31,0);
    tracep->declBus(c+4263,"iM", false,-1, 31,0);
    tracep->pushNamePrefix("ARBITRATE_REQUESTS[0] ");
    tracep->declBus(c+4029,"regrant", false,-1, 12,0);
    tracep->declBus(c+4264,"reindex", false,-1, 3,0);
    tracep->declBit(c+4030,"stay_on_channel", false,-1);
    tracep->declBit(c+4031,"requested_channel_is_available", false,-1);
    tracep->pushNamePrefix("MINDEX_MULTIPLE_SLAVES ");
    tracep->declBus(c+4032,"r_mindex", false,-1, 3,0);
    tracep->declBus(c+4029,"r_regrant", false,-1, 12,0);
    tracep->declBus(c+4264,"r_reindex", false,-1, 3,0);
    tracep->popNamePrefix(2);
    ...
    tracep->declBit(c+4173,"skd_stall", false,-1);
    tracep->declBit(c+4033,"skd_we", false,-1);
    tracep->declBus(c+4034,"skd_addr", false,-1, 24,0);
    tracep->declBus(c+4035,"skd_data", false,-1, 31,0);
    tracep->declBus(c+4036,"skd_sel", false,-1, 3,0);
    tracep->declBus(c+2621,"decoded", false,-1, 12,0);
    tracep->declBit(c+2622,"iskd_ready", false,-1);
    tracep->pushNamePrefix("adcd ");
    tracep->declBus(c+4377,"NS", false,-1, 31,0);
    tracep->declBus(c+4351,"AW", false,-1, 31,0);
    tracep->declBus(c+4488,"DW", false,-1, 31,0);
    tracep->declArray(c+4466,"SLAVE_ADDR", false,-1, 299,0);
    tracep->declArray(c+4476,"SLAVE_MASK", false,-1, 299,0);
    tracep->declBus(c+4410,"ACCESS_ALLOWED", false,-1, 11,0);
    tracep->declBus(c+4291,"OPT_REGISTERED", false,-1, 0,0);
    tracep->declBus(c+4333,"OPT_LOWPOWER", false,-1, 0,0);
    tracep->declBit(c+4176,"i_clk", false,-1);
    tracep->declBit(c+4177,"i_reset", false,-1);
    tracep->declBit(c+116,"i_valid", false,-1);
    tracep->declBit(c+4173,"o_stall", false,-1);
    tracep->declBus(c+4034,"i_addr", false,-1, 24,0);
    tracep->declQuad(c+4037,"i_data", false,-1, 36,0);
    tracep->declBit(c+4028,"o_valid", false,-1);
    tracep->declBit(c+4174,"i_stall", false,-1);
    tracep->declBus(c+2621,"o_decode", false,-1, 12,0);
    tracep->declBus(c+2623,"o_addr", false,-1, 24,0);
    tracep->declQuad(c+4039,"o_data", false,-1, 36,0);
    tracep->declBus(c+4291,"OPT_NONESEL", false,-1, 0,0);
    tracep->declBus(c+117,"request", false,-1, 12,0);
    tracep->declBus(c+4041,"prerequest", false,-1, 11,0);
    ...
    tracep->declBus(c+4333,"OPT_LOWPOWER", false,-1, 0,0);
    tracep->declBus(c+4333,"OPT_OUTREG", false,-1, 0,0);
    tracep->declBus(c+4333,"OPT_PASSTHROUGH", false,-1, 0,0);
    tracep->declBus(c+4489,"DW", false,-1, 31,0);
    tracep->declBus(c+4291,"OPT_INITIAL", false,-1, 0,0);
    tracep->declBit(c+4176,"i_clk", false,-1);
    ...
    tracep->declBit(c+4175,"i_ready", false,-1);
    tracep->declQuad(c+4042,"o_data", false,-1, 61,0);
    ...
    tracep->declBus(c+3866,"r_merr", false,-1, 0,0);
    tracep->popNamePrefix(1);
    ...
    tracep->declBit(c+4296,"unused", false,-1);
    tracep->pushNamePrefix("u_fifo ");
    tracep->declBus(c+4286,"BW", false,-1, 31,0);
    tracep->declBus(c+4373,"LGFLEN", false,-1, 31,0);
    tracep->declBus(c+4291,"OPT_ASYNC_READ", false,-1, 0,0);
    tracep->declBus(c+4333,"OPT_WRITE_ON_FULL", false,-1, 0,0);
    tracep->declBus(c+4333,"OPT_READ_ON_EMPTY", false,-1, 0,0);
    ...
    tracep->declBus(c+4285,"NM", false,-1, 31,0);
    tracep->declBus(c+4284,"NS", false,-1, 31,0);
    tracep->declBus(c+4349,"AW", false,-1, 31,0);
    tracep->declBus(c+4334,"DW", false,-1, 31,0);
    tracep->declQuad(c+4490,"SLAVE_ADDR", false,-1, 53,0);
    tracep->declQuad(c+4492,"SLAVE_MASK", false,-1, 53,0);
    tracep->declBus(c+4372,"LGMAXBURST", false,-1, 31,0);
    tracep->declBus(c+4295,"OPT_TIMEOUT", false,-1, 31,0);
    tracep->declBus(c+4333,"OPT_STARVATION_TIMEOUT", false,-1, 0,0);
    tracep->declBus(c+4291,"OPT_DBLBUFFER", false,-1, 0,0);
    ...
    tracep->declBus(c+4328,"i_msel", false,-1, 3,0);
    ...
    tracep->declBus(c+4265,"i_sstall", false,-1, 1,0);
    tracep->declBus(c+4266,"i_sack", false,-1, 1,0);
    tracep->declQuad(c+2715,"i_sdata", false,-1, 63,0);
    tracep->declBus(c+2717,"i_serr", false,-1, 1,0);
    tracep->declBus(c+4295,"TIMEOUT_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4285,"LGNM", false,-1, 31,0);
    tracep->declBus(c+4284,"LGNS", false,-1, 31,0);
    for (int i = 0; i < 1; ++i) {
    ...
    tracep->declBus(c+4333,"timed_out", false,-1, 0,0);
    tracep->declBus(c+4285,"NMFULL", false,-1, 31,0);
    tracep->declBus(c+4286,"NSFULL", false,-1, 31,0);
    for (int i = 0; i < 1; ++i) {
        tracep->declBus(c+4044+i*1,"mindex", true,(i+0), 1,0);
    }
    for (int i = 0; i < 4; ++i) {
    ...
    tracep->declBus(c+4267,"s_ack", false,-1, 3,0);
    tracep->declBus(c+2735,"s_err", false,-1, 3,0);
    tracep->declBus(c+2736,"dcd_stb", false,-1, 0,0);
    tracep->declBus(c+4291,"OPT_BUFFER_DECODER", false,-1, 0,0);
    tracep->declBus(c+2737,"iN", false,-1, 31,0);
    tracep->declBus(c+4268,"iM", false,-1, 31,0);
    tracep->pushNamePrefix("ARBITRATE_REQUESTS[0] ");
    tracep->declBus(c+4045,"regrant", false,-1, 2,0);
    tracep->declBus(c+4269,"reindex", false,-1, 1,0);
    tracep->declBit(c+2738,"stay_on_channel", false,-1);
    tracep->declBit(c+2739,"requested_channel_is_available", false,-1);
    tracep->pushNamePrefix("MINDEX_MULTIPLE_SLAVES ");
    tracep->declBus(c+4046,"r_mindex", false,-1, 1,0);
    tracep->declBus(c+4045,"r_regrant", false,-1, 2,0);
    tracep->declBus(c+4269,"r_reindex", false,-1, 1,0);
    tracep->popNamePrefix(2);
    tracep->pushNamePrefix("COUNT_PENDING_TRANSACTIONS[0] ");
    ...
    tracep->declQuad(c+4490,"SLAVE_ADDR", false,-1, 53,0);
    tracep->declQuad(c+4492,"SLAVE_MASK", false,-1, 53,0);
    tracep->declBus(c+4339,"ACCESS_ALLOWED", false,-1, 1,0);
    tracep->declBus(c+4291,"OPT_REGISTERED", false,-1, 0,0);
    tracep->declBus(c+4333,"OPT_LOWPOWER", false,-1, 0,0);
    tracep->declBit(c+4176,"i_clk", false,-1);
    tracep->declBit(c+4177,"i_reset", false,-1);
    ...
    tracep->declBus(c+4286,"NM", false,-1, 31,0);
    tracep->declBus(c+4284,"NS", false,-1, 31,0);
    tracep->declBus(c+4289,"AW", false,-1, 31,0);
    tracep->declBus(c+4331,"DW", false,-1, 31,0);
    tracep->declQuad(c+4494,"SLAVE_ADDR", false,-1, 43,0);
    tracep->declQuad(c+4496,"SLAVE_MASK", false,-1, 43,0);
    tracep->declBus(c+4372,"LGMAXBURST", false,-1, 31,0);
    tracep->declBus(c+4295,"OPT_TIMEOUT", false,-1, 31,0);
    tracep->declBus(c+4333,"OPT_STARVATION_TIMEOUT", false,-1, 0,0);
    tracep->declBus(c+4291,"OPT_DBLBUFFER", false,-1, 0,0);
    ...
    tracep->declBit(c+4176,"i_clk", false,-1);
    tracep->declBit(c+4177,"i_reset", false,-1);
    tracep->declBus(c+4047,"i_mcyc", false,-1, 3,0);
    ...
    tracep->declBus(c+4048,"o_scyc", false,-1, 1,0);
    tracep->declBus(c+4049,"o_sstb", false,-1, 1,0);
    ...
    tracep->declBus(c+4050,"i_serr", false,-1, 1,0);
    tracep->declBus(c+4295,"TIMEOUT_WIDTH", false,-1, 31,0);
    tracep->declBus(c+4284,"LGNM", false,-1, 31,0);
    tracep->declBus(c+4284,"LGNS", false,-1, 31,0);
    for (int i = 0; i < 4; ++i) {
    ...
    tracep->declBus(c+4051,"sgrant", false,-1, 1,0);
    for (int i = 0; i < 4; ++i) {
    ...
    tracep->declBus(c+4342,"timed_out", false,-1, 3,0);
    tracep->declBus(c+4286,"NMFULL", false,-1, 31,0);
    tracep->declBus(c+4286,"NSFULL", false,-1, 31,0);
    for (int i = 0; i < 4; ++i) {
        tracep->declBus(c+4052+i*1,"mindex", true,(i+0), 1,0);
    }
    for (int i = 0; i < 4; ++i) {
        tracep->declBus(c+4056+i*1,"sindex", true,(i+0), 1,0);
    }
    tracep->declBus(c+4047,"m_cyc", false,-1, 3,0);
    ...
    tracep->declBus(c+4060,"m_stall", false,-1, 3,0);
    tracep->declBus(c+4061,"s_stall", false,-1, 3,0);
    for (int i = 0; i < 4; ++i) {
        tracep->declArray(c+3074+i*16,"s_data", true,(i+0), 511,0);
    }
    tracep->declBus(c+4062,"s_ack", false,-1, 3,0);
    tracep->declBus(c+4063,"s_err", false,-1, 3,0);
    tracep->declBus(c+3138,"dcd_stb", false,-1, 3,0);
    tracep->declBus(c+4291,"OPT_BUFFER_DECODER", false,-1, 0,0);
    tracep->declBus(c+4270,"iN", false,-1, 31,0);
    tracep->declBus(c+4271,"iM", false,-1, 31,0);
    tracep->pushNamePrefix("ARBITRATE_REQUESTS[0] ");
    tracep->declBus(c+4064,"regrant", false,-1, 2,0);
    tracep->declBus(c+4272,"reindex", false,-1, 1,0);
    tracep->declBit(c+3139,"stay_on_channel", false,-1);
    tracep->declBit(c+4065,"requested_channel_is_available", false,-1);
    tracep->pushNamePrefix("MINDEX_MULTIPLE_SLAVES ");
    tracep->declBus(c+4066,"r_mindex", false,-1, 1,0);
    tracep->declBus(c+4064,"r_regrant", false,-1, 2,0);
    tracep->declBus(c+4272,"r_reindex", false,-1, 1,0);
    tracep->popNamePrefix(2);
    tracep->pushNamePrefix("ARBITRATE_REQUESTS[1] ");
    tracep->declBus(c+4067,"regrant", false,-1, 2,0);
    tracep->declBus(c+4273,"reindex", false,-1, 1,0);
    tracep->declBit(c+3140,"stay_on_channel", false,-1);
    tracep->declBit(c+4068,"requested_channel_is_available", false,-1);
    tracep->pushNamePrefix("MINDEX_MULTIPLE_SLAVES ");
    tracep->declBus(c+4069,"r_mindex", false,-1, 1,0);
    tracep->declBus(c+4067,"r_regrant", false,-1, 2,0);
    tracep->declBus(c+4273,"r_reindex", false,-1, 1,0);
    tracep->popNamePrefix(2);
    tracep->pushNamePrefix("ARBITRATE_REQUESTS[2] ");
    tracep->declBus(c+4070,"regrant", false,-1, 2,0);
    tracep->declBus(c+4274,"reindex", false,-1, 1,0);
    tracep->declBit(c+3141,"stay_on_channel", false,-1);
    tracep->declBit(c+4071,"requested_channel_is_available", false,-1);
    tracep->pushNamePrefix("MINDEX_MULTIPLE_SLAVES ");
    tracep->declBus(c+4072,"r_mindex", false,-1, 1,0);
    tracep->declBus(c+4070,"r_regrant", false,-1, 2,0);
    tracep->declBus(c+4274,"r_reindex", false,-1, 1,0);
    tracep->popNamePrefix(2);
    tracep->pushNamePrefix("ARBITRATE_REQUESTS[3] ");
    tracep->declBus(c+4073,"regrant", false,-1, 2,0);
    tracep->declBus(c+4275,"reindex", false,-1, 1,0);
    tracep->declBit(c+3142,"stay_on_channel", false,-1);
    tracep->declBit(c+4074,"requested_channel_is_available", false,-1);
    tracep->pushNamePrefix("MINDEX_MULTIPLE_SLAVES ");
    tracep->declBus(c+4075,"r_mindex", false,-1, 1,0);
    tracep->declBus(c+4073,"r_regrant", false,-1, 2,0);
    ...
    tracep->declBit(c+4076,"skd_stall", false,-1);
    ...
    tracep->declBus(c+4284,"NS", false,-1, 31,0);
    tracep->declBus(c+4289,"AW", false,-1, 31,0);
    tracep->declBus(c+4498,"DW", false,-1, 31,0);
    tracep->declQuad(c+4494,"SLAVE_ADDR", false,-1, 43,0);
    tracep->declQuad(c+4496,"SLAVE_MASK", false,-1, 43,0);
    tracep->declBus(c+4339,"ACCESS_ALLOWED", false,-1, 1,0);
    tracep->declBus(c+4291,"OPT_REGISTERED", false,-1, 0,0);
    ...
    tracep->declBit(c+4076,"o_stall", false,-1);
    ...
    tracep->declBit(c+4077,"i_stall", false,-1);
    ...
    tracep->declBus(c+4333,"OPT_OUTREG", false,-1, 0,0);
    tracep->declBus(c+4333,"OPT_PASSTHROUGH", false,-1, 0,0);
    tracep->declBus(c+4499,"DW", false,-1, 31,0);
    tracep->declBus(c+4291,"OPT_INITIAL", false,-1, 0,0);
    tracep->declBit(c+4176,"i_clk", false,-1);
    ...
    tracep->declBit(c+4078,"i_ready", false,-1);
    ...
    tracep->declBit(c+4079,"skd_stall", false,-1);
    ...
    tracep->declBit(c+4079,"o_stall", false,-1);
    ...
    tracep->declBit(c+4080,"i_stall", false,-1);
    ...
    tracep->declBit(c+4081,"i_ready", false,-1);
    ...
    tracep->declBit(c+4082,"skd_stall", false,-1);
    ...
    tracep->declBit(c+4082,"o_stall", false,-1);
    ...
    tracep->declBit(c+4083,"i_stall", false,-1);
    ...
    tracep->declBit(c+4084,"i_ready", false,-1);
    ...
    tracep->declBit(c+4085,"skd_stall", false,-1);
    ...
    tracep->declBit(c+4085,"o_stall", false,-1);
    ...
    tracep->declBit(c+4086,"i_stall", false,-1);
    ...
    tracep->declBit(c+4087,"i_ready", false,-1);
    ...
    tracep->declBus(c+4088,"regrant", false,-1, 3,0);
    tracep->declBus(c+4089,"reindex", false,-1, 1,0);
    tracep->popNamePrefix(2);
    tracep->pushNamePrefix("GEN_SINDEX[1] ");
    tracep->pushNamePrefix("SINDEX_MORE_THAN_ONE_MASTER ");
    tracep->declBus(c+3631,"r_sindex", false,-1, 1,0);
    tracep->declBus(c+4090,"regrant", false,-1, 3,0);
    tracep->declBus(c+4091,"reindex", false,-1, 1,0);
    tracep->popNamePrefix(2);
    tracep->pushNamePrefix("SLAVE_GRANT[0] ");
...
VL_ATTR_COLD void Vmain___024root__trace_full_sub_0(Vmain___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullWData(oldp+3686,(vlSelf->main__DOT__ddr3_controller_inst__DOT__stage1_data),128);
    bufp->fullSData(oldp+3690,(vlSelf->main__DOT__ddr3_controller_inst__DOT__stage1_dm),16);
    bufp->fullSData(oldp+3691,(vlSelf->main__DOT__ddr3_controller_inst__DOT__stage1_col),10);
    bufp->fullCData(oldp+3692,(vlSelf->main__DOT__ddr3_controller_inst__DOT__stage1_bank),3);
    bufp->fullSData(oldp+3693,(vlSelf->main__DOT__ddr3_controller_inst__DOT__stage1_row),14);
    bufp->fullCData(oldp+3694,(vlSelf->main__DOT__ddr3_controller_inst__DOT__stage1_next_bank),3);
    bufp->fullSData(oldp+3695,(vlSelf->main__DOT__ddr3_controller_inst__DOT__stage1_next_row),14);
    bufp->fullBit(oldp+3696,(vlSelf->main__DOT__ddr3_controller_inst__DOT__stage2_pending));
    bufp->fullBit(oldp+3697,(vlSelf->main__DOT__ddr3_controller_inst__DOT__stage2_aux));
    bufp->fullBit(oldp+3698,(vlSelf->main__DOT__ddr3_controller_inst__DOT__stage2_we));
    bufp->fullSData(oldp+3699,(vlSelf->main__DOT__ddr3_controller_inst__DOT__stage2_dm_unaligned),16);
    bufp->fullSData(oldp+3700,(vlSelf->main__DOT__ddr3_controller_inst__DOT__stage2_dm_unaligned_temp),16);
    bufp->fullSData(oldp+3701,(vlSelf->main__DOT__ddr3_controller_inst__DOT__stage2_dm[0]),16);
    bufp->fullSData(oldp+3702,(vlSelf->main__DOT__ddr3_controller_inst__DOT__stage2_dm[1]),16);
    bufp->fullWData(oldp+3703,(vlSelf->main__DOT__ddr3_controller_inst__DOT__stage2_data_unaligned),128);
    bufp->fullWData(oldp+3707,(vlSelf->main__DOT__ddr3_controller_inst__DOT__stage2_data_unaligned_temp),128);
    bufp->fullWData(oldp+3711,(vlSelf->main__DOT__ddr3_controller_inst__DOT__stage2_data[0]),128);
    bufp->fullWData(oldp+3715,(vlSelf->main__DOT__ddr3_controller_inst__DOT__stage2_data[1]),128);
    bufp->fullQData(oldp+3719,(vlSelf->main__DOT__ddr3_controller_inst__DOT__unaligned_data[0]),64);
    bufp->fullQData(oldp+3721,(vlSelf->main__DOT__ddr3_controller_inst__DOT__unaligned_data[1]),64);
    bufp->fullCData(oldp+3723,(vlSelf->main__DOT__ddr3_controller_inst__DOT__unaligned_dm[0]),8);
    bufp->fullCData(oldp+3724,(vlSelf->main__DOT__ddr3_controller_inst__DOT__unaligned_dm[1]),8);
    bufp->fullSData(oldp+3725,(vlSelf->main__DOT__ddr3_controller_inst__DOT__stage2_col),10);
    bufp->fullCData(oldp+3726,(vlSelf->main__DOT__ddr3_controller_inst__DOT__stage2_bank),3);
    bufp->fullSData(oldp+3727,(vlSelf->main__DOT__ddr3_controller_inst__DOT__stage2_row),14);
    bufp->fullCData(oldp+3728,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_precharge_counter_q[0]),4);
    bufp->fullCData(oldp+3729,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_precharge_counter_q[1]),4);
    bufp->fullCData(oldp+3730,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_precharge_counter_q[2]),4);
    bufp->fullCData(oldp+3731,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_precharge_counter_q[3]),4);
    bufp->fullCData(oldp+3732,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_precharge_counter_q[4]),4);
    bufp->fullCData(oldp+3733,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_precharge_counter_q[5]),4);
    bufp->fullCData(oldp+3734,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_precharge_counter_q[6]),4);
    bufp->fullCData(oldp+3735,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_precharge_counter_q[7]),4);
    bufp->fullCData(oldp+3736,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_activate_counter_q[0]),4);
    bufp->fullCData(oldp+3737,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_activate_counter_q[1]),4);
    bufp->fullCData(oldp+3738,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_activate_counter_q[2]),4);
    bufp->fullCData(oldp+3739,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_activate_counter_q[3]),4);
    bufp->fullCData(oldp+3740,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_activate_counter_q[4]),4);
    bufp->fullCData(oldp+3741,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_activate_counter_q[5]),4);
    bufp->fullCData(oldp+3742,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_activate_counter_q[6]),4);
    bufp->fullCData(oldp+3743,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_activate_counter_q[7]),4);
    bufp->fullCData(oldp+3744,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_write_counter_q[0]),4);
    bufp->fullCData(oldp+3745,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_write_counter_q[1]),4);
    bufp->fullCData(oldp+3746,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_write_counter_q[2]),4);
    bufp->fullCData(oldp+3747,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_write_counter_q[3]),4);
    bufp->fullCData(oldp+3748,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_write_counter_q[4]),4);
    bufp->fullCData(oldp+3749,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_write_counter_q[5]),4);
    bufp->fullCData(oldp+3750,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_write_counter_q[6]),4);
    bufp->fullCData(oldp+3751,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_write_counter_q[7]),4);
    bufp->fullCData(oldp+3752,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_read_counter_q[0]),4);
    bufp->fullCData(oldp+3753,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_read_counter_q[1]),4);
    bufp->fullCData(oldp+3754,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_read_counter_q[2]),4);
    bufp->fullCData(oldp+3755,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_read_counter_q[3]),4);
    bufp->fullCData(oldp+3756,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_read_counter_q[4]),4);
    bufp->fullCData(oldp+3757,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_read_counter_q[5]),4);
    bufp->fullCData(oldp+3758,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_read_counter_q[6]),4);
    bufp->fullCData(oldp+3759,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_read_counter_q[7]),4);
    bufp->fullBit(oldp+3760,(vlSelf->main__DOT__ddr3_controller_inst__DOT__cmd_odt_q));
    bufp->fullBit(oldp+3761,(vlSelf->main__DOT__ddr3_controller_inst__DOT__o_wb_stall_q));
    bufp->fullCData(oldp+3762,(vlSelf->main__DOT__ddr3_controller_inst__DOT__write_dqs_q),2);
    bufp->fullBit(oldp+3763,(vlSelf->main__DOT__ddr3_controller_inst__DOT__write_dqs_d));
    bufp->fullCData(oldp+3764,(vlSelf->main__DOT__ddr3_controller_inst__DOT__write_dqs),3);
    bufp->fullCData(oldp+3765,(vlSelf->main__DOT__ddr3_controller_inst__DOT__write_dqs_val),3);
    bufp->fullBit(oldp+3766,(vlSelf->main__DOT__ddr3_controller_inst__DOT__write_dq_q));
    bufp->fullBit(oldp+3767,(vlSelf->main__DOT__ddr3_controller_inst__DOT__write_dq_d));
    bufp->fullCData(oldp+3768,(vlSelf->main__DOT__ddr3_controller_inst__DOT__write_dq),4);
    bufp->fullCData(oldp+3769,(vlSelf->main__DOT__ddr3_controller_inst__DOT__state_calibrate),5);
    bufp->fullQData(oldp+3770,(vlSelf->main__DOT__ddr3_controller_inst__DOT__dqs_store),40);
    bufp->fullCData(oldp+3772,(vlSelf->main__DOT__ddr3_controller_inst__DOT__dqs_count_repeat),4);
    bufp->fullCData(oldp+3773,(vlSelf->main__DOT__ddr3_controller_inst__DOT__dqs_start_index),6);
    bufp->fullCData(oldp+3774,(vlSelf->main__DOT__ddr3_controller_inst__DOT__dqs_start_index_stored),6);
    bufp->fullCData(oldp+3775,(vlSelf->main__DOT__ddr3_controller_inst__DOT__dqs_target_index),6);
    bufp->fullCData(oldp+3776,(vlSelf->main__DOT__ddr3_controller_inst__DOT__dqs_target_index_orig),6);
    bufp->fullCData(oldp+3777,(vlSelf->main__DOT__ddr3_controller_inst__DOT__dq_target_index),6);
    bufp->fullCData(oldp+3778,(vlSelf->main__DOT__ddr3_controller_inst__DOT__dqs_target_index_value),6);
    bufp->fullCData(oldp+3779,(vlSelf->main__DOT__ddr3_controller_inst__DOT__dqs_start_index_repeat),3);
    bufp->fullCData(oldp+3780,(vlSelf->main__DOT__ddr3_controller_inst__DOT__train_delay),2);
    bufp->fullCData(oldp+3781,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_read_data),4);
    bufp->fullCData(oldp+3782,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_write_level_feedback),5);
    bufp->fullBit(oldp+3783,(vlSelf->main__DOT__ddr3_controller_inst__DOT__initial_dqs));
    bufp->fullBit(oldp+3784,(vlSelf->main__DOT__ddr3_controller_inst__DOT__lane));
    bufp->fullCData(oldp+3785,(vlSelf->main__DOT__ddr3_controller_inst__DOT__lane_times_8),4);
    bufp->fullSData(oldp+3786,(vlSelf->main__DOT__ddr3_controller_inst__DOT__dqs_bitslip_arrangement),16);
    bufp->fullCData(oldp+3787,(vlSelf->main__DOT__ddr3_controller_inst__DOT__added_read_pipe_max),4);
    bufp->fullCData(oldp+3788,(vlSelf->main__DOT__ddr3_controller_inst__DOT__added_read_pipe[0]),4);
    bufp->fullCData(oldp+3789,(vlSelf->main__DOT__ddr3_controller_inst__DOT__added_read_pipe[1]),4);
    bufp->fullCData(oldp+3790,(vlSelf->main__DOT__ddr3_controller_inst__DOT__shift_reg_read_pipe_q[0]),2);
    bufp->fullCData(oldp+3791,(vlSelf->main__DOT__ddr3_controller_inst__DOT__shift_reg_read_pipe_q[1]),2);
    bufp->fullCData(oldp+3792,(vlSelf->main__DOT__ddr3_controller_inst__DOT__shift_reg_read_pipe_q[2]),2);
    bufp->fullCData(oldp+3793,(vlSelf->main__DOT__ddr3_controller_inst__DOT__shift_reg_read_pipe_q[3]),2);
    bufp->fullCData(oldp+3794,(vlSelf->main__DOT__ddr3_controller_inst__DOT__shift_reg_read_pipe_q[4]),2);
    bufp->fullCData(oldp+3795,(vlSelf->main__DOT__ddr3_controller_inst__DOT__shift_reg_read_pipe_d[0]),2);
    bufp->fullCData(oldp+3796,(vlSelf->main__DOT__ddr3_controller_inst__DOT__shift_reg_read_pipe_d[1]),2);
    bufp->fullCData(oldp+3797,(vlSelf->main__DOT__ddr3_controller_inst__DOT__shift_reg_read_pipe_d[2]),2);
    bufp->fullCData(oldp+3798,(vlSelf->main__DOT__ddr3_controller_inst__DOT__shift_reg_read_pipe_d[3]),2);
    bufp->fullCData(oldp+3799,(vlSelf->main__DOT__ddr3_controller_inst__DOT__shift_reg_read_pipe_d[4]),2);
    bufp->fullBit(oldp+3800,(vlSelf->main__DOT__ddr3_controller_inst__DOT__index_read_pipe));
    bufp->fullBit(oldp+3801,(vlSelf->main__DOT__ddr3_controller_inst__DOT__index_wb_data));
    bufp->fullSData(oldp+3802,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_read_pipe[0]),16);
    bufp->fullSData(oldp+3803,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_read_pipe[1]),16);
    bufp->fullWData(oldp+3804,(vlSelf->main__DOT__ddr3_controller_inst__DOT__o_wb_data_q[0]),128);
    bufp->fullWData(oldp+3808,(vlSelf->main__DOT__ddr3_controller_inst__DOT__o_wb_data_q[1]),128);
    bufp->fullBit(oldp+3812,(vlSelf->main__DOT__ddr3_controller_inst__DOT__write_calib_stb));
    bufp->fullBit(oldp+3813,(vlSelf->main__DOT__ddr3_controller_inst__DOT__write_calib_aux));
    bufp->fullBit(oldp+3814,(vlSelf->main__DOT__ddr3_controller_inst__DOT__write_calib_we));
    bufp->fullSData(oldp+3815,(vlSelf->main__DOT__ddr3_controller_inst__DOT__write_calib_col),10);
    bufp->fullWData(oldp+3816,(vlSelf->main__DOT__ddr3_controller_inst__DOT__write_calib_data),128);
    bufp->fullBit(oldp+3820,(vlSelf->main__DOT__ddr3_controller_inst__DOT__write_calib_odt));
    bufp->fullBit(oldp+3821,(vlSelf->main__DOT__ddr3_controller_inst__DOT__write_calib_dqs));
    bufp->fullBit(oldp+3822,(vlSelf->main__DOT__ddr3_controller_inst__DOT__write_calib_dq));
    bufp->fullBit(oldp+3823,(vlSelf->main__DOT__ddr3_controller_inst__DOT__prev_write_level_feedback));
    bufp->fullWData(oldp+3824,(vlSelf->main__DOT__ddr3_controller_inst__DOT__read_data_store),128);
    bufp->fullWData(oldp+3828,(vlSelf->main__DOT__ddr3_controller_inst__DOT__write_pattern),128);
    bufp->fullCData(oldp+3832,(vlSelf->main__DOT__ddr3_controller_inst__DOT__data_start_index[0]),7);
    bufp->fullCData(oldp+3833,(vlSelf->main__DOT__ddr3_controller_inst__DOT__data_start_index[1]),7);
    bufp->fullCData(oldp+3834,(vlSelf->main__DOT__ddr3_controller_inst__DOT__odelay_data_cntvaluein[0]),5);
    bufp->fullCData(oldp+3835,(vlSelf->main__DOT__ddr3_controller_inst__DOT__odelay_data_cntvaluein[1]),5);
    bufp->fullCData(oldp+3836,(vlSelf->main__DOT__ddr3_controller_inst__DOT__odelay_dqs_cntvaluein[0]),5);
    bufp->fullCData(oldp+3837,(vlSelf->main__DOT__ddr3_controller_inst__DOT__odelay_dqs_cntvaluein[1]),5);
    bufp->fullCData(oldp+3838,(vlSelf->main__DOT__ddr3_controller_inst__DOT__idelay_data_cntvaluein[0]),5);
    bufp->fullCData(oldp+3839,(vlSelf->main__DOT__ddr3_controller_inst__DOT__idelay_data_cntvaluein[1]),5);
    bufp->fullCData(oldp+3840,(vlSelf->main__DOT__ddr3_controller_inst__DOT__idelay_data_cntvaluein_prev),5);
    bufp->fullCData(oldp+3841,(vlSelf->main__DOT__ddr3_controller_inst__DOT__idelay_dqs_cntvaluein[0]),5);
    bufp->fullCData(oldp+3842,(vlSelf->main__DOT__ddr3_controller_inst__DOT__idelay_dqs_cntvaluein[1]),5);
    bufp->fullBit(oldp+3843,(vlSelf->main__DOT__ddr3_controller_inst__DOT__wb2_stb));
    bufp->fullBit(oldp+3844,(vlSelf->main__DOT__ddr3_controller_inst__DOT__wb2_update));
    bufp->fullBit(oldp+3845,(vlSelf->main__DOT__ddr3_controller_inst__DOT__wb2_we));
    bufp->fullCData(oldp+3846,(vlSelf->main__DOT__ddr3_controller_inst__DOT__wb2_addr),7);
    bufp->fullIData(oldp+3847,(vlSelf->main__DOT__ddr3_controller_inst__DOT__wb2_data),32);
    bufp->fullCData(oldp+3848,(vlSelf->main__DOT__ddr3_controller_inst__DOT__wb2_sel),4);
    bufp->fullCData(oldp+3849,(vlSelf->main__DOT__ddr3_controller_inst__DOT__wb2_phy_odelay_data_cntvaluein),5);
    bufp->fullCData(oldp+3850,(vlSelf->main__DOT__ddr3_controller_inst__DOT__wb2_phy_odelay_dqs_cntvaluein),5);
    bufp->fullCData(oldp+3851,(vlSelf->main__DOT__ddr3_controller_inst__DOT__wb2_phy_idelay_data_cntvaluein),5);
    bufp->fullCData(oldp+3852,(vlSelf->main__DOT__ddr3_controller_inst__DOT__wb2_phy_idelay_dqs_cntvaluein),5);
    bufp->fullCData(oldp+3853,(vlSelf->main__DOT__ddr3_controller_inst__DOT__wb2_phy_odelay_data_ld),2);
    bufp->fullCData(oldp+3854,(vlSelf->main__DOT__ddr3_controller_inst__DOT__wb2_phy_odelay_dqs_ld),2);
    bufp->fullCData(oldp+3855,(vlSelf->main__DOT__ddr3_controller_inst__DOT__wb2_phy_idelay_data_ld),2);
    bufp->fullCData(oldp+3856,(vlSelf->main__DOT__ddr3_controller_inst__DOT__wb2_phy_idelay_dqs_ld),2);
    bufp->fullBit(oldp+3857,(vlSelf->main__DOT__ddr3_controller_inst__DOT__wb2_write_lane));
    bufp->fullIData(oldp+3858,(vlSelf->main__DOT____Vcellinp__scope1_ddr3i____pinNumber4),31);
    bufp->fullSData(oldp+3859,((((IData)(vlSelf->main__DOT__wb32_ddr3_controller_stall) 
                                 << 0xbU) | ((IData)(vlSelf->main__DOT__wb32_ddr3_phy_stall) 
                                             << 0xaU))),12);
    bufp->fullBit(oldp+3860,((1U & (IData)(vlSelf->main__DOT____Vcellout__wbwide_xbar__o_scyc))));
    bufp->fullBit(oldp+3861,((1U & (IData)(vlSelf->main__DOT____Vcellout__wbwide_xbar__o_sstb))));
    bufp->fullBit(oldp+3862,((1U & ((IData)(vlSelf->main__DOT____Vcellout__wbwide_xbar__o_scyc) 
                                    >> 1U))));
    bufp->fullBit(oldp+3863,((1U & ((IData)(vlSelf->main__DOT____Vcellout__wbwide_xbar__o_sstb) 
                                    >> 1U))));
    bufp->fullBit(oldp+3864,(vlSelf->main__DOT__u_wbdown__DOT__DOWNSIZE__DOT__r_err));
    bufp->fullBit(oldp+3865,(vlSelf->main__DOT__u_wbdown__DOT__DOWNSIZE__DOT__r_cyc));
    bufp->fullBit(oldp+3866,(vlSelf->main__DOT__wb32_xbar__DOT__DOUBLE_BUFFERRED_STALL__DOT__r_merr));
    bufp->fullBit(oldp+3867,((1U & ((IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_scyc) 
                                    >> 8U))));
    bufp->fullBit(oldp+3868,((IData)((((IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_sstb) 
                                       >> 8U) & (0U 
                                                 == 
                                                 (0x700U 
                                                  & vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[6U]))))));
    bufp->fullBit(oldp+3869,((1U & ((IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_swe) 
                                    >> 8U))));
    bufp->fullIData(oldp+3870,(vlSelf->main__DOT____Vcellout__wb32_xbar__o_sdata[8U]),32);
    bufp->fullCData(oldp+3871,((0xfU & (IData)((vlSelf->main__DOT____Vcellout__wb32_xbar__o_ssel 
                                                >> 0x20U)))),4);
    bufp->fullBit(oldp+3872,((IData)((((IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_sstb) 
                                       >> 8U) & (0x100U 
                                                 == 
                                                 (0x700U 
                                                  & vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[6U]))))));
    bufp->fullBit(oldp+3873,(vlSelf->main__DOT__wb32_sirefclk_stb));
    bufp->fullBit(oldp+3874,(vlSelf->main__DOT__wb32_spio_stb));
    bufp->fullBit(oldp+3875,((IData)((((IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_sstb) 
                                       >> 8U) & (0x400U 
                                                 == 
                                                 (0x700U 
                                                  & vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[6U]))))));
    bufp->fullBit(oldp+3876,((1U & (IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_scyc))));
    bufp->fullBit(oldp+3877,((1U & (IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_sstb))));
    bufp->fullBit(oldp+3878,((1U & (IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_swe))));
    bufp->fullIData(oldp+3879,((0x1ffffffU & vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[0U])),25);
    bufp->fullIData(oldp+3880,(vlSelf->main__DOT____Vcellout__wb32_xbar__o_sdata[0U]),32);
    bufp->fullCData(oldp+3881,((0xfU & (IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_ssel))),4);
    bufp->fullBit(oldp+3882,((1U & ((IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_scyc) 
                                    >> 1U))));
    bufp->fullBit(oldp+3883,((1U & ((IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_sstb) 
                                    >> 1U))));
    bufp->fullBit(oldp+3884,((1U & ((IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_swe) 
                                    >> 1U))));
    bufp->fullIData(oldp+3885,((0x1ffffffU & ((vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[1U] 
                                               << 7U) 
                                              | (vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[0U] 
                                                 >> 0x19U)))),25);
    bufp->fullIData(oldp+3886,(vlSelf->main__DOT____Vcellout__wb32_xbar__o_sdata[1U]),32);
    bufp->fullCData(oldp+3887,((0xfU & (IData)((vlSelf->main__DOT____Vcellout__wb32_xbar__o_ssel 
                                                >> 4U)))),4);
    bufp->fullBit(oldp+3888,((1U & ((IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_scyc) 
                                    >> 2U))));
    bufp->fullBit(oldp+3889,((1U & ((IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_sstb) 
                                    >> 2U))));
    bufp->fullBit(oldp+3890,((1U & ((IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_swe) 
                                    >> 2U))));
    bufp->fullIData(oldp+3891,((0x1ffffffU & ((vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[2U] 
                                               << 0xeU) 
                                              | (vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[1U] 
                                                 >> 0x12U)))),25);
    bufp->fullIData(oldp+3892,(vlSelf->main__DOT____Vcellout__wb32_xbar__o_sdata[2U]),32);
    bufp->fullCData(oldp+3893,((0xfU & (IData)((vlSelf->main__DOT____Vcellout__wb32_xbar__o_ssel 
                                                >> 8U)))),4);
    bufp->fullBit(oldp+3894,((1U & ((IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_scyc) 
                                    >> 3U))));
    bufp->fullBit(oldp+3895,((1U & ((IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_sstb) 
                                    >> 3U))));
    bufp->fullBit(oldp+3896,((1U & ((IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_swe) 
                                    >> 3U))));
    bufp->fullIData(oldp+3897,((0x1ffffffU & ((vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[3U] 
                                               << 0x15U) 
                                              | (vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[2U] 
                                                 >> 0xbU)))),25);
    bufp->fullIData(oldp+3898,(vlSelf->main__DOT____Vcellout__wb32_xbar__o_sdata[3U]),32);
    bufp->fullCData(oldp+3899,((0xfU & (IData)((vlSelf->main__DOT____Vcellout__wb32_xbar__o_ssel 
                                                >> 0xcU)))),4);
    bufp->fullBit(oldp+3900,((1U & ((IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_scyc) 
                                    >> 4U))));
    bufp->fullBit(oldp+3901,((1U & ((IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_sstb) 
                                    >> 4U))));
    bufp->fullBit(oldp+3902,((1U & ((IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_swe) 
                                    >> 4U))));
    bufp->fullIData(oldp+3903,((0x1ffffffU & (vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[3U] 
                                              >> 4U))),25);
    bufp->fullIData(oldp+3904,(vlSelf->main__DOT____Vcellout__wb32_xbar__o_sdata[4U]),32);
    bufp->fullCData(oldp+3905,((0xfU & (IData)((vlSelf->main__DOT____Vcellout__wb32_xbar__o_ssel 
                                                >> 0x10U)))),4);
    bufp->fullBit(oldp+3906,((1U & ((IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_scyc) 
                                    >> 5U))));
    bufp->fullBit(oldp+3907,((1U & ((IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_sstb) 
                                    >> 5U))));
    bufp->fullBit(oldp+3908,((1U & ((IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_swe) 
                                    >> 5U))));
    bufp->fullIData(oldp+3909,((0x1ffffffU & ((vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[4U] 
                                               << 3U) 
                                              | (vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[3U] 
                                                 >> 0x1dU)))),25);
    bufp->fullIData(oldp+3910,(vlSelf->main__DOT____Vcellout__wb32_xbar__o_sdata[5U]),32);
    bufp->fullCData(oldp+3911,((0xfU & (IData)((vlSelf->main__DOT____Vcellout__wb32_xbar__o_ssel 
                                                >> 0x14U)))),4);
    bufp->fullBit(oldp+3912,((1U & ((IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_scyc) 
                                    >> 6U))));
    bufp->fullBit(oldp+3913,((1U & ((IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_sstb) 
                                    >> 6U))));
    bufp->fullBit(oldp+3914,((1U & ((IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_swe) 
                                    >> 6U))));
    bufp->fullIData(oldp+3915,((0x1ffffffU & ((vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[5U] 
                                               << 0xaU) 
                                              | (vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[4U] 
                                                 >> 0x16U)))),25);
    bufp->fullIData(oldp+3916,(vlSelf->main__DOT____Vcellout__wb32_xbar__o_sdata[6U]),32);
    bufp->fullCData(oldp+3917,((0xfU & (IData)((vlSelf->main__DOT____Vcellout__wb32_xbar__o_ssel 
                                                >> 0x18U)))),4);
    bufp->fullBit(oldp+3918,((1U & ((IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_scyc) 
                                    >> 7U))));
    bufp->fullBit(oldp+3919,((1U & ((IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_sstb) 
                                    >> 7U))));
    bufp->fullBit(oldp+3920,((1U & ((IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_swe) 
                                    >> 7U))));
    bufp->fullIData(oldp+3921,((0x1ffffffU & ((vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[6U] 
                                               << 0x11U) 
                                              | (vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[5U] 
                                                 >> 0xfU)))),25);
    bufp->fullIData(oldp+3922,(vlSelf->main__DOT____Vcellout__wb32_xbar__o_sdata[7U]),32);
    bufp->fullCData(oldp+3923,((0xfU & (IData)((vlSelf->main__DOT____Vcellout__wb32_xbar__o_ssel 
                                                >> 0x1cU)))),4);
    bufp->fullBit(oldp+3924,((1U & ((IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_sstb) 
                                    >> 8U))));
    bufp->fullIData(oldp+3925,((0x1ffffffU & ((vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[7U] 
                                               << 0x18U) 
                                              | (vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[6U] 
                                                 >> 8U)))),25);
    bufp->fullBit(oldp+3926,((1U & ((IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_scyc) 
                                    >> 9U))));
    bufp->fullBit(oldp+3927,((1U & ((IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_sstb) 
                                    >> 9U))));
    bufp->fullBit(oldp+3928,((1U & ((IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_swe) 
                                    >> 9U))));
    bufp->fullIData(oldp+3929,((0x1ffffffU & (vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[7U] 
                                              >> 1U))),25);
    bufp->fullIData(oldp+3930,(vlSelf->main__DOT____Vcellout__wb32_xbar__o_sdata[9U]),32);
    bufp->fullCData(oldp+3931,((0xfU & (IData)((vlSelf->main__DOT____Vcellout__wb32_xbar__o_ssel 
                                                >> 0x24U)))),4);
    bufp->fullBit(oldp+3932,((1U & ((IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_scyc) 
                                    >> 0xaU))));
    bufp->fullBit(oldp+3933,((1U & ((IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_sstb) 
                                    >> 0xaU))));
    bufp->fullBit(oldp+3934,((1U & ((IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_swe) 
                                    >> 0xaU))));
    bufp->fullIData(oldp+3935,((0x1ffffffU & ((vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[8U] 
                                               << 6U) 
                                              | (vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[7U] 
                                                 >> 0x1aU)))),25);
    bufp->fullIData(oldp+3936,(vlSelf->main__DOT____Vcellout__wb32_xbar__o_sdata[0xaU]),32);
    bufp->fullCData(oldp+3937,((0xfU & (IData)((vlSelf->main__DOT____Vcellout__wb32_xbar__o_ssel 
                                                >> 0x28U)))),4);
    bufp->fullBit(oldp+3938,((1U & ((IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_scyc) 
                                    >> 0xbU))));
    bufp->fullBit(oldp+3939,((1U & ((IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_sstb) 
                                    >> 0xbU))));
    bufp->fullBit(oldp+3940,((1U & ((IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_swe) 
                                    >> 0xbU))));
    bufp->fullIData(oldp+3941,((0x1ffffffU & ((vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[9U] 
                                               << 0xdU) 
                                              | (vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[8U] 
                                                 >> 0x13U)))),25);
    bufp->fullIData(oldp+3942,(vlSelf->main__DOT____Vcellout__wb32_xbar__o_sdata[0xbU]),32);
    bufp->fullCData(oldp+3943,((0xfU & (IData)((vlSelf->main__DOT____Vcellout__wb32_xbar__o_ssel 
                                                >> 0x2cU)))),4);
    bufp->fullCData(oldp+3944,((3U & (vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[4U] 
                                      >> 0x16U))),2);
    bufp->fullIData(oldp+3945,((0xffffffU & ((vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[9U] 
                                              << 0xdU) 
                                             | (vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[8U] 
                                                >> 0x13U)))),24);
    ...
    bufp->fullWData(oldp+3946,(__Vtemp_hc5461f3d__0),128);
    bufp->fullSData(oldp+3950,((0xfU & (IData)((vlSelf->main__DOT____Vcellout__wb32_xbar__o_ssel 
                                                >> 0x2cU)))),16);
    bufp->fullCData(oldp+3951,((0x7fU & ((vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[8U] 
                                          << 6U) | 
                                         (vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[7U] 
                                          >> 0x1aU)))),7);
    bufp->fullIData(oldp+3952,((0xffffffU & ((IData)(5U) 
                                             + ((vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[9U] 
                                                 << 0xdU) 
                                                | (vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[8U] 
                                                   >> 0x13U))))),24);
    bufp->fullIData(oldp+3953,(vlSelf->main__DOT__ddr3_controller_inst__DOT__wb_data_to_wb2),32);
    bufp->fullCData(oldp+3954,((3U & (vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[3U] 
                                      >> 4U))),2);
    bufp->fullBit(oldp+3955,(vlSelf->main__DOT__i2ci__DOT__next_valid));
    bufp->fullCData(oldp+3956,(vlSelf->main__DOT__i2ci__DOT__next_insn),8);
    bufp->fullBit(oldp+3957,((1U & (((IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_sstb) 
                                     >> 4U) & (~ ((IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_swe) 
                                                  >> 4U))))));
    bufp->fullBit(oldp+3958,(vlSelf->main__DOT__i2ci__DOT__bus_write));
    bufp->fullBit(oldp+3959,(vlSelf->main__DOT__i2ci__DOT__bus_override));
    bufp->fullBit(oldp+3960,(vlSelf->main__DOT__i2ci__DOT__bus_manual));
    bufp->fullBit(oldp+3961,(vlSelf->main__DOT__i2ci__DOT__bus_jump));
    bufp->fullBit(oldp+3962,((1U & vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[0U])));
    bufp->fullBit(oldp+3963,((1U & ((IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_sstb) 
                                    & (IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_swe)))));
    bufp->fullBit(oldp+3964,(vlSelf->main__DOT__i2cscopei__DOT__read_from_data));
    bufp->fullBit(oldp+3965,(vlSelf->main__DOT__i2cscopei__DOT__write_to_control));
    bufp->fullBit(oldp+3966,((1U & (vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[0U] 
                                    >> 0x19U))));
    bufp->fullBit(oldp+3967,((1U & (((IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_sstb) 
                                     & (IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_swe)) 
                                    >> 1U))));
    bufp->fullBit(oldp+3968,(vlSelf->main__DOT__scope1_ddr3i__DOT__read_from_data));
    bufp->fullBit(oldp+3969,(vlSelf->main__DOT__scope1_ddr3i__DOT__write_to_control));
    bufp->fullBit(oldp+3970,((1U & (vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[1U] 
                                    >> 0x12U))));
    bufp->fullBit(oldp+3971,((1U & (((IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_sstb) 
                                     & (IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_swe)) 
                                    >> 2U))));
    bufp->fullBit(oldp+3972,(vlSelf->main__DOT__scope2_ddr3i__DOT__read_from_data));
    bufp->fullBit(oldp+3973,(vlSelf->main__DOT__scope2_ddr3i__DOT__write_to_control));
    bufp->fullBit(oldp+3974,((1U & (vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[2U] 
                                    >> 0xbU))));
    bufp->fullBit(oldp+3975,((1U & (((IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_sstb) 
                                     & (IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_swe)) 
                                    >> 3U))));
    bufp->fullBit(oldp+3976,(vlSelf->main__DOT__scope3_ddr3i__DOT__read_from_data));
    bufp->fullBit(oldp+3977,(vlSelf->main__DOT__scope3_ddr3i__DOT__write_to_control));
    bufp->fullCData(oldp+3978,(vlSelf->main__DOT__spioi__DOT__GEN_BUTTON__DOT__next_btn),5);
    bufp->fullBit(oldp+3979,(vlSelf->main__DOT__spioi__DOT__GEN_BUTTON__DOT__next_int));
    bufp->fullCData(oldp+3980,((7U & (vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[5U] 
                                      >> 0xfU))),3);
    bufp->fullBit(oldp+3981,(vlSelf->main__DOT__u_fan__DOT____Vcellinp__u_i2ccpu__i_wb_stb));
    bufp->fullCData(oldp+3982,((3U & (vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[5U] 
                                      >> 0xfU))),2);
    bufp->fullBit(oldp+3983,(vlSelf->main__DOT__u_fan__DOT__u_i2ccpu__DOT__next_valid));
    bufp->fullCData(oldp+3984,(vlSelf->main__DOT__u_fan__DOT__u_i2ccpu__DOT__next_insn),8);
    bufp->fullBit(oldp+3985,(((IData)(vlSelf->main__DOT__u_fan__DOT____Vcellinp__u_i2ccpu__i_wb_stb) 
                              & (~ ((IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_swe) 
                                    >> 7U)))));
    bufp->fullBit(oldp+3986,(vlSelf->main__DOT__u_fan__DOT__u_i2ccpu__DOT__bus_write));
    bufp->fullBit(oldp+3987,(vlSelf->main__DOT__u_fan__DOT__u_i2ccpu__DOT__bus_override));
    bufp->fullBit(oldp+3988,(vlSelf->main__DOT__u_fan__DOT__u_i2ccpu__DOT__bus_manual));
    bufp->fullBit(oldp+3989,(vlSelf->main__DOT__u_fan__DOT__u_i2ccpu__DOT__bus_jump));
    bufp->fullCData(oldp+3990,((3U & (vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr[3U] 
                                      >> 0x1dU))),2);
    bufp->fullIData(oldp+3991,(vlSelf->main__DOT__u_i2cdma__DOT__next_baseaddr),32);
    bufp->fullIData(oldp+3992,(vlSelf->main__DOT__u_i2cdma__DOT__next_memlen),32);
    bufp->fullSData(oldp+3993,(vlSelf->main__DOT____Vcellout__wb32_xbar__o_scyc),12);
    bufp->fullSData(oldp+3994,(vlSelf->main__DOT____Vcellout__wb32_xbar__o_sstb),12);
    bufp->fullSData(oldp+3995,(vlSelf->main__DOT____Vcellout__wb32_xbar__o_swe),12);
    bufp->fullWData(oldp+3996,(vlSelf->main__DOT____Vcellout__wb32_xbar__o_saddr),300);
    bufp->fullWData(oldp+4006,(vlSelf->main__DOT____Vcellout__wb32_xbar__o_sdata),384);
    bufp->fullQData(oldp+4018,(vlSelf->main__DOT____Vcellout__wb32_xbar__o_ssel),48);
    bufp->fullSData(oldp+4020,(vlSelf->main__DOT__wb32_xbar__DOT__request[0]),13);
    bufp->fullSData(oldp+4021,(vlSelf->main__DOT__wb32_xbar__DOT__sgrant),12);
    bufp->fullCData(oldp+4022,(vlSelf->main__DOT__wb32_xbar__DOT__mindex[0]),4);
    bufp->fullBit(oldp+4023,(vlSelf->main__DOT__wb32_xbar__DOT__m_stb));
    bufp->fullBit(oldp+4024,((1U & (IData)((vlSelf->main__DOT__wb32_xbar__DOT____Vcellout__DECODE_REQUEST__BRA__0__KET____DOT__adcd__o_data 
                                            >> 0x24U)))));
    bufp->fullIData(oldp+4025,(vlSelf->main__DOT__wb32_xbar__DOT__m_addr[0]),25);
    bufp->fullIData(oldp+4026,(vlSelf->main__DOT__wb32_xbar__DOT__m_data[0]),32);
    bufp->fullCData(oldp+4027,(vlSelf->main__DOT__wb32_xbar__DOT__m_sel[0]),4);
    bufp->fullBit(oldp+4028,(vlSelf->main__DOT__wb32_xbar__DOT__dcd_stb));
    bufp->fullSData(oldp+4029,(vlSelf->main__DOT__wb32_xbar__DOT__ARBITRATE_REQUESTS__BRA__0__KET____DOT__MINDEX_MULTIPLE_SLAVES__DOT__r_regrant),13);
    bufp->fullBit(oldp+4030,(vlSelf->main__DOT__wb32_xbar__DOT__ARBITRATE_REQUESTS__BRA__0__KET____DOT__stay_on_channel));
    bufp->fullBit(oldp+4031,(vlSelf->main__DOT__wb32_xbar__DOT__ARBITRATE_REQUESTS__BRA__0__KET____DOT__requested_channel_is_available));
    bufp->fullCData(oldp+4032,(vlSelf->main__DOT__wb32_xbar__DOT__ARBITRATE_REQUESTS__BRA__0__KET____DOT__MINDEX_MULTIPLE_SLAVES__DOT__r_mindex),4);
    bufp->fullBit(oldp+4033,((1U & (IData)((vlSelf->main__DOT__wb32_xbar__DOT____Vcellout__DECODE_REQUEST__BRA__0__KET____DOT__iskid__o_data 
                                            >> 0x3dU)))));
    bufp->fullIData(oldp+4034,((0x1ffffffU & (IData)(
                                                     (vlSelf->main__DOT__wb32_xbar__DOT____Vcellout__DECODE_REQUEST__BRA__0__KET____DOT__iskid__o_data 
                                                      >> 0x24U)))),25);
    bufp->fullIData(oldp+4035,((IData)((vlSelf->main__DOT__wb32_xbar__DOT____Vcellout__DECODE_REQUEST__BRA__0__KET____DOT__iskid__o_data 
                                        >> 4U))),32);
    bufp->fullCData(oldp+4036,((0xfU & (IData)(vlSelf->main__DOT__wb32_xbar__DOT____Vcellout__DECODE_REQUEST__BRA__0__KET____DOT__iskid__o_data))),4);
    bufp->fullQData(oldp+4037,((((QData)((IData)((1U 
                                                  & (IData)(
                                                            (vlSelf->main__DOT__wb32_xbar__DOT____Vcellout__DECODE_REQUEST__BRA__0__KET____DOT__iskid__o_data 
                                                             >> 0x3dU))))) 
                                 << 0x24U) | (0xfffffffffULL 
                                              & vlSelf->main__DOT__wb32_xbar__DOT____Vcellout__DECODE_REQUEST__BRA__0__KET____DOT__iskid__o_data))),37);
    bufp->fullQData(oldp+4039,(vlSelf->main__DOT__wb32_xbar__DOT____Vcellout__DECODE_REQUEST__BRA__0__KET____DOT__adcd__o_data),37);
    bufp->fullSData(oldp+4041,(vlSelf->main__DOT__wb32_xbar__DOT__DECODE_REQUEST__BRA__0__KET____DOT__adcd__DOT__prerequest),12);
    bufp->fullQData(oldp+4042,(vlSelf->main__DOT__wb32_xbar__DOT____Vcellout__DECODE_REQUEST__BRA__0__KET____DOT__iskid__o_data),62);
    bufp->fullCData(oldp+4044,(vlSelf->main__DOT__wbu_xbar__DOT__mindex[0]),2);
    bufp->fullCData(oldp+4045,(vlSelf->main__DOT__wbu_xbar__DOT__ARBITRATE_REQUESTS__BRA__0__KET____DOT__MINDEX_MULTIPLE_SLAVES__DOT__r_regrant),3);
    bufp->fullCData(oldp+4046,(vlSelf->main__DOT__wbu_xbar__DOT__ARBITRATE_REQUESTS__BRA__0__KET____DOT__MINDEX_MULTIPLE_SLAVES__DOT__r_mindex),2);
    bufp->fullCData(oldp+4047,(vlSelf->main__DOT____Vcellinp__wbwide_xbar__i_mcyc),4);
    bufp->fullCData(oldp+4048,(vlSelf->main__DOT____Vcellout__wbwide_xbar__o_scyc),2);
    bufp->fullCData(oldp+4049,(vlSelf->main__DOT____Vcellout__wbwide_xbar__o_sstb),2);
    bufp->fullCData(oldp+4050,(((IData)(vlSelf->main__DOT__u_wbdown__DOT__DOWNSIZE__DOT__r_err) 
                                << 1U)),2);
    bufp->fullCData(oldp+4051,(vlSelf->main__DOT__wbwide_xbar__DOT__sgrant),2);
    bufp->fullCData(oldp+4052,(vlSelf->main__DOT__wbwide_xbar__DOT__mindex[0]),2);
    bufp->fullCData(oldp+4053,(vlSelf->main__DOT__wbwide_xbar__DOT__mindex[1]),2);
    bufp->fullCData(oldp+4054,(vlSelf->main__DOT__wbwide_xbar__DOT__mindex[2]),2);
    bufp->fullCData(oldp+4055,(vlSelf->main__DOT__wbwide_xbar__DOT__mindex[3]),2);
    bufp->fullCData(oldp+4056,(vlSelf->main__DOT__wbwide_xbar__DOT__sindex[0]),2);
    bufp->fullCData(oldp+4057,(vlSelf->main__DOT__wbwide_xbar__DOT__sindex[1]),2);
    bufp->fullCData(oldp+4058,(vlSelf->main__DOT__wbwide_xbar__DOT__sindex[2]),2);
    bufp->fullCData(oldp+4059,(vlSelf->main__DOT__wbwide_xbar__DOT__sindex[3]),2);
    bufp->fullCData(oldp+4060,(vlSelf->main__DOT__wbwide_xbar__DOT__m_stall),4);
    bufp->fullCData(oldp+4061,(vlSelf->main__DOT__wbwide_xbar__DOT__s_stall),4);
    bufp->fullCData(oldp+4062,(vlSelf->main__DOT__wbwide_xbar__DOT__s_ack),4);
    bufp->fullCData(oldp+4063,(vlSelf->main__DOT__wbwide_xbar__DOT__s_err),4);
    bufp->fullCData(oldp+4064,(vlSelf->main__DOT__wbwide_xbar__DOT__ARBITRATE_REQUESTS__BRA__0__KET____DOT__MINDEX_MULTIPLE_SLAVES__DOT__r_regrant),3);
    bufp->fullBit(oldp+4065,(vlSelf->main__DOT__wbwide_xbar__DOT__ARBITRATE_REQUESTS__BRA__0__KET____DOT__requested_channel_is_available));
    bufp->fullCData(oldp+4066,(vlSelf->main__DOT__wbwide_xbar__DOT__ARBITRATE_REQUESTS__BRA__0__KET____DOT__MINDEX_MULTIPLE_SLAVES__DOT__r_mindex),2);
    bufp->fullCData(oldp+4067,(vlSelf->main__DOT__wbwide_xbar__DOT__ARBITRATE_REQUESTS__BRA__1__KET____DOT__MINDEX_MULTIPLE_SLAVES__DOT__r_regrant),3);
    bufp->fullBit(oldp+4068,(vlSelf->main__DOT__wbwide_xbar__DOT__ARBITRATE_REQUESTS__BRA__1__KET____DOT__requested_channel_is_available));
    bufp->fullCData(oldp+4069,(vlSelf->main__DOT__wbwide_xbar__DOT__ARBITRATE_REQUESTS__BRA__1__KET____DOT__MINDEX_MULTIPLE_SLAVES__DOT__r_mindex),2);
    bufp->fullCData(oldp+4070,(vlSelf->main__DOT__wbwide_xbar__DOT__ARBITRATE_REQUESTS__BRA__2__KET____DOT__MINDEX_MULTIPLE_SLAVES__DOT__r_regrant),3);
    bufp->fullBit(oldp+4071,(vlSelf->main__DOT__wbwide_xbar__DOT__ARBITRATE_REQUESTS__BRA__2__KET____DOT__requested_channel_is_available));
    bufp->fullCData(oldp+4072,(vlSelf->main__DOT__wbwide_xbar__DOT__ARBITRATE_REQUESTS__BRA__2__KET____DOT__MINDEX_MULTIPLE_SLAVES__DOT__r_mindex),2);
    bufp->fullCData(oldp+4073,(vlSelf->main__DOT__wbwide_xbar__DOT__ARBITRATE_REQUESTS__BRA__3__KET____DOT__MINDEX_MULTIPLE_SLAVES__DOT__r_regrant),3);
    bufp->fullBit(oldp+4074,(vlSelf->main__DOT__wbwide_xbar__DOT__ARBITRATE_REQUESTS__BRA__3__KET____DOT__requested_channel_is_available));
    bufp->fullCData(oldp+4075,(vlSelf->main__DOT__wbwide_xbar__DOT__ARBITRATE_REQUESTS__BRA__3__KET____DOT__MINDEX_MULTIPLE_SLAVES__DOT__r_mindex),2);
    bufp->fullBit(oldp+4076,(vlSelf->main__DOT__wbwide_xbar__DOT__DECODE_REQUEST__BRA__0__KET____DOT__skd_stall));
    bufp->fullBit(oldp+4077,(vlSelf->main__DOT__wbwide_xbar__DOT____Vcellinp__DECODE_REQUEST__BRA__0__KET____DOT__adcd__i_stall));
    bufp->fullBit(oldp+4078,((1U & (~ (IData)(vlSelf->main__DOT__wbwide_xbar__DOT__DECODE_REQUEST__BRA__0__KET____DOT__skd_stall)))));
    bufp->fullBit(oldp+4079,(vlSelf->main__DOT__wbwide_xbar__DOT__DECODE_REQUEST__BRA__1__KET____DOT__skd_stall));
    bufp->fullBit(oldp+4080,(vlSelf->main__DOT__wbwide_xbar__DOT____Vcellinp__DECODE_REQUEST__BRA__1__KET____DOT__adcd__i_stall));
    bufp->fullBit(oldp+4081,((1U & (~ (IData)(vlSelf->main__DOT__wbwide_xbar__DOT__DECODE_REQUEST__BRA__1__KET____DOT__skd_stall)))));
    bufp->fullBit(oldp+4082,(vlSelf->main__DOT__wbwide_xbar__DOT__DECODE_REQUEST__BRA__2__KET____DOT__skd_stall));
    bufp->fullBit(oldp+4083,(vlSelf->main__DOT__wbwide_xbar__DOT____Vcellinp__DECODE_REQUEST__BRA__2__KET____DOT__adcd__i_stall));
    bufp->fullBit(oldp+4084,((1U & (~ (IData)(vlSelf->main__DOT__wbwide_xbar__DOT__DECODE_REQUEST__BRA__2__KET____DOT__skd_stall)))));
    bufp->fullBit(oldp+4085,(vlSelf->main__DOT__wbwide_xbar__DOT__DECODE_REQUEST__BRA__3__KET____DOT__skd_stall));
    bufp->fullBit(oldp+4086,(vlSelf->main__DOT__wbwide_xbar__DOT____Vcellinp__DECODE_REQUEST__BRA__3__KET____DOT__adcd__i_stall));
    bufp->fullBit(oldp+4087,((1U & (~ (IData)(vlSelf->main__DOT__wbwide_xbar__DOT__DECODE_REQUEST__BRA__3__KET____DOT__skd_stall)))));
    bufp->fullCData(oldp+4088,(vlSelf->main__DOT__wbwide_xbar__DOT__GEN_SINDEX__BRA__0__KET____DOT__SINDEX_MORE_THAN_ONE_MASTER__DOT__regrant),4);
    bufp->fullCData(oldp+4089,(vlSelf->main__DOT__wbwide_xbar__DOT__GEN_SINDEX__BRA__0__KET____DOT__SINDEX_MORE_THAN_ONE_MASTER__DOT__reindex),2);
    bufp->fullCData(oldp+4090,(vlSelf->main__DOT__wbwide_xbar__DOT__GEN_SINDEX__BRA__1__KET____DOT__SINDEX_MORE_THAN_ONE_MASTER__DOT__regrant),4);
    bufp->fullCData(oldp+4091,(vlSelf->main__DOT__wbwide_xbar__DOT__GEN_SINDEX__BRA__1__KET____DOT__SINDEX_MORE_THAN_ONE_MASTER__DOT__reindex),2);
    bufp->fullBit(oldp+4092,((1U & (vlSelf->main__DOT__ddr3_controller_inst__DOT__o_wb_ack_read_q
                                    [0U] >> 1U))));
    bufp->fullIData(oldp+4093,(vlSelf->main__DOT____Vcellout__ddr3_controller_inst__o_wb_data[0U]),32);
    bufp->fullWData(oldp+4094,(vlSelf->main__DOT____Vcellout__ddr3_controller_inst__o_wb_data),128);
    bufp->fullCData(oldp+4098,(vlSelf->main__DOT__ddr3_controller_inst__DOT__o_wb_ack_read_q[0]),2);
    bufp->fullCData(oldp+4099,(vlSelf->main__DOT__ddr3_controller_inst__DOT__o_wb_ack_read_q[1]),2);
    bufp->fullCData(oldp+4100,(vlSelf->main__DOT__ddr3_controller_inst__DOT__o_wb_ack_read_q[2]),2);
    bufp->fullCData(oldp+4101,(vlSelf->main__DOT__ddr3_controller_inst__DOT__o_wb_ack_read_q[3]),2);
    bufp->fullCData(oldp+4102,(vlSelf->main__DOT__ddr3_controller_inst__DOT__o_wb_ack_read_q[4]),2);
    bufp->fullCData(oldp+4103,(vlSelf->main__DOT__ddr3_controller_inst__DOT__o_wb_ack_read_q[5]),2);
    bufp->fullCData(oldp+4104,(vlSelf->main__DOT__ddr3_controller_inst__DOT__o_wb_ack_read_q[6]),2);
    bufp->fullCData(oldp+4105,(vlSelf->main__DOT__ddr3_controller_inst__DOT__o_wb_ack_read_q[7]),2);
    bufp->fullCData(oldp+4106,(vlSelf->main__DOT__ddr3_controller_inst__DOT__o_wb_ack_read_q[8]),2);
    bufp->fullCData(oldp+4107,(vlSelf->main__DOT__ddr3_controller_inst__DOT__o_wb_ack_read_q[9]),2);
    bufp->fullCData(oldp+4108,(vlSelf->main__DOT__ddr3_controller_inst__DOT__o_wb_ack_read_q[10]),2);
    bufp->fullCData(oldp+4109,(vlSelf->main__DOT__ddr3_controller_inst__DOT__o_wb_ack_read_q[11]),2);
    bufp->fullCData(oldp+4110,(vlSelf->main__DOT__ddr3_controller_inst__DOT__o_wb_ack_read_q[12]),2);
    bufp->fullCData(oldp+4111,(vlSelf->main__DOT__ddr3_controller_inst__DOT__o_wb_ack_read_q[13]),2);
    bufp->fullCData(oldp+4112,(vlSelf->main__DOT__ddr3_controller_inst__DOT__o_wb_ack_read_q[14]),2);
    bufp->fullCData(oldp+4113,(vlSelf->main__DOT__ddr3_controller_inst__DOT__o_wb_ack_read_q[15]),2);
    bufp->fullBit(oldp+4114,((1U & vlSelf->main__DOT__ddr3_controller_inst__DOT__o_wb_ack_read_q
                              [0U])));
    bufp->fullBit(oldp+4115,(vlSelf->main__DOT__ddr3_controller_inst__DOT__stage2_stall));
    bufp->fullBit(oldp+4116,(vlSelf->main__DOT__ddr3_controller_inst__DOT__stage1_stall));
    bufp->fullCData(oldp+4117,(vlSelf->main__DOT__ddr3_controller_inst__DOT__bank_status_d),8);
    bufp->fullSData(oldp+4118,(vlSelf->main__DOT__ddr3_controller_inst__DOT__bank_active_row_d[0]),14);
    bufp->fullSData(oldp+4119,(vlSelf->main__DOT__ddr3_controller_inst__DOT__bank_active_row_d[1]),14);
    bufp->fullSData(oldp+4120,(vlSelf->main__DOT__ddr3_controller_inst__DOT__bank_active_row_d[2]),14);
    bufp->fullSData(oldp+4121,(vlSelf->main__DOT__ddr3_controller_inst__DOT__bank_active_row_d[3]),14);
    bufp->fullSData(oldp+4122,(vlSelf->main__DOT__ddr3_controller_inst__DOT__bank_active_row_d[4]),14);
    bufp->fullSData(oldp+4123,(vlSelf->main__DOT__ddr3_controller_inst__DOT__bank_active_row_d[5]),14);
    bufp->fullSData(oldp+4124,(vlSelf->main__DOT__ddr3_controller_inst__DOT__bank_active_row_d[6]),14);
    bufp->fullSData(oldp+4125,(vlSelf->main__DOT__ddr3_controller_inst__DOT__bank_active_row_d[7]),14);
    bufp->fullCData(oldp+4126,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_precharge_counter_d[0]),4);
    bufp->fullCData(oldp+4127,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_precharge_counter_d[1]),4);
    bufp->fullCData(oldp+4128,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_precharge_counter_d[2]),4);
    bufp->fullCData(oldp+4129,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_precharge_counter_d[3]),4);
    bufp->fullCData(oldp+4130,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_precharge_counter_d[4]),4);
    bufp->fullCData(oldp+4131,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_precharge_counter_d[5]),4);
    bufp->fullCData(oldp+4132,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_precharge_counter_d[6]),4);
    bufp->fullCData(oldp+4133,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_precharge_counter_d[7]),4);
    bufp->fullCData(oldp+4134,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_activate_counter_d[0]),4);
    bufp->fullCData(oldp+4135,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_activate_counter_d[1]),4);
    bufp->fullCData(oldp+4136,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_activate_counter_d[2]),4);
    bufp->fullCData(oldp+4137,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_activate_counter_d[3]),4);
    bufp->fullCData(oldp+4138,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_activate_counter_d[4]),4);
    bufp->fullCData(oldp+4139,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_activate_counter_d[5]),4);
    bufp->fullCData(oldp+4140,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_activate_counter_d[6]),4);
    bufp->fullCData(oldp+4141,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_activate_counter_d[7]),4);
    bufp->fullCData(oldp+4142,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_write_counter_d[0]),4);
    bufp->fullCData(oldp+4143,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_write_counter_d[1]),4);
    bufp->fullCData(oldp+4144,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_write_counter_d[2]),4);
    bufp->fullCData(oldp+4145,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_write_counter_d[3]),4);
    bufp->fullCData(oldp+4146,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_write_counter_d[4]),4);
    bufp->fullCData(oldp+4147,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_write_counter_d[5]),4);
    bufp->fullCData(oldp+4148,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_write_counter_d[6]),4);
    bufp->fullCData(oldp+4149,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_write_counter_d[7]),4);
    bufp->fullCData(oldp+4150,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_read_counter_d[0]),4);
    bufp->fullCData(oldp+4151,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_read_counter_d[1]),4);
    bufp->fullCData(oldp+4152,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_read_counter_d[2]),4);
    bufp->fullCData(oldp+4153,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_read_counter_d[3]),4);
    bufp->fullCData(oldp+4154,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_read_counter_d[4]),4);
    bufp->fullCData(oldp+4155,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_read_counter_d[5]),4);
    bufp->fullCData(oldp+4156,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_read_counter_d[6]),4);
    bufp->fullCData(oldp+4157,(vlSelf->main__DOT__ddr3_controller_inst__DOT__delay_before_read_counter_d[7]),4);
    bufp->fullIData(oldp+4158,(vlSelf->main__DOT__ddr3_controller_inst__DOT__cmd_d[0]),24);
    bufp->fullIData(oldp+4159,(vlSelf->main__DOT__ddr3_controller_inst__DOT__cmd_d[1]),24);
    bufp->fullIData(oldp+4160,(vlSelf->main__DOT__ddr3_controller_inst__DOT__cmd_d[2]),24);
    bufp->fullIData(oldp+4161,(vlSelf->main__DOT__ddr3_controller_inst__DOT__cmd_d[3]),24);
    bufp->fullBit(oldp+4162,(vlSelf->main__DOT__ddr3_controller_inst__DOT__cmd_odt));
    bufp->fullBit(oldp+4163,(vlSelf->main__DOT__ddr3_controller_inst__DOT__cmd_ck_en));
    bufp->fullBit(oldp+4164,(vlSelf->main__DOT__ddr3_controller_inst__DOT__cmd_reset_n));
    bufp->fullBit(oldp+4165,(vlSelf->main__DOT__ddr3_controller_inst__DOT__o_wb_stall_d));
    bufp->fullBit(oldp+4166,(vlSelf->main__DOT__ddr3_controller_inst__DOT__precharge_slot_busy));
    bufp->fullBit(oldp+4167,(vlSelf->main__DOT__ddr3_controller_inst__DOT__activate_slot_busy));
    bufp->fullBit(oldp+4168,(vlSelf->main__DOT__scope1_ddr3i__DOT__dw_trigger));
    bufp->fullBit(oldp+4169,(vlSelf->main__DOT__scope2_ddr3i__DOT__dw_trigger));
    bufp->fullBit(oldp+4170,(vlSelf->main__DOT__scope3_ddr3i__DOT__dw_trigger));
    bufp->fullBit(oldp+4171,(vlSelf->main__DOT__wb32_xbar__DOT__m_stall));
    bufp->fullSData(oldp+4172,(vlSelf->main__DOT__wb32_xbar__DOT__s_stall),16);
    bufp->fullBit(oldp+4173,(vlSelf->main__DOT__wb32_xbar__DOT__DECODE_REQUEST__BRA__0__KET____DOT__skd_stall));
    bufp->fullBit(oldp+4174,(vlSelf->main__DOT__wb32_xbar__DOT____Vcellinp__DECODE_REQUEST__BRA__0__KET____DOT__adcd__i_stall));
    bufp->fullBit(oldp+4175,((1U & (~ (IData)(vlSelf->main__DOT__wb32_xbar__DOT__DECODE_REQUEST__BRA__0__KET____DOT__skd_stall)))));
    bufp->fullBit(oldp+4176,(vlSelf->i_clk));
    bufp->fullBit(oldp+4177,(vlSelf->i_reset));
    bufp->fullWData(oldp+4178,(vlSelf->i_ddr3_controller_iserdes_data),128);
    bufp->fullSData(oldp+4182,(vlSelf->i_ddr3_controller_iserdes_dqs),16);
    bufp->fullSData(oldp+4183,(vlSelf->i_ddr3_controller_iserdes_bitslip_reference),16);
    bufp->fullBit(oldp+4184,(vlSelf->i_ddr3_controller_idelayctrl_rdy));
    bufp->fullWData(oldp+4185,(vlSelf->o_ddr3_controller_cmd),96);
    bufp->fullBit(oldp+4188,(vlSelf->o_ddr3_controller_dqs_tri_control));
    bufp->fullBit(oldp+4189,(vlSelf->o_ddr3_controller_dq_tri_control));
    bufp->fullBit(oldp+4190,(vlSelf->o_ddr3_controller_toggle_dqs));
    bufp->fullWData(oldp+4191,(vlSelf->o_ddr3_controller_data),128);
    bufp->fullSData(oldp+4195,(vlSelf->o_ddr3_controller_dm),16);
    bufp->fullCData(oldp+4196,(vlSelf->o_ddr3_controller_odelay_data_cntvaluein),5);
    bufp->fullCData(oldp+4197,(vlSelf->o_ddr3_controller_odelay_dqs_cntvaluein),5);
    bufp->fullCData(oldp+4198,(vlSelf->o_ddr3_controller_idelay_data_cntvaluein),5);
    bufp->fullCData(oldp+4199,(vlSelf->o_ddr3_controller_idelay_dqs_cntvaluein),5);
    bufp->fullCData(oldp+4200,(vlSelf->o_ddr3_controller_odelay_data_ld),2);
    bufp->fullCData(oldp+4201,(vlSelf->o_ddr3_controller_odelay_dqs_ld),2);
    bufp->fullCData(oldp+4202,(vlSelf->o_ddr3_controller_idelay_data_ld),2);
    bufp->fullCData(oldp+4203,(vlSelf->o_ddr3_controller_idelay_dqs_ld),2);
    bufp->fullCData(oldp+4204,(vlSelf->o_ddr3_controller_bitslip),2);
    bufp->fullCData(oldp+4205,(vlSelf->o_sirefclk_word),8);
    bufp->fullBit(oldp+4206,(vlSelf->o_sirefclk_ce));
    bufp->fullBit(oldp+4207,(vlSelf->i_fan_sda));
    bufp->fullBit(oldp+4208,(vlSelf->i_fan_scl));
    bufp->fullBit(oldp+4209,(vlSelf->o_fan_sda));
    bufp->fullBit(oldp+4210,(vlSelf->o_fan_scl));
    bufp->fullBit(oldp+4211,(vlSelf->o_fpga_pwm));
    bufp->fullBit(oldp+4212,(vlSelf->o_sys_pwm));
    bufp->fullBit(oldp+4213,(vlSelf->i_fan_tach));
    bufp->fullBit(oldp+4214,(vlSelf->i_i2c_sda));
    bufp->fullBit(oldp+4215,(vlSelf->i_i2c_scl));
    bufp->fullBit(oldp+4216,(vlSelf->o_i2c_sda));
    bufp->fullBit(oldp+4217,(vlSelf->o_i2c_scl));
    bufp->fullBit(oldp+4218,(vlSelf->cpu_sim_cyc));
    bufp->fullBit(oldp+4219,(vlSelf->cpu_sim_stb));
    bufp->fullBit(oldp+4220,(vlSelf->cpu_sim_we));
    bufp->fullCData(oldp+4221,(vlSelf->cpu_sim_addr),7);
    bufp->fullIData(oldp+4222,(vlSelf->cpu_sim_data),32);
    bufp->fullBit(oldp+4223,(vlSelf->cpu_sim_stall));
    bufp->fullBit(oldp+4224,(vlSelf->cpu_sim_ack));
    bufp->fullIData(oldp+4225,(vlSelf->cpu_sim_idata),32);
    bufp->fullBit(oldp+4226,(vlSelf->cpu_prof_stb));
    bufp->fullIData(oldp+4227,(vlSelf->cpu_prof_addr),28);
    bufp->fullIData(oldp+4228,(vlSelf->cpu_prof_ticks),32);
    bufp->fullBit(oldp+4229,(vlSelf->i_cpu_reset));
    bufp->fullBit(oldp+4230,(vlSelf->i_wbu_uart_rx));
    bufp->fullBit(oldp+4231,(vlSelf->o_wbu_uart_tx));
    bufp->fullBit(oldp+4232,(vlSelf->o_wbu_uart_cts_n));
    bufp->fullSData(oldp+4233,(vlSelf->i_gpio),16);
    bufp->fullCData(oldp+4234,(vlSelf->o_gpio),8);
    bufp->fullCData(oldp+4235,(vlSelf->i_sw),8);
    bufp->fullCData(oldp+4236,(vlSelf->i_btn),5);
    bufp->fullCData(oldp+4237,(vlSelf->o_led),8);
    bufp->fullBit(oldp+4238,(vlSelf->i_clk200));
    bufp->fullIData(oldp+4239,(((vlSelf->main__DOT__ddr3_controller_inst__DOT__o_wb_ack_read_q
                                 [0U] << 0x1fU) | vlSelf->main__DOT____Vcellinp__scope1_ddr3i____pinNumber4)),32);
    bufp->fullIData(oldp+4240,(((vlSelf->main__DOT__ddr3_controller_inst__DOT__o_wb_ack_read_q
    ...
    bufp->fullIData(oldp+4242,((((IData)(vlSelf->main__DOT__u_fan__DOT__u_i2ccpu__DOT__r_aborted) 
                                 << 0x1fU) | ((0x40000000U 
    ...
    bufp->fullIData(oldp+4243,((((IData)(vlSelf->main__DOT__gpioi__DOT__r_gpio) 
                                 << 0x10U) | (IData)(vlSelf->o_gpio))),32);
    bufp->fullBit(oldp+4244,((vlSelf->main__DOT__ddr3_controller_inst__DOT__o_wb_ack_read_q
                              [0U] & (0xeU == (IData)(vlSelf->main__DOT__ddr3_controller_inst__DOT__state_calibrate)))));
    bufp->fullBit(oldp+4245,(((IData)(vlSelf->cpu_sim_cyc) 
                              | (IData)(vlSelf->main__DOT__swic__DOT__DELAY_THE_DEBUG_BUS__DOT__wbdelay__DOT__SKIDBUFFER__DOT__r_stb))));
    bufp->fullBit(oldp+4246,(((~ (IData)(vlSelf->cpu_sim_cyc)) 
                              & (IData)(vlSelf->main__DOT__raw_cpu_dbg_ack))));
    bufp->fullBit(oldp+4247,((0U == (((vlSelf->i_ddr3_controller_iserdes_data[0U] 
                                       | vlSelf->i_ddr3_controller_iserdes_data[1U]) 
                                      | vlSelf->i_ddr3_controller_iserdes_data[2U]) 
                                     | vlSelf->i_ddr3_controller_iserdes_data[3U]))));
    bufp->fullSData(oldp+4248,(vlSelf->o_gpio),16);
    bufp->fullIData(oldp+4249,(vlSelf->main__DOT____Vcellinp__scope2_ddr3i____pinNumber4),31);
    bufp->fullCData(oldp+4250,(((IData)(vlSelf->cpu_sim_cyc)
                                 ? 0xfU : (0xfU & ((IData)(vlSelf->main__DOT____Vcellout__wbu_xbar__o_ssel) 
                                                   >> 4U)))),4);
    bufp->fullIData(oldp+4251,(vlSelf->main__DOT__swic__DOT__thecpu__DOT__core__DOT__dcd_pc),28);
    bufp->fullBit(oldp+4252,((((~ ((IData)(vlSelf->main__DOT__swic__DOT__thecpu__DOT__core__DOT__dcd_F) 
    ...
    bufp->fullBit(oldp+4253,(vlSelf->main__DOT__swic__DOT__thecpu__DOT__core__DOT__instruction_decoder__DOT__o_sim));
    bufp->fullIData(oldp+4254,(vlSelf->main__DOT__swic__DOT__thecpu__DOT__core__DOT__instruction_decoder__DOT__o_sim_immv),23);
    bufp->fullBit(oldp+4255,(vlSelf->main__DOT__swic__DOT__thecpu__DOT__core__DOT__op_valid));
    bufp->fullBit(oldp+4256,(vlSelf->main__DOT__swic__DOT__thecpu__DOT__core__DOT__op_sim));
    bufp->fullIData(oldp+4257,(vlSelf->main__DOT__swic__DOT__thecpu__DOT__core__DOT__op_sim_immv),23);
    bufp->fullBit(oldp+4258,(vlSelf->main__DOT__swic__DOT__thecpu__DOT__core__DOT__alu_sim));
    bufp->fullIData(oldp+4259,(vlSelf->main__DOT__swic__DOT__thecpu__DOT__core__DOT__alu_sim_immv),23);
    bufp->fullBit(oldp+4260,(vlSelf->main__DOT__swic__DOT__thecpu__DOT__core__DOT__alu_ce));
    bufp->fullIData(oldp+4261,((((IData)(vlSelf->main__DOT__u_fan__DOT__u_i2ccpu__DOT__half_insn) 
                                                                         ...
                                                                         | (((IData)(vlSelf->main__DOT__u_fan__DOT__u_i2ccpu__DOT__GEN_MANUAL__DOT__o_sda) 
                                                                            ...
                                                                            | (((IData)(vlSelf->i_fan_scl) 
                                                                               ...
                                                                               | (((IData)(vlSelf->i_fan_sda) 
                                                                                << 0xcU) 
                                                                                | (IData)(vlSelf->main__DOT__u_fan__DOT__u_i2ccpu__DOT__insn)))))))))))))))),32);
    bufp->fullSData(oldp+4262,(((0xfffff800U & ((IData)(vlSelf->main__DOT____Vcellout__wb32_xbar__o_scyc) 
    ...
    bufp->fullIData(oldp+4263,(vlSelf->main__DOT__wb32_xbar__DOT__iM),32);
    bufp->fullCData(oldp+4264,(vlSelf->main__DOT__wb32_xbar__DOT__ARBITRATE_REQUESTS__BRA__0__KET____DOT__MINDEX_MULTIPLE_SLAVES__DOT__r_reindex),4);
    bufp->fullCData(oldp+4265,(((((IData)(vlSelf->cpu_sim_cyc) 
                                  | (IData)(vlSelf->main__DOT__swic__DOT__DELAY_THE_DEBUG_BUS__DOT__wbdelay__DOT__SKIDBUFFER__DOT__r_stb)) 
                                 << 1U) | (IData)(vlSelf->main__DOT__wbu_wbu_arbiter_stall))),2);
    bufp->fullCData(oldp+4266,(((((~ (IData)(vlSelf->cpu_sim_cyc)) 
                                  & (IData)(vlSelf->main__DOT__raw_cpu_dbg_ack)) 
                                 << 1U) | (IData)(vlSelf->main__DOT__wbu_arbiter_upsz__DOT__UPSIZE__DOT__r_ack))),2);
    bufp->fullCData(oldp+4267,(((0xfffffffeU & ((IData)(vlSelf->main__DOT____Vcellout__wbu_xbar__o_scyc) 
    ...
    bufp->fullIData(oldp+4268,(vlSelf->main__DOT__wbu_xbar__DOT__iM),32);
    bufp->fullCData(oldp+4269,(vlSelf->main__DOT__wbu_xbar__DOT__ARBITRATE_REQUESTS__BRA__0__KET____DOT__MINDEX_MULTIPLE_SLAVES__DOT__r_reindex),2);
    bufp->fullIData(oldp+4270,(vlSelf->main__DOT__wbwide_xbar__DOT__iN),32);
    bufp->fullIData(oldp+4271,(vlSelf->main__DOT__wbwide_xbar__DOT__iM),32);
    bufp->fullCData(oldp+4272,(vlSelf->main__DOT__wbwide_xbar__DOT__ARBITRATE_REQUESTS__BRA__0__KET____DOT__MINDEX_MULTIPLE_SLAVES__DOT__r_reindex),2);
    bufp->fullCData(oldp+4273,(vlSelf->main__DOT__wbwide_xbar__DOT__ARBITRATE_REQUESTS__BRA__1__KET____DOT__MINDEX_MULTIPLE_SLAVES__DOT__r_reindex),2);
    bufp->fullCData(oldp+4274,(vlSelf->main__DOT__wbwide_xbar__DOT__ARBITRATE_REQUESTS__BRA__2__KET____DOT__MINDEX_MULTIPLE_SLAVES__DOT__r_reindex),2);
    bufp->fullCData(oldp+4275,(vlSelf->main__DOT__wbwide_xbar__DOT__ARBITRATE_REQUESTS__BRA__3__KET____DOT__MINDEX_MULTIPLE_SLAVES__DOT__r_reindex),2);
    bufp->fullDouble(oldp+4276,(10.0));
    bufp->fullDouble(oldp+4278,(2.50000000000000000e+00));
    bufp->fullIData(oldp+4280,(0xeU),32);
    bufp->fullIData(oldp+4281,(0xaU),32);
    bufp->fullIData(oldp+4282,(3U),32);
    bufp->fullIData(oldp+4283,(8U),32);
    bufp->fullIData(oldp+4284,(2U),32);
    bufp->fullIData(oldp+4285,(1U),32);
    bufp->fullIData(oldp+4286,(4U),32);
    bufp->fullIData(oldp+4287,(0x18U),32);
    bufp->fullIData(oldp+4288,(0x2000000U),32);
    bufp->fullIData(oldp+4289,(0x16U),32);
    bufp->fullIData(oldp+4290,(0x10U),32);
    bufp->fullBit(oldp+4291,(1U));
    bufp->fullIData(oldp+4292,(0x64U),24);
    bufp->fullIData(oldp+4293,(7U),32);
    bufp->fullIData(oldp+4294,(0x13U),32);
    bufp->fullIData(oldp+4295,(0U),32);
    bufp->fullBit(oldp+4296,(0U));
    bufp->fullBit(oldp+4297,(1U));
    bufp->fullWData(oldp+4298,(Vmain__ConstPool__CONST_h93e1b771_0),512);
    bufp->fullQData(oldp+4314,(0xffffffffffffffffULL),64);
    bufp->fullIData(oldp+4316,(vlSelf->main__DOT__wb32_buildtime_addr),25);
    bufp->fullBit(oldp+4317,(vlSelf->main__DOT__wb32_buildtime_err));
    bufp->fullIData(oldp+4318,(0x102339U),32);
    bufp->fullIData(oldp+4319,(vlSelf->main__DOT__wb32_gpio_addr),25);
    bufp->fullBit(oldp+4320,(vlSelf->main__DOT__wb32_gpio_err));
    bufp->fullIData(oldp+4321,(vlSelf->main__DOT__wb32_sirefclk_addr),25);
    bufp->fullBit(oldp+4322,(vlSelf->main__DOT__wb32_sirefclk_err));
    bufp->fullIData(oldp+4323,(vlSelf->main__DOT__wb32_spio_addr),25);
    bufp->fullBit(oldp+4324,(vlSelf->main__DOT__wb32_spio_err));
    bufp->fullIData(oldp+4325,(vlSelf->main__DOT__wb32_version_addr),25);
    bufp->fullBit(oldp+4326,(vlSelf->main__DOT__wb32_version_err));
    bufp->fullIData(oldp+4327,(0x20230827U),32);
    bufp->fullCData(oldp+4328,(0xfU),4);
    bufp->fullCData(oldp+4329,(0x20U),8);
    bufp->fullIData(oldp+4330,(0x14U),32);
    bufp->fullIData(oldp+4331,(0x200U),32);
    bufp->fullCData(oldp+4332,(0U),8);
    bufp->fullBit(oldp+4333,(0U));
    bufp->fullIData(oldp+4334,(0x20U),32);
    bufp->fullCData(oldp+4335,(6U),4);
    bufp->fullCData(oldp+4336,(0U),2);
    bufp->fullCData(oldp+4337,(1U),2);
    bufp->fullCData(oldp+4338,(2U),2);
    bufp->fullCData(oldp+4339,(3U),2);
    bufp->fullIData(oldp+4340,(0x40U),32);
    bufp->fullIData(oldp+4341,(0x80U),32);
    bufp->fullCData(oldp+4342,(0U),4);
    bufp->fullCData(oldp+4343,(1U),4);
    bufp->fullCData(oldp+4344,(2U),4);
    bufp->fullCData(oldp+4345,(3U),4);
    bufp->fullCData(oldp+4346,(4U),4);
    bufp->fullCData(oldp+4347,(5U),4);
    bufp->fullCData(oldp+4348,(7U),4);
    bufp->fullIData(oldp+4349,(0x1bU),32);
    bufp->fullIData(oldp+4350,(0x1aU),32);
    bufp->fullIData(oldp+4351,(0x19U),32);
    bufp->fullIData(oldp+4352,(0x17U),32);
    bufp->fullIData(oldp+4353,(0x12U),32);
    bufp->fullIData(oldp+4354,(0x15U),32);
    bufp->fullIData(oldp+4355,(0x11U),32);
    bufp->fullIData(oldp+4356,(0xdU),32);
    bufp->fullIData(oldp+4357,(0xbebc200U),32);
    bufp->fullIData(oldp+4358,(0x1dcd6500U),32);
    bufp->fullDouble(oldp+4359,(1.37500000000000000e+01));
    bufp->fullIData(oldp+4361,(0x23U),32);
    bufp->fullDouble(oldp+4362,(350.0));
    bufp->fullIData(oldp+4364,(0x1e78U),32);
    bufp->fullDouble(oldp+4365,(360.0));
    bufp->fullDouble(oldp+4367,(15.0));
    bufp->fullIData(oldp+4369,(0xaU),19);
    bufp->fullDouble(oldp+4370,(7.50000000000000000e+00));
    bufp->fullIData(oldp+4372,(6U),32);
    bufp->fullIData(oldp+4373,(5U),32);
    bufp->fullIData(oldp+4374,(0x2f080U),19);
    bufp->fullIData(oldp+4375,(9U),32);
    bufp->fullIData(oldp+4376,(0xbU),32);
    bufp->fullIData(oldp+4377,(0xcU),32);
    bufp->fullCData(oldp+4378,(0U),3);
    bufp->fullCData(oldp+4379,(2U),3);
    bufp->fullIData(oldp+4380,(0x20040U),19);
    bufp->fullCData(oldp+4381,(3U),3);
    bufp->fullIData(oldp+4382,(0x30004U),19);
    bufp->fullIData(oldp+4383,(0x30000U),19);
    bufp->fullCData(oldp+4384,(1U),3);
    bufp->fullIData(oldp+4385,(0x100c4U),19);
    bufp->fullIData(oldp+4386,(0x10044U),19);
    bufp->fullIData(oldp+4387,(0x720U),19);
    bufp->fullIData(oldp+4388,(0x4380005U),28);
    bufp->fullIData(oldp+4389,(vlSelf->main__DOT__ddr3_controller_inst__DOT__get_slot__Vstatic__delay),32);
    bufp->fullCData(oldp+4390,(vlSelf->main__DOT__ddr3_controller_inst__DOT__get_slot__Vstatic__slot_number),2);
    bufp->fullCData(oldp+4391,(vlSelf->main__DOT__ddr3_controller_inst__DOT__get_slot__Vstatic__read_slot),2);
    bufp->fullCData(oldp+4392,(vlSelf->main__DOT__ddr3_controller_inst__DOT__get_slot__Vstatic__write_slot),2);
    bufp->fullCData(oldp+4393,(vlSelf->main__DOT__ddr3_controller_inst__DOT__get_slot__Vstatic__anticipate_activate_slot),2);
    bufp->fullCData(oldp+4394,(vlSelf->main__DOT__ddr3_controller_inst__DOT__get_slot__Vstatic__anticipate_precharge_slot),2);
    bufp->fullIData(oldp+4395,(vlSelf->main__DOT__ddr3_controller_inst__DOT__find_delay__Vstatic__k),32);
    bufp->fullIData(oldp+4396,(0x1eU),32);
    bufp->fullIData(oldp+4397,(0x24U),32);
    bufp->fullIData(oldp+4398,(0x400U),32);
    bufp->fullCData(oldp+4399,(0U),5);
    bufp->fullQData(oldp+4400,(0x100000000ULL),36);
    bufp->fullQData(oldp+4402,(0x40000000ULL),36);
    bufp->fullQData(oldp+4404,(0ULL),36);
    bufp->fullCData(oldp+4406,(0x4fU),7);
    bufp->fullCData(oldp+4407,(0x49U),7);
    bufp->fullIData(oldp+4408,(0x1cU),32);
    bufp->fullIData(oldp+4409,(0U),28);
    bufp->fullSData(oldp+4410,(0xfffU),12);
    bufp->fullCData(oldp+4411,(8U),4);
    bufp->fullCData(oldp+4412,(9U),4);
    bufp->fullCData(oldp+4413,(0xaU),4);
    bufp->fullCData(oldp+4414,(0xbU),4);
    bufp->fullCData(oldp+4415,(0xcU),4);
    bufp->fullCData(oldp+4416,(0xdU),4);
    bufp->fullCData(oldp+4417,(4U),3);
    bufp->fullCData(oldp+4418,(5U),3);
    bufp->fullCData(oldp+4419,(6U),3);
    bufp->fullCData(oldp+4420,(7U),3);
    bufp->fullCData(oldp+4421,(0xaU),5);
    bufp->fullIData(oldp+4422,(0x1fU),32);
    bufp->fullIData(oldp+4423,(0x1fcU),20);
    bufp->fullIData(oldp+4424,(0x7fffffffU),31);
    bufp->fullCData(oldp+4425,(0x64U),7);
    bufp->fullCData(oldp+4426,(0x32U),7);
    bufp->fullIData(oldp+4427,(0xc0000000U),32);
    bufp->fullCData(oldp+4428,(1U),8);
    bufp->fullCData(oldp+4429,(2U),8);
    bufp->fullCData(oldp+4430,(3U),8);
    bufp->fullCData(oldp+4431,(4U),8);
    bufp->fullCData(oldp+4432,(5U),8);
    bufp->fullCData(oldp+4433,(6U),8);
    bufp->fullCData(oldp+4434,(7U),8);
    bufp->fullCData(oldp+4435,(8U),8);
    bufp->fullCData(oldp+4436,(9U),8);
    bufp->fullCData(oldp+4437,(0xaU),8);
    bufp->fullCData(oldp+4438,(0xbU),8);
    bufp->fullCData(oldp+4439,(0xcU),8);
    bufp->fullCData(oldp+4440,(0xdU),8);
    bufp->fullCData(oldp+4441,(0xeU),8);
    bufp->fullCData(oldp+4442,(0xfU),8);
    bufp->fullCData(oldp+4443,(0x80U),8);
    bufp->fullCData(oldp+4444,(0x10U),8);
    bufp->fullIData(oldp+4445,(0U),20);
    bufp->fullIData(oldp+4446,(0x208U),32);
    __Vtemp_hf465e4c8__0[0U] = 0x54494e47U;
    __Vtemp_hf465e4c8__0[1U] = 0x45524e41U;
    __Vtemp_hf465e4c8__0[2U] = 0x414c54U;
    bufp->fullWData(oldp+4447,(__Vtemp_hf465e4c8__0),88);
    bufp->fullIData(oldp+4450,(0x41425254U),32);
    bufp->fullIData(oldp+4451,(0x40U),32);
    bufp->fullIData(oldp+4452,(0xfU),32);
    bufp->fullBit(oldp+4453,(vlSelf->main__DOT__swic__DOT__thecpu__DOT__DATA_CACHE__DOT__mem__DOT__UNUSED_BITS__DOT__unused_aw));
    bufp->fullIData(oldp+4454,(0x800000U),26);
    bufp->fullCData(oldp+4455,(0xeU),4);
    bufp->fullSData(oldp+4456,(0x1d7U),9);
    bufp->fullSData(oldp+4457,(0x2000U),14);
    bufp->fullIData(oldp+4458,(0U),31);
    bufp->fullCData(oldp+4459,(7U),5);
    bufp->fullIData(oldp+4460,(0x5f5e100U),32);
    bufp->fullIData(oldp+4461,(0x186a0U),32);
    bufp->fullIData(oldp+4462,(0x4e20U),32);
    bufp->fullIData(oldp+4463,(0x1387U),32);
    bufp->fullSData(oldp+4464,(0xc8U),12);
    bufp->fullIData(oldp+4465,(0x10U),32);
    bufp->fullWData(oldp+4466,(Vmain__ConstPool__CONST_h3dd842ba_0),300);
    bufp->fullWData(oldp+4476,(Vmain__ConstPool__CONST_h21727c79_0),300);
    bufp->fullSData(oldp+4486,(0U),12);
    bufp->fullSData(oldp+4487,(0xf000U),16);
    bufp->fullIData(oldp+4488,(0x25U),32);
    bufp->fullIData(oldp+4489,(0x3eU),32);
    bufp->fullQData(oldp+4490,(0x20000000000000ULL),54);
    bufp->fullQData(oldp+4492,(0x20000004000000ULL),54);
    bufp->fullQData(oldp+4494,(0x80000080000ULL),44);
    bufp->fullQData(oldp+4496,(0x80000380000ULL),44);
    bufp->fullIData(oldp+4498,(0x241U),32);
    bufp->fullIData(oldp+4499,(0x257U),32);
}

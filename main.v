...
// DO NOT EDIT THIS FILE!
//
// CmdLine:	autofpga autofpga -I .: -d -o . allclocks.txt global.txt wbdown.txt icape.txt version.txt gpio.txt spio.txt wbuconsole.txt zipmaster.txt bkram.txt ddr3.txt ddr3scope.txt mem_bkram_only.txt mem_flash_bkram.txt i2ccpu.txt fan.txt sirefclk.txt i2cscope.txt
//
...
// }}}
	...
	//
	wire	scope1_ddr3_int;	// scope1_ddr3.INT.DDR3SCOPE1.WIRE
	wire	scope2_ddr3_int;	// scope2_ddr3.INT.DDR3SCOPE2.WIRE
	...
	wire	scope3_ddr3_int;	// scope3_ddr3.INT.DDR3SCOPE2.WIRE
...
// }}}
	...
	wire	[24:0]	wb32_scope1_ddr3_addr;
	...
	wire	[31:0]	wb32_scope1_ddr3_idata;
	// Verilator lint_on UNUSED
	...
	wire	[24:0]	wb32_scope2_ddr3_addr;
	...
	wire	[31:0]	wb32_scope2_ddr3_idata;
	// Verilator lint_on UNUSED
	...
	wire	[24:0]	wb32_scope3_ddr3_addr;
	...
	wire	[24:0]	wb32_ddr3_controller_addr;
	...
	//
	wbxbar #(
		.NM(4), .NS(2), .AW(22), .DW(512),
		.SLAVE_ADDR({
			// Address width    = 22
			// Address LSBs     = 6
			// Slave name width = 6
			{ 22'h200000 }, // wbdown: 0x8000000
			{ 22'h080000 }  //  bkram: 0x2000000
		}),
		.SLAVE_MASK({
			// Address width    = 22
			// Address LSBs     = 6
	...
	assign	wb32_buildtime_stb = wb32_sio_stb && (wb32_sio_addr[ 2: 0] ==  3'h0);  // 0x0000000
	...
	assign	wb32_gpio_stb = wb32_sio_stb && (wb32_sio_addr[ 2: 0] ==  3'h1);  // 0x0000004
	...
	assign	wb32_sirefclk_stb = wb32_sio_stb && (wb32_sio_addr[ 2: 0] ==  3'h2);  // 0x0000008
	...
	assign	wb32_spio_stb = wb32_sio_stb && (wb32_sio_addr[ 2: 0] ==  3'h3);  // 0x000000c
	...
	assign	wb32_version_stb = wb32_sio_stb && (wb32_sio_addr[ 2: 0] ==  3'h4);  // 0x0000010
	...
	assign	wb32_scope1_ddr3_err= 1'b0;
	assign	wb32_scope2_ddr3_err= 1'b0;
	assign	wb32_scope3_ddr3_err= 1'b0;
	...
	//
	wbxbar #(
		.NM(1), .NS(12), .AW(25), .DW(32),
		.SLAVE_ADDR({
			// Address width    = 25
			// Address LSBs     = 2
			// Slave name width = 15
			{ 25'h1000000 }, // ddr3_controller: 0x4000000
			{ 25'h0a00000 }, //        ddr3_phy: 0x2800000
			{ 25'h0900000 }, //             cfg: 0x2400000
			{ 25'h0800000 }, //        wb32_sio: 0x2000000
			{ 25'h0700000 }, //             fan: 0x1c00000
			{ 25'h0600000 }, //            uart: 0x1800000
			{ 25'h0500000 }, //          i2cdma: 0x1400000
			{ 25'h0400000 }, //             i2c: 0x1000000
			{ 25'h0300000 }, //     scope3_ddr3: 0x0c00000
			{ 25'h0200000 }, //     scope2_ddr3: 0x0800000
			{ 25'h0100000 }, //     scope1_ddr3: 0x0400000
			{ 25'h0000000 }  //        i2cscope: 0x0000000
		}),
		.SLAVE_MASK({
			// Address width    = 25
			// Address LSBs     = 2
			...
			{ 25'h1f00000 }, //        ddr3_phy
			{ 25'h1f00000 }, //             cfg
			{ 25'h1f00000 }, //        wb32_sio
			{ 25'h1f00000 }, //             fan
			{ 25'h1f00000 }, //            uart
			{ 25'h1f00000 }, //          i2cdma
			{ 25'h1f00000 }, //             i2c
			{ 25'h1f00000 }, //     scope3_ddr3
			{ 25'h1f00000 }, //     scope2_ddr3
			{ 25'h1f00000 }, //     scope1_ddr3
			{ 25'h1f00000 }  //        i2cscope
		}),
		.OPT_DBLBUFFER(1'b1))
	wb32_xbar(
		.i_clk(i_clk), .i_reset(i_reset),
		...
		.o_scyc({
			...
			wb32_i2cdma_cyc,
			wb32_i2cs_cyc,
			wb32_scope3_ddr3_cyc,
			wb32_scope2_ddr3_cyc,
			wb32_scope1_ddr3_cyc,
			wb32_i2cscope_cyc
		}),
		.o_sstb({
			...
			wb32_i2cdma_stb,
			wb32_i2cs_stb,
			wb32_scope3_ddr3_stb,
			wb32_scope2_ddr3_stb,
			wb32_scope1_ddr3_stb,
			wb32_i2cscope_stb
		}),
		.o_swe({
		...
		.o_saddr({
			...
			wb32_i2cdma_addr,
			wb32_i2cs_addr,
			wb32_scope3_ddr3_addr,
			wb32_scope2_ddr3_addr,
			wb32_scope1_ddr3_addr,
			wb32_i2cscope_addr
		}),
		.o_sdata({
			...
			wb32_i2cdma_data,
			wb32_i2cs_data,
			wb32_scope3_ddr3_data,
			wb32_scope2_ddr3_data,
			wb32_scope1_ddr3_data,
			wb32_i2cscope_data
		}),
		.o_ssel({
			...
			wb32_i2cdma_sel,
			wb32_i2cs_sel,
			wb32_scope3_ddr3_sel,
			wb32_scope2_ddr3_sel,
			wb32_scope1_ddr3_sel,
			wb32_i2cscope_sel
		}),
		.i_sstall({
			...
			wb32_i2cdma_stall,
			wb32_i2cs_stall,
			wb32_scope3_ddr3_stall,
			wb32_scope2_ddr3_stall,
			wb32_scope1_ddr3_stall,
			wb32_i2cscope_stall
		}),
		.i_sack({
			...
			wb32_i2cdma_ack,
			wb32_i2cs_ack,
			wb32_scope3_ddr3_ack,
			wb32_scope2_ddr3_ack,
			wb32_scope1_ddr3_ack,
			wb32_i2cscope_ack
		}),
		.i_sdata({
			...
			wb32_i2cdma_idata,
			wb32_i2cs_idata,
			wb32_scope3_ddr3_idata,
			wb32_scope2_ddr3_idata,
			wb32_scope1_ddr3_idata,
			wb32_i2cscope_idata
		}),
		.i_serr({
			...
			wb32_i2cdma_err,
			wb32_i2cs_err,
			wb32_scope3_ddr3_err,
			wb32_scope2_ddr3_err,
			wb32_scope1_ddr3_err,
			wb32_i2cscope_err
		})
		);
...
`ifdef	DDR3SCOPE1_SCOPC
	...
	wbscopc #(
		...
		// {{{
		i_clk, 1'b1, ddr3_controller_debug1[31], ddr3_controller_debug1[30:0],
		i_clk,
		wb32_scope1_ddr3_cyc, wb32_scope1_ddr3_stb, wb32_scope1_ddr3_we,
			wb32_scope1_ddr3_addr[1-1:0],
			wb32_scope1_ddr3_data, // 32 bits wide
			wb32_scope1_ddr3_sel,  // 32/8 bits wide
		wb32_scope1_ddr3_stall, wb32_scope1_ddr3_ack, wb32_scope1_ddr3_idata,
		scope1_ddr3_int
		// }}}
	);
	// }}}
`else	// DDR3SCOPE1_SCOPC
	...
	//
	// In the case that there is no wb32_scope1_ddr3 peripheral
	// responding on the wb32 bus
	assign	wb32_scope1_ddr3_ack   = 1'b0;
	assign	wb32_scope1_ddr3_err   = (wb32_scope1_ddr3_stb);
	assign	wb32_scope1_ddr3_stall = 0;
	assign	wb32_scope1_ddr3_idata = 0;

	// }}}
	// Null interrupt definitions
	// {{{
	assign	scope1_ddr3_int = 1'b0;	// scope1_ddr3.INT.DDR3SCOPE1.WIRE
	// }}}
	// }}}
...
`ifdef	DDR3SCOPE2_SCOPC
	...
	wbscopc #(
		...
		// {{{
		i_clk, 1'b1, ddr3_controller_debug2[31], ddr3_controller_debug2[30:0],
		i_clk,
		wb32_scope2_ddr3_cyc, wb32_scope2_ddr3_stb, wb32_scope2_ddr3_we,
			wb32_scope2_ddr3_addr[1-1:0],
			wb32_scope2_ddr3_data, // 32 bits wide
			wb32_scope2_ddr3_sel,  // 32/8 bits wide
		wb32_scope2_ddr3_stall, wb32_scope2_ddr3_ack, wb32_scope2_ddr3_idata,
		scope2_ddr3_int
		// }}}
	);
	// }}}
`else	// DDR3SCOPE2_SCOPC
	...
	//
	// In the case that there is no wb32_scope2_ddr3 peripheral
	// responding on the wb32 bus
	assign	wb32_scope2_ddr3_ack   = 1'b0;
	assign	wb32_scope2_ddr3_err   = (wb32_scope2_ddr3_stb);
	assign	wb32_scope2_ddr3_stall = 0;
	assign	wb32_scope2_ddr3_idata = 0;

	// }}}
	// Null interrupt definitions
	// {{{
	assign	scope2_ddr3_int = 1'b0;	// scope2_ddr3.INT.DDR3SCOPE2.WIRE
	// }}}
	// }}}
...
`ifdef	DDR3_CONTROLLER_ACCESS
	...
	ddr3_controller #(
			...
			.i_wb_addr(wb32_ddr3_controller_addr[24-1:0]),
...
`endif	// I2CCPU_ACCESS
	...
	wbdown #(
		...
		.i_waddr( wbwide_wbdown_addr[21-1:0]),
		...
		.o_saddr( wb32_wbdown_addr[25-1:0]),
...
`ifdef	DDR3SCOPE3_SCOPC
	...
	wbscopc #(
		...
		// {{{
		i_clk, 1'b1, ddr3_controller_debug3[31], ddr3_controller_debug3[30:0],
		i_clk,
		wb32_scope3_ddr3_cyc, wb32_scope3_ddr3_stb, wb32_scope3_ddr3_we,
			wb32_scope3_ddr3_addr[1-1:0],
			wb32_scope3_ddr3_data, // 32 bits wide
			wb32_scope3_ddr3_sel,  // 32/8 bits wide
		wb32_scope3_ddr3_stall, wb32_scope3_ddr3_ack, wb32_scope3_ddr3_idata,
		scope3_ddr3_int
		// }}}
	);
	// }}}
`else	// DDR3SCOPE3_SCOPC
	...
	//
	// In the case that there is no wb32_scope3_ddr3 peripheral
	// responding on the wb32 bus
	assign	wb32_scope3_ddr3_ack   = 1'b0;
	assign	wb32_scope3_ddr3_err   = (wb32_scope3_ddr3_stb);
	assign	wb32_scope3_ddr3_stall = 0;
	assign	wb32_scope3_ddr3_idata = 0;

	// }}}
	// Null interrupt definitions
	// {{{
	assign	scope3_ddr3_int = 1'b0;	// scope3_ddr3.INT.DDR3SCOPE2.WIRE
	// }}}
	// }}}
